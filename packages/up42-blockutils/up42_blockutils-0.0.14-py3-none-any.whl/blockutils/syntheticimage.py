...
class SyntheticImage:
    ...
    def __init__(
        ...
        Arguments:
            ...
            nodata: Value representing nodata within each raster band, default is 0.
    ...
    def add_img_pattern(self, seed: int) -> np.ndarray:
        """
    ...
    def create(
        ...
        with rasterio.open(
            ...
            for band_id, layer in enumerate(band_list):
                layer[0 : self.nodata_fill, 0 : self.nodata_fill] = self.nodata
