...
def generate_file_paths(lh_gii_path=None, lh_inclusion_mask=None, 
			nifti_ts_path=None, nifti_inclusion_mask=None, aroma_included=True):
    """
    ...
    if type(lh_gifti_inclusion_mask) != type(None):

	path_dictionary['lh_inclusion_mask_path'] = lh_inclusion_mask
	path_dictionary['rh_inclusion_mask_path'] = 'rh' + lh_inclusion_mask[2:]
    ...
    if type(nifti_inclusion_mask) != type(None):

	path_dictionary['nifti_inclusion_mask_path'] = nifti_inclusion_mask
