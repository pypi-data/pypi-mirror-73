...
class MBTilesClient:
    ...
    def parse_and_clean_metadata(self):
        ...
        carto_partition_query = """
            SELECT q1.min_zoom_level, q1.max_zoom_level, MIN(q0.tile_column), MAX(q0.tile_column), MIN(q0.tile_row), MAX(q0.tile_row)
                FROM (SELECT zoom_level, tile_column, ((2 << (zoom_level - 1)) - tile_row - 1) AS tile_row FROM tiles) q0,
