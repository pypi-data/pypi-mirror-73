...
toml_file_path = Path(__file__).parent.joinpath('pyproject.toml')
...
VERSION = toml_config.get('tool.poetry', 'version', fallback='0.1.1').replace('"', '')
...
TILESET_VALID_VERSIONS = ['3']
CARTO_PARTITION_VALID_VERSIONS = [1]
