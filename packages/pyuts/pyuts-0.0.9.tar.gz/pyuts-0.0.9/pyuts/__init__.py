...
try:
    from pyuts.py_crawl.scrapyPiplineU import ScrapyPiplineU

    def scrapyPiplineU(key=None) -> ScrapyPiplineU:
        '''
        
        scrapyPipline相关封装工具
        
        '''
        return ScrapyPiplineU.produce(key)
except ImportError as e:
    print(e)
...
try:
    from pyuts.py_crawl.scrapyMiddlewareU import ScrapyMiddlewareU

    def scrapyMiddlewareU(key=None) -> ScrapyMiddlewareU:
        '''
        
        scrapyMiddleware相关封装工具
        
        '''
        return ScrapyMiddlewareU.produce(key)
except ImportError as e:
    print(e)
