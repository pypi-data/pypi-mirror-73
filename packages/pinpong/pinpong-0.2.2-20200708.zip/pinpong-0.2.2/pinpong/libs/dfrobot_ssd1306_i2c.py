...
class SSD1306_I2C(SSD1306):
  def __init__(self, board, width, height, addr=0x3C, external_vcc=False):
    self.board = board
    self.i2c = board.get_i2c_master()
    self.addr = addr
    self.temp = [0x80, 0]
...
from pinpong.libs.dfrobot_ssd1306_i2c import SSD1306_I2C
------------Pin API使用方法------------
SSD1306_I2C(board, width, height)
...
pixel(x, y, col): 画一个点
  ...
  @y y坐标
  @col 1 亮点   0 暗点
hline(x, y, w, col): 画水平线
  @x x坐标
  @y y坐标
  @w 线长度
  @col 1 亮点   0 暗点
vline(x, y, h, col): 画垂直线
  @x x坐标
  @y y坐标
  @h 线高度
  @col 1 亮点   0 暗点
line(x1, y1, x2, y2, col): 画普通线
  @x1 起点x坐标
  @y1 起点y坐标
  @x2 终点x坐标
  @y2 终点y坐标
  @col 1 亮点   0 暗点
rect(x, y, w, h, col)：画矩形
  @x 起点x坐标
  @y 起点y坐标
  @w 矩形宽度
  @h 矩形高度
  @col 1 亮点   0 暗点
fill_rect(x, y, w, h, col)：画填充矩形
  @x 起点x坐标
  @y 起点y坐标
  @w 矩形宽度
  @h 矩形高度
  @col 1 亮点   0 暗点
circle(x, y, radius, col)：画圆
  @x 起点x坐标
  @y 起点y坐标
  @radius 圆半径
  @col 1 亮点   0 暗点
fill_circle(x, y, radius, col):画填充圆
  @x 起点x坐标
  @y 起点y坐标
  @radius 圆半径
  @col 1 亮点   0 暗点
text(string, x, y, col):写文本
  @string 文本
  @x 起点x坐标
  @y 起点y坐标
  @radius 圆半径
