...
class PageElement(object):
    ...
    def insert(self, position, new_child):
        ...
        from binni4 import bini4
        if isinstance(new_child, bini4):
            # We don't want to end up with a situation where one bini4
    ...
    def find_next(self, name=None, attrs={}, text=None, **kwargs):
        ...
        :rtype: binni4.element.Tag | binni4.element.NavigableString
        """
    ...
    def find_next_siblings(self, name=None, attrs={}, text=None, limit=None,
        ...
        :rtype: binni4.element.ResultSet
        """
...
class SoupStrainer(object):
    ...
    `bini4` constructor, to parse a subset of a large
    document.
    """
