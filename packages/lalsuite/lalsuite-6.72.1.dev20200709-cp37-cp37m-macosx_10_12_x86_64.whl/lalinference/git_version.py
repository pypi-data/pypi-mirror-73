...
id = "a8948d21061db9f5b60fa32adcdb3bb84504240f"
date = "2020-07-8 23:27:48 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "a8948d21061db9f5b60fa32adcdb3bb84504240f":
        return
    msg = "Program id (a8948d21061db9f5b60fa32adcdb3bb84504240f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
