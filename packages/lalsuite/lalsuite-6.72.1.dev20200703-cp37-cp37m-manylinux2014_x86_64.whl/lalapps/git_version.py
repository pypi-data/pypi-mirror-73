...
id = "fb245ac0744375368c3d71dea76596a7ba041cd0"
date = "2020-07-1 15:21:42 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "fb245ac0744375368c3d71dea76596a7ba041cd0":
        return
    msg = "Program id (fb245ac0744375368c3d71dea76596a7ba041cd0) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
