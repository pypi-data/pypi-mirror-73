...
@jsii.implements(aws_cdk.core.IInspectable)
class CfnHostedConfigurationVersion(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appconfig.CfnHostedConfigurationVersion"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, application_id: str, configuration_profile_id: str, content: str, content_type: str, description: typing.Optional[str]=None, latest_version_number: typing.Optional[jsii.Number]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnHostedConfigurationVersion":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-appconfig.CfnHostedConfigurationVersionProps", jsii_struct_bases=[], name_mapping={'application_id': 'applicationId', 'configuration_profile_id': 'configurationProfileId', 'content': 'content', 'content_type': 'contentType', 'description': 'description', 'latest_version_number': 'latestVersionNumber'})
