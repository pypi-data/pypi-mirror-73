...
class Production_order_opers_per_launch(Hierarcy):
    ...
    operation_operation = ForeignKeyProtect(Operation_operation, null=True, blank=True)
    num = CodeField()
    ...
    # location_sector = ForeignKeyProtect(Locations, related_name='Production_order_opers_per_launch_location_sector')
