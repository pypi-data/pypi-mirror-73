...
**当前包的版本为：NASFileGrpcSystem==1.1.0 （新版本增加对Python2.7的支持）** 
**前一版本为：NASFileGrpcSystem==1.0.0** 
...
from NASFileGrpcSystem import create_file, describe_file, modify_file, copy_file, move_file
