...
def get_reservation_errors(
    ...
    get_activities_url = f"GetFilteredActivityFeedInfoList?diagramId={reservation_id}"
    ...
    with requests.session() as session:
        ...
        enc_user = public_key.encrypt(conf.user, padding.PKCS1v15())
        enc_user = base64.b64encode(enc_user)
        enc_pass = public_key.encrypt(conf.password, padding.PKCS1v15())
