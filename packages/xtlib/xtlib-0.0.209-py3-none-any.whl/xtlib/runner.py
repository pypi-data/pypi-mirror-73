...
class Runner():
    ...
    def snapshot_all_code(self, bootstrap_dir, snapshot_dir, cmd_parts, args):
        ...
        if xtlib_capture:
            ...
            # copy XTLIB directory to "xtlib" subdir of BOOTSTRAP SNAPSHOT
            dest_dir = bootstrap_dir + "/xtlib"
    ...
    def process_run_command(self, args):
        ...
        bootstrap_dir = os.path.join(snapshot_base, "bootstrap")
        ...
        if not fake_submit:
            if code_upload:
                ...
                # zip and upload XT BOOTSTRAP files
                self.core.upload_before_files_to_job(job_id, bootstrap_dir, "before/bootstrap", code_omit, "fast", "bootstrap", args)
