...
class AzureML(BackendBase):
    ...
    def create_estimator(self, job_id, workspace, aml_ws_name, xt_exper_name, aml_exper_name, run_name, code_dir, target_fn, arg_dict, 
        ...
        use_environment = bool(container_registry)  #   use_docker
        ...
        if fake_submit or self.submit_logs:
            ...
            if use_environment:
                serializable_environment = {"environment_variables": env_vars, "docker": {"enabled": use_docker, "gpu_support": use_gpu,
                ...
                self.serializable_estimator = {"source_directory": code_dir, "script_params": arg_dict, "compute_target": actual_target, 
                    ...
                    "pip_requirements_file": fn_requirements, "use_gpu": use_gpu, "use_docker": use_docker, 
        ...
        if fake_submit:
            ...
            if use_environment:
                ...
                # TODO: specify conda_packages and pip_packages here
    ...
    def read_log_file(self, service_node_info, log_name, start_offset=0, end_offset=None, 
        ...
        FN_STDOUT_LOG = "azureml-logs/70_driver_log.txt"
