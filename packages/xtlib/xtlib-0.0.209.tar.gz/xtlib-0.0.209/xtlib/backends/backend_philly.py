...
class Philly(BackendBase):
    ...
    def wrap_cmd_line_for_philly_job(self, user_cmd, store_before_dir, store_output_dir, store_after_dir, 
        ...
        self.append(cmds, 'export XT_CODE_DIR="/mnt/default/' + store_before_dir + '/bootstrap"')
        ...
        self.append_unzip(cmds, constants.BOOTSTRAP_ZIP_FN, ".")
        self.append(cmds, "rm {}".format(constants.BOOTSTRAP_ZIP_FN))

        # debug - verify code is present
        ...
        super().add_xt_setup_cmds(cmds, args, self.is_windows)
        ...
        wrapped_cmd = self.create_wrapped_cmd(cmds, user_cmd)
        return wrapped_cmd

    def create_wrapped_cmd(self, cmds, user_cmd):
