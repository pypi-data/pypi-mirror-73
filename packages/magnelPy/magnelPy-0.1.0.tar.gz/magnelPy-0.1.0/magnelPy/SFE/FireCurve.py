...
def EuroCodeParametric(time, openingFactor, fireLoadDensity, thermalInertia, length, width, height, t_lim = 20, Reitgruber=False):
	...
	fireLoadDensity : float
		design value of the fire load density related to the surface area [MJ/m2]

	thermalInertia : float
		thermal interia of the compartment, typically between 100 and 2200 [J/m2 s1/2 K]

	length, width, height : float
		dimensions of a rectangular compartment [m]

	t_lim : float
		factor which indicates the fire growth rate [min]
