...
class CfnAnalyzer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-accessanalyzer.CfnAnalyzer"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnAnalyzer":
    ...
    def archive_rules(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["ArchiveRuleProperty", aws_cdk.core.IResolvable]]]]:
    ...
    def archive_rules(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["ArchiveRuleProperty", aws_cdk.core.IResolvable]]]]) -> None:
    ...
    class FilterProperty():
        def __init__(self, *, property: str, contains: typing.Optional[typing.List[str]]=None, eq: typing.Optional[typing.List[str]]=None, exists: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, neq: typing.Optional[typing.List[str]]=None) -> None:
            """
        ...
        @builtins.property
        def exists(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
...
class CfnAnalyzerProps():
    def __init__(self, *, type: str, analyzer_name: typing.Optional[str]=None, archive_rules: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnAnalyzer.ArchiveRuleProperty", aws_cdk.core.IResolvable]]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    @builtins.property
    def archive_rules(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnAnalyzer.ArchiveRuleProperty", aws_cdk.core.IResolvable]]]]:
        """``AWS::AccessAnalyzer::Analyzer.ArchiveRules``.
