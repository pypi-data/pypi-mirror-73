...
class EmailSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.EmailSubscription"):
    ...
    """
    def __init__(self, email_address: str, *, json: typing.Optional[bool]=None, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
        """
        :param email_address: -
...
class LambdaSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.LambdaSubscription"):
    ...
    def __init__(self, fn: aws_cdk.aws_lambda.IFunction, *, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
        """
        :param fn: -
        :param dead_letter_queue: Queue to be used as dead letter queue. If not passed no dead letter queue is enabled. Default: - No dead letter queue enabled.
        :param filter_policy: The filter policy. Default: - all messages are delivered
...
@jsii.implements(aws_cdk.aws_sns.ITopicSubscription)
class SmsSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.SmsSubscription"):
    """Use an sms address as a subscription target."""
    def __init__(self, phone_number: str, *, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
        """
        :param phone_number: -
        :param dead_letter_queue: Queue to be used as dead letter queue. If not passed no dead letter queue is enabled. Default: - No dead letter queue enabled.
        :param filter_policy: The filter policy. Default: - all messages are delivered
...
class SqsSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.SqsSubscription"):
    ...
    def __init__(self, queue: aws_cdk.aws_sqs.IQueue, *, raw_message_delivery: typing.Optional[bool]=None, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
        """
        :param queue: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns-subscriptions.SubscriptionProps", jsii_struct_bases=[], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy'})
class SubscriptionProps():
    def __init__(self, *, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
...
class UrlSubscription(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.UrlSubscription"):
    ...
    """
    def __init__(self, url: str, *, protocol: typing.Optional[aws_cdk.aws_sns.SubscriptionProtocol]=None, raw_message_delivery: typing.Optional[bool]=None, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
        """
        :param url: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns-subscriptions.UrlSubscriptionProps", jsii_struct_bases=[SubscriptionProps], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'protocol': 'protocol', 'raw_message_delivery': 'rawMessageDelivery'})
class UrlSubscriptionProps(SubscriptionProps):
    def __init__(self, *, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None, protocol: typing.Optional[aws_cdk.aws_sns.SubscriptionProtocol]=None, raw_message_delivery: typing.Optional[bool]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns-subscriptions.EmailSubscriptionProps", jsii_struct_bases=[SubscriptionProps], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'json': 'json'})
class EmailSubscriptionProps(SubscriptionProps):
    def __init__(self, *, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None, json: typing.Optional[bool]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns-subscriptions.LambdaSubscriptionProps", jsii_struct_bases=[SubscriptionProps], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns-subscriptions.SmsSubscriptionProps", jsii_struct_bases=[SubscriptionProps], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns-subscriptions.SqsSubscriptionProps", jsii_struct_bases=[SubscriptionProps], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery'})
class SqsSubscriptionProps(SubscriptionProps):
    def __init__(self, *, dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None, raw_message_delivery: typing.Optional[bool]=None) -> None:
