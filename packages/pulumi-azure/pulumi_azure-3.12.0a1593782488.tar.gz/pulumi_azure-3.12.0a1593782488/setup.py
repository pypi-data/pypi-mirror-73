...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.12.0-alpha.1593782488+94fc5bad'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.12.0-alpha.1593782488+94fc5bad`
                """)
            else:
                raise
