...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.13.0-alpha.1594663447+6a28dd5f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.13.0-alpha.1594663447+6a28dd5f`
                """)
            else:
                raise
