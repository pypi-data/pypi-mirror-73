...
class view(object):
    ...
    def __init__(self,width=640,height=480,q='',para='',command='',full=1,v=''):
        ...
        '''
        if full == 1:
            jsfile = 'https://www.ncbi.nlm.nih.gov/Structure/icn3d2/es5/icn3d_all_full.js'
            css1file = 'https://www.ncbi.nlm.nih.gov/Structure/icn3d/lib/jquery-ui.min.css'
            css2file = 'https://www.ncbi.nlm.nih.gov/Structure/icn3d/icn3d_full_ui.css'
        else:
            jsfile = 'https://www.ncbi.nlm.nih.gov/Structure/icn3d2/es5/icn3d_all_simple.js'
            css1file = 'https://www.ncbi.nlm.nih.gov/Structure/icn3d/lib/jquery-ui.min.css'
            css2file = 'https://www.ncbi.nlm.nih.gov/Structure/icn3d/icn3d_simple_ui.css'
...
""" % (jsfile,css1file,css2file,warnid)
        ...
        self.startjs += 'cfg = {divid: "%s", "%s": "%s", width: "%spx", height: "%spx", mobilemenu: 1, command: "%s", %s};\n' % (divid, queryArray[0], queryArray[1], width, height, command, para)
