...
class view(object):
    ...
    '''
    def __init__(self,width=640,height=960,q="",para="",command="",full=1,v=""):
        '''Create a iCn3D view.
            width -- width of container in pixels
            height -- twice height of container in pixels
