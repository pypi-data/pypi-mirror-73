...
class Asset(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3-assets.Asset"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, path: str, readers: typing.Optional[typing.List[aws_cdk.aws_iam.IGrantable]]=None, source_hash: typing.Optional[str]=None, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional[aws_cdk.assets.FollowMode]=None, asset_hash: typing.Optional[str]=None, asset_hash_type: typing.Optional[aws_cdk.core.AssetHashType]=None, bundling: typing.Optional[aws_cdk.core.BundlingOptions]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-s3-assets.AssetOptions", jsii_struct_bases=[aws_cdk.assets.CopyOptions, aws_cdk.core.AssetOptions], name_mapping={'exclude': 'exclude', 'follow': 'follow', 'asset_hash': 'assetHash', 'asset_hash_type': 'assetHashType', 'bundling': 'bundling', 'readers': 'readers', 'source_hash': 'sourceHash'})
class AssetOptions(aws_cdk.assets.CopyOptions, aws_cdk.core.AssetOptions):
    def __init__(self, *, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional[aws_cdk.assets.FollowMode]=None, asset_hash: typing.Optional[str]=None, asset_hash_type: typing.Optional[aws_cdk.core.AssetHashType]=None, bundling: typing.Optional[aws_cdk.core.BundlingOptions]=None, readers: typing.Optional[typing.List[aws_cdk.aws_iam.IGrantable]]=None, source_hash: typing.Optional[str]=None) -> None:
        """
        :param exclude: Glob patterns to exclude from the copy. Default: nothing is excluded
        :param follow: A strategy for how to handle symlinks. Default: Never
        :param asset_hash: Specify a custom hash for this asset. If ``assetHashType`` is set it must be set to ``AssetHashType.CUSTOM``. For consistency, this custom hash will be SHA256 hashed and encoded as hex. The resulting hash will be the asset hash. NOTE: the hash is used in order to identify a specific revision of the asset, and used for optimizing and caching deployment activities related to this asset such as packaging, uploading to Amazon S3, etc. If you chose to customize the hash, you will need to make sure it is updated every time the asset changes, or otherwise it is possible that some deployments will not be invalidated. Default: - based on ``assetHashType``
        ...
        :stability: experimental
        """
        if isinstance(bundling, dict): bundling = aws_cdk.core.BundlingOptions(**bundling)
        self._values = {
        }
...
@jsii.data_type(jsii_type="@aws-cdk/aws-s3-assets.AssetProps", jsii_struct_bases=[AssetOptions], name_mapping={'exclude': 'exclude', 'follow': 'follow', 'asset_hash': 'assetHash', 'asset_hash_type': 'assetHashType', 'bundling': 'bundling', 'readers': 'readers', 'source_hash': 'sourceHash', 'path': 'path'})
