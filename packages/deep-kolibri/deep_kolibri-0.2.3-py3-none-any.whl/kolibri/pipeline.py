...
class Pipeline():
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        """ fit
        Sequentially fit and transformer data in all but last step, then fit
        ...
        for name, transformer in self.steps[:-1]:
            ...
            if hasattr(transformer, "fit_transform"):
                ...
                if Xt_val:
                    Xt_val=transformer.fit(Xt, y_val).transform(Xt_val)
    ...
    def partial_fit(self, X, y, classes=None):
        """ partial_fit
        Sequentially partial fit and transformer data in all but last step,
    ...
    def train(self, data:BaseStream, **kwargs):
        """ fit
        Sequentially fit and transform data in all but last step, then fit
        the model in last step.
        Parameters
        ----------
        training_data: DataStream structure containing training data
