...
from kolibri.indexers import ClassificationIndexer, LabelingIndexer, ScoringIndexer
...
class Embedding(object):
    ...
    def __init__(self,
        ...
        if indexer is None:
            ...
            elif task == TaskType.LABELING:
                self.indexer = LabelingIndexer()
            elif task == TaskType.SCORING:
                self.indexer = ScoringIndexer()
            else:
                raise ValueError('Need to set the indexer param, value: {labeling, classification, scoring}')
        else:
    ...
    def token_count(self) -> int:
        ...
        corpus token count
        """
        return len(self.indexer.token2idx)
    ...
    def analyze_corpus(self,
        ...
        """
        Prepare embedding layer and pre-indexer for labeling task
        ...
        """
        self.indexer.analyze_corpus(x, y)
    ...
    def embed_one(self, sentence: Union[List[str], List[int]]) -> np.array:
        ...
        Args:
            sentence: label sentence, list of str
    ...
    def process_x_dataset(self,
        ...
        """
        return self.indexer.process_x_dataset(data, self.sequence_length, subset)
    ...
    def process_y_dataset(self,
        ...
        Returns:
            vectorized feature tensor
        """
        return self.indexer.process_y_dataset(data, self.sequence_length, subset)
