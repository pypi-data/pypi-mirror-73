import json
import click
from meta1.proposal import Proposals
...
def disapproveproposal(ctx, proposal, account):
    ...
    """
    print_tx(ctx.meta1.disapproveproposal(proposal, account=account))
...
def approveproposal(ctx, proposal, account):
    """ Approve a proposal
    """
    print_tx(ctx.meta1.approveproposal(proposal, account=account))
