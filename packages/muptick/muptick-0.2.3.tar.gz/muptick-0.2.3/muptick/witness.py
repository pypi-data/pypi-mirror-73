...
from meta1.witness import Witnesses
...
def approvewitness(ctx, witnesses, account):
    """ Approve witness(es)
    """
    print_tx(ctx.meta1.approvewitness(witnesses, account=account))
...
def disapprovewitness(ctx, witnesses, account):
    ...
    """
    print_tx(ctx.meta1.disapprovewitness(witnesses, account=account))
