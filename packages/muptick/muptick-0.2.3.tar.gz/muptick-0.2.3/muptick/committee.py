...
def approvecommittee(ctx, members, account):
    ...
    """
    print_tx(ctx.meta1.approvecommittee(members, account=account))
...
def disapprovecommittee(ctx, members, account):
    ...
    """
    print_tx(ctx.meta1.disapprovecommittee(members, account=account))
...
def createcommittee(ctx, url, account):
    ...
    """
    print_tx(ctx.meta1.create_committee_member(url, account=account))
