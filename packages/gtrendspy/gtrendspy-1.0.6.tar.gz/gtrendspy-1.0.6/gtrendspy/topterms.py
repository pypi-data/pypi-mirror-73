...
def theo_timeline_top(root_terms = None, num_terms_per_root = 25,
                  start = None, end = None, timeframe_list = None, timestep_years = 1,
                  outpath = None, creds = None, geo_country_list = [None],
                  geo_dma_list  = [None], geo_region_list  = [None],
                  worldwide = False, batch_size = 30, us_states = False,
                  get_all = False, all_path = None,
                  rm_US_ = True):
    ...
    regions = geo_country_list + geo_dma_list + geo_region_list
