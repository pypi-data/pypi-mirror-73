...
class ValuePlayerWidget(VBox):
    ...
    #def __init__(self, player, UI=None, actions=None):
    def __init__(self,visualisation, UI=None, actions=None, language=None):
        ...
        self.player = Player(visualisation, language)#player
        ...
        if UI == "btn":
            ...
            for tag in actions:
                for i in actions[tag]:
                    ...
                    # setattr( self.delpy, k, MethodType(v, self.delpy))
...
#def ValuePlayerWidget(visualisation, UI=None, actions=None, language=None):
#    """
...
#        visualisation : (type=traitlets) the visualisation we link the player with
#        UI : (default value=None) (type=string) The type of User Interface
#        actions : (type=dictionnary) a dictionnary of lists. Each list contains tuples. Each tupple defines an action and fit the followinf #format : ('function_name', fun, *args) 
#        language : (type=None) language for displayed labels
#        
#    """
#    player = Player(visualisation, language)
#    app = PlayerView(player, UI, actions)
#    return app
