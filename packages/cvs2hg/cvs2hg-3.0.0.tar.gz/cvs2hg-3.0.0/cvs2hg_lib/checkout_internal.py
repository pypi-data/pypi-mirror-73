...
from cvs2hg_lib.database import Database
from cvs2hg_lib.database import IndexedDatabase
from cvs2hg_lib.rcs_stream import RCSStream
from cvs2hg_lib.rcs_stream import MalformedDeltaException
...
from cvs2hg_lib.serializer import CompressingSerializer
...
class _Sink(cvs2hg_rcsparse.Sink):
...
class InternalRevisionReader(RevisionReader):
    ...
    def get_content(self, cvs_rev):
        ...
        except MalformedDeltaException as msg:
