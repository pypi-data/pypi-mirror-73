...
from cvs2hg_lib.common import is_trunk_revision
...
from cvs2hg_lib.cvs_path import CVSPath
from cvs2hg_lib.cvs_path import CVSFile
from cvs2hg_lib.cvs_path import CVSDirectory
...
from cvs2hg_lib.cvs_item import cvs_revision_type_map
from cvs2hg_lib.cvs_file_items import VendorBranchError
from cvs2hg_lib.cvs_file_items import CVSFileItems
from cvs2hg_lib.key_generator import KeyGenerator
from cvs2hg_lib.cvs_item_database import NewCVSItemStore
from cvs2hg_lib.symbol_statistics import SymbolStatisticsCollector
from cvs2hg_lib.metadata_database import MetadataDatabase
from cvs2hg_lib.metadata_database import MetadataLogger
from cvs2hg_lib.repository_walker import walk_repository
...
class _FileDataCollector(cvs2hg_rcsparse.Sink):
...
class _ProjectDataCollector:
    ...
    def process_file(self, cvs_file):
        ...
        try:
            cvs2hg_rcsparse.parse(open(cvs_file.filename, 'rb'), fdc)
        except (cvs2hg_rcsparse.common.RCSParseError, ValueError, RuntimeError):
            self.collect_data.record_fatal_error(
