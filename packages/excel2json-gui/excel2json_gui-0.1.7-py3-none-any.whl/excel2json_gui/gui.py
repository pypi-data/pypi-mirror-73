...
class ExcelConverterGui(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        open_file_action = QAction(
            QIcon('folder-open-big.png'), "Open file...", self)
        ...
        convert_action = QAction(QIcon('convert-big.png'), "Convert Excel to JSON", self)
        ...
        save_file_action = QAction(QIcon('save-big.png'), "Save", self)
