...
def KFPClientFactory(
    ...
    Args:
        ...
        role_arn (str): role to assume when requesting token for cluster
    ...
    kube_token = _get_token(cluster_name, cluster_region, role_arn)
