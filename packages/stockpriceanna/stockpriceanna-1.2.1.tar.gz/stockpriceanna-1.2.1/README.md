...
p1 = data.DataReader('^GSPC', 'yahoo', "2000-01-01", "2010-01-01")  #daily SP500 index ten years after dotcom bubble
VR_test(data=p1["Close"], periods=range(2,10))
output:  
periods
2   -2.599856
3   -3.200185
...
p2= data.DataReader('^GSPC', 'yahoo', "2010-01-01", "2020-01-01")  #daily SP500 index in the more recent years
VR_test(data=p2["Close"], periods=range(2,10))
output: 
periods
2   -1.413111
3   -1.097611
