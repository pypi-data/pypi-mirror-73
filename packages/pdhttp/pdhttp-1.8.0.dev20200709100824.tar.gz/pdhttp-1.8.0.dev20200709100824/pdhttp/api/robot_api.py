...
class RobotApi(object):
    ...
    def wrist_button_state(self, since, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wrist_button_state(since, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.wrist_button_state_with_http_info(since, **kwargs)  # noqa: E501
        else:
            (data) = self.wrist_button_state_with_http_info(since, **kwargs)  # noqa: E501
            return data

    def wrist_button_state_with_http_info(self, since, **kwargs):  # noqa: E501
        """Get last states of wrist Buttons  # noqa: E501

        The function returns list states for each wrist Button. List represents a set of events (PRESSED/RELEASED) and their timestamps that were occurred since requested timestamp  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wrist_button_state_with_http_info(since, async_req=True)
        >>> result = thread.get()
