...
class CfnCertificate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-acmpca.CfnCertificate"):
    ...
    @validity.setter
    def validity(self, value: typing.Union[aws_cdk.core.IResolvable, "ValidityProperty"]) -> None:
...
class CfnCertificateAuthority(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-acmpca.CfnCertificateAuthority"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnCertificateAuthority":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @subject.setter
    def subject(self, value: typing.Union["SubjectProperty", aws_cdk.core.IResolvable]) -> None:
    ...
    def revocation_configuration(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RevocationConfigurationProperty"]]:
    ...
    def revocation_configuration(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RevocationConfigurationProperty"]]) -> None:
    ...
    class CrlConfigurationProperty():
        def __init__(self, *, custom_cname: typing.Optional[str]=None, enabled: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, expiration_in_days: typing.Optional[jsii.Number]=None, s3_bucket_name: typing.Optional[str]=None) -> None:
            """
    ...
    class RevocationConfigurationProperty():
        def __init__(self, *, crl_configuration: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnCertificateAuthority.CrlConfigurationProperty"]]=None) -> None:
            """
        ...
        @builtins.property
        def crl_configuration(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnCertificateAuthority.CrlConfigurationProperty"]]:
...
class CfnCertificateAuthorityActivation(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-acmpca.CfnCertificateAuthorityActivation"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnCertificateAuthorityActivation":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnCertificateAuthorityProps():
    ...
    @builtins.property
    def revocation_configuration(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnCertificateAuthority.RevocationConfigurationProperty"]]:
        """``AWS::ACMPCA::CertificateAuthority.RevocationConfiguration``.
