...
class AttachedPolicyDefinitionResponse(object):
    ...
    def __init__(self, source_role=None, role_hierarchy_index=None, description=None, applications=None, policy_type=None, id=None, grant=None, selectors=None, _for=None, _if=None, when=None, how=None):  # noqa: E501
        ...
        :param source_role: 
        :type source_role: shrine.RoleId
        ...
        :param policy_type: 
        :type policy_type: shrine.PolicyType
        :param id: 
        :type id: shrine.PolicyId
        :param grant: 
        :type grant: shrine.Grant
        :param selectors: 
        :type selectors: list[shrine.SelectorDefinition]
        :param _for: 
        :type _for: list[shrine.ForSpec]
        :param _if: 
        :type _if: list[shrine.IfExpression]
        :param when: 
        :type when: shrine.WhenSpec
        :param how: 
        :type how: shrine.HowSpec
