...
from shrine import Configuration, ApiClient
...
class ApiClientBuilder:
    """
    The ApiClientBuilder is responsible for building a shrine.ApiClient. This includes obtaining an access token from
    Okta or using the provided token.

    Any validation on the inputs required to build a shrine.ApiClient is the responsibility of this ApiClientBuilder.
    """
    ...
    def build(cls, api_secrets_filename=None, okta_response_handler=None, api_configuration=None, token=None):
        ...
        :param typing.callable okta_response_handler: An optional function to handle the Okta response
        :param shrine.utilities.ApiConfiguration api_configuration: A pre-populated ApiConfiguration
        :param str token: The pre-populated access token to use instead of asking Okta for a token

        :return: shrine.ApiClient: The configured LUSID ApiClient
        """
