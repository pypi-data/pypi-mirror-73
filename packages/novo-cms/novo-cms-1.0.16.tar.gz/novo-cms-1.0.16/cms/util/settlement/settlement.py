...
class Settlement(object):
    def __init__(self, report_files, outfile, lims_file=None, logger=None, no_filter=False):
    ...
    def get_stage_data(self):
        ...
        return parse_report_data(self.report_files, no_filter=self.no_filter)
...
def main(**args):
    ...
    settlement = Settlement(args['report'], args['out'], lims_file=args['lims_data'], no_filter=args['no_filter'], logger=logger)
...
def parser_add_settlement(parser):
    ...
    parser.add_argument('-no', '--no-filter', help='do not filter the report', action='store_true')
