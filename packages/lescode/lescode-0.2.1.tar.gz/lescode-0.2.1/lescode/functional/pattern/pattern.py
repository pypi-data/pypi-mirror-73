...
from .types import (Callable, Entry, GenericMeta, Hashable, Matcher, NoneType,
                    Pattern, Result)
...
def __case(matcher:Matcher) -> Matcher:
    ...
    @functools.wraps(matcher)
    def wrapper(*entries:List[Entry], val:Any=None, accept_none:bool=False, accept_empty:bool=False) -> Union[Callable, Result]:

        if len(entries) == 0 and not accept_empty:
            return functools.partial(wrapper, val=val, accept_none=accept_none, accept_empty=True)
...
def __case_async(matcher:Matcher) -> Matcher:
    ...
    @functools.wraps(matcher)
    async def wrapper(*entries:List[Entry], val:Any=None, accept_none:bool=False, accept_empty:bool=False) -> Union[Callable, Result]:

        if len(entries) == 0 and not accept_empty:
            return ensure_coroutine(functools.partial(wrapper, val=val, accept_none=accept_none, accept_empty=True))
...
def __pipe(matcher:Matcher) -> Matcher:
    ...
    @functools.wraps(matcher)
    def wrapper(*entries:List[Entry], val:Any=None, accept_none:bool=False, accept_empty:bool=False, early_stop:bool=False) -> Union[Callable, Result]:

        if len(entries) == 0 and not accept_empty:
            return functools.partial(wrapper, val=val, accept_none=accept_none, accept_empty=True, early_stop=early_stop)
...
def __pipe_async(matcher:Matcher) -> Matcher:
    ...
    @functools.wraps(matcher)
    async def wrapper(*entries:List[Entry], val:Any=None, accept_none:bool=False, accept_empty:bool=False, early_stop:bool=False) -> Union[Callable, Result]:
