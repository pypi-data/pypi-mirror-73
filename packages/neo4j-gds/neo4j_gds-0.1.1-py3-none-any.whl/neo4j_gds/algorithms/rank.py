...
from neo4j_gds.algorithms.algorithm import AlgorithmOperation, Algorithm
from neo4j_gds.algorithms.rank_configuration import RankConfiguration
from neo4j_gds.exceptions import NeededPropertyNameNotSpecified
...
class Rank(Algorithm):
    ...
    returned_properties: Optional[List[str]] = None
