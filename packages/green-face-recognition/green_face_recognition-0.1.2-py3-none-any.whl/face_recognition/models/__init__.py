...
from ..utils.tools import get_cfg, download_url
...
model_urls = {
    'arc-face': '1idHHwtG7r9ZUGCgQizqfxj2QVpOnoDEU',
...
def build_model(name: str, cfg_path: str = ""):
    ...
    if not os.path.exists('models/FaceDetection'):
        download_url(model_urls['retina-r50'], name='retina', dst = "models")

    if not os.path.exists('models/FaceEmbedding'):
        download_url(model_urls['arc-face'],name = 'arc', dst = "models")
