...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.BackupProps", jsii_struct_bases=[], name_mapping={'retention': 'retention', 'preferred_window': 'preferredWindow'})
class BackupProps():
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.ClusterParameterGroupProps", jsii_struct_bases=[], name_mapping={'family': 'family', 'parameters': 'parameters', 'db_cluster_parameter_group_name': 'dbClusterParameterGroupName', 'description': 'description'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.DatabaseInstanceAttributes", jsii_struct_bases=[], name_mapping={'instance_endpoint_address': 'instanceEndpointAddress', 'instance_identifier': 'instanceIdentifier', 'port': 'port'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.DatabaseInstanceProps", jsii_struct_bases=[], name_mapping={'cluster': 'cluster', 'instance_class': 'instanceClass', 'auto_minor_version_upgrade': 'autoMinorVersionUpgrade', 'availability_zone': 'availabilityZone', 'db_instance_name': 'dbInstanceName', 'preferred_maintenance_window': 'preferredMaintenanceWindow', 'removal_policy': 'removalPolicy'})
class DatabaseInstanceProps():
    def __init__(self, *, cluster: "IDatabaseCluster", instance_class: aws_cdk.aws_ec2.InstanceType, auto_minor_version_upgrade: typing.Optional[bool]=None, availability_zone: typing.Optional[str]=None, db_instance_name: typing.Optional[str]=None, preferred_maintenance_window: typing.Optional[str]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None) -> None:
...
class DatabaseSecret(aws_cdk.aws_secretsmanager.Secret, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-docdb.DatabaseSecret"):
    """A database secret.
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, username: str, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, master_secret: typing.Optional[aws_cdk.aws_secretsmanager.ISecret]=None, secret_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.DatabaseSecretProps", jsii_struct_bases=[], name_mapping={'username': 'username', 'encryption_key': 'encryptionKey', 'master_secret': 'masterSecret', 'secret_name': 'secretName'})
class DatabaseSecretProps():
    def __init__(self, *, username: str, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, master_secret: typing.Optional[aws_cdk.aws_secretsmanager.ISecret]=None, secret_name: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.InstanceProps", jsii_struct_bases=[], name_mapping={'instance_type': 'instanceType', 'vpc': 'vpc', 'parameter_group': 'parameterGroup', 'security_group': 'securityGroup', 'vpc_subnets': 'vpcSubnets'})
class InstanceProps():
    def __init__(self, *, instance_type: aws_cdk.aws_ec2.InstanceType, vpc: aws_cdk.aws_ec2.IVpc, parameter_group: typing.Optional["IClusterParameterGroup"]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.Login", jsii_struct_bases=[], name_mapping={'username': 'username', 'kms_key': 'kmsKey', 'password': 'password'})
class Login():
...
@jsii.data_type(jsii_type="@aws-cdk/aws-docdb.RotationMultiUserOptions", jsii_struct_bases=[], name_mapping={'secret': 'secret', 'automatically_after': 'automaticallyAfter'})
...
class ClusterParameterGroup(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-docdb.ClusterParameterGroup"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, family: str, parameters: typing.Mapping[str, str], db_cluster_parameter_group_name: typing.Optional[str]=None, description: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param family: Database family of this parameter group.
    ...
    @builtins.classmethod
    def from_parameter_group_name(cls, scope: aws_cdk.core.Construct, id: str, parameter_group_name: str) -> "IClusterParameterGroup":
...
class DatabaseCluster(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-docdb.DatabaseCluster"):
    """Create a clustered database with a given number of instances.
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, instance_props: "InstanceProps", master_user: "Login", backup: typing.Optional["BackupProps"]=None, db_cluster_name: typing.Optional[str]=None, engine_version: typing.Optional[str]=None, instance_identifier_base: typing.Optional[str]=None, instances: typing.Optional[jsii.Number]=None, kms_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, parameter_group: typing.Optional["IClusterParameterGroup"]=None, port: typing.Optional[jsii.Number]=None, preferred_maintenance_window: typing.Optional[str]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, storage_encrypted: typing.Optional[bool]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param instance_props: Settings for the individual instances that are launched.
...
class DatabaseInstance(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-docdb.DatabaseInstance"):
    """A database instance.
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster: "IDatabaseCluster", instance_class: aws_cdk.aws_ec2.InstanceType, auto_minor_version_upgrade: typing.Optional[bool]=None, availability_zone: typing.Optional[str]=None, db_instance_name: typing.Optional[str]=None, preferred_maintenance_window: typing.Optional[str]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cluster: The DocumentDB database cluster the instance should launch into.
    ...
    @builtins.classmethod
    def from_database_instance_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, instance_endpoint_address: str, instance_identifier: str, port: jsii.Number) -> "IDatabaseInstance":
