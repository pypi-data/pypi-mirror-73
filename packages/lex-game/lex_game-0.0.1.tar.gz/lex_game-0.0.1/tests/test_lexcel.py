...
from lexcel import LExcel, Board, init_board_params, VIOLET, CYAN
...
class TestLexcel(unittest.TestCase):
    ...
    def test_choose_and_remember_move_flipped(self):
        ...
        self.assertEqual(match, [(Board.flip_move(move), '533', 6)])
    ...
    def test_make_empty_experience(self):
        LExcel.make_empty_experience(self.TMP, [VIOLET, CYAN])
        self.assertTrue(os.path.isfile(self.TMP))
        t = LExcel(self.TMP)
