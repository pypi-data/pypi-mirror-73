...
def playonyt(topic):
    ...
    try:
        ...
        raise Exception("Chrome driver not found, call pywhatkit.help()")
    req = driver.get(url)
    sctext = driver.page_source
    driver.quit()
...
NOTE : To use new functions, you must have Google Chrome installed and updated
...
What's new:
1. Fixed playonyt() function.
2. Added some new functions, to know how to use them check pywhatkit.help().""")
    file.write("--------------------\n")
    file.close()
    file = None
#end
