...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.AccessPointOptions", jsii_struct_bases=[], name_mapping={'create_acl': 'createAcl', 'path': 'path', 'posix_user': 'posixUser'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.AccessPointProps", jsii_struct_bases=[AccessPointOptions], name_mapping={'create_acl': 'createAcl', 'path': 'path', 'posix_user': 'posixUser', 'file_system': 'fileSystem'})
