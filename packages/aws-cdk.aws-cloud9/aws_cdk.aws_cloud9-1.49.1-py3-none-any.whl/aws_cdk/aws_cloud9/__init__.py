...
class CfnEnvironmentEC2(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloud9.CfnEnvironmentEC2"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, instance_type: str, automatic_stop_time_minutes: typing.Optional[jsii.Number]=None, connection_type: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, owner_arn: typing.Optional[str]=None, repositories: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["RepositoryProperty", aws_cdk.core.IResolvable]]]]=None, subnet_id: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    def repositories(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["RepositoryProperty", aws_cdk.core.IResolvable]]]]:
    ...
    @repositories.setter
    def repositories(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["RepositoryProperty", aws_cdk.core.IResolvable]]]]) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cloud9.CfnEnvironmentEC2Props", jsii_struct_bases=[], name_mapping={'instance_type': 'instanceType', 'automatic_stop_time_minutes': 'automaticStopTimeMinutes', 'connection_type': 'connectionType', 'description': 'description', 'name': 'name', 'owner_arn': 'ownerArn', 'repositories': 'repositories', 'subnet_id': 'subnetId', 'tags': 'tags'})
class CfnEnvironmentEC2Props():
    ...
    @builtins.property
    def repositories(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnEnvironmentEC2.RepositoryProperty", aws_cdk.core.IResolvable]]]]:
        """``AWS::Cloud9::EnvironmentEC2.Repositories``.
...
class CloneRepository(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloud9.CloneRepository"):
    ...
    @builtins.classmethod
    def from_code_commit(cls, repository: aws_cdk.aws_codecommit.IRepository, path: str) -> "CloneRepository":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cloud9.Ec2EnvironmentProps", jsii_struct_bases=[], name_mapping={'vpc': 'vpc', 'cloned_repositories': 'clonedRepositories', 'description': 'description', 'ec2_environment_name': 'ec2EnvironmentName', 'instance_type': 'instanceType', 'subnet_selection': 'subnetSelection'})
class Ec2EnvironmentProps():
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, cloned_repositories: typing.Optional[typing.List["CloneRepository"]]=None, description: typing.Optional[str]=None, ec2_environment_name: typing.Optional[str]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
...
class Ec2Environment(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloud9.Ec2Environment"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, vpc: aws_cdk.aws_ec2.IVpc, cloned_repositories: typing.Optional[typing.List["CloneRepository"]]=None, description: typing.Optional[str]=None, ec2_environment_name: typing.Optional[str]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param vpc: The VPC that AWS Cloud9 will use to communicate with the Amazon Elastic Compute Cloud (Amazon EC2) instance.
