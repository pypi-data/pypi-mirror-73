...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.ContainerOverride", jsii_struct_bases=[], name_mapping={'container_definition': 'containerDefinition', 'command': 'command', 'cpu': 'cpu', 'environment': 'environment', 'memory_limit': 'memoryLimit', 'memory_reservation': 'memoryReservation'})
class ContainerOverride():
    def __init__(self, *, container_definition: aws_cdk.aws_ecs.ContainerDefinition, command: typing.Optional[typing.List[str]]=None, cpu: typing.Optional[jsii.Number]=None, environment: typing.Optional[typing.List["TaskEnvironmentVariable"]]=None, memory_limit: typing.Optional[jsii.Number]=None, memory_reservation: typing.Optional[jsii.Number]=None) -> None:
...
class DynamoDeleteItem(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoDeleteItem"):
    """A StepFunctions task to call DynamoDeleteItem.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, key: typing.Mapping[str, "DynamoAttributeValue"], table: aws_cdk.aws_dynamodb.ITable, condition_expression: typing.Optional[str]=None, expression_attribute_names: typing.Optional[typing.Mapping[str, str]]=None, expression_attribute_values: typing.Optional[typing.Mapping[str, "DynamoAttributeValue"]]=None, return_consumed_capacity: typing.Optional["DynamoConsumedCapacity"]=None, return_item_collection_metrics: typing.Optional["DynamoItemCollectionMetrics"]=None, return_values: typing.Optional["DynamoReturnValues"]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoDeleteItemProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'key': 'key', 'table': 'table', 'condition_expression': 'conditionExpression', 'expression_attribute_names': 'expressionAttributeNames', 'expression_attribute_values': 'expressionAttributeValues', 'return_consumed_capacity': 'returnConsumedCapacity', 'return_item_collection_metrics': 'returnItemCollectionMetrics', 'return_values': 'returnValues'})
class DynamoDeleteItemProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, key: typing.Mapping[str, "DynamoAttributeValue"], table: aws_cdk.aws_dynamodb.ITable, condition_expression: typing.Optional[str]=None, expression_attribute_names: typing.Optional[typing.Mapping[str, str]]=None, expression_attribute_values: typing.Optional[typing.Mapping[str, "DynamoAttributeValue"]]=None, return_consumed_capacity: typing.Optional["DynamoConsumedCapacity"]=None, return_item_collection_metrics: typing.Optional["DynamoItemCollectionMetrics"]=None, return_values: typing.Optional["DynamoReturnValues"]=None) -> None:
...
class DynamoGetItem(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoGetItem"):
    """A StepFunctions task to call DynamoGetItem.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, key: typing.Mapping[str, "DynamoAttributeValue"], table: aws_cdk.aws_dynamodb.ITable, consistent_read: typing.Optional[bool]=None, expression_attribute_names: typing.Optional[typing.Mapping[str, str]]=None, projection_expression: typing.Optional[typing.List["DynamoProjectionExpression"]]=None, return_consumed_capacity: typing.Optional["DynamoConsumedCapacity"]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param key: Primary key of the item to retrieve. For the primary key, you must provide all of the attributes. For example, with a simple primary key, you only need to provide a value for the partition key. For a composite primary key, you must provide values for both the partition key and the sort key.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoGetItemProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'key': 'key', 'table': 'table', 'consistent_read': 'consistentRead', 'expression_attribute_names': 'expressionAttributeNames', 'projection_expression': 'projectionExpression', 'return_consumed_capacity': 'returnConsumedCapacity'})
...
class DynamoPutItem(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoPutItem"):
    """A StepFunctions task to call DynamoPutItem.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, item: typing.Mapping[str, "DynamoAttributeValue"], table: aws_cdk.aws_dynamodb.ITable, condition_expression: typing.Optional[str]=None, expression_attribute_names: typing.Optional[typing.Mapping[str, str]]=None, expression_attribute_values: typing.Optional[typing.Mapping[str, "DynamoAttributeValue"]]=None, return_consumed_capacity: typing.Optional["DynamoConsumedCapacity"]=None, return_item_collection_metrics: typing.Optional["DynamoItemCollectionMetrics"]=None, return_values: typing.Optional["DynamoReturnValues"]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoPutItemProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'item': 'item', 'table': 'table', 'condition_expression': 'conditionExpression', 'expression_attribute_names': 'expressionAttributeNames', 'expression_attribute_values': 'expressionAttributeValues', 'return_consumed_capacity': 'returnConsumedCapacity', 'return_item_collection_metrics': 'returnItemCollectionMetrics', 'return_values': 'returnValues'})
class DynamoPutItemProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, item: typing.Mapping[str, "DynamoAttributeValue"], table: aws_cdk.aws_dynamodb.ITable, condition_expression: typing.Optional[str]=None, expression_attribute_names: typing.Optional[typing.Mapping[str, str]]=None, expression_attribute_values: typing.Optional[typing.Mapping[str, "DynamoAttributeValue"]]=None, return_consumed_capacity: typing.Optional["DynamoConsumedCapacity"]=None, return_item_collection_metrics: typing.Optional["DynamoItemCollectionMetrics"]=None, return_values: typing.Optional["DynamoReturnValues"]=None) -> None:
...
class DynamoUpdateItem(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.DynamoUpdateItem"):
    """A StepFunctions task to call DynamoUpdateItem.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, key: typing.Mapping[str, "DynamoAttributeValue"], table: aws_cdk.aws_dynamodb.ITable, condition_expression: typing.Optional[str]=None, expression_attribute_names: typing.Optional[typing.Mapping[str, str]]=None, expression_attribute_values: typing.Optional[typing.Mapping[str, "DynamoAttributeValue"]]=None, return_consumed_capacity: typing.Optional["DynamoConsumedCapacity"]=None, return_item_collection_metrics: typing.Optional["DynamoItemCollectionMetrics"]=None, return_values: typing.Optional["DynamoReturnValues"]=None, update_expression: typing.Optional[str]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param key: Primary key of the item to retrieve. For the primary key, you must provide all of the attributes. For example, with a simple primary key, you only need to provide a value for the partition key. For a composite primary key, you must provide values for both the partition key and the sort key.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsEc2LaunchTargetOptions", jsii_struct_bases=[], name_mapping={'placement_constraints': 'placementConstraints', 'placement_strategies': 'placementStrategies'})
class EcsEc2LaunchTargetOptions():
    def __init__(self, *, placement_constraints: typing.Optional[typing.List[aws_cdk.aws_ecs.PlacementConstraint]]=None, placement_strategies: typing.Optional[typing.List[aws_cdk.aws_ecs.PlacementStrategy]]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'EcsEc2LaunchTargetOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsFargateLaunchTargetOptions", jsii_struct_bases=[], name_mapping={'platform_version': 'platformVersion'})
class EcsFargateLaunchTargetOptions():
    def __init__(self, *, platform_version: aws_cdk.aws_ecs.FargatePlatformVersion) -> None:
    ...
    def __repr__(self) -> str:
        return 'EcsFargateLaunchTargetOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsLaunchTargetConfig", jsii_struct_bases=[], name_mapping={'parameters': 'parameters'})
class EcsLaunchTargetConfig():
    def __init__(self, *, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'EcsLaunchTargetConfig(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.aws_ec2.IConnectable)
class EcsRunTask(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsRunTask"):
    """Run a Task on ECS or Fargate.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster: aws_cdk.aws_ecs.ICluster, launch_target: "IEcsLaunchTarget", task_definition: aws_cdk.aws_ecs.TaskDefinition, assign_public_ip: typing.Optional[bool]=None, container_overrides: typing.Optional[typing.List["ContainerOverride"]]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = EcsRunTaskProps(cluster=cluster, launch_target=launch_target, task_definition=task_definition, assign_public_ip=assign_public_ip, container_overrides=container_overrides, security_groups=security_groups, subnets=subnets, comment=comment, heartbeat=heartbeat, input_path=input_path, integration_pattern=integration_pattern, output_path=output_path, result_path=result_path, timeout=timeout)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsRunTaskProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster': 'cluster', 'launch_target': 'launchTarget', 'task_definition': 'taskDefinition', 'assign_public_ip': 'assignPublicIp', 'container_overrides': 'containerOverrides', 'security_groups': 'securityGroups', 'subnets': 'subnets'})
class EcsRunTaskProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster: aws_cdk.aws_ecs.ICluster, launch_target: "IEcsLaunchTarget", task_definition: aws_cdk.aws_ecs.TaskDefinition, assign_public_ip: typing.Optional[bool]=None, container_overrides: typing.Optional[typing.List["ContainerOverride"]]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'EcsRunTaskProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class EvaluateExpression(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EvaluateExpression"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, expression: str, runtime: typing.Optional[aws_cdk.aws_lambda.Runtime]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = EvaluateExpressionProps(expression=expression, runtime=runtime, comment=comment, heartbeat=heartbeat, input_path=input_path, integration_pattern=integration_pattern, output_path=output_path, result_path=result_path, timeout=timeout)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EvaluateExpressionProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'expression': 'expression', 'runtime': 'runtime'})
class EvaluateExpressionProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, expression: str, runtime: typing.Optional[aws_cdk.aws_lambda.Runtime]=None) -> None:
...
class IEcsLaunchTarget(jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, task: "EcsRunTask", *, task_definition: aws_cdk.aws_ecs.ITaskDefinition, cluster: typing.Optional[aws_cdk.aws_ecs.ICluster]=None) -> "EcsLaunchTargetConfig":
...
class _IEcsLaunchTargetProxy():
    ...
    def bind(self, task: "EcsRunTask", *, task_definition: aws_cdk.aws_ecs.ITaskDefinition, cluster: typing.Optional[aws_cdk.aws_ecs.ICluster]=None) -> "EcsLaunchTargetConfig":
        ...
        :stability: experimental
        """
        launch_target_options = LaunchTargetBindOptions(task_definition=task_definition, cluster=cluster)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.LaunchTargetBindOptions", jsii_struct_bases=[], name_mapping={'task_definition': 'taskDefinition', 'cluster': 'cluster'})
class LaunchTargetBindOptions():
    def __init__(self, *, task_definition: aws_cdk.aws_ecs.ITaskDefinition, cluster: typing.Optional[aws_cdk.aws_ecs.ICluster]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'LaunchTargetBindOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class EcsEc2LaunchTarget(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsEc2LaunchTarget"):
    ...
    def __init__(self, *, placement_constraints: typing.Optional[typing.List[aws_cdk.aws_ecs.PlacementConstraint]]=None, placement_strategies: typing.Optional[typing.List[aws_cdk.aws_ecs.PlacementStrategy]]=None) -> None:
        ...
        :stability: experimental
        """
        options = EcsEc2LaunchTargetOptions(placement_constraints=placement_constraints, placement_strategies=placement_strategies)

        jsii.create(EcsEc2LaunchTarget, self, [options])

    @jsii.member(jsii_name="bind")
    def bind(self, _task: "EcsRunTask", *, task_definition: aws_cdk.aws_ecs.ITaskDefinition, cluster: typing.Optional[aws_cdk.aws_ecs.ICluster]=None) -> "EcsLaunchTargetConfig":
...
@jsii.implements(IEcsLaunchTarget)
class EcsFargateLaunchTarget(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EcsFargateLaunchTarget"):
