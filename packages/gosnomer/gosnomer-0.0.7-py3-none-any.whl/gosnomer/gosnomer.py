...
# берем за основую статью Википедии https://ru.wikipedia.org/wiki/Регистрационные_знаки_транспортных_средств_в_России
    re.findall(r'\d*',
'''
        Три и более кодов региона используют Москва (коды 77, 99, 97, 177, 199, 197, 777, 799, 797), 
        ...
        Республика Башкортостан (02, 102, 702) и 
