...
class QueryWidget:
    ...
    def check_capture_configurations_for_unique_sample_rate(self, capture_configurations_names):
        sample_rate_list = []
    ...
    def get_uuid_capture_configurations(self, capture_configurations_names):
        ...
        return df_capture_configurations[
            df_capture_configurations.Name.isin(capture_configurations_names)].UUID.to_list()
    ...
    def _refresh(self):
        ...
        capture_configurations_items = sorted(self._dsk.list_capture_configurations()['Name'].to_list())
        self._capture_configurations_mselector.options = capture_configurations_items
        self._capture_configurations_mselector_create.options = capture_configurations_items
        self._capture_configurations_mselector_create.value = capture_configurations_items
    ...
    def populate_items(self, populate_create=False):
        ...
        self._items["capture_configuration"] = self._capture_configurations_mselector.value
        ...
        if populate_create:
            ...
            self._items["capture_configuration"] = self._capture_configurations_mselector_create.value
    ...
    def get_name_capture_configurations(self, capture_configurations_uuid):
        ...
        df_capture_configurations = self._dsk.list_capture_configurations()
        return df_capture_configurations[
            df_capture_configurations.UUID.isin(capture_configurations_uuid)].Name.to_list()
    ...
    def populate_query(self, change=None):
        ...
        if self.query:
            ...
            self._capture_configurations_mselector.value = self.get_name_capture_configurations( qdict["capture_configurations"])            
    ...
    def create_widget(self, name=""):
        ...
        self._capture_configurations_mselector = SelectMultiple(description="Configuration")
        self._capture_configurations_mselector_create = SelectMultiple(description="Configuration")
