...
import logging
from thrift.metric.ttypes import *
...
class listTopics_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (thrift.topic.ttypes.ListTopicsInfoResponse, thrift.topic.ttypes.ListTopicsInfoResponse.thrift_spec), None, ), # 0
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = thrift.topic.ttypes.ListTopicsInfoResponse()
