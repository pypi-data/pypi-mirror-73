...
import thrift.quota.ttypes
from thrift.authorization.ttypes import Grantee
...
class TopicAttribute:
  ...
  def __init__(self, partitionNumber=None, messageRetentionSecs=None, attributes=None,):
...
class Topic:
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'topicQuota', (thrift.quota.ttypes.BaseQuota, thrift.quota.ttypes.BaseQuota.thrift_spec), None, ), # 4
...
class CreateTopicRequest:
  ...
  thrift_spec = (
    ...
    (1, TType.STRING, 'topicName', None, None, ), # 1
    (2, TType.STRUCT, 'topicAttribute', (TopicAttribute, TopicAttribute.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'topicQuota', (thrift.quota.ttypes.BaseQuota, thrift.quota.ttypes.BaseQuota.thrift_spec), None, ), # 3
    (4, TType.MAP, 'aclMap', (TType.STRUCT,(Grantee, Grantee.thrift_spec),TType.I32,None), None, ), # 4
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i29 in range(_size25):
            _key30 = rpc.authorization.ttypes.Grantee()
            _key30.read(iprot)
...
class SetTopicQuotaRequest:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'topicQuota', (thrift.quota.ttypes.BaseQuota, thrift.quota.ttypes.BaseQuota.thrift_spec), None, ), # 2
  )
...
class QueryTopicQuotaResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'topicQuota', (thrift.quota.ttypes.BaseQuota, thrift.quota.ttypes.BaseQuota.thrift_spec), None, ), # 1
  )
...
class SetPermissionRequest:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'topicResourceName', (TopicTalosResourceName, TopicTalosResourceName.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'grant', (Grantee, Grantee.thrift_spec), None, ), # 2
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.grant = rpc.authorization.ttypes.Grantee()
