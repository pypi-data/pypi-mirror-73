...
import thrift.common.ttypes
import thrift.topic.ttypes
...
class MessageIndex:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'topicAndPartition', (thrift.topic.ttypes.TopicAndPartition, thrift.topic.ttypes.TopicAndPartition.thrift_spec), None, ), # 1
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.topicAndPartition = thrift.topic.ttypes.TopicAndPartition()
...
class GetTopicOffsetRequest:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'topicTalosResourceName', (thrift.topic.ttypes.TopicTalosResourceName, thrift.topic.ttypes.TopicTalosResourceName.thrift_spec), None, ), # 1
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.topicTalosResourceName = thrift.topic.ttypes.TopicTalosResourceName()
...
class GetPartitionsOffsetRequest:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'topicAndPartitionList', (TType.STRUCT,(thrift.topic.ttypes.TopicAndPartition, thrift.topic.ttypes.TopicAndPartition.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i64 in range(_size60):
            _elem65 = thrift.topic.ttypes.TopicAndPartition()
            _elem65.read(iprot)
...
class GetScheduleInfoResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'scheduleInfo', (TType.STRUCT,(thrift.topic.ttypes.TopicAndPartition, thrift.topic.ttypes.TopicAndPartition.thrift_spec),TType.STRING,None), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i78 in range(_size74):
            _key79 = thrift.topic.ttypes.TopicAndPartition()
            _key79.read(iprot)
