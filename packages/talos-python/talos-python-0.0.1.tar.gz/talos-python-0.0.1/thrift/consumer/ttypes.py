...
class ConsumeUnit:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'topicTalosResourceName', (thrift.topic.ttypes.TopicTalosResourceName, thrift.topic.ttypes.TopicTalosResourceName.thrift_spec), None, ), # 2
...
class CheckPoint:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'consumerGroup', None, None, ), # 1
    (2, TType.STRUCT, 'topicAndPartition', (thrift.topic.ttypes.TopicAndPartition, thrift.topic.ttypes.TopicAndPartition.thrift_spec), None, ), # 2
