...
from thrift.consumer.ttypes import UnlockPartitionRequest
from thrift.consumer.ttypes import LockPartitionRequest
...
class PartitionFetcher(object):
    ...
    def fetcher_state_machine(self):
        ...
        try:
            ...
            self.logger.error("Worker: " + self.workerId +
                              " query partition offset error: "
                              + "we will skip this partition" + e.message)
            self.clean()
            return
    ...
    def steal_partition(self):
        ...
        try:
            ...
            self.logger.error("Worker: " + self.workerId + " steal partition id : "
                              + str(self.partitionId) + " error! " + e.message)
            return False
