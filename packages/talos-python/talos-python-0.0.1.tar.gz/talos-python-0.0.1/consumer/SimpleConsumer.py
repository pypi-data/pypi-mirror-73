...
from client.TalosClientConfig import TalosClientConfigKeys
...
class SimpleConsumer:
    ...
    def __init__(self, clientConfig=None, topicName=None, partitionId=None, topicAndPartition=None, credential=None, messageClient=None):
    ...
    def get_topic_info(self, topicClient=None, topicName=None, partitionId=None):
        ...
        self.topicAndPartition = TopicAndPartition(topicName, response.topicTalosResourceName, partitionId)
    ...
    def fetch_message(self, startOffset=None, maxFetchedNumber=None):
        ...
        messageAndOffsetList = Compression().decompress(getMessageResponse.messageBlocks, getMessageResponse.unHandledMessageNumber)
        ...
        if messageAndOffsetList[0].messageOffset == startOffset or startOffset == MessageOffset.START_OFFSET or startOffset == MessageOffset.LATEST_OFFSET:
            return messageAndOffsetList
        else:
