...
class WebhookResponse(Model):
    ...
    def __init__(self, webhook_id=None, webhook_name=None, webhook_description=None, created_by=None, mailing_list=None, success_rate=None, webhook_status=None, url=None, secret=None, event_type=None):
