...
_DESCRIPTION = """\
The Text REtrieval Conference (TREC) Question Classification dataset contains 5500 labeled questions in training set and another 500 for test set. The dataset has 6 labels, 50 level-2 labels. Average length of each sentence is 10, vocabulary size of 8700.
    ...
    def _info(self):
        ...
        return nlp.DatasetInfo(
            ...
            features=nlp.Features(
                {
                    "label-coarse": nlp.Value("string"), # nlp.ClassLabel(names=_COARSE_LABELS),
                    "label-fine": nlp.Value("string"),  #nlp.ClassLabel(names=[]),
