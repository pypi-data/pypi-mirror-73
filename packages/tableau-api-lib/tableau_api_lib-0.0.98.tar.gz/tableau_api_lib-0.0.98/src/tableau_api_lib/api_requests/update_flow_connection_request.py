...
class UpdateFlowConnectionRequest(BaseRequest):
    """
    Builds the request body for Tableau Server REST API requests updating flow connections.
    ...
    :param bool embed_password_flag: True if embedding password in the flow connection, False otherwise
    """
    def __init__(self,
                 ts_connection,
                 server_address=None,
