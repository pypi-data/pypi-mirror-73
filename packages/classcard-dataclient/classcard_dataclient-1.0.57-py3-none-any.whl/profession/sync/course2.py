...
class CourseSyncV2(BaseSync2):
    ...
    def sync(self):
        ...
        semester = SemesterV2(name=response['semester'], begin_date=begin_date, end_date=end_date,
                              number=get_md5_hash(response['semester'])[:20])
        ...
        self.related_member()
        course_table_name = "{}课表_{}".format(response['semester'], str(uuid.uuid4())[:4])
