...
class Target:
    ...
    def script(self, content, path=None, name=None, remove=True):
        ...
        if remove: self.run(f'rm {full}')
        return ret, out, err

    def read(self, path, mode='rt'): todo(self)
    def write(self, path, content, mode='rt'): todo(self)
