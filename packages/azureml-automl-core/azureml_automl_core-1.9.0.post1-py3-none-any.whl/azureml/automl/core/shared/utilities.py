...
from azureml.automl.core.shared.exceptions import AutoMLException, ErrorTypes, ClientException, MemorylimitException, \
    ServiceException
...
def get_error_code(exception: BaseException, as_hierarchy: bool = False) -> str:
    ...
    def get_error_code(ex: AutoMLException) -> str:
    ...
    try:
        if isinstance(exception, MemoryError):
            ...
            error_code = get_error_code(memory_exception)
        elif isinstance(exception, AutoMLException):
            ...
            if hasattr(exception, 'error'):
                ...
                error_code = get_error_code(service_exception)
