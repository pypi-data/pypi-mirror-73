...
class MetaModel:
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        cls.__def_values__ = {} if cls.__def_values__ is None else cls.__def_values__.copy()
        cls.__validators__ = {} if cls.__validators__ is None else cls.__validators__.copy()
        cls.__rejected_fields__ = set() if cls.__rejected_fields__ is None else cls.__rejected_fields__.copy()
        cls.__restricted_fields__ = set() if cls.__restricted_fields__ is None else cls.__restricted_fields__.copy()
        cls.__def_indexes__ = [] if cls.__def_indexes__ is None else cls.__def_indexes__[:]
        cls.__cache_key_fields__ = {"_id"} if cls.__cache_key_fields__ is None else cls.__cache_key_fields__.copy()
