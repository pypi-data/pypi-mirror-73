...
class RelatedField(PrimaryKeyRelatedField):
    ...
    def __init__(self, **kwargs):
        ...
        self.create_on_null = kwargs.get('create_on_null', False)
    ...
    def to_internal_value(self, data):
        return get_related_object(data, self.queryset.model, fail_on_not_found=self.fail_on_not_found, create_on_null=self.create_on_null, extra_filter=self.extra_filter)
