...
def test_new_study_instance_uids(db, detect_duplicates_task, create_uid, sdk_mock):
    sdk_mock.check_uids_exist.return_value = {"sessions": ["uid2"]}
    ...
    assert set(["uid1", "uid2"]) == set(args[0].sessions)
...
def test_new_series_instance_uids(db, detect_duplicates_task, create_uid, sdk_mock):
    sdk_mock.check_uids_exist.return_value = {"acquisitions": ["uid2"]}
    ...
    assert set(["uid1", "uid2"]) == set(args[0].acquisitions)
