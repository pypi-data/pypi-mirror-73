...
class ComplexArguments:
    def __init__(self, sub_arg_objs: dict, with_group_prefix=False, conflict_error=False):
        self._parser = argparse.ArgumentParser(conflict_handler='error' if conflict_error else 'resolve')
...
class Arguments:
    def __init__(self, configObj, parser=None, with_group_prefix=False, conflict_error=True):
