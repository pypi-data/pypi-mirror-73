...
class AquaCropModel:
    ...
    def initialize(self,):
        ...
        self.ParamStruct,self.IrrMngt = read_irrigation_management(self.ParamStruct,self.IrrMngt,self.ClockStruct)
    ...
    def perform_timestep(self):
        ...
        #%% Get model solution %%
        NewCond,ParamStruct,Outputs = solution(self.InitCond,self.ParamStruct,self.ClockStruct,weather_step,self.Outputs,self.IrrMngt)
