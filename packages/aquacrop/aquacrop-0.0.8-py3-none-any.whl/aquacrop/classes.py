...
__all__ = ['ClockStructClass', 'OutputClass', 'ParamStructClass', 'SoilClass', 'CropClass', 'IrrMngtClass',
           'IrrMngtStruct', 'spec', 'FieldMngtClass', 'GwClass', 'InitWCClass', 'CropStruct', 'spec', 'InitCondClass',
           'spec', 'WevapClass', 'spec', 'SoilProfileClass', 'spec', 'TAWClass', 'spec', 'DrClass', 'spec', 'thRZClass',
           'spec', 'KswClass', 'spec', 'KstClass', 'spec', 'CO2Class', 'spec']
...
class ClockStructClass:
    ...
    def __init__(self):
        ...
        self.SeasonCounter = 0 # running counter of seasons
...
class SoilClass:
    ...
    **Attributes**:\n
    ...
    A number of float attributes specified in the initialisation of the class
        ...
        '''
    def __init__(self,soilType,dz=[0.1]*6+[0.2]*4+[0.3]*2,CalcSHP = 0,
                 AdjREW= 1,REW= 9.0,CalcCN=1,CN=61.0,zRes=-999,
