...
# Cell
def solution(InitCond,ParamStruct,ClockStruct,weather_step,Outputs,IrrMngt):
    """
    ...
    *Returns:*
    ...
    if ClockStruct.SeasonCounter >= 0:
        ...
        python_crop = ParamStruct.python_crop_list[ClockStruct.SeasonCounter]
        Crop_Name = python_crop.Name
        #IrrMngt = python_crop.IrrMngtStruct



        if GrowingSeason == True:
            FieldMngt = python_crop.FieldMngt
        else:
        ...
        #IrrMngt = ParamStruct.python_fallow_crop.IrrMngt
    ...
    NewCond,Soil = check_groundwater_table(ClockStruct,Soil,NewCond,ParamStruct)
    ...
    # 5. Surface runoff
    Runoff,Infl,NewCond = rainfall_partition(P,NewCond,FieldMngt.SRinhb,
                       FieldMngt.Bunds,FieldMngt.zBund,FieldMngt.CNadjPct,
    ...
    # 7. Infiltration
    NewCond,DeepPerc,RunoffTot,Infl,FluxOut = infiltration(Soil.Profile,NewCond,Infl,Irr,IrrMngt.AppEff,FieldMngt.Bunds,
                                                           FieldMngt.zBund,FluxOut,DeepPerc,Runoff,GrowingSeason)
    # 8. Capillary Rise
    NewCond,CR = capillary_rise(Soil,NewCond,FluxOut,ParamStruct.WaterTable)
    ...
    NewCond,Es,EsPot = soil_evaporation(ClockStruct.EvapTimeSteps,ClockStruct.SimOffSeason,ClockStruct.TimeStepCounter,
                                        ...
                                        FieldMngt.Mulches,FieldMngt.fMulch,FieldMngt.MulchPct,
...
def reset_initial_conditions(ClockStruct,InitCond,ParamStruct,weather):
    ...
    *Returns:*
    ...
    Soil = ParamStruct.Soil
    Crop = ParamStruct.Seasonal_Crop_List[ClockStruct.SeasonCounter]
    py_Crop = ParamStruct.python_crop_list[ClockStruct.SeasonCounter]
    FieldMngt = py_Crop.FieldMngt
    CO2 = ParamStruct.CO2
