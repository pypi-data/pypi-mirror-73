...
# Cell
@njit()
def check_groundwater_table(ClockStruct_TimeStepCounter,prof,InitCond,
                            ParamStruct_WaterTable,ParamStruct_WTMethod,ParamStruct_zGW):
    """
    ...
    *Returns:*
    ...
    if (ParamStruct_WaterTable == 1) and (ParamStruct_WTMethod == 'Variable'):

        # Update groundwater conditions for current day
        NewCond.zGW = float(ParamStruct_zGW[ClockStruct_TimeStepCounter])
