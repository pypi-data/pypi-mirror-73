...
class BufferedIOReader(IOReader):
    ...
    totsz = property(_swigfaiss.BufferedIOReader_totsz_get, _swigfaiss.BufferedIOReader_totsz_set)
...
class BufferedIOWriter(IOWriter):
    ...
    def __init__(self, writer, bsz):
        _swigfaiss.BufferedIOWriter_swiginit(self, _swigfaiss.new_BufferedIOWriter(writer, bsz))
