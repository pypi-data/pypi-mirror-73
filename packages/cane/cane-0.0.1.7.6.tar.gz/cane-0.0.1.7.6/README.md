...
It is possible to apply these transformations to specific columns only instead of the full dataset (follow the example), however the dataset will be sorted alphabetically!
