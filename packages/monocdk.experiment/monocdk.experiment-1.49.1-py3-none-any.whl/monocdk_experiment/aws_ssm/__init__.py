...
class CfnMaintenanceWindow(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindow"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, allow_unassociated_targets: typing.Union[bool, _IResolvable_9ceae33e], cutoff: jsii.Number, duration: jsii.Number, name: str, schedule: str, description: typing.Optional[str]=None, end_date: typing.Optional[str]=None, schedule_offset: typing.Optional[jsii.Number]=None, schedule_timezone: typing.Optional[str]=None, start_date: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
        ...
        """
        props = CfnMaintenanceWindowProps(allow_unassociated_targets=allow_unassociated_targets, cutoff=cutoff, duration=duration, name=name, schedule=schedule, description=description, end_date=end_date, schedule_offset=schedule_offset, schedule_timezone=schedule_timezone, start_date=start_date, tags=tags)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowProps", jsii_struct_bases=[], name_mapping={'allow_unassociated_targets': 'allowUnassociatedTargets', 'cutoff': 'cutoff', 'duration': 'duration', 'name': 'name', 'schedule': 'schedule', 'description': 'description', 'end_date': 'endDate', 'schedule_offset': 'scheduleOffset', 'schedule_timezone': 'scheduleTimezone', 'start_date': 'startDate', 'tags': 'tags'})
class CfnMaintenanceWindowProps():
    def __init__(self, *, allow_unassociated_targets: typing.Union[bool, _IResolvable_9ceae33e], cutoff: jsii.Number, duration: jsii.Number, name: str, schedule: str, description: typing.Optional[str]=None, end_date: typing.Optional[str]=None, schedule_offset: typing.Optional[jsii.Number]=None, schedule_timezone: typing.Optional[str]=None, start_date: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
        ...
        if schedule_offset is not None: self._values["schedule_offset"] = schedule_offset
