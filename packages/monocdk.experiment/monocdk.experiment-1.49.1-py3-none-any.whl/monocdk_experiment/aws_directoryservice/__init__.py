...
class CfnMicrosoftAD(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_directoryservice.CfnMicrosoftAD"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, password: str, vpc_settings: typing.Union["VpcSettingsProperty", _IResolvable_9ceae33e], create_alias: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, edition: typing.Optional[str]=None, enable_sso: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, short_name: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMicrosoftAD":
    ...
    def vpc_settings(self) -> typing.Union["VpcSettingsProperty", _IResolvable_9ceae33e]:
    ...
    @vpc_settings.setter
    def vpc_settings(self, value: typing.Union["VpcSettingsProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "vpcSettings", value)

    @builtins.property
    @jsii.member(jsii_name="createAlias")
    def create_alias(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @create_alias.setter
    def create_alias(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @enable_sso.setter
    def enable_sso(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_directoryservice.CfnMicrosoftAD.VpcSettingsProperty", jsii_struct_bases=[], name_mapping={'subnet_ids': 'subnetIds', 'vpc_id': 'vpcId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_directoryservice.CfnMicrosoftADProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'password': 'password', 'vpc_settings': 'vpcSettings', 'create_alias': 'createAlias', 'edition': 'edition', 'enable_sso': 'enableSso', 'short_name': 'shortName'})
class CfnMicrosoftADProps():
    def __init__(self, *, name: str, password: str, vpc_settings: typing.Union["CfnMicrosoftAD.VpcSettingsProperty", _IResolvable_9ceae33e], create_alias: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, edition: typing.Optional[str]=None, enable_sso: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, short_name: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def vpc_settings(self) -> typing.Union["CfnMicrosoftAD.VpcSettingsProperty", _IResolvable_9ceae33e]:
        """``AWS::DirectoryService::MicrosoftAD.VpcSettings``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnSimpleAD(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_directoryservice.CfnSimpleAD"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, password: str, size: str, vpc_settings: typing.Union["VpcSettingsProperty", _IResolvable_9ceae33e], create_alias: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, description: typing.Optional[str]=None, enable_sso: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, short_name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnSimpleAD":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_directoryservice.CfnSimpleAD.VpcSettingsProperty", jsii_struct_bases=[], name_mapping={'subnet_ids': 'subnetIds', 'vpc_id': 'vpcId'})
    class VpcSettingsProperty():
        def __init__(self, *, subnet_ids: typing.List[str], vpc_id: str) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_directoryservice.CfnSimpleADProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'password': 'password', 'size': 'size', 'vpc_settings': 'vpcSettings', 'create_alias': 'createAlias', 'description': 'description', 'enable_sso': 'enableSso', 'short_name': 'shortName'})
class CfnSimpleADProps():
    ...
    @builtins.property
    def vpc_settings(self) -> typing.Union["CfnSimpleAD.VpcSettingsProperty", _IResolvable_9ceae33e]:
        """``AWS::DirectoryService::SimpleAD.VpcSettings``.
