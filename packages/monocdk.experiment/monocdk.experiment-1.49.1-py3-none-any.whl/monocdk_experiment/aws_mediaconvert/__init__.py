...
class CfnJobTemplate(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_mediaconvert.CfnJobTemplate"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, settings_json: typing.Any, acceleration_settings: typing.Optional[typing.Union["AccelerationSettingsProperty", _IResolvable_9ceae33e]]=None, category: typing.Optional[str]=None, description: typing.Optional[str]=None, hop_destinations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["HopDestinationProperty", _IResolvable_9ceae33e]]]]=None, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, status_update_interval: typing.Optional[str]=None, tags: typing.Any=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnJobTemplate":
    ...
    def acceleration_settings(self) -> typing.Optional[typing.Union["AccelerationSettingsProperty", _IResolvable_9ceae33e]]:
    ...
    def acceleration_settings(self, value: typing.Optional[typing.Union["AccelerationSettingsProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def hop_destinations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["HopDestinationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def hop_destinations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["HopDestinationProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_mediaconvert.CfnJobTemplate.AccelerationSettingsProperty", jsii_struct_bases=[], name_mapping={'mode': 'mode'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_mediaconvert.CfnJobTemplate.HopDestinationProperty", jsii_struct_bases=[], name_mapping={'priority': 'priority', 'queue': 'queue', 'wait_minutes': 'waitMinutes'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_mediaconvert.CfnJobTemplateProps", jsii_struct_bases=[], name_mapping={'settings_json': 'settingsJson', 'acceleration_settings': 'accelerationSettings', 'category': 'category', 'description': 'description', 'hop_destinations': 'hopDestinations', 'name': 'name', 'priority': 'priority', 'queue': 'queue', 'status_update_interval': 'statusUpdateInterval', 'tags': 'tags'})
class CfnJobTemplateProps():
    def __init__(self, *, settings_json: typing.Any, acceleration_settings: typing.Optional[typing.Union["CfnJobTemplate.AccelerationSettingsProperty", _IResolvable_9ceae33e]]=None, category: typing.Optional[str]=None, description: typing.Optional[str]=None, hop_destinations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobTemplate.HopDestinationProperty", _IResolvable_9ceae33e]]]]=None, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, status_update_interval: typing.Optional[str]=None, tags: typing.Any=None) -> None:
    ...
    @builtins.property
    def acceleration_settings(self) -> typing.Optional[typing.Union["CfnJobTemplate.AccelerationSettingsProperty", _IResolvable_9ceae33e]]:
        """``AWS::MediaConvert::JobTemplate.AccelerationSettings``.
    ...
    @builtins.property
    def hop_destinations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobTemplate.HopDestinationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::MediaConvert::JobTemplate.HopDestinations``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnPreset(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_mediaconvert.CfnPreset"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, settings_json: typing.Any, category: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, tags: typing.Any=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnPreset":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_mediaconvert.CfnPresetProps", jsii_struct_bases=[], name_mapping={'settings_json': 'settingsJson', 'category': 'category', 'description': 'description', 'name': 'name', 'tags': 'tags'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnQueue(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_mediaconvert.CfnQueue"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, description: typing.Optional[str]=None, name: typing.Optional[str]=None, pricing_plan: typing.Optional[str]=None, status: typing.Optional[str]=None, tags: typing.Any=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_mediaconvert.CfnQueueProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'name': 'name', 'pricing_plan': 'pricingPlan', 'status': 'status', 'tags': 'tags'})
class CfnQueueProps():
