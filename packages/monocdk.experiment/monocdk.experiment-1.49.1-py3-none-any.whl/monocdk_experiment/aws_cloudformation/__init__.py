...
from .. import (CfnResource as _CfnResource_7760e8e4, Construct as _Construct_f50a3f53, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IInspectable as _IInspectable_051e6ed8, TagManager as _TagManager_2508893f, IResolvable as _IResolvable_9ceae33e, CfnTag as _CfnTag_b4661f1a, CustomResource as _CustomResource_ed3258f5, RemovalPolicy as _RemovalPolicy_5986e9f3, NestedStack as _NestedStack_e205561c, Duration as _Duration_5170c158)
from ..aws_lambda import (IFunction as _IFunction_1c1de0bc)
from ..aws_sns import (ITopic as _ITopic_ef0ebe0e)


@jsii.implements(_IInspectable_051e6ed8)
class CfnCustomResource(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CfnCustomResource"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, service_token: str) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnCustomResource":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.CfnCustomResourceProps", jsii_struct_bases=[], name_mapping={'service_token': 'serviceToken'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMacro(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CfnMacro"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, function_name: str, name: str, description: typing.Optional[str]=None, log_group_name: typing.Optional[str]=None, log_role_arn: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMacro":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.CfnMacroProps", jsii_struct_bases=[], name_mapping={'function_name': 'functionName', 'name': 'name', 'description': 'description', 'log_group_name': 'logGroupName', 'log_role_arn': 'logRoleArn'})
class CfnMacroProps():
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnStack(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CfnStack"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, template_url: str, notification_arns: typing.Optional[typing.List[str]]=None, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, timeout_in_minutes: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.CfnStackProps", jsii_struct_bases=[], name_mapping={'template_url': 'templateUrl', 'notification_arns': 'notificationArns', 'parameters': 'parameters', 'tags': 'tags', 'timeout_in_minutes': 'timeoutInMinutes'})
class CfnStackProps():
    def __init__(self, *, template_url: str, notification_arns: typing.Optional[typing.List[str]]=None, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, timeout_in_minutes: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnWaitCondition(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CfnWaitCondition"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, count: typing.Optional[jsii.Number]=None, handle: typing.Optional[str]=None, timeout: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnWaitCondition":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnWaitConditionHandle(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CfnWaitConditionHandle"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnWaitConditionHandle":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.CfnWaitConditionProps", jsii_struct_bases=[], name_mapping={'count': 'count', 'handle': 'handle', 'timeout': 'timeout'})
...
class CustomResource(_CustomResource_ed3258f5, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CustomResource"):
    """Deprecated.
    ...
    :stability: deprecated
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, provider: "ICustomResourceProvider", properties: typing.Optional[typing.Mapping[str, typing.Any]]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, resource_type: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.CustomResourceProps", jsii_struct_bases=[], name_mapping={'provider': 'provider', 'properties': 'properties', 'removal_policy': 'removalPolicy', 'resource_type': 'resourceType'})
class CustomResourceProps():
    def __init__(self, *, provider: "ICustomResourceProvider", properties: typing.Optional[typing.Mapping[str, typing.Any]]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, resource_type: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.CustomResourceProviderConfig", jsii_struct_bases=[], name_mapping={'service_token': 'serviceToken'})
...
@jsii.interface(jsii_type="monocdk-experiment.aws_cloudformation.ICustomResourceProvider")
...
class NestedStack(_NestedStack_e205561c, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.NestedStack"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, notifications: typing.Optional[typing.List[_ITopic_ef0ebe0e]]=None, parameters: typing.Optional[typing.Mapping[str, str]]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudformation.NestedStackProps", jsii_struct_bases=[], name_mapping={'notifications': 'notifications', 'parameters': 'parameters', 'timeout': 'timeout'})
class NestedStackProps():
    def __init__(self, *, notifications: typing.Optional[typing.List[_ITopic_ef0ebe0e]]=None, parameters: typing.Optional[typing.Mapping[str, str]]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
...
class CustomResourceProvider(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudformation.CustomResourceProvider"):
    """Represents a provider for an AWS CloudFormation custom resources.
