...
class CfnServer(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_opsworkscm.CfnServer"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, instance_profile_arn: str, instance_type: str, service_role_arn: str, associate_public_ip_address: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, backup_id: typing.Optional[str]=None, backup_retention_count: typing.Optional[jsii.Number]=None, custom_certificate: typing.Optional[str]=None, custom_domain: typing.Optional[str]=None, custom_private_key: typing.Optional[str]=None, disable_automated_backup: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, engine: typing.Optional[str]=None, engine_attributes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["EngineAttributeProperty", _IResolvable_9ceae33e]]]]=None, engine_model: typing.Optional[str]=None, engine_version: typing.Optional[str]=None, key_pair: typing.Optional[str]=None, preferred_backup_window: typing.Optional[str]=None, preferred_maintenance_window: typing.Optional[str]=None, security_group_ids: typing.Optional[typing.List[str]]=None, server_name: typing.Optional[str]=None, subnet_ids: typing.Optional[typing.List[str]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnServer":
    ...
    def disable_automated_backup(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def disable_automated_backup(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def engine_attributes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["EngineAttributeProperty", _IResolvable_9ceae33e]]]]:
    ...
    def engine_attributes(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["EngineAttributeProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_opsworkscm.CfnServer.EngineAttributeProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
...
class CfnServerProps():
    ...
    @builtins.property
    def engine_attributes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnServer.EngineAttributeProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::OpsWorksCM::Server.EngineAttributes``.
