...
class CfnCostCategory(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ce.CfnCostCategory"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, rules: str, rule_version: str) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnCostCategory":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ce.CfnCostCategoryProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'rules': 'rules', 'rule_version': 'ruleVersion'})
