...
from ..aws_secretsmanager import (SecretRotation as _SecretRotation_312fb992, SecretAttachmentTargetProps as _SecretAttachmentTargetProps_b948cd13, ISecret as _ISecret_75279d36, Secret as _Secret_01d21232, ISecretAttachmentTarget as _ISecretAttachmentTarget_0a569782)


@jsii.implements(_IInspectable_051e6ed8)
class CfnCluster(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.CfnCluster"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cluster_type: str, db_name: str, master_username: str, master_user_password: str, node_type: str, allow_version_upgrade: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, automated_snapshot_retention_period: typing.Optional[jsii.Number]=None, availability_zone: typing.Optional[str]=None, cluster_identifier: typing.Optional[str]=None, cluster_parameter_group_name: typing.Optional[str]=None, cluster_security_groups: typing.Optional[typing.List[str]]=None, cluster_subnet_group_name: typing.Optional[str]=None, cluster_version: typing.Optional[str]=None, elastic_ip: typing.Optional[str]=None, encrypted: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, hsm_client_certificate_identifier: typing.Optional[str]=None, hsm_configuration_identifier: typing.Optional[str]=None, iam_roles: typing.Optional[typing.List[str]]=None, kms_key_id: typing.Optional[str]=None, logging_properties: typing.Optional[typing.Union["LoggingPropertiesProperty", _IResolvable_9ceae33e]]=None, number_of_nodes: typing.Optional[jsii.Number]=None, owner_account: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, preferred_maintenance_window: typing.Optional[str]=None, publicly_accessible: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, snapshot_cluster_identifier: typing.Optional[str]=None, snapshot_identifier: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, vpc_security_group_ids: typing.Optional[typing.List[str]]=None) -> None:
    ...
    def allow_version_upgrade(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def allow_version_upgrade(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def automated_snapshot_retention_period(self, value: typing.Optional[jsii.Number]) -> None:
    ...
    def logging_properties(self) -> typing.Optional[typing.Union["LoggingPropertiesProperty", _IResolvable_9ceae33e]]:
    ...
    def logging_properties(self, value: typing.Optional[typing.Union["LoggingPropertiesProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.CfnCluster.LoggingPropertiesProperty", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 's3_key_prefix': 's3KeyPrefix'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnClusterParameterGroup(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.CfnClusterParameterGroup"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, description: str, parameter_group_family: str, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ParameterProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnClusterParameterGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def parameters(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ParameterProperty", _IResolvable_9ceae33e]]]]:
    ...
    @parameters.setter
    def parameters(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ParameterProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "parameters", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.CfnClusterParameterGroup.ParameterProperty", jsii_struct_bases=[], name_mapping={'parameter_name': 'parameterName', 'parameter_value': 'parameterValue'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.CfnClusterParameterGroupProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'parameter_group_family': 'parameterGroupFamily', 'parameters': 'parameters', 'tags': 'tags'})
class CfnClusterParameterGroupProps():
    def __init__(self, *, description: str, parameter_group_family: str, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnClusterParameterGroup.ParameterProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @builtins.property
    def parameters(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnClusterParameterGroup.ParameterProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::Redshift::ClusterParameterGroup.Parameters``.
...
class CfnClusterProps():
    ...
    @builtins.property
    def logging_properties(self) -> typing.Optional[typing.Union["CfnCluster.LoggingPropertiesProperty", _IResolvable_9ceae33e]]:
        """``AWS::Redshift::Cluster.LoggingProperties``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnClusterSecurityGroup(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.CfnClusterSecurityGroup"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, description: str, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnClusterSecurityGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnClusterSecurityGroupIngress(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.CfnClusterSecurityGroupIngress"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cluster_security_group_name: str, cidrip: typing.Optional[str]=None, ec2_security_group_name: typing.Optional[str]=None, ec2_security_group_owner_id: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnClusterSecurityGroupIngress":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.CfnClusterSecurityGroupIngressProps", jsii_struct_bases=[], name_mapping={'cluster_security_group_name': 'clusterSecurityGroupName', 'cidrip': 'cidrip', 'ec2_security_group_name': 'ec2SecurityGroupName', 'ec2_security_group_owner_id': 'ec2SecurityGroupOwnerId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.CfnClusterSecurityGroupProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'tags': 'tags'})
class CfnClusterSecurityGroupProps():
    def __init__(self, *, description: str, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnClusterSubnetGroup(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.CfnClusterSubnetGroup"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, description: str, subnet_ids: typing.List[str], tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnClusterSubnetGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.CfnClusterSubnetGroupProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'subnet_ids': 'subnetIds', 'tags': 'tags'})
class CfnClusterSubnetGroupProps():
    def __init__(self, *, description: str, subnet_ids: typing.List[str], tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.ClusterAttributes", jsii_struct_bases=[], name_mapping={'cluster_endpoint_address': 'clusterEndpointAddress', 'cluster_endpoint_port': 'clusterEndpointPort', 'cluster_name': 'clusterName', 'security_groups': 'securityGroups'})
class ClusterAttributes():
    def __init__(self, *, cluster_endpoint_address: str, cluster_endpoint_port: jsii.Number, cluster_name: str, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.ClusterParameterGroupProps", jsii_struct_bases=[], name_mapping={'parameters': 'parameters', 'description': 'description'})
class ClusterParameterGroupProps():
    def __init__(self, *, parameters: typing.Mapping[str, str], description: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.ClusterProps", jsii_struct_bases=[], name_mapping={'master_user': 'masterUser', 'vpc': 'vpc', 'cluster_name': 'clusterName', 'cluster_type': 'clusterType', 'default_database_name': 'defaultDatabaseName', 'encrypted': 'encrypted', 'encryption_key': 'encryptionKey', 'logging_bucket': 'loggingBucket', 'logging_key_prefix': 'loggingKeyPrefix', 'node_type': 'nodeType', 'number_of_nodes': 'numberOfNodes', 'parameter_group': 'parameterGroup', 'port': 'port', 'preferred_maintenance_window': 'preferredMaintenanceWindow', 'removal_policy': 'removalPolicy', 'roles': 'roles', 'security_groups': 'securityGroups', 'vpc_subnets': 'vpcSubnets'})
class ClusterProps():
    def __init__(self, *, master_user: "Login", vpc: _IVpc_3795853f, cluster_name: typing.Optional[str]=None, cluster_type: typing.Optional["ClusterType"]=None, default_database_name: typing.Optional[str]=None, encrypted: typing.Optional[bool]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None, logging_bucket: typing.Optional[_IBucket_25bad983]=None, logging_key_prefix: typing.Optional[str]=None, node_type: typing.Optional["NodeType"]=None, number_of_nodes: typing.Optional[jsii.Number]=None, parameter_group: typing.Optional["IClusterParameterGroup"]=None, port: typing.Optional[jsii.Number]=None, preferred_maintenance_window: typing.Optional[str]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, roles: typing.Optional[typing.List[_IRole_e69bbae4]]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        ...
        if cluster_type is not None: self._values["cluster_type"] = cluster_type
        ...
        if logging_bucket is not None: self._values["logging_bucket"] = logging_bucket
        if logging_key_prefix is not None: self._values["logging_key_prefix"] = logging_key_prefix
...
class DatabaseSecret(_Secret_01d21232, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.DatabaseSecret"):
    """A database secret.
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, username: str, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.DatabaseSecretProps", jsii_struct_bases=[], name_mapping={'username': 'username', 'encryption_key': 'encryptionKey'})
class DatabaseSecretProps():
    def __init__(self, *, username: str, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> None:
...
class Endpoint(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.Endpoint"):
...
class ICluster(_IResource_72f7ee7e, _IConnectable_a587039f, _ISecretAttachmentTarget_0a569782, jsii.compat.Protocol):
...
class _IClusterProxy(jsii.proxy_for(_IResource_72f7ee7e), jsii.proxy_for(_IConnectable_a587039f), jsii.proxy_for(_ISecretAttachmentTarget_0a569782)):
    """Create a Redshift Cluster with a given number of nodes.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.Login", jsii_struct_bases=[], name_mapping={'master_username': 'masterUsername', 'encryption_key': 'encryptionKey', 'master_password': 'masterPassword'})
class Login():
    def __init__(self, *, master_username: str, encryption_key: typing.Optional[_IKey_3336c79d]=None, master_password: typing.Optional[_SecretValue_99478b8b]=None) -> None:
        ...
        if encryption_key is not None: self._values["encryption_key"] = encryption_key
        if master_password is not None: self._values["master_password"] = master_password
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_redshift.RotationMultiUserOptions", jsii_struct_bases=[], name_mapping={'secret': 'secret', 'automatically_after': 'automaticallyAfter'})
...
class Cluster(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.Cluster"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, master_user: "Login", vpc: _IVpc_3795853f, cluster_name: typing.Optional[str]=None, cluster_type: typing.Optional["ClusterType"]=None, default_database_name: typing.Optional[str]=None, encrypted: typing.Optional[bool]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None, logging_bucket: typing.Optional[_IBucket_25bad983]=None, logging_key_prefix: typing.Optional[str]=None, node_type: typing.Optional["NodeType"]=None, number_of_nodes: typing.Optional[jsii.Number]=None, parameter_group: typing.Optional["IClusterParameterGroup"]=None, port: typing.Optional[jsii.Number]=None, preferred_maintenance_window: typing.Optional[str]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, roles: typing.Optional[typing.List[_IRole_e69bbae4]]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param master_user: Username and password for the administrative user.
        ...
        :stability: experimental
        """
        props = ClusterProps(master_user=master_user, vpc=vpc, cluster_name=cluster_name, cluster_type=cluster_type, default_database_name=default_database_name, encrypted=encrypted, encryption_key=encryption_key, logging_bucket=logging_bucket, logging_key_prefix=logging_key_prefix, node_type=node_type, number_of_nodes=number_of_nodes, parameter_group=parameter_group, port=port, preferred_maintenance_window=preferred_maintenance_window, removal_policy=removal_policy, roles=roles, security_groups=security_groups, vpc_subnets=vpc_subnets)

        jsii.create(Cluster, self, [scope, id, props])

    @jsii.member(jsii_name="fromClusterAttributes")
    @builtins.classmethod
    def from_cluster_attributes(cls, scope: _Construct_f50a3f53, id: str, *, cluster_endpoint_address: str, cluster_endpoint_port: jsii.Number, cluster_name: str, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None) -> "ICluster":
        ...
        :stability: experimental
        """
        attrs = ClusterAttributes(cluster_endpoint_address=cluster_endpoint_address, cluster_endpoint_port=cluster_endpoint_port, cluster_name=cluster_name, security_groups=security_groups)
...
class ClusterParameterGroup(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_redshift.ClusterParameterGroup"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, parameters: typing.Mapping[str, str], description: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param parameters: The parameters in this parameter group.
        ...
        :stability: experimental
        """
        props = ClusterParameterGroupProps(parameters=parameters, description=description)

        jsii.create(ClusterParameterGroup, self, [scope, id, props])

    @jsii.member(jsii_name="fromClusterParameterGroupName")
    @builtins.classmethod
    def from_cluster_parameter_group_name(cls, scope: _Construct_f50a3f53, id: str, cluster_parameter_group_name: str) -> "IClusterParameterGroup":
