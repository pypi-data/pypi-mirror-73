...
from .. import (CfnResource as _CfnResource_7760e8e4, Construct as _Construct_f50a3f53, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, TagManager as _TagManager_2508893f, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, Duration as _Duration_5170c158, Resource as _Resource_884d0774, IResource as _IResource_72f7ee7e)
from ..aws_lambda import (IFunction as _IFunction_1c1de0bc)


@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.BatchHttpRouteOptions", jsii_struct_bases=[], name_mapping={'integration': 'integration'})
...
class CfnApi(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApi"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_key_selection_expression: typing.Optional[str]=None, base_path: typing.Optional[str]=None, body: typing.Any=None, body_s3_location: typing.Optional[typing.Union["BodyS3LocationProperty", _IResolvable_9ceae33e]]=None, cors_configuration: typing.Optional[typing.Union["CorsProperty", _IResolvable_9ceae33e]]=None, credentials_arn: typing.Optional[str]=None, description: typing.Optional[str]=None, disable_schema_validation: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, fail_on_warnings: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, name: typing.Optional[str]=None, protocol_type: typing.Optional[str]=None, route_key: typing.Optional[str]=None, route_selection_expression: typing.Optional[str]=None, tags: typing.Any=None, target: typing.Optional[str]=None, version: typing.Optional[str]=None) -> None:
    ...
    def body_s3_location(self) -> typing.Optional[typing.Union["BodyS3LocationProperty", _IResolvable_9ceae33e]]:
    ...
    def body_s3_location(self, value: typing.Optional[typing.Union["BodyS3LocationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "bodyS3Location", value)

    @builtins.property
    @jsii.member(jsii_name="corsConfiguration")
    def cors_configuration(self) -> typing.Optional[typing.Union["CorsProperty", _IResolvable_9ceae33e]]:
    ...
    def cors_configuration(self, value: typing.Optional[typing.Union["CorsProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def disable_schema_validation(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def disable_schema_validation(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "disableSchemaValidation", value)

    @builtins.property
    @jsii.member(jsii_name="failOnWarnings")
    def fail_on_warnings(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def fail_on_warnings(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApi.BodyS3LocationProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'etag': 'etag', 'key': 'key', 'version': 'version'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApi.CorsProperty", jsii_struct_bases=[], name_mapping={'allow_credentials': 'allowCredentials', 'allow_headers': 'allowHeaders', 'allow_methods': 'allowMethods', 'allow_origins': 'allowOrigins', 'expose_headers': 'exposeHeaders', 'max_age': 'maxAge'})
    class CorsProperty():
        def __init__(self, *, allow_credentials: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, allow_headers: typing.Optional[typing.List[str]]=None, allow_methods: typing.Optional[typing.List[str]]=None, allow_origins: typing.Optional[typing.List[str]]=None, expose_headers: typing.Optional[typing.List[str]]=None, max_age: typing.Optional[jsii.Number]=None) -> None:
            """
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnApiMapping(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiMapping"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, domain_name: str, stage: str, api_mapping_key: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnApiMapping":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnApiMappingProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'domain_name': 'domainName', 'stage': 'stage', 'api_mapping_key': 'apiMappingKey'})
...
class CfnApiProps():
    ...
    @builtins.property
    def body_s3_location(self) -> typing.Optional[typing.Union["CfnApi.BodyS3LocationProperty", _IResolvable_9ceae33e]]:
        """``AWS::ApiGatewayV2::Api.BodyS3Location``.
    ...
    @builtins.property
    def cors_configuration(self) -> typing.Optional[typing.Union["CfnApi.CorsProperty", _IResolvable_9ceae33e]]:
        """``AWS::ApiGatewayV2::Api.CorsConfiguration``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnAuthorizer(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnAuthorizer"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, authorizer_type: str, identity_source: typing.List[str], name: str, authorizer_credentials_arn: typing.Optional[str]=None, authorizer_result_ttl_in_seconds: typing.Optional[jsii.Number]=None, authorizer_uri: typing.Optional[str]=None, identity_validation_expression: typing.Optional[str]=None, jwt_configuration: typing.Optional[typing.Union["JWTConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnAuthorizer":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def authorizer_result_ttl_in_seconds(self, value: typing.Optional[jsii.Number]) -> None:
    ...
    def jwt_configuration(self) -> typing.Optional[typing.Union["JWTConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def jwt_configuration(self, value: typing.Optional[typing.Union["JWTConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "jwtConfiguration", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnAuthorizer.JWTConfigurationProperty", jsii_struct_bases=[], name_mapping={'audience': 'audience', 'issuer': 'issuer'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnAuthorizerProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'authorizer_type': 'authorizerType', 'identity_source': 'identitySource', 'name': 'name', 'authorizer_credentials_arn': 'authorizerCredentialsArn', 'authorizer_result_ttl_in_seconds': 'authorizerResultTtlInSeconds', 'authorizer_uri': 'authorizerUri', 'identity_validation_expression': 'identityValidationExpression', 'jwt_configuration': 'jwtConfiguration'})
class CfnAuthorizerProps():
    ...
    @builtins.property
    def jwt_configuration(self) -> typing.Optional[typing.Union["CfnAuthorizer.JWTConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::ApiGatewayV2::Authorizer.JwtConfiguration``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnDeployment(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnDeployment"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, description: typing.Optional[str]=None, stage_name: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnDeploymentProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'description': 'description', 'stage_name': 'stageName'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnDomainName(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnDomainName"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, domain_name: str, domain_name_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DomainNameConfigurationProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Any=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDomainName":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def domain_name_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DomainNameConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def domain_name_configurations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DomainNameConfigurationProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "domainNameConfigurations", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnDomainName.DomainNameConfigurationProperty", jsii_struct_bases=[], name_mapping={'certificate_arn': 'certificateArn', 'certificate_name': 'certificateName', 'endpoint_type': 'endpointType'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnDomainNameProps", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'domain_name_configurations': 'domainNameConfigurations', 'tags': 'tags'})
class CfnDomainNameProps():
    def __init__(self, *, domain_name: str, domain_name_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDomainName.DomainNameConfigurationProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Any=None) -> None:
    ...
    @builtins.property
    def domain_name_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDomainName.DomainNameConfigurationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::ApiGatewayV2::DomainName.DomainNameConfigurations``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnIntegration(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnIntegration"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnIntegration":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def tls_config(self) -> typing.Optional[typing.Union["TlsConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @tls_config.setter
    def tls_config(self, value: typing.Optional[typing.Union["TlsConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "tlsConfig", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnIntegration.TlsConfigProperty", jsii_struct_bases=[], name_mapping={'server_name_to_verify': 'serverNameToVerify'})
...
class CfnIntegrationProps():
    ...
    @builtins.property
    def tls_config(self) -> typing.Optional[typing.Union["CfnIntegration.TlsConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::ApiGatewayV2::Integration.TlsConfig``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnIntegrationResponse(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnIntegrationResponse"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, integration_id: str, integration_response_key: str, content_handling_strategy: typing.Optional[str]=None, response_parameters: typing.Any=None, response_templates: typing.Any=None, template_selection_expression: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnIntegrationResponse":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnModel(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnModel"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, name: str, schema: typing.Any, content_type: typing.Optional[str]=None, description: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnModel":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnModelProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'name': 'name', 'schema': 'schema', 'content_type': 'contentType', 'description': 'description'})
class CfnModelProps():
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnRoute(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnRoute"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, route_key: str, api_key_required: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, authorization_scopes: typing.Optional[typing.List[str]]=None, authorization_type: typing.Optional[str]=None, authorizer_id: typing.Optional[str]=None, model_selection_expression: typing.Optional[str]=None, operation_name: typing.Optional[str]=None, request_models: typing.Any=None, request_parameters: typing.Any=None, route_response_selection_expression: typing.Optional[str]=None, target: typing.Optional[str]=None) -> None:
    ...
    def api_key_required(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def api_key_required(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnRoute.ParameterConstraintsProperty", jsii_struct_bases=[], name_mapping={'required': 'required'})
    class ParameterConstraintsProperty():
        def __init__(self, *, required: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
            """
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnRouteResponse(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnRouteResponse"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, route_id: str, route_response_key: str, model_selection_expression: typing.Optional[str]=None, response_models: typing.Any=None, response_parameters: typing.Any=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnRouteResponse":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnRouteResponse.ParameterConstraintsProperty", jsii_struct_bases=[], name_mapping={'required': 'required'})
    class ParameterConstraintsProperty():
        def __init__(self, *, required: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnRouteResponseProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'route_id': 'routeId', 'route_response_key': 'routeResponseKey', 'model_selection_expression': 'modelSelectionExpression', 'response_models': 'responseModels', 'response_parameters': 'responseParameters'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnStage(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.CfnStage"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, stage_name: str, access_log_settings: typing.Optional[typing.Union["AccessLogSettingsProperty", _IResolvable_9ceae33e]]=None, auto_deploy: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, client_certificate_id: typing.Optional[str]=None, default_route_settings: typing.Optional[typing.Union["RouteSettingsProperty", _IResolvable_9ceae33e]]=None, deployment_id: typing.Optional[str]=None, description: typing.Optional[str]=None, route_settings: typing.Any=None, stage_variables: typing.Any=None, tags: typing.Any=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnStage":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def access_log_settings(self) -> typing.Optional[typing.Union["AccessLogSettingsProperty", _IResolvable_9ceae33e]]:
    ...
    def access_log_settings(self, value: typing.Optional[typing.Union["AccessLogSettingsProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @auto_deploy.setter
    def auto_deploy(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def default_route_settings(self) -> typing.Optional[typing.Union["RouteSettingsProperty", _IResolvable_9ceae33e]]:
    ...
    def default_route_settings(self, value: typing.Optional[typing.Union["RouteSettingsProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CfnStage.AccessLogSettingsProperty", jsii_struct_bases=[], name_mapping={'destination_arn': 'destinationArn', 'format': 'format'})
    ...
    class RouteSettingsProperty():
        def __init__(self, *, data_trace_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, detailed_metrics_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, logging_level: typing.Optional[str]=None, throttling_burst_limit: typing.Optional[jsii.Number]=None, throttling_rate_limit: typing.Optional[jsii.Number]=None) -> None:
            """
        ...
        @builtins.property
        def data_trace_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def detailed_metrics_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
class CfnStageProps():
    ...
    @builtins.property
    def access_log_settings(self) -> typing.Optional[typing.Union["CfnStage.AccessLogSettingsProperty", _IResolvable_9ceae33e]]:
        """``AWS::ApiGatewayV2::Stage.AccessLogSettings``.
    ...
    @builtins.property
    def default_route_settings(self) -> typing.Optional[typing.Union["CfnStage.RouteSettingsProperty", _IResolvable_9ceae33e]]:
        """``AWS::ApiGatewayV2::Stage.DefaultRouteSettings``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CommonStageOptions", jsii_struct_bases=[], name_mapping={'auto_deploy': 'autoDeploy', 'stage_name': 'stageName'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.CorsPreflightOptions", jsii_struct_bases=[], name_mapping={'allow_credentials': 'allowCredentials', 'allow_headers': 'allowHeaders', 'allow_methods': 'allowMethods', 'allow_origins': 'allowOrigins', 'expose_headers': 'exposeHeaders', 'max_age': 'maxAge'})
class CorsPreflightOptions():
    def __init__(self, *, allow_credentials: typing.Optional[bool]=None, allow_headers: typing.Optional[typing.List[str]]=None, allow_methods: typing.Optional[typing.List["HttpMethod"]]=None, allow_origins: typing.Optional[typing.List[str]]=None, expose_headers: typing.Optional[typing.List[str]]=None, max_age: typing.Optional[_Duration_5170c158]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpApiProps", jsii_struct_bases=[], name_mapping={'api_name': 'apiName', 'cors_preflight': 'corsPreflight', 'create_default_stage': 'createDefaultStage', 'default_integration': 'defaultIntegration'})
class HttpApiProps():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpIntegrationProps", jsii_struct_bases=[], name_mapping={'http_api': 'httpApi', 'integration_type': 'integrationType', 'integration_uri': 'integrationUri', 'method': 'method', 'payload_format_version': 'payloadFormatVersion'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpProxyIntegrationProps", jsii_struct_bases=[], name_mapping={'url': 'url', 'method': 'method'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpRouteIntegrationConfig", jsii_struct_bases=[], name_mapping={'payload_format_version': 'payloadFormatVersion', 'type': 'type', 'uri': 'uri', 'method': 'method'})
...
class HttpRouteKey(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.HttpRouteKey"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpRouteProps", jsii_struct_bases=[BatchHttpRouteOptions], name_mapping={'integration': 'integration', 'http_api': 'httpApi', 'route_key': 'routeKey'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpStageOptions", jsii_struct_bases=[CommonStageOptions], name_mapping={'auto_deploy': 'autoDeploy', 'stage_name': 'stageName'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.HttpStageProps", jsii_struct_bases=[HttpStageOptions], name_mapping={'auto_deploy': 'autoDeploy', 'stage_name': 'stageName', 'http_api': 'httpApi'})
...
class LambdaProxyIntegration(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.LambdaProxyIntegration"):
    """The Lambda Proxy integration resource for HTTP API.

    stability
    :stability: experimental
    """
    def __init__(self, *, handler: _IFunction_1c1de0bc, payload_format_version: typing.Optional["PayloadFormatVersion"]=None) -> None:
        """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.LambdaProxyIntegrationProps", jsii_struct_bases=[], name_mapping={'handler': 'handler', 'payload_format_version': 'payloadFormatVersion'})
...
class PayloadFormatVersion(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.PayloadFormatVersion"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_apigatewayv2.AddRoutesOptions", jsii_struct_bases=[BatchHttpRouteOptions], name_mapping={'integration': 'integration', 'path': 'path', 'methods': 'methods'})
...
class HttpApi(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.HttpApi"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_name: typing.Optional[str]=None, cors_preflight: typing.Optional["CorsPreflightOptions"]=None, create_default_stage: typing.Optional[bool]=None, default_integration: typing.Optional["IHttpRouteIntegration"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param api_name: Name for the HTTP API resoruce. Default: - id of the HttpApi construct.
    ...
    @builtins.classmethod
    def from_api_id(cls, scope: _Construct_f50a3f53, id: str, http_api_id: str) -> "IHttpApi":
...
@jsii.implements(IHttpRouteIntegration)
class HttpProxyIntegration(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.HttpProxyIntegration"):
...
class HttpStage(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.HttpStage"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, http_api: "IHttpApi", auto_deploy: typing.Optional[bool]=None, stage_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param http_api: The HTTP API to which this stage is associated.
    ...
    @builtins.classmethod
    def from_stage_name(cls, scope: _Construct_f50a3f53, id: str, stage_name: str) -> "IStage":
...
class HttpIntegration(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.HttpIntegration"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, http_api: "IHttpApi", integration_type: "HttpIntegrationType", integration_uri: str, method: typing.Optional["HttpMethod"]=None, payload_format_version: typing.Optional["PayloadFormatVersion"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param http_api: The HTTP API to which this integration should be bound.
...
class HttpRoute(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_apigatewayv2.HttpRoute"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, http_api: "IHttpApi", route_key: "HttpRouteKey", integration: "IHttpRouteIntegration") -> None:
        """
        :param scope: -
        :param id: -
        :param http_api: the API the route is associated with.
