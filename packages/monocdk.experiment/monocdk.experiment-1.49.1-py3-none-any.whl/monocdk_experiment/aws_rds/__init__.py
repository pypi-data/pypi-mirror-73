...
@jsii.data_type(jsii_type="monocdk-experiment.aws_rds.DatabaseProxyAttributes", jsii_struct_bases=[], name_mapping={'db_proxy_arn': 'dbProxyArn', 'db_proxy_name': 'dbProxyName', 'endpoint': 'endpoint', 'security_groups': 'securityGroups'})
class DatabaseProxyAttributes():
    def __init__(self, *, db_proxy_arn: str, db_proxy_name: str, endpoint: str, security_groups: typing.List[_ISecurityGroup_d72ab8e8]) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_rds.DatabaseProxyOptions", jsii_struct_bases=[], name_mapping={'secret': 'secret', 'vpc': 'vpc', 'borrow_timeout': 'borrowTimeout', 'db_proxy_name': 'dbProxyName', 'debug_logging': 'debugLogging', 'iam_auth': 'iamAuth', 'idle_client_timeout': 'idleClientTimeout', 'init_query': 'initQuery', 'max_connections_percent': 'maxConnectionsPercent', 'max_idle_connections_percent': 'maxIdleConnectionsPercent', 'require_tls': 'requireTLS', 'role': 'role', 'security_groups': 'securityGroups', 'session_pinning_filters': 'sessionPinningFilters', 'vpc_subnets': 'vpcSubnets'})
class DatabaseProxyOptions():
    def __init__(self, *, secret: _ISecret_75279d36, vpc: _IVpc_3795853f, borrow_timeout: typing.Optional[_Duration_5170c158]=None, db_proxy_name: typing.Optional[str]=None, debug_logging: typing.Optional[bool]=None, iam_auth: typing.Optional[bool]=None, idle_client_timeout: typing.Optional[_Duration_5170c158]=None, init_query: typing.Optional[str]=None, max_connections_percent: typing.Optional[jsii.Number]=None, max_idle_connections_percent: typing.Optional[jsii.Number]=None, require_tls: typing.Optional[bool]=None, role: typing.Optional[_IRole_e69bbae4]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, session_pinning_filters: typing.Optional[typing.List["SessionPinningFilter"]]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_rds.DatabaseProxyProps", jsii_struct_bases=[DatabaseProxyOptions], name_mapping={'secret': 'secret', 'vpc': 'vpc', 'borrow_timeout': 'borrowTimeout', 'db_proxy_name': 'dbProxyName', 'debug_logging': 'debugLogging', 'iam_auth': 'iamAuth', 'idle_client_timeout': 'idleClientTimeout', 'init_query': 'initQuery', 'max_connections_percent': 'maxConnectionsPercent', 'max_idle_connections_percent': 'maxIdleConnectionsPercent', 'require_tls': 'requireTLS', 'role': 'role', 'security_groups': 'securityGroups', 'session_pinning_filters': 'sessionPinningFilters', 'vpc_subnets': 'vpcSubnets', 'proxy_target': 'proxyTarget'})
class DatabaseProxyProps(DatabaseProxyOptions):
    def __init__(self, *, secret: _ISecret_75279d36, vpc: _IVpc_3795853f, borrow_timeout: typing.Optional[_Duration_5170c158]=None, db_proxy_name: typing.Optional[str]=None, debug_logging: typing.Optional[bool]=None, iam_auth: typing.Optional[bool]=None, idle_client_timeout: typing.Optional[_Duration_5170c158]=None, init_query: typing.Optional[str]=None, max_connections_percent: typing.Optional[jsii.Number]=None, max_idle_connections_percent: typing.Optional[jsii.Number]=None, require_tls: typing.Optional[bool]=None, role: typing.Optional[_IRole_e69bbae4]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, session_pinning_filters: typing.Optional[typing.List["SessionPinningFilter"]]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None, proxy_target: "ProxyTarget") -> None:
...
class IDatabaseCluster(_IResource_72f7ee7e, _IConnectable_a587039f, _ISecretAttachmentTarget_0a569782, jsii.compat.Protocol):
    ...
    def add_proxy(self, id: str, *, secret: _ISecret_75279d36, vpc: _IVpc_3795853f, borrow_timeout: typing.Optional[_Duration_5170c158]=None, db_proxy_name: typing.Optional[str]=None, debug_logging: typing.Optional[bool]=None, iam_auth: typing.Optional[bool]=None, idle_client_timeout: typing.Optional[_Duration_5170c158]=None, init_query: typing.Optional[str]=None, max_connections_percent: typing.Optional[jsii.Number]=None, max_idle_connections_percent: typing.Optional[jsii.Number]=None, require_tls: typing.Optional[bool]=None, role: typing.Optional[_IRole_e69bbae4]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, session_pinning_filters: typing.Optional[typing.List["SessionPinningFilter"]]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> "DatabaseProxy":
...
class ProxyTarget(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_rds.ProxyTarget"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_rds.ProxyTargetConfig", jsii_struct_bases=[], name_mapping={'engine_family': 'engineFamily', 'db_clusters': 'dbClusters', 'db_instances': 'dbInstances'})
...
class SessionPinningFilter(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_rds.SessionPinningFilter"):
...
class DatabaseProxy(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_rds.DatabaseProxy"):
    """RDS Database Proxy.
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, proxy_target: "ProxyTarget", secret: _ISecret_75279d36, vpc: _IVpc_3795853f, borrow_timeout: typing.Optional[_Duration_5170c158]=None, db_proxy_name: typing.Optional[str]=None, debug_logging: typing.Optional[bool]=None, iam_auth: typing.Optional[bool]=None, idle_client_timeout: typing.Optional[_Duration_5170c158]=None, init_query: typing.Optional[str]=None, max_connections_percent: typing.Optional[jsii.Number]=None, max_idle_connections_percent: typing.Optional[jsii.Number]=None, require_tls: typing.Optional[bool]=None, role: typing.Optional[_IRole_e69bbae4]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, session_pinning_filters: typing.Optional[typing.List["SessionPinningFilter"]]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param proxy_target: DB proxy target: Instance or Cluster.
    ...
    @builtins.classmethod
    def from_database_proxy_attributes(cls, scope: _Construct_f50a3f53, id: str, *, db_proxy_arn: str, db_proxy_name: str, endpoint: str, security_groups: typing.List[_ISecurityGroup_d72ab8e8]) -> "IDatabaseProxy":
