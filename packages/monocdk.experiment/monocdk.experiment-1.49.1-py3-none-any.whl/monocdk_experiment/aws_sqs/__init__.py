...
class CfnQueue(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sqs.CfnQueue"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, content_based_deduplication: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, delay_seconds: typing.Optional[jsii.Number]=None, fifo_queue: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, kms_data_key_reuse_period_seconds: typing.Optional[jsii.Number]=None, kms_master_key_id: typing.Optional[str]=None, maximum_message_size: typing.Optional[jsii.Number]=None, message_retention_period: typing.Optional[jsii.Number]=None, queue_name: typing.Optional[str]=None, receive_message_wait_time_seconds: typing.Optional[jsii.Number]=None, redrive_policy: typing.Any=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, visibility_timeout: typing.Optional[jsii.Number]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnQueue":
    ...
    @fifo_queue.setter
    def fifo_queue(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def kms_data_key_reuse_period_seconds(self, value: typing.Optional[jsii.Number]) -> None:
    ...
    def receive_message_wait_time_seconds(self, value: typing.Optional[jsii.Number]) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnQueuePolicy(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sqs.CfnQueuePolicy"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, policy_document: typing.Any, queues: typing.List[str]) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnQueuePolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sqs.CfnQueuePolicyProps", jsii_struct_bases=[], name_mapping={'policy_document': 'policyDocument', 'queues': 'queues'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sqs.DeadLetterQueue", jsii_struct_bases=[], name_mapping={'max_receive_count': 'maxReceiveCount', 'queue': 'queue'})
...
class IQueue(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def grant(self, grantee: _IGrantable_0fcfc53a, *queue_actions: str) -> _Grant_96af6d2d:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sqs.QueueAttributes", jsii_struct_bases=[], name_mapping={'queue_arn': 'queueArn', 'key_arn': 'keyArn', 'queue_name': 'queueName', 'queue_url': 'queueUrl'})
...
class QueueBase(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_sqs.QueueBase"):
...
class QueuePolicy(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sqs.QueuePolicy"):
    """Applies a policy to SQS queues.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, queues: typing.List["IQueue"]) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sqs.QueuePolicyProps", jsii_struct_bases=[], name_mapping={'queues': 'queues'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sqs.QueueProps", jsii_struct_bases=[], name_mapping={'content_based_deduplication': 'contentBasedDeduplication', 'data_key_reuse': 'dataKeyReuse', 'dead_letter_queue': 'deadLetterQueue', 'delivery_delay': 'deliveryDelay', 'encryption': 'encryption', 'encryption_master_key': 'encryptionMasterKey', 'fifo': 'fifo', 'max_message_size_bytes': 'maxMessageSizeBytes', 'queue_name': 'queueName', 'receive_message_wait_time': 'receiveMessageWaitTime', 'retention_period': 'retentionPeriod', 'visibility_timeout': 'visibilityTimeout'})
class QueueProps():
    def __init__(self, *, content_based_deduplication: typing.Optional[bool]=None, data_key_reuse: typing.Optional[_Duration_5170c158]=None, dead_letter_queue: typing.Optional["DeadLetterQueue"]=None, delivery_delay: typing.Optional[_Duration_5170c158]=None, encryption: typing.Optional["QueueEncryption"]=None, encryption_master_key: typing.Optional[_IKey_3336c79d]=None, fifo: typing.Optional[bool]=None, max_message_size_bytes: typing.Optional[jsii.Number]=None, queue_name: typing.Optional[str]=None, receive_message_wait_time: typing.Optional[_Duration_5170c158]=None, retention_period: typing.Optional[_Duration_5170c158]=None, visibility_timeout: typing.Optional[_Duration_5170c158]=None) -> None:
...
class Queue(QueueBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sqs.Queue"):
    """A new Amazon SQS queue.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, content_based_deduplication: typing.Optional[bool]=None, data_key_reuse: typing.Optional[_Duration_5170c158]=None, dead_letter_queue: typing.Optional["DeadLetterQueue"]=None, delivery_delay: typing.Optional[_Duration_5170c158]=None, encryption: typing.Optional["QueueEncryption"]=None, encryption_master_key: typing.Optional[_IKey_3336c79d]=None, fifo: typing.Optional[bool]=None, max_message_size_bytes: typing.Optional[jsii.Number]=None, queue_name: typing.Optional[str]=None, receive_message_wait_time: typing.Optional[_Duration_5170c158]=None, retention_period: typing.Optional[_Duration_5170c158]=None, visibility_timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param content_based_deduplication: Specifies whether to enable content-based deduplication. During the deduplication interval (5 minutes), Amazon SQS treats messages that are sent with identical content (excluding attributes) as duplicates and delivers only one copy of the message. If you don't enable content-based deduplication and you want to deduplicate messages, provide an explicit deduplication ID in your SendMessage() call. (Only applies to FIFO queues.) Default: false
    ...
    @builtins.classmethod
    def from_queue_arn(cls, scope: _Construct_f50a3f53, id: str, queue_arn: str) -> "IQueue":
    ...
    @builtins.classmethod
    def from_queue_attributes(cls, scope: _Construct_f50a3f53, id: str, *, queue_arn: str, key_arn: typing.Optional[str]=None, queue_name: typing.Optional[str]=None, queue_url: typing.Optional[str]=None) -> "IQueue":
