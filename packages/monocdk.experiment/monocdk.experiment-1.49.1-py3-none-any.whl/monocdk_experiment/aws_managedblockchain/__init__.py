...
class CfnMember(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, member_configuration: typing.Union["MemberConfigurationProperty", _IResolvable_9ceae33e], invitation_id: typing.Optional[str]=None, network_configuration: typing.Optional[typing.Union["NetworkConfigurationProperty", _IResolvable_9ceae33e]]=None, network_id: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMember":
    ...
    def member_configuration(self) -> typing.Union["MemberConfigurationProperty", _IResolvable_9ceae33e]:
    ...
    def member_configuration(self, value: typing.Union["MemberConfigurationProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.ApprovalThresholdPolicyProperty", jsii_struct_bases=[], name_mapping={'proposal_duration_in_hours': 'proposalDurationInHours', 'threshold_comparator': 'thresholdComparator', 'threshold_percentage': 'thresholdPercentage'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.MemberConfigurationProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'description': 'description', 'member_framework_configuration': 'memberFrameworkConfiguration'})
    class MemberConfigurationProperty():
        def __init__(self, *, name: str, description: typing.Optional[str]=None, member_framework_configuration: typing.Optional[typing.Union["CfnMember.MemberFrameworkConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def member_framework_configuration(self) -> typing.Optional[typing.Union["CfnMember.MemberFrameworkConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.MemberFabricConfigurationProperty", jsii_struct_bases=[], name_mapping={'admin_password': 'adminPassword', 'admin_username': 'adminUsername'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.MemberFrameworkConfigurationProperty", jsii_struct_bases=[], name_mapping={'member_fabric_configuration': 'memberFabricConfiguration'})
    class MemberFrameworkConfigurationProperty():
        def __init__(self, *, member_fabric_configuration: typing.Optional[typing.Union["CfnMember.MemberFabricConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def member_fabric_configuration(self) -> typing.Optional[typing.Union["CfnMember.MemberFabricConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.NetworkConfigurationProperty", jsii_struct_bases=[], name_mapping={'framework': 'framework', 'framework_version': 'frameworkVersion', 'name': 'name', 'voting_policy': 'votingPolicy', 'description': 'description', 'network_framework_configuration': 'networkFrameworkConfiguration'})
    class NetworkConfigurationProperty():
        def __init__(self, *, framework: str, framework_version: str, name: str, voting_policy: typing.Union["CfnMember.VotingPolicyProperty", _IResolvable_9ceae33e], description: typing.Optional[str]=None, network_framework_configuration: typing.Optional[typing.Union["CfnMember.NetworkFrameworkConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def voting_policy(self) -> typing.Union["CfnMember.VotingPolicyProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def network_framework_configuration(self) -> typing.Optional[typing.Union["CfnMember.NetworkFrameworkConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.NetworkFabricConfigurationProperty", jsii_struct_bases=[], name_mapping={'edition': 'edition'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.NetworkFrameworkConfigurationProperty", jsii_struct_bases=[], name_mapping={'network_fabric_configuration': 'networkFabricConfiguration'})
    class NetworkFrameworkConfigurationProperty():
        def __init__(self, *, network_fabric_configuration: typing.Optional[typing.Union["CfnMember.NetworkFabricConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def network_fabric_configuration(self) -> typing.Optional[typing.Union["CfnMember.NetworkFabricConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMember.VotingPolicyProperty", jsii_struct_bases=[], name_mapping={'approval_threshold_policy': 'approvalThresholdPolicy'})
    class VotingPolicyProperty():
        def __init__(self, *, approval_threshold_policy: typing.Optional[typing.Union["CfnMember.ApprovalThresholdPolicyProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def approval_threshold_policy(self) -> typing.Optional[typing.Union["CfnMember.ApprovalThresholdPolicyProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnMemberProps", jsii_struct_bases=[], name_mapping={'member_configuration': 'memberConfiguration', 'invitation_id': 'invitationId', 'network_configuration': 'networkConfiguration', 'network_id': 'networkId'})
class CfnMemberProps():
    ...
    @builtins.property
    def member_configuration(self) -> typing.Union["CfnMember.MemberConfigurationProperty", _IResolvable_9ceae33e]:
        """``AWS::ManagedBlockchain::Member.MemberConfiguration``.
    ...
    @builtins.property
    def network_configuration(self) -> typing.Optional[typing.Union["CfnMember.NetworkConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::ManagedBlockchain::Member.NetworkConfiguration``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnNode(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_managedblockchain.CfnNode"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, member_id: str, network_id: str, node_configuration: typing.Union["NodeConfigurationProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnNode":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def node_configuration(self) -> typing.Union["NodeConfigurationProperty", _IResolvable_9ceae33e]:
    ...
    def node_configuration(self, value: typing.Union["NodeConfigurationProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "nodeConfiguration", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnNode.NodeConfigurationProperty", jsii_struct_bases=[], name_mapping={'availability_zone': 'availabilityZone', 'instance_type': 'instanceType'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_managedblockchain.CfnNodeProps", jsii_struct_bases=[], name_mapping={'member_id': 'memberId', 'network_id': 'networkId', 'node_configuration': 'nodeConfiguration'})
class CfnNodeProps():
    def __init__(self, *, member_id: str, network_id: str, node_configuration: typing.Union["CfnNode.NodeConfigurationProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @builtins.property
    def node_configuration(self) -> typing.Union["CfnNode.NodeConfigurationProperty", _IResolvable_9ceae33e]:
        """``AWS::ManagedBlockchain::Node.NodeConfiguration``.
