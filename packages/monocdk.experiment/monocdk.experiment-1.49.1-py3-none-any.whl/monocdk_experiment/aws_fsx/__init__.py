...
from .. import (CfnResource as _CfnResource_7760e8e4, Construct as _Construct_f50a3f53, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, TagManager as _TagManager_2508893f, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, CfnTag as _CfnTag_b4661f1a, Resource as _Resource_884d0774, ResourceProps as _ResourceProps_92be6f66)
from ..aws_ec2 import (ISecurityGroup as _ISecurityGroup_d72ab8e8, Connections as _Connections_231f38b5, IVpc as _IVpc_3795853f, IConnectable as _IConnectable_a587039f, ISubnet as _ISubnet_7f5367e6)
from ..aws_kms import (IKey as _IKey_3336c79d)


@jsii.implements(_IInspectable_051e6ed8)
class CfnFileSystem(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_fsx.CfnFileSystem"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, file_system_type: str, subnet_ids: typing.List[str], backup_id: typing.Optional[str]=None, kms_key_id: typing.Optional[str]=None, lustre_configuration: typing.Optional[typing.Union["LustreConfigurationProperty", _IResolvable_9ceae33e]]=None, security_group_ids: typing.Optional[typing.List[str]]=None, storage_capacity: typing.Optional[jsii.Number]=None, storage_type: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, windows_configuration: typing.Optional[typing.Union["WindowsConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    def lustre_configuration(self) -> typing.Optional[typing.Union["LustreConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def lustre_configuration(self, value: typing.Optional[typing.Union["LustreConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def windows_configuration(self) -> typing.Optional[typing.Union["WindowsConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_fsx.CfnFileSystem.WindowsConfigurationProperty", jsii_struct_bases=[], name_mapping={'active_directory_id': 'activeDirectoryId', 'automatic_backup_retention_days': 'automaticBackupRetentionDays', 'copy_tags_to_backups': 'copyTagsToBackups', 'daily_automatic_backup_start_time': 'dailyAutomaticBackupStartTime', 'deployment_type': 'deploymentType', 'preferred_subnet_id': 'preferredSubnetId', 'self_managed_active_directory_configuration': 'selfManagedActiveDirectoryConfiguration', 'throughput_capacity': 'throughputCapacity', 'weekly_maintenance_start_time': 'weeklyMaintenanceStartTime'})
    class WindowsConfigurationProperty():
        def __init__(self, *, active_directory_id: typing.Optional[str]=None, automatic_backup_retention_days: typing.Optional[jsii.Number]=None, copy_tags_to_backups: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, daily_automatic_backup_start_time: typing.Optional[str]=None, deployment_type: typing.Optional[str]=None, preferred_subnet_id: typing.Optional[str]=None, self_managed_active_directory_configuration: typing.Optional[typing.Union["CfnFileSystem.SelfManagedActiveDirectoryConfigurationProperty", _IResolvable_9ceae33e]]=None, throughput_capacity: typing.Optional[jsii.Number]=None, weekly_maintenance_start_time: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def copy_tags_to_backups(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def self_managed_active_directory_configuration(self) -> typing.Optional[typing.Union["CfnFileSystem.SelfManagedActiveDirectoryConfigurationProperty", _IResolvable_9ceae33e]]:
...
class CfnFileSystemProps():
    ...
    @builtins.property
    def lustre_configuration(self) -> typing.Optional[typing.Union["CfnFileSystem.LustreConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::FSx::FileSystem.LustreConfiguration``.
    ...
    @builtins.property
    def windows_configuration(self) -> typing.Optional[typing.Union["CfnFileSystem.WindowsConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::FSx::FileSystem.WindowsConfiguration``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_fsx.FileSystemAttributes", jsii_struct_bases=[], name_mapping={'dns_name': 'dnsName', 'file_system_id': 'fileSystemId', 'security_group': 'securityGroup'})
class FileSystemAttributes():
    def __init__(self, *, dns_name: str, file_system_id: str, security_group: _ISecurityGroup_d72ab8e8) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_fsx.FileSystemProps", jsii_struct_bases=[], name_mapping={'storage_capacity_gib': 'storageCapacityGiB', 'vpc': 'vpc', 'backup_id': 'backupId', 'kms_key': 'kmsKey', 'security_group': 'securityGroup'})
class FileSystemProps():
    def __init__(self, *, storage_capacity_gib: jsii.Number, vpc: _IVpc_3795853f, backup_id: typing.Optional[str]=None, kms_key: typing.Optional[_IKey_3336c79d]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_fsx.LustreConfiguration", jsii_struct_bases=[], name_mapping={'deployment_type': 'deploymentType', 'export_path': 'exportPath', 'imported_file_chunk_size_mib': 'importedFileChunkSizeMiB', 'import_path': 'importPath', 'per_unit_storage_throughput': 'perUnitStorageThroughput', 'weekly_maintenance_start_time': 'weeklyMaintenanceStartTime'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_fsx.LustreFileSystemProps", jsii_struct_bases=[FileSystemProps], name_mapping={'storage_capacity_gib': 'storageCapacityGiB', 'vpc': 'vpc', 'backup_id': 'backupId', 'kms_key': 'kmsKey', 'security_group': 'securityGroup', 'lustre_configuration': 'lustreConfiguration', 'vpc_subnet': 'vpcSubnet'})
class LustreFileSystemProps(FileSystemProps):
    def __init__(self, *, storage_capacity_gib: jsii.Number, vpc: _IVpc_3795853f, backup_id: typing.Optional[str]=None, kms_key: typing.Optional[_IKey_3336c79d]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None, lustre_configuration: "LustreConfiguration", vpc_subnet: _ISubnet_7f5367e6) -> None:
...
class LustreMaintenanceTime(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_fsx.LustreMaintenanceTime"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_fsx.LustreMaintenanceTimeProps", jsii_struct_bases=[], name_mapping={'day': 'day', 'hour': 'hour', 'minute': 'minute'})
...
class FileSystemBase(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_fsx.FileSystemBase"):
...
class LustreFileSystem(FileSystemBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_fsx.LustreFileSystem"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, lustre_configuration: "LustreConfiguration", vpc_subnet: _ISubnet_7f5367e6, storage_capacity_gib: jsii.Number, vpc: _IVpc_3795853f, backup_id: typing.Optional[str]=None, kms_key: typing.Optional[_IKey_3336c79d]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param lustre_configuration: Additional configuration for FSx specific to Lustre.
    ...
    @builtins.classmethod
    def from_lustre_file_system_attributes(cls, scope: _Construct_f50a3f53, id: str, *, dns_name: str, file_system_id: str, security_group: _ISecurityGroup_d72ab8e8) -> "IFileSystem":
