...
from ..cloud_assembly_schema import (ArtifactManifest as _ArtifactManifest_38498e6d, AssemblyManifest as _AssemblyManifest_10a6b60e, RuntimeInfo as _RuntimeInfo_847d082a, MissingContext as _MissingContext_d8a115db, FileAssetMetadataEntry as _FileAssetMetadataEntry_401d6b3e, ContainerImageAssetMetadataEntry as _ContainerImageAssetMetadataEntry_d177c3e3, MetadataEntry as _MetadataEntry_1c069657, Tag as _Tag_9bdb11cc)


@jsii.data_type(jsii_type="monocdk-experiment.cx_api.AssemblyBuildOptions", jsii_struct_bases=[], name_mapping={'runtime_info': 'runtimeInfo'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.AwsCloudFormationStackProperties", jsii_struct_bases=[], name_mapping={'template_file': 'templateFile', 'parameters': 'parameters', 'stack_name': 'stackName', 'termination_protection': 'terminationProtection'})
...
class CloudArtifact(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudArtifact"):
    """Represents an artifact within a cloud assembly.

    stability
    :stability: experimental
    """
    def __init__(self, assembly: "CloudAssembly", id: str, *, type: _ArtifactType_9221e05d, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]]=None, properties: typing.Optional[typing.Union[_AwsCloudFormationStackProperties_cbabc075, _AssetManifestProperties_8c80271b, _TreeArtifactProperties_8af66c6c, _NestedCloudAssemblyProperties_2d939e98]]=None) -> None:
        """
        :param assembly: -
        :param id: -
        ...
        :stability: experimental
        """
        manifest = _ArtifactManifest_38498e6d(type=type, dependencies=dependencies, environment=environment, metadata=metadata, properties=properties)

        jsii.create(CloudArtifact, self, [assembly, id, manifest])

    @jsii.member(jsii_name="fromManifest")
    @builtins.classmethod
    def from_manifest(cls, assembly: "CloudAssembly", id: str, *, type: _ArtifactType_9221e05d, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]]=None, properties: typing.Optional[typing.Union[_AwsCloudFormationStackProperties_cbabc075, _AssetManifestProperties_8c80271b, _TreeArtifactProperties_8af66c6c, _NestedCloudAssemblyProperties_2d939e98]]=None) -> typing.Optional["CloudArtifact"]:
        ...
        :stability: experimental
        """
        artifact = _ArtifactManifest_38498e6d(type=type, dependencies=dependencies, environment=environment, metadata=metadata, properties=properties)
...
class CloudAssembly(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudAssembly"):
    ...
    def get_nested_assembly_artifact(self, artifact_id: str) -> "NestedCloudAssemblyArtifact":
...
class CloudAssemblyBuilder(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudAssemblyBuilder"):
    ...
    def add_artifact(self, id: str, *, type: _ArtifactType_9221e05d, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]]=None, properties: typing.Optional[typing.Union[_AwsCloudFormationStackProperties_cbabc075, _AssetManifestProperties_8c80271b, _TreeArtifactProperties_8af66c6c, _NestedCloudAssemblyProperties_2d939e98]]=None) -> None:
    ...
    def add_missing(self, *, key: str, props: typing.Union[_AmiContextQuery_f862ae87, _AvailabilityZonesContextQuery_9a5bac5f, _HostedZoneContextQuery_42616509, _SSMParameterContextQuery_f21616f8, _VpcContextQuery_65dc9cbf, _EndpointServiceAvailabilityZonesContextQuery_ea2c3fa6], provider: _ContextProvider_25ce5cb1) -> None:
    ...
    def create_nested_assembly(self, artifact_id: str, display_name: str) -> "CloudAssemblyBuilder":
...
class CloudFormationStackArtifact(CloudArtifact, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.CloudFormationStackArtifact"):
    """
    stability
    :stability: experimental
    """
    def __init__(self, assembly: "CloudAssembly", artifact_id: str, *, type: _ArtifactType_9221e05d, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]]=None, properties: typing.Optional[typing.Union[_AwsCloudFormationStackProperties_cbabc075, _AssetManifestProperties_8c80271b, _TreeArtifactProperties_8af66c6c, _NestedCloudAssemblyProperties_2d939e98]]=None) -> None:
        """
        :param assembly: -
        :param artifact_id: -
        :param type: The type of artifact.
    ...
    def assets(self) -> typing.List[typing.Union[_FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.EndpointServiceAvailabilityZonesContextQuery", jsii_struct_bases=[], name_mapping={'account': 'account', 'region': 'region', 'service_name': 'serviceName'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.Environment", jsii_struct_bases=[], name_mapping={'account': 'account', 'name': 'name', 'region': 'region'})
class Environment():
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.EnvironmentPlaceholderValues", jsii_struct_bases=[], name_mapping={'account_id': 'accountId', 'partition': 'partition', 'region': 'region'})
...
class EnvironmentPlaceholders(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.EnvironmentPlaceholders"):
...
class EnvironmentUtils(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.EnvironmentUtils"):
    """
    stability
    :stability: experimental
    """
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.MetadataEntry", jsii_struct_bases=[_MetadataEntry_1c069657], name_mapping={'type': 'type', 'data': 'data', 'trace': 'trace'})
class MetadataEntry(_MetadataEntry_1c069657):
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[str, _FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3, typing.List[_Tag_9bdb11cc]]]=None, trace: typing.Optional[typing.List[str]]=None) -> None:
    ...
    @builtins.property
    def data(self) -> typing.Optional[typing.Union[str, _FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3, typing.List[_Tag_9bdb11cc]]]:
        """The data.
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.MetadataEntryResult", jsii_struct_bases=[_MetadataEntry_1c069657], name_mapping={'type': 'type', 'data': 'data', 'trace': 'trace', 'path': 'path'})
class MetadataEntryResult(_MetadataEntry_1c069657):
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[str, _FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3, typing.List[_Tag_9bdb11cc]]]=None, trace: typing.Optional[typing.List[str]]=None, path: str) -> None:
        """
        :param type: The type of the metadata entry.
        :param data: The data. Default: - no data.
        :param trace: A stack trace for when the entry was created. Default: - no trace.
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.MissingContext", jsii_struct_bases=[], name_mapping={'key': 'key', 'props': 'props', 'provider': 'provider'})
...
class NestedCloudAssemblyArtifact(CloudArtifact, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.NestedCloudAssemblyArtifact"):
    """Asset manifest is a description of a set of assets which need to be built and published.

    stability
    :stability: experimental
    """
    def __init__(self, assembly: "CloudAssembly", name: str, *, type: _ArtifactType_9221e05d, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]]=None, properties: typing.Optional[typing.Union[_AwsCloudFormationStackProperties_cbabc075, _AssetManifestProperties_8c80271b, _TreeArtifactProperties_8af66c6c, _NestedCloudAssemblyProperties_2d939e98]]=None) -> None:
        """
        :param assembly: -
        :param name: -
        :param type: The type of artifact.
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.RuntimeInfo", jsii_struct_bases=[_RuntimeInfo_847d082a], name_mapping={'libraries': 'libraries'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.SynthesisMessage", jsii_struct_bases=[], name_mapping={'entry': 'entry', 'id': 'id', 'level': 'level'})
class SynthesisMessage():
    def __init__(self, *, entry: _MetadataEntry_1c069657, id: str, level: "SynthesisMessageLevel") -> None:
        """
        :param entry: 
        :param id: 
        :param level: 
        ...
        :stability: experimental
        """
        if isinstance(entry, dict): entry = _MetadataEntry_1c069657(**entry)
        self._values = {
            'entry': entry,
            'id': id,
            'level': level,
...
class TreeCloudArtifact(CloudArtifact, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.TreeCloudArtifact"):
    """
    stability
    :stability: experimental
    """
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.VpcSubnet", jsii_struct_bases=[], name_mapping={'availability_zone': 'availabilityZone', 'route_table_id': 'routeTableId', 'subnet_id': 'subnetId', 'cidr': 'cidr'})
class VpcSubnet():
...
@jsii.data_type(jsii_type="monocdk-experiment.cx_api.VpcSubnetGroup", jsii_struct_bases=[], name_mapping={'name': 'name', 'subnets': 'subnets', 'type': 'type'})
...
class AssetManifestArtifact(CloudArtifact, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cx_api.AssetManifestArtifact"):
    """Asset manifest is a description of a set of assets which need to be built and published.
