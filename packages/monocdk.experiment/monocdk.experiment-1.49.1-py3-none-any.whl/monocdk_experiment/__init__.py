...
@jsii.data_type(jsii_type="monocdk-experiment.DockerVolume", jsii_struct_bases=[], name_mapping={'container_path': 'containerPath', 'host_path': 'hostPath', 'consistency': 'consistency'})
class DockerVolume():
    def __init__(self, *, container_path: str, host_path: str, consistency: typing.Optional["DockerVolumeConsistency"]=None) -> None:
        """A Docker volume.
        ...
        if consistency is not None: self._values["consistency"] = consistency
