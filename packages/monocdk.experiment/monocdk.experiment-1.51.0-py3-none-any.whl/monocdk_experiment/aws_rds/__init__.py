...
class DatabaseClusterEngine(
    ...
    def __init__(
        self,
        name: str,
        single_user_rotation_application: _SecretRotationApplication_5d71a263,
        multi_user_rotation_application: _SecretRotationApplication_5d71a263,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_rds.ParameterGroupFamily",
    jsii_struct_bases=[],
    name_mapping={
...
class ClusterParameterGroup(
    _Resource_884d0774,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_rds.ClusterParameterGroup",
):
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_rds.ClusterParameterGroupProps",
