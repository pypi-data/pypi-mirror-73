...
class CfnGitHubRepository(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepository"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, repository_access_token: str, repository_name: str, repository_owner: str, code: typing.Optional[typing.Union["CodeProperty", _IResolvable_9ceae33e]]=None, enable_issues: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, is_private: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, repository_description: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnGitHubRepository":
    ...
    def enable_issues(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def enable_issues(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @is_private.setter
    def is_private(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepository.CodeProperty", jsii_struct_bases=[], name_mapping={'s3': 's3'})
    class CodeProperty():
        def __init__(self, *, s3: typing.Union["CfnGitHubRepository.S3Property", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def s3(self) -> typing.Union["CfnGitHubRepository.S3Property", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepository.S3Property", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'key': 'key', 'object_version': 'objectVersion'})
    class S3Property():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_codestar.CfnGitHubRepositoryProps", jsii_struct_bases=[], name_mapping={'repository_access_token': 'repositoryAccessToken', 'repository_name': 'repositoryName', 'repository_owner': 'repositoryOwner', 'code': 'code', 'enable_issues': 'enableIssues', 'is_private': 'isPrivate', 'repository_description': 'repositoryDescription'})
class CfnGitHubRepositoryProps():
    def __init__(self, *, repository_access_token: str, repository_name: str, repository_owner: str, code: typing.Optional[typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_9ceae33e]]=None, enable_issues: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, is_private: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, repository_description: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def code(self) -> typing.Optional[typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_9ceae33e]]:
        """``AWS::CodeStar::GitHubRepository.Code``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_codestar.GitHubRepositoryProps", jsii_struct_bases=[], name_mapping={'access_token': 'accessToken', 'contents_bucket': 'contentsBucket', 'contents_key': 'contentsKey', 'owner': 'owner', 'repository_name': 'repositoryName', 'contents_s3_version': 'contentsS3Version', 'description': 'description', 'enable_issues': 'enableIssues', 'visibility': 'visibility'})
class GitHubRepositoryProps():
    def __init__(self, *, access_token: _SecretValue_99478b8b, contents_bucket: _IBucket_25bad983, contents_key: str, owner: str, repository_name: str, contents_s3_version: typing.Optional[str]=None, description: typing.Optional[str]=None, enable_issues: typing.Optional[bool]=None, visibility: typing.Optional["RepositoryVisibility"]=None) -> None:
        ...
        if contents_s3_version is not None: self._values["contents_s3_version"] = contents_s3_version
    ...
    def __repr__(self) -> str:
        return 'GitHubRepositoryProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class GitHubRepository(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_codestar.GitHubRepository"):
    """The GitHubRepository resource.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, access_token: _SecretValue_99478b8b, contents_bucket: _IBucket_25bad983, contents_key: str, owner: str, repository_name: str, contents_s3_version: typing.Optional[str]=None, description: typing.Optional[str]=None, enable_issues: typing.Optional[bool]=None, visibility: typing.Optional["RepositoryVisibility"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param access_token: The GitHub user's personal access token for the GitHub repository.
        ...
        :stability: experimental
        """
        props = GitHubRepositoryProps(access_token=access_token, contents_bucket=contents_bucket, contents_key=contents_key, owner=owner, repository_name=repository_name, contents_s3_version=contents_s3_version, description=description, enable_issues=enable_issues, visibility=visibility)
