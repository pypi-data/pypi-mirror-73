...
from .. import (CfnResource as _CfnResource_7760e8e4, Construct as _Construct_f50a3f53, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, Resource as _Resource_884d0774, Tag as _Tag_ef7f3fe6, IResource as _IResource_72f7ee7e, Duration as _Duration_5170c158)
from ..aws_ec2 import (IVpc as _IVpc_3795853f, IMachineImage as _IMachineImage_d5cd7b45, InstanceType as _InstanceType_85a97b30, ISecurityGroup as _ISecurityGroup_d72ab8e8, SubnetSelection as _SubnetSelection_36a13cd6)
from ..aws_ecs import (ContainerImage as _ContainerImage_99cc4b15, LinuxParameters as _LinuxParameters_4f2b9dff, MountPoint as _MountPoint_4cb35154, Ulimit as _Ulimit_05b23ec0, Volume as _Volume_0361ca6f)
...
class CfnComputeEnvironment(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironment"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, service_role: str, type: str, compute_environment_name: typing.Optional[str]=None, compute_resources: typing.Optional[typing.Union["ComputeResourcesProperty", _IResolvable_9ceae33e]]=None, state: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnComputeEnvironment":
    ...
    def compute_resources(self) -> typing.Optional[typing.Union["ComputeResourcesProperty", _IResolvable_9ceae33e]]:
    ...
    def compute_resources(self, value: typing.Optional[typing.Union["ComputeResourcesProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    class ComputeResourcesProperty():
        ...
        @builtins.property
        def launch_template(self) -> typing.Optional[typing.Union["CfnComputeEnvironment.LaunchTemplateSpecificationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironment.LaunchTemplateSpecificationProperty", jsii_struct_bases=[], name_mapping={'launch_template_id': 'launchTemplateId', 'launch_template_name': 'launchTemplateName', 'version': 'version'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnComputeEnvironmentProps", jsii_struct_bases=[], name_mapping={'service_role': 'serviceRole', 'type': 'type', 'compute_environment_name': 'computeEnvironmentName', 'compute_resources': 'computeResources', 'state': 'state'})
class CfnComputeEnvironmentProps():
    def __init__(self, *, service_role: str, type: str, compute_environment_name: typing.Optional[str]=None, compute_resources: typing.Optional[typing.Union["CfnComputeEnvironment.ComputeResourcesProperty", _IResolvable_9ceae33e]]=None, state: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def compute_resources(self) -> typing.Optional[typing.Union["CfnComputeEnvironment.ComputeResourcesProperty", _IResolvable_9ceae33e]]:
        """``AWS::Batch::ComputeEnvironment.ComputeResources``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnJobDefinition(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, type: str, container_properties: typing.Optional[typing.Union["ContainerPropertiesProperty", _IResolvable_9ceae33e]]=None, job_definition_name: typing.Optional[str]=None, node_properties: typing.Optional[typing.Union["NodePropertiesProperty", _IResolvable_9ceae33e]]=None, parameters: typing.Any=None, retry_strategy: typing.Optional[typing.Union["RetryStrategyProperty", _IResolvable_9ceae33e]]=None, timeout: typing.Optional[typing.Union["TimeoutProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnJobDefinition":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def container_properties(self) -> typing.Optional[typing.Union["ContainerPropertiesProperty", _IResolvable_9ceae33e]]:
    ...
    def container_properties(self, value: typing.Optional[typing.Union["ContainerPropertiesProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def node_properties(self) -> typing.Optional[typing.Union["NodePropertiesProperty", _IResolvable_9ceae33e]]:
    ...
    def node_properties(self, value: typing.Optional[typing.Union["NodePropertiesProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "nodeProperties", value)

    @builtins.property
    @jsii.member(jsii_name="retryStrategy")
    def retry_strategy(self) -> typing.Optional[typing.Union["RetryStrategyProperty", _IResolvable_9ceae33e]]:
    ...
    def retry_strategy(self, value: typing.Optional[typing.Union["RetryStrategyProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "retryStrategy", value)

    @builtins.property
    @jsii.member(jsii_name="timeout")
    def timeout(self) -> typing.Optional[typing.Union["TimeoutProperty", _IResolvable_9ceae33e]]:
    ...
    @timeout.setter
    def timeout(self, value: typing.Optional[typing.Union["TimeoutProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "timeout", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.ContainerPropertiesProperty", jsii_struct_bases=[], name_mapping={'image': 'image', 'command': 'command', 'environment': 'environment', 'instance_type': 'instanceType', 'job_role_arn': 'jobRoleArn', 'linux_parameters': 'linuxParameters', 'memory': 'memory', 'mount_points': 'mountPoints', 'privileged': 'privileged', 'readonly_root_filesystem': 'readonlyRootFilesystem', 'resource_requirements': 'resourceRequirements', 'ulimits': 'ulimits', 'user': 'user', 'vcpus': 'vcpus', 'volumes': 'volumes'})
    class ContainerPropertiesProperty():
        def __init__(self, *, image: str, command: typing.Optional[typing.List[str]]=None, environment: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.EnvironmentProperty", _IResolvable_9ceae33e]]]]=None, instance_type: typing.Optional[str]=None, job_role_arn: typing.Optional[str]=None, linux_parameters: typing.Optional[typing.Union["CfnJobDefinition.LinuxParametersProperty", _IResolvable_9ceae33e]]=None, memory: typing.Optional[jsii.Number]=None, mount_points: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.MountPointsProperty", _IResolvable_9ceae33e]]]]=None, privileged: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, readonly_root_filesystem: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, resource_requirements: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.ResourceRequirementProperty", _IResolvable_9ceae33e]]]]=None, ulimits: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.UlimitProperty", _IResolvable_9ceae33e]]]]=None, user: typing.Optional[str]=None, vcpus: typing.Optional[jsii.Number]=None, volumes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.VolumesProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def environment(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.EnvironmentProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def linux_parameters(self) -> typing.Optional[typing.Union["CfnJobDefinition.LinuxParametersProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def mount_points(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.MountPointsProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def resource_requirements(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.ResourceRequirementProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def ulimits(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.UlimitProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def volumes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.VolumesProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.DeviceProperty", jsii_struct_bases=[], name_mapping={'container_path': 'containerPath', 'host_path': 'hostPath', 'permissions': 'permissions'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.EnvironmentProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.LinuxParametersProperty", jsii_struct_bases=[], name_mapping={'devices': 'devices'})
    class LinuxParametersProperty():
        def __init__(self, *, devices: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.DeviceProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def devices(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.DeviceProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.MountPointsProperty", jsii_struct_bases=[], name_mapping={'container_path': 'containerPath', 'read_only': 'readOnly', 'source_volume': 'sourceVolume'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.NodePropertiesProperty", jsii_struct_bases=[], name_mapping={'main_node': 'mainNode', 'node_range_properties': 'nodeRangeProperties', 'num_nodes': 'numNodes'})
    class NodePropertiesProperty():
        def __init__(self, *, main_node: jsii.Number, node_range_properties: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.NodeRangePropertyProperty", _IResolvable_9ceae33e]]], num_nodes: jsii.Number) -> None:
            """
        ...
        @builtins.property
        def node_range_properties(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobDefinition.NodeRangePropertyProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.NodeRangePropertyProperty", jsii_struct_bases=[], name_mapping={'target_nodes': 'targetNodes', 'container': 'container'})
    class NodeRangePropertyProperty():
        def __init__(self, *, target_nodes: str, container: typing.Optional[typing.Union["CfnJobDefinition.ContainerPropertiesProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def container(self) -> typing.Optional[typing.Union["CfnJobDefinition.ContainerPropertiesProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.ResourceRequirementProperty", jsii_struct_bases=[], name_mapping={'type': 'type', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.RetryStrategyProperty", jsii_struct_bases=[], name_mapping={'attempts': 'attempts'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.TimeoutProperty", jsii_struct_bases=[], name_mapping={'attempt_duration_seconds': 'attemptDurationSeconds'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.UlimitProperty", jsii_struct_bases=[], name_mapping={'hard_limit': 'hardLimit', 'name': 'name', 'soft_limit': 'softLimit'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.VolumesHostProperty", jsii_struct_bases=[], name_mapping={'source_path': 'sourcePath'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinition.VolumesProperty", jsii_struct_bases=[], name_mapping={'host': 'host', 'name': 'name'})
    class VolumesProperty():
        def __init__(self, *, host: typing.Optional[typing.Union["CfnJobDefinition.VolumesHostProperty", _IResolvable_9ceae33e]]=None, name: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def host(self) -> typing.Optional[typing.Union["CfnJobDefinition.VolumesHostProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobDefinitionProps", jsii_struct_bases=[], name_mapping={'type': 'type', 'container_properties': 'containerProperties', 'job_definition_name': 'jobDefinitionName', 'node_properties': 'nodeProperties', 'parameters': 'parameters', 'retry_strategy': 'retryStrategy', 'timeout': 'timeout'})
class CfnJobDefinitionProps():
    def __init__(self, *, type: str, container_properties: typing.Optional[typing.Union["CfnJobDefinition.ContainerPropertiesProperty", _IResolvable_9ceae33e]]=None, job_definition_name: typing.Optional[str]=None, node_properties: typing.Optional[typing.Union["CfnJobDefinition.NodePropertiesProperty", _IResolvable_9ceae33e]]=None, parameters: typing.Any=None, retry_strategy: typing.Optional[typing.Union["CfnJobDefinition.RetryStrategyProperty", _IResolvable_9ceae33e]]=None, timeout: typing.Optional[typing.Union["CfnJobDefinition.TimeoutProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def container_properties(self) -> typing.Optional[typing.Union["CfnJobDefinition.ContainerPropertiesProperty", _IResolvable_9ceae33e]]:
        """``AWS::Batch::JobDefinition.ContainerProperties``.
    ...
    @builtins.property
    def node_properties(self) -> typing.Optional[typing.Union["CfnJobDefinition.NodePropertiesProperty", _IResolvable_9ceae33e]]:
        """``AWS::Batch::JobDefinition.NodeProperties``.
    ...
    @builtins.property
    def retry_strategy(self) -> typing.Optional[typing.Union["CfnJobDefinition.RetryStrategyProperty", _IResolvable_9ceae33e]]:
        """``AWS::Batch::JobDefinition.RetryStrategy``.
    ...
    @builtins.property
    def timeout(self) -> typing.Optional[typing.Union["CfnJobDefinition.TimeoutProperty", _IResolvable_9ceae33e]]:
        """``AWS::Batch::JobDefinition.Timeout``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnJobQueue(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_batch.CfnJobQueue"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, compute_environment_order: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e]]], priority: jsii.Number, job_queue_name: typing.Optional[str]=None, state: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnJobQueue":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def compute_environment_order(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e]]]:
    ...
    def compute_environment_order(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobQueue.ComputeEnvironmentOrderProperty", jsii_struct_bases=[], name_mapping={'compute_environment': 'computeEnvironment', 'order': 'order'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.CfnJobQueueProps", jsii_struct_bases=[], name_mapping={'compute_environment_order': 'computeEnvironmentOrder', 'priority': 'priority', 'job_queue_name': 'jobQueueName', 'state': 'state'})
class CfnJobQueueProps():
    def __init__(self, *, compute_environment_order: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobQueue.ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e]]], priority: jsii.Number, job_queue_name: typing.Optional[str]=None, state: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def compute_environment_order(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnJobQueue.ComputeEnvironmentOrderProperty", _IResolvable_9ceae33e]]]:
        """``AWS::Batch::JobQueue.ComputeEnvironmentOrder``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.ComputeEnvironmentProps", jsii_struct_bases=[], name_mapping={'compute_environment_name': 'computeEnvironmentName', 'compute_resources': 'computeResources', 'enabled': 'enabled', 'managed': 'managed', 'service_role': 'serviceRole'})
class ComputeEnvironmentProps():
    def __init__(self, *, compute_environment_name: typing.Optional[str]=None, compute_resources: typing.Optional["ComputeResources"]=None, enabled: typing.Optional[bool]=None, managed: typing.Optional[bool]=None, service_role: typing.Optional[_IRole_e69bbae4]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.ComputeResources", jsii_struct_bases=[], name_mapping={'vpc': 'vpc', 'allocation_strategy': 'allocationStrategy', 'bid_percentage': 'bidPercentage', 'compute_resources_tags': 'computeResourcesTags', 'desiredv_cpus': 'desiredvCpus', 'ec2_key_pair': 'ec2KeyPair', 'image': 'image', 'instance_role': 'instanceRole', 'instance_types': 'instanceTypes', 'launch_template': 'launchTemplate', 'maxv_cpus': 'maxvCpus', 'minv_cpus': 'minvCpus', 'security_groups': 'securityGroups', 'spot_fleet_role': 'spotFleetRole', 'type': 'type', 'vpc_subnets': 'vpcSubnets'})
class ComputeResources():
    def __init__(self, *, vpc: _IVpc_3795853f, allocation_strategy: typing.Optional["AllocationStrategy"]=None, bid_percentage: typing.Optional[jsii.Number]=None, compute_resources_tags: typing.Optional[_Tag_ef7f3fe6]=None, desiredv_cpus: typing.Optional[jsii.Number]=None, ec2_key_pair: typing.Optional[str]=None, image: typing.Optional[_IMachineImage_d5cd7b45]=None, instance_role: typing.Optional[str]=None, instance_types: typing.Optional[typing.List[_InstanceType_85a97b30]]=None, launch_template: typing.Optional["LaunchTemplateSpecification"]=None, maxv_cpus: typing.Optional[jsii.Number]=None, minv_cpus: typing.Optional[jsii.Number]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, spot_fleet_role: typing.Optional[_IRole_e69bbae4]=None, type: typing.Optional["ComputeResourceType"]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
...
class JobDefinition(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_batch.JobDefinition"):
    ...
    @builtins.classmethod
    def from_job_definition_arn(cls, scope: _Construct_f50a3f53, id: str, job_definition_arn: str) -> "IJobDefinition":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.JobDefinitionContainer", jsii_struct_bases=[], name_mapping={'image': 'image', 'command': 'command', 'environment': 'environment', 'gpu_count': 'gpuCount', 'instance_type': 'instanceType', 'job_role': 'jobRole', 'linux_params': 'linuxParams', 'memory_limit_mib': 'memoryLimitMiB', 'mount_points': 'mountPoints', 'privileged': 'privileged', 'read_only': 'readOnly', 'ulimits': 'ulimits', 'user': 'user', 'vcpus': 'vcpus', 'volumes': 'volumes'})
class JobDefinitionContainer():
    def __init__(self, *, image: _ContainerImage_99cc4b15, command: typing.Optional[typing.List[str]]=None, environment: typing.Optional[typing.Mapping[str, str]]=None, gpu_count: typing.Optional[jsii.Number]=None, instance_type: typing.Optional[_InstanceType_85a97b30]=None, job_role: typing.Optional[_IRole_e69bbae4]=None, linux_params: typing.Optional[_LinuxParameters_4f2b9dff]=None, memory_limit_mib: typing.Optional[jsii.Number]=None, mount_points: typing.Optional[typing.List[_MountPoint_4cb35154]]=None, privileged: typing.Optional[bool]=None, read_only: typing.Optional[bool]=None, ulimits: typing.Optional[typing.List[_Ulimit_05b23ec0]]=None, user: typing.Optional[str]=None, vcpus: typing.Optional[jsii.Number]=None, volumes: typing.Optional[typing.List[_Volume_0361ca6f]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.JobDefinitionProps", jsii_struct_bases=[], name_mapping={'container': 'container', 'job_definition_name': 'jobDefinitionName', 'node_props': 'nodeProps', 'parameters': 'parameters', 'retry_attempts': 'retryAttempts', 'timeout': 'timeout'})
class JobDefinitionProps():
    def __init__(self, *, container: "JobDefinitionContainer", job_definition_name: typing.Optional[str]=None, node_props: typing.Optional["IMultiNodeProps"]=None, parameters: typing.Optional[typing.Mapping[str, str]]=None, retry_attempts: typing.Optional[jsii.Number]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
...
class JobQueue(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_batch.JobQueue"):
    """Batch Job Queue.
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, compute_environments: typing.List["JobQueueComputeEnvironment"], enabled: typing.Optional[bool]=None, job_queue_name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_job_queue_arn(cls, scope: _Construct_f50a3f53, id: str, job_queue_arn: str) -> "IJobQueue":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.JobQueueComputeEnvironment", jsii_struct_bases=[], name_mapping={'compute_environment': 'computeEnvironment', 'order': 'order'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.JobQueueProps", jsii_struct_bases=[], name_mapping={'compute_environments': 'computeEnvironments', 'enabled': 'enabled', 'job_queue_name': 'jobQueueName', 'priority': 'priority'})
class JobQueueProps():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_batch.LaunchTemplateSpecification", jsii_struct_bases=[], name_mapping={'launch_template_name': 'launchTemplateName', 'version': 'version'})
...
class ComputeEnvironment(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_batch.ComputeEnvironment"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, compute_environment_name: typing.Optional[str]=None, compute_resources: typing.Optional["ComputeResources"]=None, enabled: typing.Optional[bool]=None, managed: typing.Optional[bool]=None, service_role: typing.Optional[_IRole_e69bbae4]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param compute_environment_name: A name for the compute environment. Up to 128 letters (uppercase and lowercase), numbers, hyphens, and underscores are allowed. Default: - CloudFormation-generated name
    ...
    @builtins.classmethod
    def from_compute_environment_arn(cls, scope: _Construct_f50a3f53, id: str, compute_environment_arn: str) -> "IComputeEnvironment":
