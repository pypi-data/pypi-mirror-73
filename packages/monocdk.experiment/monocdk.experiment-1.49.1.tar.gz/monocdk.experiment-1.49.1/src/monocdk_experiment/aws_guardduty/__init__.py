...
class CfnDetector(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_guardduty.CfnDetector"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, enable: typing.Union[bool, _IResolvable_9ceae33e], finding_publishing_frequency: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDetector":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnDetectorProps", jsii_struct_bases=[], name_mapping={'enable': 'enable', 'finding_publishing_frequency': 'findingPublishingFrequency'})
class CfnDetectorProps():
    def __init__(self, *, enable: typing.Union[bool, _IResolvable_9ceae33e], finding_publishing_frequency: typing.Optional[str]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnFilter(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_guardduty.CfnFilter"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, action: str, description: str, detector_id: str, finding_criteria: typing.Union["FindingCriteriaProperty", _IResolvable_9ceae33e], name: str, rank: jsii.Number) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnFilter":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def finding_criteria(self) -> typing.Union["FindingCriteriaProperty", _IResolvable_9ceae33e]:
    ...
    def finding_criteria(self, value: typing.Union["FindingCriteriaProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnFilter.ConditionProperty", jsii_struct_bases=[], name_mapping={'eq': 'eq', 'gte': 'gte', 'lt': 'lt', 'lte': 'lte', 'neq': 'neq'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnFilter.FindingCriteriaProperty", jsii_struct_bases=[], name_mapping={'criterion': 'criterion', 'item_type': 'itemType'})
    class FindingCriteriaProperty():
        def __init__(self, *, criterion: typing.Any=None, item_type: typing.Optional[typing.Union["CfnFilter.ConditionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def item_type(self) -> typing.Optional[typing.Union["CfnFilter.ConditionProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnFilterProps", jsii_struct_bases=[], name_mapping={'action': 'action', 'description': 'description', 'detector_id': 'detectorId', 'finding_criteria': 'findingCriteria', 'name': 'name', 'rank': 'rank'})
class CfnFilterProps():
    def __init__(self, *, action: str, description: str, detector_id: str, finding_criteria: typing.Union["CfnFilter.FindingCriteriaProperty", _IResolvable_9ceae33e], name: str, rank: jsii.Number) -> None:
    ...
    @builtins.property
    def finding_criteria(self) -> typing.Union["CfnFilter.FindingCriteriaProperty", _IResolvable_9ceae33e]:
        """``AWS::GuardDuty::Filter.FindingCriteria``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnIPSet(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_guardduty.CfnIPSet"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, activate: typing.Union[bool, _IResolvable_9ceae33e], detector_id: str, format: str, location: str, name: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnIPSetProps", jsii_struct_bases=[], name_mapping={'activate': 'activate', 'detector_id': 'detectorId', 'format': 'format', 'location': 'location', 'name': 'name'})
class CfnIPSetProps():
    def __init__(self, *, activate: typing.Union[bool, _IResolvable_9ceae33e], detector_id: str, format: str, location: str, name: typing.Optional[str]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMaster(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_guardduty.CfnMaster"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, detector_id: str, master_id: str, invitation_id: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMaster":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnMasterProps", jsii_struct_bases=[], name_mapping={'detector_id': 'detectorId', 'master_id': 'masterId', 'invitation_id': 'invitationId'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMember(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_guardduty.CfnMember"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, detector_id: str, email: str, member_id: str, disable_email_notification: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, message: typing.Optional[str]=None, status: typing.Optional[str]=None) -> None:
    ...
    def disable_email_notification(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def disable_email_notification(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnMemberProps", jsii_struct_bases=[], name_mapping={'detector_id': 'detectorId', 'email': 'email', 'member_id': 'memberId', 'disable_email_notification': 'disableEmailNotification', 'message': 'message', 'status': 'status'})
class CfnMemberProps():
    def __init__(self, *, detector_id: str, email: str, member_id: str, disable_email_notification: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, message: typing.Optional[str]=None, status: typing.Optional[str]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnThreatIntelSet(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_guardduty.CfnThreatIntelSet"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnThreatIntelSet":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_guardduty.CfnThreatIntelSetProps", jsii_struct_bases=[], name_mapping={'activate': 'activate', 'detector_id': 'detectorId', 'format': 'format', 'location': 'location', 'name': 'name'})
