...
@jsii.data_type(jsii_type="monocdk-experiment.assets.CopyOptions", jsii_struct_bases=[], name_mapping={'exclude': 'exclude', 'follow': 'follow'})
class CopyOptions():
...
@jsii.data_type(jsii_type="monocdk-experiment.assets.FingerprintOptions", jsii_struct_bases=[CopyOptions], name_mapping={'exclude': 'exclude', 'follow': 'follow', 'extra_hash': 'extraHash'})
...
class Staging(_AssetStaging_5a226461, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.assets.Staging"):
    """Deprecated.
    ...
    :stability: deprecated
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, source_path: str, extra_hash: typing.Optional[str]=None, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional["FollowMode"]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.assets.StagingProps", jsii_struct_bases=[FingerprintOptions], name_mapping={'exclude': 'exclude', 'follow': 'follow', 'extra_hash': 'extraHash', 'source_path': 'sourcePath'})
