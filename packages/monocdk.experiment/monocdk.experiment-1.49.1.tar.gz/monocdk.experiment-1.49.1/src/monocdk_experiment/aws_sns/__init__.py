...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.BetweenCondition", jsii_struct_bases=[], name_mapping={'start': 'start', 'stop': 'stop'})
...
class CfnSubscription(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.CfnSubscription"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, protocol: str, topic_arn: str, delivery_policy: typing.Any=None, endpoint: typing.Optional[str]=None, filter_policy: typing.Any=None, raw_message_delivery: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, redrive_policy: typing.Any=None, region: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnSubscription":
    ...
    def raw_message_delivery(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def raw_message_delivery(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.CfnSubscriptionProps", jsii_struct_bases=[], name_mapping={'protocol': 'protocol', 'topic_arn': 'topicArn', 'delivery_policy': 'deliveryPolicy', 'endpoint': 'endpoint', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'redrive_policy': 'redrivePolicy', 'region': 'region'})
class CfnSubscriptionProps():
    def __init__(self, *, protocol: str, topic_arn: str, delivery_policy: typing.Any=None, endpoint: typing.Optional[str]=None, filter_policy: typing.Any=None, raw_message_delivery: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, redrive_policy: typing.Any=None, region: typing.Optional[str]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnTopic(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.CfnTopic"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, content_based_deduplication: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, display_name: typing.Optional[str]=None, fifo_topic: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, kms_master_key_id: typing.Optional[str]=None, subscription: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["SubscriptionProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, topic_name: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnTopicProps(content_based_deduplication=content_based_deduplication, display_name=display_name, fifo_topic=fifo_topic, kms_master_key_id=kms_master_key_id, subscription=subscription, tags=tags, topic_name=topic_name)

        jsii.create(CfnTopic, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnTopic":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def content_based_deduplication(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def content_based_deduplication(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @fifo_topic.setter
    def fifo_topic(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def subscription(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["SubscriptionProperty", _IResolvable_9ceae33e]]]]:
    ...
    @subscription.setter
    def subscription(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["SubscriptionProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_sns.CfnTopic.SubscriptionProperty", jsii_struct_bases=[], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnTopicPolicy(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.CfnTopicPolicy"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, policy_document: typing.Any, topics: typing.List[str]) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnTopicPolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.CfnTopicPolicyProps", jsii_struct_bases=[], name_mapping={'policy_document': 'policyDocument', 'topics': 'topics'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.CfnTopicProps", jsii_struct_bases=[], name_mapping={'content_based_deduplication': 'contentBasedDeduplication', 'display_name': 'displayName', 'fifo_topic': 'fifoTopic', 'kms_master_key_id': 'kmsMasterKeyId', 'subscription': 'subscription', 'tags': 'tags', 'topic_name': 'topicName'})
class CfnTopicProps():
    def __init__(self, *, content_based_deduplication: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, display_name: typing.Optional[str]=None, fifo_topic: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, kms_master_key_id: typing.Optional[str]=None, subscription: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopic.SubscriptionProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, topic_name: typing.Optional[str]=None) -> None:
        ...
        if fifo_topic is not None: self._values["fifo_topic"] = fifo_topic
    ...
    @builtins.property
    def subscription(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopic.SubscriptionProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::SNS::Topic.Subscription``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.NumericConditions", jsii_struct_bases=[], name_mapping={'between': 'between', 'between_strict': 'betweenStrict', 'greater_than': 'greaterThan', 'greater_than_or_equal_to': 'greaterThanOrEqualTo', 'less_than': 'lessThan', 'less_than_or_equal_to': 'lessThanOrEqualTo', 'whitelist': 'whitelist'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.StringConditions", jsii_struct_bases=[], name_mapping={'blacklist': 'blacklist', 'match_prefixes': 'matchPrefixes', 'whitelist': 'whitelist'})
...
class Subscription(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.Subscription"):
    """A new subscription.
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, topic: "ITopic", endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[_IQueue_b743f559]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = SubscriptionProps(topic=topic, endpoint=endpoint, protocol=protocol, dead_letter_queue=dead_letter_queue, filter_policy=filter_policy, raw_message_delivery=raw_message_delivery, region=region)
...
class SubscriptionFilter(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.SubscriptionFilter"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.SubscriptionOptions", jsii_struct_bases=[], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol', 'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'region': 'region'})
class SubscriptionOptions():
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[_IQueue_b743f559]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.SubscriptionProps", jsii_struct_bases=[SubscriptionOptions], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol', 'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'region': 'region', 'topic': 'topic'})
class SubscriptionProps(SubscriptionOptions):
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[_IQueue_b743f559]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None, topic: "ITopic") -> None:
...
class TopicBase(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_sns.TopicBase"):
...
class TopicPolicy(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.TopicPolicy"):
    """Applies a policy to SNS topics.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, topics: typing.List["ITopic"]) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.TopicPolicyProps", jsii_struct_bases=[], name_mapping={'topics': 'topics'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.TopicProps", jsii_struct_bases=[], name_mapping={'display_name': 'displayName', 'master_key': 'masterKey', 'topic_name': 'topicName'})
class TopicProps():
    def __init__(self, *, display_name: typing.Optional[str]=None, master_key: typing.Optional[_IKey_3336c79d]=None, topic_name: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.TopicSubscriptionConfig", jsii_struct_bases=[SubscriptionOptions], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol', 'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'region': 'region', 'subscriber_id': 'subscriberId', 'subscriber_scope': 'subscriberScope'})
class TopicSubscriptionConfig(SubscriptionOptions):
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[_IQueue_b743f559]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None, subscriber_id: str, subscriber_scope: typing.Optional[_Construct_f50a3f53]=None) -> None:
...
class Topic(TopicBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_sns.Topic"):
    """A new SNS topic.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, display_name: typing.Optional[str]=None, master_key: typing.Optional[_IKey_3336c79d]=None, topic_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param display_name: A developer-defined string that can be used to identify this SNS topic. Default: None
    ...
    @builtins.classmethod
    def from_topic_arn(cls, scope: _Construct_f50a3f53, id: str, topic_arn: str) -> "ITopic":
