...
from .. import (Resource as _Resource_884d0774, Construct as _Construct_f50a3f53, IDependable as _IDependable_4fc803f7, RemovalPolicy as _RemovalPolicy_5986e9f3, CfnResource as _CfnResource_7760e8e4, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, TagManager as _TagManager_2508893f, CfnTag as _CfnTag_b4661f1a, IResource as _IResource_72f7ee7e, Duration as _Duration_5170c158)
from ..aws_events import (Rule as _Rule_c38e0b39, OnEventOptions as _OnEventOptions_926fbcf9, EventPattern as _EventPattern_8aa7b781, IRuleTarget as _IRuleTarget_41800a77)
...
class BlockPublicAccess(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.BlockPublicAccess"):
    """
    stability
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.BlockPublicAccessOptions", jsii_struct_bases=[], name_mapping={'block_public_acls': 'blockPublicAcls', 'block_public_policy': 'blockPublicPolicy', 'ignore_public_acls': 'ignorePublicAcls', 'restrict_public_buckets': 'restrictPublicBuckets'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.BucketAttributes", jsii_struct_bases=[], name_mapping={'bucket_arn': 'bucketArn', 'bucket_domain_name': 'bucketDomainName', 'bucket_dual_stack_domain_name': 'bucketDualStackDomainName', 'bucket_name': 'bucketName', 'bucket_regional_domain_name': 'bucketRegionalDomainName', 'bucket_website_new_url_format': 'bucketWebsiteNewUrlFormat', 'bucket_website_url': 'bucketWebsiteUrl', 'encryption_key': 'encryptionKey'})
class BucketAttributes():
    def __init__(self, *, bucket_arn: typing.Optional[str]=None, bucket_domain_name: typing.Optional[str]=None, bucket_dual_stack_domain_name: typing.Optional[str]=None, bucket_name: typing.Optional[str]=None, bucket_regional_domain_name: typing.Optional[str]=None, bucket_website_new_url_format: typing.Optional[bool]=None, bucket_website_url: typing.Optional[str]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.BucketMetrics", jsii_struct_bases=[], name_mapping={'id': 'id', 'prefix': 'prefix', 'tag_filters': 'tagFilters'})
class BucketMetrics():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.BucketNotificationDestinationConfig", jsii_struct_bases=[], name_mapping={'arn': 'arn', 'type': 'type', 'dependencies': 'dependencies'})
class BucketNotificationDestinationConfig():
    def __init__(self, *, arn: str, type: "BucketNotificationDestinationType", dependencies: typing.Optional[typing.List[_IDependable_4fc803f7]]=None) -> None:
...
class BucketPolicy(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.BucketPolicy"):
    """Applies an Amazon S3 bucket policy to an Amazon S3 bucket.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, bucket: "IBucket", removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.BucketPolicyProps", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'removal_policy': 'removalPolicy'})
class BucketPolicyProps():
    def __init__(self, *, bucket: "IBucket", removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None) -> None:
        """
        :param bucket: The Amazon S3 bucket that the policy applies to.
        :param removal_policy: Policy to apply when the policy is removed from this stack. Default: - RemovalPolicy.DESTROY.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.BucketProps", jsii_struct_bases=[], name_mapping={'access_control': 'accessControl', 'block_public_access': 'blockPublicAccess', 'bucket_name': 'bucketName', 'cors': 'cors', 'encryption': 'encryption', 'encryption_key': 'encryptionKey', 'lifecycle_rules': 'lifecycleRules', 'metrics': 'metrics', 'public_read_access': 'publicReadAccess', 'removal_policy': 'removalPolicy', 'server_access_logs_bucket': 'serverAccessLogsBucket', 'server_access_logs_prefix': 'serverAccessLogsPrefix', 'versioned': 'versioned', 'website_error_document': 'websiteErrorDocument', 'website_index_document': 'websiteIndexDocument', 'website_redirect': 'websiteRedirect', 'website_routing_rules': 'websiteRoutingRules'})
class BucketProps():
    def __init__(self, *, access_control: typing.Optional["BucketAccessControl"]=None, block_public_access: typing.Optional["BlockPublicAccess"]=None, bucket_name: typing.Optional[str]=None, cors: typing.Optional[typing.List["CorsRule"]]=None, encryption: typing.Optional["BucketEncryption"]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None, lifecycle_rules: typing.Optional[typing.List["LifecycleRule"]]=None, metrics: typing.Optional[typing.List["BucketMetrics"]]=None, public_read_access: typing.Optional[bool]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, server_access_logs_bucket: typing.Optional["IBucket"]=None, server_access_logs_prefix: typing.Optional[str]=None, versioned: typing.Optional[bool]=None, website_error_document: typing.Optional[str]=None, website_index_document: typing.Optional[str]=None, website_redirect: typing.Optional["RedirectTarget"]=None, website_routing_rules: typing.Optional[typing.List["RoutingRule"]]=None) -> None:
        """
...
class CfnAccessPoint(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.CfnAccessPoint"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, bucket: str, creation_date: typing.Optional[str]=None, name: typing.Optional[str]=None, network_origin: typing.Optional[str]=None, policy: typing.Any=None, policy_status: typing.Any=None, public_access_block_configuration: typing.Optional[typing.Union["PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]=None, vpc_configuration: typing.Optional[typing.Union["VpcConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    def public_access_block_configuration(self) -> typing.Optional[typing.Union["PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def public_access_block_configuration(self, value: typing.Optional[typing.Union["PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "publicAccessBlockConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="vpcConfiguration")
    def vpc_configuration(self) -> typing.Optional[typing.Union["VpcConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def vpc_configuration(self, value: typing.Optional[typing.Union["VpcConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "vpcConfiguration", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnAccessPoint.PublicAccessBlockConfigurationProperty", jsii_struct_bases=[], name_mapping={'block_public_acls': 'blockPublicAcls', 'block_public_policy': 'blockPublicPolicy', 'ignore_public_acls': 'ignorePublicAcls', 'restrict_public_buckets': 'restrictPublicBuckets'})
    class PublicAccessBlockConfigurationProperty():
        def __init__(self, *, block_public_acls: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, block_public_policy: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, ignore_public_acls: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, restrict_public_buckets: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def block_public_acls(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def block_public_policy(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def ignore_public_acls(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def restrict_public_buckets(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnAccessPoint.VpcConfigurationProperty", jsii_struct_bases=[], name_mapping={'vpc_id': 'vpcId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnAccessPointProps", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'creation_date': 'creationDate', 'name': 'name', 'network_origin': 'networkOrigin', 'policy': 'policy', 'policy_status': 'policyStatus', 'public_access_block_configuration': 'publicAccessBlockConfiguration', 'vpc_configuration': 'vpcConfiguration'})
class CfnAccessPointProps():
    def __init__(self, *, bucket: str, creation_date: typing.Optional[str]=None, name: typing.Optional[str]=None, network_origin: typing.Optional[str]=None, policy: typing.Any=None, policy_status: typing.Any=None, public_access_block_configuration: typing.Optional[typing.Union["CfnAccessPoint.PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]=None, vpc_configuration: typing.Optional[typing.Union["CfnAccessPoint.VpcConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def public_access_block_configuration(self) -> typing.Optional[typing.Union["CfnAccessPoint.PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::AccessPoint.PublicAccessBlockConfiguration``.
    ...
    @builtins.property
    def vpc_configuration(self) -> typing.Optional[typing.Union["CfnAccessPoint.VpcConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::AccessPoint.VpcConfiguration``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnBucket(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.CfnBucket"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, accelerate_configuration: typing.Optional[typing.Union["AccelerateConfigurationProperty", _IResolvable_9ceae33e]]=None, access_control: typing.Optional[str]=None, analytics_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["AnalyticsConfigurationProperty", _IResolvable_9ceae33e]]]]=None, bucket_encryption: typing.Optional[typing.Union["BucketEncryptionProperty", _IResolvable_9ceae33e]]=None, bucket_name: typing.Optional[str]=None, cors_configuration: typing.Optional[typing.Union["CorsConfigurationProperty", _IResolvable_9ceae33e]]=None, inventory_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["InventoryConfigurationProperty", _IResolvable_9ceae33e]]]]=None, lifecycle_configuration: typing.Optional[typing.Union["LifecycleConfigurationProperty", _IResolvable_9ceae33e]]=None, logging_configuration: typing.Optional[typing.Union["LoggingConfigurationProperty", _IResolvable_9ceae33e]]=None, metrics_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricsConfigurationProperty", _IResolvable_9ceae33e]]]]=None, notification_configuration: typing.Optional[typing.Union["NotificationConfigurationProperty", _IResolvable_9ceae33e]]=None, object_lock_configuration: typing.Optional[typing.Union["ObjectLockConfigurationProperty", _IResolvable_9ceae33e]]=None, object_lock_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, public_access_block_configuration: typing.Optional[typing.Union["PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]=None, replication_configuration: typing.Optional[typing.Union["ReplicationConfigurationProperty", _IResolvable_9ceae33e]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, versioning_configuration: typing.Optional[typing.Union["VersioningConfigurationProperty", _IResolvable_9ceae33e]]=None, website_configuration: typing.Optional[typing.Union["WebsiteConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnBucket":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def accelerate_configuration(self) -> typing.Optional[typing.Union["AccelerateConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def accelerate_configuration(self, value: typing.Optional[typing.Union["AccelerateConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def analytics_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["AnalyticsConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def analytics_configurations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["AnalyticsConfigurationProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "analyticsConfigurations", value)

    @builtins.property
    @jsii.member(jsii_name="bucketEncryption")
    def bucket_encryption(self) -> typing.Optional[typing.Union["BucketEncryptionProperty", _IResolvable_9ceae33e]]:
    ...
    def bucket_encryption(self, value: typing.Optional[typing.Union["BucketEncryptionProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def cors_configuration(self) -> typing.Optional[typing.Union["CorsConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def cors_configuration(self, value: typing.Optional[typing.Union["CorsConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "corsConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="inventoryConfigurations")
    def inventory_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["InventoryConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def inventory_configurations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["InventoryConfigurationProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "inventoryConfigurations", value)

    @builtins.property
    @jsii.member(jsii_name="lifecycleConfiguration")
    def lifecycle_configuration(self) -> typing.Optional[typing.Union["LifecycleConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def lifecycle_configuration(self, value: typing.Optional[typing.Union["LifecycleConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def metrics_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricsConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def metrics_configurations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricsConfigurationProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "metricsConfigurations", value)

    @builtins.property
    @jsii.member(jsii_name="notificationConfiguration")
    def notification_configuration(self) -> typing.Optional[typing.Union["NotificationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def notification_configuration(self, value: typing.Optional[typing.Union["NotificationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "notificationConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="objectLockConfiguration")
    def object_lock_configuration(self) -> typing.Optional[typing.Union["ObjectLockConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def object_lock_configuration(self, value: typing.Optional[typing.Union["ObjectLockConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "objectLockConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="objectLockEnabled")
    def object_lock_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def object_lock_enabled(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def replication_configuration(self) -> typing.Optional[typing.Union["ReplicationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def replication_configuration(self, value: typing.Optional[typing.Union["ReplicationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "replicationConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="versioningConfiguration")
    def versioning_configuration(self) -> typing.Optional[typing.Union["VersioningConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def versioning_configuration(self, value: typing.Optional[typing.Union["VersioningConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "versioningConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="websiteConfiguration")
    def website_configuration(self) -> typing.Optional[typing.Union["WebsiteConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def website_configuration(self, value: typing.Optional[typing.Union["WebsiteConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "websiteConfiguration", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.AbortIncompleteMultipartUploadProperty", jsii_struct_bases=[], name_mapping={'days_after_initiation': 'daysAfterInitiation'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.AccelerateConfigurationProperty", jsii_struct_bases=[], name_mapping={'acceleration_status': 'accelerationStatus'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.AccessControlTranslationProperty", jsii_struct_bases=[], name_mapping={'owner': 'owner'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.AnalyticsConfigurationProperty", jsii_struct_bases=[], name_mapping={'id': 'id', 'storage_class_analysis': 'storageClassAnalysis', 'prefix': 'prefix', 'tag_filters': 'tagFilters'})
    class AnalyticsConfigurationProperty():
        def __init__(self, *, id: str, storage_class_analysis: typing.Union["CfnBucket.StorageClassAnalysisProperty", _IResolvable_9ceae33e], prefix: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def storage_class_analysis(self) -> typing.Union["CfnBucket.StorageClassAnalysisProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def tag_filters(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.BucketEncryptionProperty", jsii_struct_bases=[], name_mapping={'server_side_encryption_configuration': 'serverSideEncryptionConfiguration'})
    class BucketEncryptionProperty():
        def __init__(self, *, server_side_encryption_configuration: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.ServerSideEncryptionRuleProperty", _IResolvable_9ceae33e]]]) -> None:
            """
        ...
        @builtins.property
        def server_side_encryption_configuration(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.ServerSideEncryptionRuleProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.CorsConfigurationProperty", jsii_struct_bases=[], name_mapping={'cors_rules': 'corsRules'})
    class CorsConfigurationProperty():
        def __init__(self, *, cors_rules: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.CorsRuleProperty", _IResolvable_9ceae33e]]]) -> None:
            """
        ...
        @builtins.property
        def cors_rules(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.CorsRuleProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.CorsRuleProperty", jsii_struct_bases=[], name_mapping={'allowed_methods': 'allowedMethods', 'allowed_origins': 'allowedOrigins', 'allowed_headers': 'allowedHeaders', 'exposed_headers': 'exposedHeaders', 'id': 'id', 'max_age': 'maxAge'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.DataExportProperty", jsii_struct_bases=[], name_mapping={'destination': 'destination', 'output_schema_version': 'outputSchemaVersion'})
    class DataExportProperty():
        def __init__(self, *, destination: typing.Union["CfnBucket.DestinationProperty", _IResolvable_9ceae33e], output_schema_version: str) -> None:
            """
        ...
        @builtins.property
        def destination(self) -> typing.Union["CfnBucket.DestinationProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.DefaultRetentionProperty", jsii_struct_bases=[], name_mapping={'days': 'days', 'mode': 'mode', 'years': 'years'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.DeleteMarkerReplicationProperty", jsii_struct_bases=[], name_mapping={'status': 'status'})
    class DeleteMarkerReplicationProperty():
        ...
        def __repr__(self) -> str:
            return 'DeleteMarkerReplicationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.DestinationProperty", jsii_struct_bases=[], name_mapping={'bucket_arn': 'bucketArn', 'format': 'format', 'bucket_account_id': 'bucketAccountId', 'prefix': 'prefix'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.EncryptionConfigurationProperty", jsii_struct_bases=[], name_mapping={'replica_kms_key_id': 'replicaKmsKeyId'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.FilterRuleProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.InventoryConfigurationProperty", jsii_struct_bases=[], name_mapping={'destination': 'destination', 'enabled': 'enabled', 'id': 'id', 'included_object_versions': 'includedObjectVersions', 'schedule_frequency': 'scheduleFrequency', 'optional_fields': 'optionalFields', 'prefix': 'prefix'})
    class InventoryConfigurationProperty():
        def __init__(self, *, destination: typing.Union["CfnBucket.DestinationProperty", _IResolvable_9ceae33e], enabled: typing.Union[bool, _IResolvable_9ceae33e], id: str, included_object_versions: str, schedule_frequency: str, optional_fields: typing.Optional[typing.List[str]]=None, prefix: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.LambdaConfigurationProperty", jsii_struct_bases=[], name_mapping={'event': 'event', 'function': 'function', 'filter': 'filter'})
    class LambdaConfigurationProperty():
        def __init__(self, *, event: str, function: str, filter: typing.Optional[typing.Union["CfnBucket.NotificationFilterProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def filter(self) -> typing.Optional[typing.Union["CfnBucket.NotificationFilterProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.LifecycleConfigurationProperty", jsii_struct_bases=[], name_mapping={'rules': 'rules'})
    class LifecycleConfigurationProperty():
        def __init__(self, *, rules: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.RuleProperty", _IResolvable_9ceae33e]]]) -> None:
            """
        ...
        @builtins.property
        def rules(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.RuleProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.LoggingConfigurationProperty", jsii_struct_bases=[], name_mapping={'destination_bucket_name': 'destinationBucketName', 'log_file_prefix': 'logFilePrefix'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.MetricsConfigurationProperty", jsii_struct_bases=[], name_mapping={'id': 'id', 'prefix': 'prefix', 'tag_filters': 'tagFilters'})
    class MetricsConfigurationProperty():
        def __init__(self, *, id: str, prefix: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.MetricsProperty", jsii_struct_bases=[], name_mapping={'event_threshold': 'eventThreshold', 'status': 'status'})
    class MetricsProperty():
        def __init__(self, *, event_threshold: typing.Union["CfnBucket.ReplicationTimeValueProperty", _IResolvable_9ceae33e], status: str) -> None:
            """
        ...
        @builtins.property
        def event_threshold(self) -> typing.Union["CfnBucket.ReplicationTimeValueProperty", _IResolvable_9ceae33e]:
        ...
        def __repr__(self) -> str:
            return 'MetricsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.NoncurrentVersionTransitionProperty", jsii_struct_bases=[], name_mapping={'storage_class': 'storageClass', 'transition_in_days': 'transitionInDays'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.NotificationConfigurationProperty", jsii_struct_bases=[], name_mapping={'lambda_configurations': 'lambdaConfigurations', 'queue_configurations': 'queueConfigurations', 'topic_configurations': 'topicConfigurations'})
    class NotificationConfigurationProperty():
        def __init__(self, *, lambda_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.LambdaConfigurationProperty", _IResolvable_9ceae33e]]]]=None, queue_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.QueueConfigurationProperty", _IResolvable_9ceae33e]]]]=None, topic_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TopicConfigurationProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def lambda_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.LambdaConfigurationProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def queue_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.QueueConfigurationProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def topic_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TopicConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.NotificationFilterProperty", jsii_struct_bases=[], name_mapping={'s3_key': 's3Key'})
    class NotificationFilterProperty():
        def __init__(self, *, s3_key: typing.Union["CfnBucket.S3KeyFilterProperty", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def s3_key(self) -> typing.Union["CfnBucket.S3KeyFilterProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ObjectLockConfigurationProperty", jsii_struct_bases=[], name_mapping={'object_lock_enabled': 'objectLockEnabled', 'rule': 'rule'})
    class ObjectLockConfigurationProperty():
        def __init__(self, *, object_lock_enabled: typing.Optional[str]=None, rule: typing.Optional[typing.Union["CfnBucket.ObjectLockRuleProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def rule(self) -> typing.Optional[typing.Union["CfnBucket.ObjectLockRuleProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ObjectLockRuleProperty", jsii_struct_bases=[], name_mapping={'default_retention': 'defaultRetention'})
    class ObjectLockRuleProperty():
        def __init__(self, *, default_retention: typing.Optional[typing.Union["CfnBucket.DefaultRetentionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def default_retention(self) -> typing.Optional[typing.Union["CfnBucket.DefaultRetentionProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.PublicAccessBlockConfigurationProperty", jsii_struct_bases=[], name_mapping={'block_public_acls': 'blockPublicAcls', 'block_public_policy': 'blockPublicPolicy', 'ignore_public_acls': 'ignorePublicAcls', 'restrict_public_buckets': 'restrictPublicBuckets'})
    class PublicAccessBlockConfigurationProperty():
        def __init__(self, *, block_public_acls: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, block_public_policy: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, ignore_public_acls: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, restrict_public_buckets: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.QueueConfigurationProperty", jsii_struct_bases=[], name_mapping={'event': 'event', 'queue': 'queue', 'filter': 'filter'})
    class QueueConfigurationProperty():
        def __init__(self, *, event: str, queue: str, filter: typing.Optional[typing.Union["CfnBucket.NotificationFilterProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.RedirectAllRequestsToProperty", jsii_struct_bases=[], name_mapping={'host_name': 'hostName', 'protocol': 'protocol'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.RedirectRuleProperty", jsii_struct_bases=[], name_mapping={'host_name': 'hostName', 'http_redirect_code': 'httpRedirectCode', 'protocol': 'protocol', 'replace_key_prefix_with': 'replaceKeyPrefixWith', 'replace_key_with': 'replaceKeyWith'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationConfigurationProperty", jsii_struct_bases=[], name_mapping={'role': 'role', 'rules': 'rules'})
    class ReplicationConfigurationProperty():
        def __init__(self, *, role: str, rules: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.ReplicationRuleProperty", _IResolvable_9ceae33e]]]) -> None:
            """
        ...
        @builtins.property
        def rules(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.ReplicationRuleProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationDestinationProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'access_control_translation': 'accessControlTranslation', 'account': 'account', 'encryption_configuration': 'encryptionConfiguration', 'metrics': 'metrics', 'replication_time': 'replicationTime', 'storage_class': 'storageClass'})
    class ReplicationDestinationProperty():
        def __init__(self, *, bucket: str, access_control_translation: typing.Optional[typing.Union["CfnBucket.AccessControlTranslationProperty", _IResolvable_9ceae33e]]=None, account: typing.Optional[str]=None, encryption_configuration: typing.Optional[typing.Union["CfnBucket.EncryptionConfigurationProperty", _IResolvable_9ceae33e]]=None, metrics: typing.Optional[typing.Union["CfnBucket.MetricsProperty", _IResolvable_9ceae33e]]=None, replication_time: typing.Optional[typing.Union["CfnBucket.ReplicationTimeProperty", _IResolvable_9ceae33e]]=None, storage_class: typing.Optional[str]=None) -> None:
            """
            ...
            if metrics is not None: self._values["metrics"] = metrics
            if replication_time is not None: self._values["replication_time"] = replication_time
        ...
        @builtins.property
        def access_control_translation(self) -> typing.Optional[typing.Union["CfnBucket.AccessControlTranslationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def encryption_configuration(self) -> typing.Optional[typing.Union["CfnBucket.EncryptionConfigurationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def metrics(self) -> typing.Optional[typing.Union["CfnBucket.MetricsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def replication_time(self) -> typing.Optional[typing.Union["CfnBucket.ReplicationTimeProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationRuleAndOperatorProperty", jsii_struct_bases=[], name_mapping={'prefix': 'prefix', 'tag_filters': 'tagFilters'})
    class ReplicationRuleAndOperatorProperty():
        def __init__(self, *, prefix: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'ReplicationRuleAndOperatorProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationRuleFilterProperty", jsii_struct_bases=[], name_mapping={'and_': 'and', 'prefix': 'prefix', 'tag_filter': 'tagFilter'})
    class ReplicationRuleFilterProperty():
        def __init__(self, *, and_: typing.Optional[typing.Union["CfnBucket.ReplicationRuleAndOperatorProperty", _IResolvable_9ceae33e]]=None, prefix: typing.Optional[str]=None, tag_filter: typing.Optional[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if and_ is not None: self._values["and_"] = and_
            if prefix is not None: self._values["prefix"] = prefix
            if tag_filter is not None: self._values["tag_filter"] = tag_filter

        @builtins.property
        def and_(self) -> typing.Optional[typing.Union["CfnBucket.ReplicationRuleAndOperatorProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def tag_filter(self) -> typing.Optional[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]:
        ...
        def __repr__(self) -> str:
            return 'ReplicationRuleFilterProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationRuleProperty", jsii_struct_bases=[], name_mapping={'destination': 'destination', 'status': 'status', 'delete_marker_replication': 'deleteMarkerReplication', 'filter': 'filter', 'id': 'id', 'prefix': 'prefix', 'priority': 'priority', 'source_selection_criteria': 'sourceSelectionCriteria'})
    class ReplicationRuleProperty():
        def __init__(self, *, destination: typing.Union["CfnBucket.ReplicationDestinationProperty", _IResolvable_9ceae33e], status: str, delete_marker_replication: typing.Optional[typing.Union["CfnBucket.DeleteMarkerReplicationProperty", _IResolvable_9ceae33e]]=None, filter: typing.Optional[typing.Union["CfnBucket.ReplicationRuleFilterProperty", _IResolvable_9ceae33e]]=None, id: typing.Optional[str]=None, prefix: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, source_selection_criteria: typing.Optional[typing.Union["CfnBucket.SourceSelectionCriteriaProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if delete_marker_replication is not None: self._values["delete_marker_replication"] = delete_marker_replication
            if filter is not None: self._values["filter"] = filter
            if id is not None: self._values["id"] = id
            if prefix is not None: self._values["prefix"] = prefix
        ...
        @builtins.property
        def destination(self) -> typing.Union["CfnBucket.ReplicationDestinationProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def delete_marker_replication(self) -> typing.Optional[typing.Union["CfnBucket.DeleteMarkerReplicationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def filter(self) -> typing.Optional[typing.Union["CfnBucket.ReplicationRuleFilterProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def source_selection_criteria(self) -> typing.Optional[typing.Union["CfnBucket.SourceSelectionCriteriaProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationTimeProperty", jsii_struct_bases=[], name_mapping={'status': 'status', 'time': 'time'})
    class ReplicationTimeProperty():
        def __init__(self, *, status: str, time: typing.Union["CfnBucket.ReplicationTimeValueProperty", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def time(self) -> typing.Union["CfnBucket.ReplicationTimeValueProperty", _IResolvable_9ceae33e]:
        ...
        def __repr__(self) -> str:
            return 'ReplicationTimeProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationTimeValueProperty", jsii_struct_bases=[], name_mapping={'minutes': 'minutes'})
    class ReplicationTimeValueProperty():
        ...
        def __repr__(self) -> str:
            return 'ReplicationTimeValueProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.RoutingRuleConditionProperty", jsii_struct_bases=[], name_mapping={'http_error_code_returned_equals': 'httpErrorCodeReturnedEquals', 'key_prefix_equals': 'keyPrefixEquals'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.RoutingRuleProperty", jsii_struct_bases=[], name_mapping={'redirect_rule': 'redirectRule', 'routing_rule_condition': 'routingRuleCondition'})
    class RoutingRuleProperty():
        def __init__(self, *, redirect_rule: typing.Union["CfnBucket.RedirectRuleProperty", _IResolvable_9ceae33e], routing_rule_condition: typing.Optional[typing.Union["CfnBucket.RoutingRuleConditionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def redirect_rule(self) -> typing.Union["CfnBucket.RedirectRuleProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def routing_rule_condition(self) -> typing.Optional[typing.Union["CfnBucket.RoutingRuleConditionProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.RuleProperty", jsii_struct_bases=[], name_mapping={'status': 'status', 'abort_incomplete_multipart_upload': 'abortIncompleteMultipartUpload', 'expiration_date': 'expirationDate', 'expiration_in_days': 'expirationInDays', 'id': 'id', 'noncurrent_version_expiration_in_days': 'noncurrentVersionExpirationInDays', 'noncurrent_version_transition': 'noncurrentVersionTransition', 'noncurrent_version_transitions': 'noncurrentVersionTransitions', 'prefix': 'prefix', 'tag_filters': 'tagFilters', 'transition': 'transition', 'transitions': 'transitions'})
    class RuleProperty():
        def __init__(self, *, status: str, abort_incomplete_multipart_upload: typing.Optional[typing.Union["CfnBucket.AbortIncompleteMultipartUploadProperty", _IResolvable_9ceae33e]]=None, expiration_date: typing.Optional[typing.Union[_IResolvable_9ceae33e, datetime.datetime]]=None, expiration_in_days: typing.Optional[jsii.Number]=None, id: typing.Optional[str]=None, noncurrent_version_expiration_in_days: typing.Optional[jsii.Number]=None, noncurrent_version_transition: typing.Optional[typing.Union["CfnBucket.NoncurrentVersionTransitionProperty", _IResolvable_9ceae33e]]=None, noncurrent_version_transitions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.NoncurrentVersionTransitionProperty", _IResolvable_9ceae33e]]]]=None, prefix: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TagFilterProperty", _IResolvable_9ceae33e]]]]=None, transition: typing.Optional[typing.Union["CfnBucket.TransitionProperty", _IResolvable_9ceae33e]]=None, transitions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TransitionProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def abort_incomplete_multipart_upload(self) -> typing.Optional[typing.Union["CfnBucket.AbortIncompleteMultipartUploadProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def expiration_date(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, datetime.datetime]]:
        ...
        @builtins.property
        def noncurrent_version_transition(self) -> typing.Optional[typing.Union["CfnBucket.NoncurrentVersionTransitionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def noncurrent_version_transitions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.NoncurrentVersionTransitionProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def transition(self) -> typing.Optional[typing.Union["CfnBucket.TransitionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def transitions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.TransitionProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.S3KeyFilterProperty", jsii_struct_bases=[], name_mapping={'rules': 'rules'})
    class S3KeyFilterProperty():
        def __init__(self, *, rules: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.FilterRuleProperty", _IResolvable_9ceae33e]]]) -> None:
            """
        ...
        @builtins.property
        def rules(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.FilterRuleProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ServerSideEncryptionByDefaultProperty", jsii_struct_bases=[], name_mapping={'sse_algorithm': 'sseAlgorithm', 'kms_master_key_id': 'kmsMasterKeyId'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ServerSideEncryptionRuleProperty", jsii_struct_bases=[], name_mapping={'server_side_encryption_by_default': 'serverSideEncryptionByDefault'})
    class ServerSideEncryptionRuleProperty():
        def __init__(self, *, server_side_encryption_by_default: typing.Optional[typing.Union["CfnBucket.ServerSideEncryptionByDefaultProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def server_side_encryption_by_default(self) -> typing.Optional[typing.Union["CfnBucket.ServerSideEncryptionByDefaultProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.SourceSelectionCriteriaProperty", jsii_struct_bases=[], name_mapping={'sse_kms_encrypted_objects': 'sseKmsEncryptedObjects'})
    class SourceSelectionCriteriaProperty():
        def __init__(self, *, sse_kms_encrypted_objects: typing.Union["CfnBucket.SseKmsEncryptedObjectsProperty", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def sse_kms_encrypted_objects(self) -> typing.Union["CfnBucket.SseKmsEncryptedObjectsProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.SseKmsEncryptedObjectsProperty", jsii_struct_bases=[], name_mapping={'status': 'status'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.StorageClassAnalysisProperty", jsii_struct_bases=[], name_mapping={'data_export': 'dataExport'})
    class StorageClassAnalysisProperty():
        def __init__(self, *, data_export: typing.Optional[typing.Union["CfnBucket.DataExportProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def data_export(self) -> typing.Optional[typing.Union["CfnBucket.DataExportProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.TagFilterProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.TopicConfigurationProperty", jsii_struct_bases=[], name_mapping={'event': 'event', 'topic': 'topic', 'filter': 'filter'})
    class TopicConfigurationProperty():
        def __init__(self, *, event: str, topic: str, filter: typing.Optional[typing.Union["CfnBucket.NotificationFilterProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.TransitionProperty", jsii_struct_bases=[], name_mapping={'storage_class': 'storageClass', 'transition_date': 'transitionDate', 'transition_in_days': 'transitionInDays'})
    class TransitionProperty():
        def __init__(self, *, storage_class: str, transition_date: typing.Optional[typing.Union[_IResolvable_9ceae33e, datetime.datetime]]=None, transition_in_days: typing.Optional[jsii.Number]=None) -> None:
            """
        ...
        @builtins.property
        def transition_date(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, datetime.datetime]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.VersioningConfigurationProperty", jsii_struct_bases=[], name_mapping={'status': 'status'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.WebsiteConfigurationProperty", jsii_struct_bases=[], name_mapping={'error_document': 'errorDocument', 'index_document': 'indexDocument', 'redirect_all_requests_to': 'redirectAllRequestsTo', 'routing_rules': 'routingRules'})
    class WebsiteConfigurationProperty():
        def __init__(self, *, error_document: typing.Optional[str]=None, index_document: typing.Optional[str]=None, redirect_all_requests_to: typing.Optional[typing.Union["CfnBucket.RedirectAllRequestsToProperty", _IResolvable_9ceae33e]]=None, routing_rules: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.RoutingRuleProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def redirect_all_requests_to(self) -> typing.Optional[typing.Union["CfnBucket.RedirectAllRequestsToProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def routing_rules(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.RoutingRuleProperty", _IResolvable_9ceae33e]]]]:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnBucketPolicy(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.CfnBucketPolicy"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, bucket: str, policy_document: typing.Any) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnBucketPolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucketPolicyProps", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'policy_document': 'policyDocument'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucketProps", jsii_struct_bases=[], name_mapping={'accelerate_configuration': 'accelerateConfiguration', 'access_control': 'accessControl', 'analytics_configurations': 'analyticsConfigurations', 'bucket_encryption': 'bucketEncryption', 'bucket_name': 'bucketName', 'cors_configuration': 'corsConfiguration', 'inventory_configurations': 'inventoryConfigurations', 'lifecycle_configuration': 'lifecycleConfiguration', 'logging_configuration': 'loggingConfiguration', 'metrics_configurations': 'metricsConfigurations', 'notification_configuration': 'notificationConfiguration', 'object_lock_configuration': 'objectLockConfiguration', 'object_lock_enabled': 'objectLockEnabled', 'public_access_block_configuration': 'publicAccessBlockConfiguration', 'replication_configuration': 'replicationConfiguration', 'tags': 'tags', 'versioning_configuration': 'versioningConfiguration', 'website_configuration': 'websiteConfiguration'})
class CfnBucketProps():
    def __init__(self, *, accelerate_configuration: typing.Optional[typing.Union["CfnBucket.AccelerateConfigurationProperty", _IResolvable_9ceae33e]]=None, access_control: typing.Optional[str]=None, analytics_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.AnalyticsConfigurationProperty", _IResolvable_9ceae33e]]]]=None, bucket_encryption: typing.Optional[typing.Union["CfnBucket.BucketEncryptionProperty", _IResolvable_9ceae33e]]=None, bucket_name: typing.Optional[str]=None, cors_configuration: typing.Optional[typing.Union["CfnBucket.CorsConfigurationProperty", _IResolvable_9ceae33e]]=None, inventory_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.InventoryConfigurationProperty", _IResolvable_9ceae33e]]]]=None, lifecycle_configuration: typing.Optional[typing.Union["CfnBucket.LifecycleConfigurationProperty", _IResolvable_9ceae33e]]=None, logging_configuration: typing.Optional[typing.Union["CfnBucket.LoggingConfigurationProperty", _IResolvable_9ceae33e]]=None, metrics_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.MetricsConfigurationProperty", _IResolvable_9ceae33e]]]]=None, notification_configuration: typing.Optional[typing.Union["CfnBucket.NotificationConfigurationProperty", _IResolvable_9ceae33e]]=None, object_lock_configuration: typing.Optional[typing.Union["CfnBucket.ObjectLockConfigurationProperty", _IResolvable_9ceae33e]]=None, object_lock_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, public_access_block_configuration: typing.Optional[typing.Union["CfnBucket.PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]=None, replication_configuration: typing.Optional[typing.Union["CfnBucket.ReplicationConfigurationProperty", _IResolvable_9ceae33e]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, versioning_configuration: typing.Optional[typing.Union["CfnBucket.VersioningConfigurationProperty", _IResolvable_9ceae33e]]=None, website_configuration: typing.Optional[typing.Union["CfnBucket.WebsiteConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def accelerate_configuration(self) -> typing.Optional[typing.Union["CfnBucket.AccelerateConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.AccelerateConfiguration``.
    ...
    @builtins.property
    def analytics_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.AnalyticsConfigurationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::S3::Bucket.AnalyticsConfigurations``.
    ...
    @builtins.property
    def bucket_encryption(self) -> typing.Optional[typing.Union["CfnBucket.BucketEncryptionProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.BucketEncryption``.
    ...
    @builtins.property
    def cors_configuration(self) -> typing.Optional[typing.Union["CfnBucket.CorsConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.CorsConfiguration``.
    ...
    @builtins.property
    def inventory_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.InventoryConfigurationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::S3::Bucket.InventoryConfigurations``.
    ...
    @builtins.property
    def lifecycle_configuration(self) -> typing.Optional[typing.Union["CfnBucket.LifecycleConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.LifecycleConfiguration``.
    ...
    @builtins.property
    def logging_configuration(self) -> typing.Optional[typing.Union["CfnBucket.LoggingConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.LoggingConfiguration``.
    ...
    @builtins.property
    def metrics_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnBucket.MetricsConfigurationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::S3::Bucket.MetricsConfigurations``.
    ...
    @builtins.property
    def notification_configuration(self) -> typing.Optional[typing.Union["CfnBucket.NotificationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.NotificationConfiguration``.
    ...
    @builtins.property
    def object_lock_configuration(self) -> typing.Optional[typing.Union["CfnBucket.ObjectLockConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.ObjectLockConfiguration``.
    ...
    @builtins.property
    def public_access_block_configuration(self) -> typing.Optional[typing.Union["CfnBucket.PublicAccessBlockConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.PublicAccessBlockConfiguration``.
    ...
    @builtins.property
    def replication_configuration(self) -> typing.Optional[typing.Union["CfnBucket.ReplicationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.ReplicationConfiguration``.
    ...
    @builtins.property
    def versioning_configuration(self) -> typing.Optional[typing.Union["CfnBucket.VersioningConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.VersioningConfiguration``.
    ...
    @builtins.property
    def website_configuration(self) -> typing.Optional[typing.Union["CfnBucket.WebsiteConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::S3::Bucket.WebsiteConfiguration``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CorsRule", jsii_struct_bases=[], name_mapping={'allowed_methods': 'allowedMethods', 'allowed_origins': 'allowedOrigins', 'allowed_headers': 'allowedHeaders', 'exposed_headers': 'exposedHeaders', 'id': 'id', 'max_age': 'maxAge'})
class CorsRule():
...
class IBucket(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def add_to_resource_policy(self, permission: _PolicyStatement_f75dc775) -> _AddToResourcePolicyResult_d2a345d1:
    ...
    def grant_delete(self, identity: _IGrantable_0fcfc53a, objects_key_pattern: typing.Any=None) -> _Grant_96af6d2d:
    ...
    def grant_public_access(self, key_prefix: typing.Optional[str]=None, *allowed_actions: str) -> _Grant_96af6d2d:
    ...
    def grant_put(self, identity: _IGrantable_0fcfc53a, objects_key_pattern: typing.Any=None) -> _Grant_96af6d2d:
    ...
    def grant_read(self, identity: _IGrantable_0fcfc53a, objects_key_pattern: typing.Any=None) -> _Grant_96af6d2d:
    ...
    def grant_read_write(self, identity: _IGrantable_0fcfc53a, objects_key_pattern: typing.Any=None) -> _Grant_96af6d2d:
    ...
    def grant_write(self, identity: _IGrantable_0fcfc53a, objects_key_pattern: typing.Any=None) -> _Grant_96af6d2d:
    ...
    def on_cloud_trail_event(self, id: str, *, paths: typing.Optional[typing.List[str]]=None, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None) -> _Rule_c38e0b39:
    ...
    def on_cloud_trail_put_object(self, id: str, *, paths: typing.Optional[typing.List[str]]=None, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None) -> _Rule_c38e0b39:
    ...
    def on_cloud_trail_write_object(self, id: str, *, paths: typing.Optional[typing.List[str]]=None, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None) -> _Rule_c38e0b39:
...
class IBucketNotificationDestination(jsii.compat.Protocol):
    ...
    def bind(self, scope: _Construct_f50a3f53, bucket: "IBucket") -> "BucketNotificationDestinationConfig":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.LifecycleRule", jsii_struct_bases=[], name_mapping={'abort_incomplete_multipart_upload_after': 'abortIncompleteMultipartUploadAfter', 'enabled': 'enabled', 'expiration': 'expiration', 'expiration_date': 'expirationDate', 'id': 'id', 'noncurrent_version_expiration': 'noncurrentVersionExpiration', 'noncurrent_version_transitions': 'noncurrentVersionTransitions', 'prefix': 'prefix', 'tag_filters': 'tagFilters', 'transitions': 'transitions'})
class LifecycleRule():
    def __init__(self, *, abort_incomplete_multipart_upload_after: typing.Optional[_Duration_5170c158]=None, enabled: typing.Optional[bool]=None, expiration: typing.Optional[_Duration_5170c158]=None, expiration_date: typing.Optional[datetime.datetime]=None, id: typing.Optional[str]=None, noncurrent_version_expiration: typing.Optional[_Duration_5170c158]=None, noncurrent_version_transitions: typing.Optional[typing.List["NoncurrentVersionTransition"]]=None, prefix: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Mapping[str, typing.Any]]=None, transitions: typing.Optional[typing.List["Transition"]]=None) -> None:
    ...
    @builtins.property
    def abort_incomplete_multipart_upload_after(self) -> typing.Optional[_Duration_5170c158]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.Location", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'object_key': 'objectKey', 'object_version': 'objectVersion'})
class Location():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.NoncurrentVersionTransition", jsii_struct_bases=[], name_mapping={'storage_class': 'storageClass', 'transition_after': 'transitionAfter'})
class NoncurrentVersionTransition():
    def __init__(self, *, storage_class: "StorageClass", transition_after: _Duration_5170c158) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.NotificationKeyFilter", jsii_struct_bases=[], name_mapping={'prefix': 'prefix', 'suffix': 'suffix'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.OnCloudTrailBucketEventOptions", jsii_struct_bases=[_OnEventOptions_926fbcf9], name_mapping={'description': 'description', 'event_pattern': 'eventPattern', 'rule_name': 'ruleName', 'target': 'target', 'paths': 'paths'})
class OnCloudTrailBucketEventOptions(_OnEventOptions_926fbcf9):
    def __init__(self, *, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None, paths: typing.Optional[typing.List[str]]=None) -> None:
        ...
        :stability: experimental
        """
        if isinstance(event_pattern, dict): event_pattern = _EventPattern_8aa7b781(**event_pattern)
        self._values = {
        }
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.RedirectTarget", jsii_struct_bases=[], name_mapping={'host_name': 'hostName', 'protocol': 'protocol'})
...
class ReplaceKey(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.ReplaceKey"):
    """
    stability
    :stability: experimental
    """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.RoutingRule", jsii_struct_bases=[], name_mapping={'condition': 'condition', 'host_name': 'hostName', 'http_redirect_code': 'httpRedirectCode', 'protocol': 'protocol', 'replace_key': 'replaceKey'})
class RoutingRule():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.RoutingRuleCondition", jsii_struct_bases=[], name_mapping={'http_error_code_returned_equals': 'httpErrorCodeReturnedEquals', 'key_prefix_equals': 'keyPrefixEquals'})
...
class StorageClass(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.StorageClass"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_s3.Transition", jsii_struct_bases=[], name_mapping={'storage_class': 'storageClass', 'transition_after': 'transitionAfter', 'transition_date': 'transitionDate'})
class Transition():
    def __init__(self, *, storage_class: "StorageClass", transition_after: typing.Optional[_Duration_5170c158]=None, transition_date: typing.Optional[datetime.datetime]=None) -> None:
...
class Bucket(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.Bucket"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, access_control: typing.Optional["BucketAccessControl"]=None, block_public_access: typing.Optional["BlockPublicAccess"]=None, bucket_name: typing.Optional[str]=None, cors: typing.Optional[typing.List["CorsRule"]]=None, encryption: typing.Optional["BucketEncryption"]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None, lifecycle_rules: typing.Optional[typing.List["LifecycleRule"]]=None, metrics: typing.Optional[typing.List["BucketMetrics"]]=None, public_read_access: typing.Optional[bool]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, server_access_logs_bucket: typing.Optional["IBucket"]=None, server_access_logs_prefix: typing.Optional[str]=None, versioned: typing.Optional[bool]=None, website_error_document: typing.Optional[str]=None, website_index_document: typing.Optional[str]=None, website_redirect: typing.Optional["RedirectTarget"]=None, website_routing_rules: typing.Optional[typing.List["RoutingRule"]]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param access_control: Specifies a canned ACL that grants predefined permissions to the bucket. Default: BucketAccessControl.PRIVATE
    ...
    @builtins.classmethod
    def from_bucket_arn(cls, scope: _Construct_f50a3f53, id: str, bucket_arn: str) -> "IBucket":
        """
        :param scope: -
        :param id: -
        :param bucket_arn: -
    ...
    @builtins.classmethod
    def from_bucket_attributes(cls, scope: _Construct_f50a3f53, id: str, *, bucket_arn: typing.Optional[str]=None, bucket_domain_name: typing.Optional[str]=None, bucket_dual_stack_domain_name: typing.Optional[str]=None, bucket_name: typing.Optional[str]=None, bucket_regional_domain_name: typing.Optional[str]=None, bucket_website_new_url_format: typing.Optional[bool]=None, bucket_website_url: typing.Optional[str]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> "IBucket":
    ...
    @builtins.classmethod
    def from_bucket_name(cls, scope: _Construct_f50a3f53, id: str, bucket_name: str) -> "IBucket":
        """
        :param scope: -
        :param id: -
        :param bucket_name: -
    ...
    def add_lifecycle_rule(self, *, abort_incomplete_multipart_upload_after: typing.Optional[_Duration_5170c158]=None, enabled: typing.Optional[bool]=None, expiration: typing.Optional[_Duration_5170c158]=None, expiration_date: typing.Optional[datetime.datetime]=None, id: typing.Optional[str]=None, noncurrent_version_expiration: typing.Optional[_Duration_5170c158]=None, noncurrent_version_transitions: typing.Optional[typing.List["NoncurrentVersionTransition"]]=None, prefix: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Mapping[str, typing.Any]]=None, transitions: typing.Optional[typing.List["Transition"]]=None) -> None:
