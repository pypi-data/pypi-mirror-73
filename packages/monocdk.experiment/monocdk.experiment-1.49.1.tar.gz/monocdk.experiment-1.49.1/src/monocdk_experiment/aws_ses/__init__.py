...
from .. import (CfnResource as _CfnResource_7760e8e4, Construct as _Construct_f50a3f53, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IInspectable as _IInspectable_051e6ed8, IResolvable as _IResolvable_9ceae33e, IResource as _IResource_72f7ee7e, Resource as _Resource_884d0774)


@jsii.implements(_IInspectable_051e6ed8)
class CfnConfigurationSet(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSet"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnConfigurationSet":
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnConfigurationSetEventDestination(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, configuration_set_name: str, event_destination: typing.Union["EventDestinationProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnConfigurationSetEventDestination":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def event_destination(self) -> typing.Union["EventDestinationProperty", _IResolvable_9ceae33e]:
    ...
    def event_destination(self, value: typing.Union["EventDestinationProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "eventDestination", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.CloudWatchDestinationProperty", jsii_struct_bases=[], name_mapping={'dimension_configurations': 'dimensionConfigurations'})
    class CloudWatchDestinationProperty():
        def __init__(self, *, dimension_configurations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnConfigurationSetEventDestination.DimensionConfigurationProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def dimension_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnConfigurationSetEventDestination.DimensionConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.DimensionConfigurationProperty", jsii_struct_bases=[], name_mapping={'default_dimension_value': 'defaultDimensionValue', 'dimension_name': 'dimensionName', 'dimension_value_source': 'dimensionValueSource'})
    ...
    class EventDestinationProperty():
        ...
        @builtins.property
        def cloud_watch_destination(self) -> typing.Optional[typing.Union["CfnConfigurationSetEventDestination.CloudWatchDestinationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def kinesis_firehose_destination(self) -> typing.Optional[typing.Union["CfnConfigurationSetEventDestination.KinesisFirehoseDestinationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestination.KinesisFirehoseDestinationProperty", jsii_struct_bases=[], name_mapping={'delivery_stream_arn': 'deliveryStreamArn', 'iam_role_arn': 'iamRoleArn'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetEventDestinationProps", jsii_struct_bases=[], name_mapping={'configuration_set_name': 'configurationSetName', 'event_destination': 'eventDestination'})
class CfnConfigurationSetEventDestinationProps():
    def __init__(self, *, configuration_set_name: str, event_destination: typing.Union["CfnConfigurationSetEventDestination.EventDestinationProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @builtins.property
    def event_destination(self) -> typing.Union["CfnConfigurationSetEventDestination.EventDestinationProperty", _IResolvable_9ceae33e]:
        """``AWS::SES::ConfigurationSetEventDestination.EventDestination``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnConfigurationSetProps", jsii_struct_bases=[], name_mapping={'name': 'name'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnReceiptFilter(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilter"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, filter: typing.Union["FilterProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnReceiptFilter":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @filter.setter
    def filter(self, value: typing.Union["FilterProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "filter", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilter.FilterProperty", jsii_struct_bases=[], name_mapping={'ip_filter': 'ipFilter', 'name': 'name'})
    class FilterProperty():
        def __init__(self, *, ip_filter: typing.Union["CfnReceiptFilter.IpFilterProperty", _IResolvable_9ceae33e], name: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def ip_filter(self) -> typing.Union["CfnReceiptFilter.IpFilterProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilter.IpFilterProperty", jsii_struct_bases=[], name_mapping={'cidr': 'cidr', 'policy': 'policy'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptFilterProps", jsii_struct_bases=[], name_mapping={'filter': 'filter'})
class CfnReceiptFilterProps():
    def __init__(self, *, filter: typing.Union["CfnReceiptFilter.FilterProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @builtins.property
    def filter(self) -> typing.Union["CfnReceiptFilter.FilterProperty", _IResolvable_9ceae33e]:
        """``AWS::SES::ReceiptFilter.Filter``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnReceiptRule(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, rule: typing.Union["RuleProperty", _IResolvable_9ceae33e], rule_set_name: str, after: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnReceiptRule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.ActionProperty", jsii_struct_bases=[], name_mapping={'add_header_action': 'addHeaderAction', 'bounce_action': 'bounceAction', 'lambda_action': 'lambdaAction', 's3_action': 's3Action', 'sns_action': 'snsAction', 'stop_action': 'stopAction', 'workmail_action': 'workmailAction'})
    class ActionProperty():
        def __init__(self, *, add_header_action: typing.Optional[typing.Union["CfnReceiptRule.AddHeaderActionProperty", _IResolvable_9ceae33e]]=None, bounce_action: typing.Optional[typing.Union["CfnReceiptRule.BounceActionProperty", _IResolvable_9ceae33e]]=None, lambda_action: typing.Optional[typing.Union["CfnReceiptRule.LambdaActionProperty", _IResolvable_9ceae33e]]=None, s3_action: typing.Optional[typing.Union["CfnReceiptRule.S3ActionProperty", _IResolvable_9ceae33e]]=None, sns_action: typing.Optional[typing.Union["CfnReceiptRule.SNSActionProperty", _IResolvable_9ceae33e]]=None, stop_action: typing.Optional[typing.Union["CfnReceiptRule.StopActionProperty", _IResolvable_9ceae33e]]=None, workmail_action: typing.Optional[typing.Union["CfnReceiptRule.WorkmailActionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def add_header_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.AddHeaderActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def bounce_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.BounceActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def lambda_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.LambdaActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def s3_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.S3ActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def sns_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.SNSActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def stop_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.StopActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def workmail_action(self) -> typing.Optional[typing.Union["CfnReceiptRule.WorkmailActionProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.AddHeaderActionProperty", jsii_struct_bases=[], name_mapping={'header_name': 'headerName', 'header_value': 'headerValue'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.BounceActionProperty", jsii_struct_bases=[], name_mapping={'message': 'message', 'sender': 'sender', 'smtp_reply_code': 'smtpReplyCode', 'status_code': 'statusCode', 'topic_arn': 'topicArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.LambdaActionProperty", jsii_struct_bases=[], name_mapping={'function_arn': 'functionArn', 'invocation_type': 'invocationType', 'topic_arn': 'topicArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.RuleProperty", jsii_struct_bases=[], name_mapping={'actions': 'actions', 'enabled': 'enabled', 'name': 'name', 'recipients': 'recipients', 'scan_enabled': 'scanEnabled', 'tls_policy': 'tlsPolicy'})
    class RuleProperty():
        def __init__(self, *, actions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnReceiptRule.ActionProperty", _IResolvable_9ceae33e]]]]=None, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, name: typing.Optional[str]=None, recipients: typing.Optional[typing.List[str]]=None, scan_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, tls_policy: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def actions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnReceiptRule.ActionProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def scan_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.S3ActionProperty", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'kms_key_arn': 'kmsKeyArn', 'object_key_prefix': 'objectKeyPrefix', 'topic_arn': 'topicArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.SNSActionProperty", jsii_struct_bases=[], name_mapping={'encoding': 'encoding', 'topic_arn': 'topicArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.StopActionProperty", jsii_struct_bases=[], name_mapping={'scope': 'scope', 'topic_arn': 'topicArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRule.WorkmailActionProperty", jsii_struct_bases=[], name_mapping={'organization_arn': 'organizationArn', 'topic_arn': 'topicArn'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRuleProps", jsii_struct_bases=[], name_mapping={'rule': 'rule', 'rule_set_name': 'ruleSetName', 'after': 'after'})
class CfnReceiptRuleProps():
    def __init__(self, *, rule: typing.Union["CfnReceiptRule.RuleProperty", _IResolvable_9ceae33e], rule_set_name: str, after: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def rule(self) -> typing.Union["CfnReceiptRule.RuleProperty", _IResolvable_9ceae33e]:
        """``AWS::SES::ReceiptRule.Rule``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnReceiptRuleSet(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.CfnReceiptRuleSet"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, rule_set_name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnReceiptRuleSet":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnReceiptRuleSetProps", jsii_struct_bases=[], name_mapping={'rule_set_name': 'ruleSetName'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnTemplate(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.CfnTemplate"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, template: typing.Optional[typing.Union["TemplateProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnTemplate":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def template(self) -> typing.Optional[typing.Union["TemplateProperty", _IResolvable_9ceae33e]]:
    ...
    @template.setter
    def template(self, value: typing.Optional[typing.Union["TemplateProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "template", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnTemplate.TemplateProperty", jsii_struct_bases=[], name_mapping={'html_part': 'htmlPart', 'subject_part': 'subjectPart', 'template_name': 'templateName', 'text_part': 'textPart'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.CfnTemplateProps", jsii_struct_bases=[], name_mapping={'template': 'template'})
class CfnTemplateProps():
    def __init__(self, *, template: typing.Optional[typing.Union["CfnTemplate.TemplateProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def template(self) -> typing.Optional[typing.Union["CfnTemplate.TemplateProperty", _IResolvable_9ceae33e]]:
        """``AWS::SES::Template.Template``.
...
class DropSpamReceiptRule(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.DropSpamReceiptRule"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, rule_set: "IReceiptRuleSet", actions: typing.Optional[typing.List["IReceiptRuleAction"]]=None, after: typing.Optional["IReceiptRule"]=None, enabled: typing.Optional[bool]=None, receipt_rule_name: typing.Optional[str]=None, recipients: typing.Optional[typing.List[str]]=None, scan_enabled: typing.Optional[bool]=None, tls_policy: typing.Optional["TlsPolicy"]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class ReceiptFilter(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.ReceiptFilter"):
    """A receipt filter.
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, ip: typing.Optional[str]=None, policy: typing.Optional["ReceiptFilterPolicy"]=None, receipt_filter_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.ReceiptFilterProps", jsii_struct_bases=[], name_mapping={'ip': 'ip', 'policy': 'policy', 'receipt_filter_name': 'receiptFilterName'})
...
class ReceiptRule(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.ReceiptRule"):
    """A new receipt rule.
    ...
    @builtins.classmethod
    def from_receipt_rule_name(cls, scope: _Construct_f50a3f53, id: str, receipt_rule_name: str) -> "IReceiptRule":
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.ReceiptRuleActionConfig", jsii_struct_bases=[], name_mapping={'add_header_action': 'addHeaderAction', 'bounce_action': 'bounceAction', 'lambda_action': 'lambdaAction', 's3_action': 's3Action', 'sns_action': 'snsAction', 'stop_action': 'stopAction', 'workmail_action': 'workmailAction'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.ReceiptRuleOptions", jsii_struct_bases=[], name_mapping={'actions': 'actions', 'after': 'after', 'enabled': 'enabled', 'receipt_rule_name': 'receiptRuleName', 'recipients': 'recipients', 'scan_enabled': 'scanEnabled', 'tls_policy': 'tlsPolicy'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.ReceiptRuleProps", jsii_struct_bases=[ReceiptRuleOptions], name_mapping={'actions': 'actions', 'after': 'after', 'enabled': 'enabled', 'receipt_rule_name': 'receiptRuleName', 'recipients': 'recipients', 'scan_enabled': 'scanEnabled', 'tls_policy': 'tlsPolicy', 'rule_set': 'ruleSet'})
...
class ReceiptRuleSet(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.ReceiptRuleSet"):
    """A new receipt rule set.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, drop_spam: typing.Optional[bool]=None, receipt_rule_set_name: typing.Optional[str]=None, rules: typing.Optional[typing.List["ReceiptRuleOptions"]]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_receipt_rule_set_name(cls, scope: _Construct_f50a3f53, id: str, receipt_rule_set_name: str) -> "IReceiptRuleSet":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.ReceiptRuleSetProps", jsii_struct_bases=[], name_mapping={'drop_spam': 'dropSpam', 'receipt_rule_set_name': 'receiptRuleSetName', 'rules': 'rules'})
...
class WhiteListReceiptFilter(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ses.WhiteListReceiptFilter"):
    """A white list receipt filter.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, ips: typing.List[str]) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.WhiteListReceiptFilterProps", jsii_struct_bases=[], name_mapping={'ips': 'ips'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ses.DropSpamReceiptRuleProps", jsii_struct_bases=[ReceiptRuleProps], name_mapping={'actions': 'actions', 'after': 'after', 'enabled': 'enabled', 'receipt_rule_name': 'receiptRuleName', 'recipients': 'recipients', 'scan_enabled': 'scanEnabled', 'tls_policy': 'tlsPolicy', 'rule_set': 'ruleSet'})
