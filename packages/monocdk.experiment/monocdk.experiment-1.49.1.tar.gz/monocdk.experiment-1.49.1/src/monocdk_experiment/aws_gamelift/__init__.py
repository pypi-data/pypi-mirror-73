...
class CfnAlias(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnAlias"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, routing_strategy: typing.Union["RoutingStrategyProperty", _IResolvable_9ceae33e], description: typing.Optional[str]=None) -> None:
    ...
    def routing_strategy(self) -> typing.Union["RoutingStrategyProperty", _IResolvable_9ceae33e]:
    ...
    def routing_strategy(self, value: typing.Union["RoutingStrategyProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnAlias.RoutingStrategyProperty", jsii_struct_bases=[], name_mapping={'type': 'type', 'fleet_id': 'fleetId', 'message': 'message'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnAliasProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'routing_strategy': 'routingStrategy', 'description': 'description'})
class CfnAliasProps():
    def __init__(self, *, name: str, routing_strategy: typing.Union["CfnAlias.RoutingStrategyProperty", _IResolvable_9ceae33e], description: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def routing_strategy(self) -> typing.Union["CfnAlias.RoutingStrategyProperty", _IResolvable_9ceae33e]:
        """``AWS::GameLift::Alias.RoutingStrategy``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnBuild(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnBuild"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: typing.Optional[str]=None, operating_system: typing.Optional[str]=None, storage_location: typing.Optional[typing.Union["S3LocationProperty", _IResolvable_9ceae33e]]=None, version: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnBuild":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def storage_location(self) -> typing.Optional[typing.Union["S3LocationProperty", _IResolvable_9ceae33e]]:
    ...
    def storage_location(self, value: typing.Optional[typing.Union["S3LocationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnBuild.S3LocationProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'key': 'key', 'role_arn': 'roleArn', 'object_version': 'objectVersion'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnBuildProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'operating_system': 'operatingSystem', 'storage_location': 'storageLocation', 'version': 'version'})
class CfnBuildProps():
    def __init__(self, *, name: typing.Optional[str]=None, operating_system: typing.Optional[str]=None, storage_location: typing.Optional[typing.Union["CfnBuild.S3LocationProperty", _IResolvable_9ceae33e]]=None, version: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def storage_location(self) -> typing.Optional[typing.Union["CfnBuild.S3LocationProperty", _IResolvable_9ceae33e]]:
        """``AWS::GameLift::Build.StorageLocation``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnFleet(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnFleet"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, ec2_instance_type: str, name: str, build_id: typing.Optional[str]=None, certificate_configuration: typing.Optional[typing.Union["CertificateConfigurationProperty", _IResolvable_9ceae33e]]=None, description: typing.Optional[str]=None, desired_ec2_instances: typing.Optional[jsii.Number]=None, ec2_inbound_permissions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["IpPermissionProperty", _IResolvable_9ceae33e]]]]=None, fleet_type: typing.Optional[str]=None, instance_role_arn: typing.Optional[str]=None, log_paths: typing.Optional[typing.List[str]]=None, max_size: typing.Optional[jsii.Number]=None, metric_groups: typing.Optional[typing.List[str]]=None, min_size: typing.Optional[jsii.Number]=None, new_game_session_protection_policy: typing.Optional[str]=None, peer_vpc_aws_account_id: typing.Optional[str]=None, peer_vpc_id: typing.Optional[str]=None, resource_creation_limit_policy: typing.Optional[typing.Union["ResourceCreationLimitPolicyProperty", _IResolvable_9ceae33e]]=None, runtime_configuration: typing.Optional[typing.Union["RuntimeConfigurationProperty", _IResolvable_9ceae33e]]=None, script_id: typing.Optional[str]=None, server_launch_parameters: typing.Optional[str]=None, server_launch_path: typing.Optional[str]=None) -> None:
    ...
    def certificate_configuration(self) -> typing.Optional[typing.Union["CertificateConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def certificate_configuration(self, value: typing.Optional[typing.Union["CertificateConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def ec2_inbound_permissions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["IpPermissionProperty", _IResolvable_9ceae33e]]]]:
    ...
    def ec2_inbound_permissions(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["IpPermissionProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    def resource_creation_limit_policy(self) -> typing.Optional[typing.Union["ResourceCreationLimitPolicyProperty", _IResolvable_9ceae33e]]:
    ...
    def resource_creation_limit_policy(self, value: typing.Optional[typing.Union["ResourceCreationLimitPolicyProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "resourceCreationLimitPolicy", value)

    @builtins.property
    @jsii.member(jsii_name="runtimeConfiguration")
    def runtime_configuration(self) -> typing.Optional[typing.Union["RuntimeConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def runtime_configuration(self, value: typing.Optional[typing.Union["RuntimeConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnFleet.CertificateConfigurationProperty", jsii_struct_bases=[], name_mapping={'certificate_type': 'certificateType'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnFleet.IpPermissionProperty", jsii_struct_bases=[], name_mapping={'from_port': 'fromPort', 'ip_range': 'ipRange', 'protocol': 'protocol', 'to_port': 'toPort'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnFleet.ResourceCreationLimitPolicyProperty", jsii_struct_bases=[], name_mapping={'new_game_sessions_per_creator': 'newGameSessionsPerCreator', 'policy_period_in_minutes': 'policyPeriodInMinutes'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnFleet.RuntimeConfigurationProperty", jsii_struct_bases=[], name_mapping={'game_session_activation_timeout_seconds': 'gameSessionActivationTimeoutSeconds', 'max_concurrent_game_session_activations': 'maxConcurrentGameSessionActivations', 'server_processes': 'serverProcesses'})
    class RuntimeConfigurationProperty():
        ...
        @builtins.property
        def server_processes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnFleet.ServerProcessProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnFleet.ServerProcessProperty", jsii_struct_bases=[], name_mapping={'concurrent_executions': 'concurrentExecutions', 'launch_path': 'launchPath', 'parameters': 'parameters'})
...
class CfnFleetProps():
    ...
    @builtins.property
    def certificate_configuration(self) -> typing.Optional[typing.Union["CfnFleet.CertificateConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::GameLift::Fleet.CertificateConfiguration``.
    ...
    @builtins.property
    def ec2_inbound_permissions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnFleet.IpPermissionProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::GameLift::Fleet.EC2InboundPermissions``.
    ...
    @builtins.property
    def resource_creation_limit_policy(self) -> typing.Optional[typing.Union["CfnFleet.ResourceCreationLimitPolicyProperty", _IResolvable_9ceae33e]]:
        """``AWS::GameLift::Fleet.ResourceCreationLimitPolicy``.
    ...
    @builtins.property
    def runtime_configuration(self) -> typing.Optional[typing.Union["CfnFleet.RuntimeConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::GameLift::Fleet.RuntimeConfiguration``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnGameSessionQueue(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnGameSessionQueue"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, destinations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DestinationProperty", _IResolvable_9ceae33e]]]]=None, player_latency_policies: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["PlayerLatencyPolicyProperty", _IResolvable_9ceae33e]]]]=None, timeout_in_seconds: typing.Optional[jsii.Number]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnGameSessionQueue":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def destinations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DestinationProperty", _IResolvable_9ceae33e]]]]:
    ...
    @destinations.setter
    def destinations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DestinationProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "destinations", value)

    @builtins.property
    @jsii.member(jsii_name="playerLatencyPolicies")
    def player_latency_policies(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["PlayerLatencyPolicyProperty", _IResolvable_9ceae33e]]]]:
    ...
    def player_latency_policies(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["PlayerLatencyPolicyProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnGameSessionQueue.DestinationProperty", jsii_struct_bases=[], name_mapping={'destination_arn': 'destinationArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnGameSessionQueue.PlayerLatencyPolicyProperty", jsii_struct_bases=[], name_mapping={'maximum_individual_player_latency_milliseconds': 'maximumIndividualPlayerLatencyMilliseconds', 'policy_duration_seconds': 'policyDurationSeconds'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnGameSessionQueueProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'destinations': 'destinations', 'player_latency_policies': 'playerLatencyPolicies', 'timeout_in_seconds': 'timeoutInSeconds'})
class CfnGameSessionQueueProps():
    def __init__(self, *, name: str, destinations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnGameSessionQueue.DestinationProperty", _IResolvable_9ceae33e]]]]=None, player_latency_policies: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnGameSessionQueue.PlayerLatencyPolicyProperty", _IResolvable_9ceae33e]]]]=None, timeout_in_seconds: typing.Optional[jsii.Number]=None) -> None:
    ...
    @builtins.property
    def destinations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnGameSessionQueue.DestinationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::GameLift::GameSessionQueue.Destinations``.
    ...
    @builtins.property
    def player_latency_policies(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnGameSessionQueue.PlayerLatencyPolicyProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::GameLift::GameSessionQueue.PlayerLatencyPolicies``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMatchmakingConfiguration(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnMatchmakingConfiguration"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, acceptance_required: typing.Union[bool, _IResolvable_9ceae33e], game_session_queue_arns: typing.List[str], name: str, request_timeout_seconds: jsii.Number, rule_set_name: str, acceptance_timeout_seconds: typing.Optional[jsii.Number]=None, additional_player_count: typing.Optional[jsii.Number]=None, backfill_mode: typing.Optional[str]=None, custom_event_data: typing.Optional[str]=None, description: typing.Optional[str]=None, game_properties: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["GamePropertyProperty", _IResolvable_9ceae33e]]]]=None, game_session_data: typing.Optional[str]=None, notification_target: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMatchmakingConfiguration":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def acceptance_required(self, value: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
    ...
    def game_properties(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["GamePropertyProperty", _IResolvable_9ceae33e]]]]:
    ...
    def game_properties(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["GamePropertyProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnMatchmakingConfiguration.GamePropertyProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnMatchmakingConfigurationProps", jsii_struct_bases=[], name_mapping={'acceptance_required': 'acceptanceRequired', 'game_session_queue_arns': 'gameSessionQueueArns', 'name': 'name', 'request_timeout_seconds': 'requestTimeoutSeconds', 'rule_set_name': 'ruleSetName', 'acceptance_timeout_seconds': 'acceptanceTimeoutSeconds', 'additional_player_count': 'additionalPlayerCount', 'backfill_mode': 'backfillMode', 'custom_event_data': 'customEventData', 'description': 'description', 'game_properties': 'gameProperties', 'game_session_data': 'gameSessionData', 'notification_target': 'notificationTarget'})
class CfnMatchmakingConfigurationProps():
    def __init__(self, *, acceptance_required: typing.Union[bool, _IResolvable_9ceae33e], game_session_queue_arns: typing.List[str], name: str, request_timeout_seconds: jsii.Number, rule_set_name: str, acceptance_timeout_seconds: typing.Optional[jsii.Number]=None, additional_player_count: typing.Optional[jsii.Number]=None, backfill_mode: typing.Optional[str]=None, custom_event_data: typing.Optional[str]=None, description: typing.Optional[str]=None, game_properties: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnMatchmakingConfiguration.GamePropertyProperty", _IResolvable_9ceae33e]]]]=None, game_session_data: typing.Optional[str]=None, notification_target: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def game_properties(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnMatchmakingConfiguration.GamePropertyProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::GameLift::MatchmakingConfiguration.GameProperties``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMatchmakingRuleSet(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnMatchmakingRuleSet"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, rule_set_body: str) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMatchmakingRuleSet":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnMatchmakingRuleSetProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'rule_set_body': 'ruleSetBody'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnScript(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_gamelift.CfnScript"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, storage_location: typing.Union["S3LocationProperty", _IResolvable_9ceae33e], name: typing.Optional[str]=None, version: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnScript":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @builtins.property
    @jsii.member(jsii_name="storageLocation")
    def storage_location(self) -> typing.Union["S3LocationProperty", _IResolvable_9ceae33e]:
    ...
    @storage_location.setter
    def storage_location(self, value: typing.Union["S3LocationProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "storageLocation", value)
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnScript.S3LocationProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'key': 'key', 'role_arn': 'roleArn', 'object_version': 'objectVersion'})
    class S3LocationProperty():
        def __init__(self, *, bucket: str, key: str, role_arn: str, object_version: typing.Optional[str]=None) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_gamelift.CfnScriptProps", jsii_struct_bases=[], name_mapping={'storage_location': 'storageLocation', 'name': 'name', 'version': 'version'})
class CfnScriptProps():
    def __init__(self, *, storage_location: typing.Union["CfnScript.S3LocationProperty", _IResolvable_9ceae33e], name: typing.Optional[str]=None, version: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def storage_location(self) -> typing.Union["CfnScript.S3LocationProperty", _IResolvable_9ceae33e]:
        """``AWS::GameLift::Script.StorageLocation``.
