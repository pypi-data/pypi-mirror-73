...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling_common.Alarms", jsii_struct_bases=[], name_mapping={'lower_alarm_interval_index': 'lowerAlarmIntervalIndex', 'upper_alarm_interval_index': 'upperAlarmIntervalIndex'})
class Alarms():
    def __init__(self, *, lower_alarm_interval_index: typing.Optional[jsii.Number]=None, upper_alarm_interval_index: typing.Optional[jsii.Number]=None) -> None:
        """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling_common.ArbitraryIntervals", jsii_struct_bases=[], name_mapping={'absolute': 'absolute', 'intervals': 'intervals'})
class ArbitraryIntervals():
    def __init__(self, *, absolute: bool, intervals: typing.List["ScalingInterval"]) -> None:
        """
        :param absolute: 
        :param intervals: 
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling_common.CompleteScalingInterval", jsii_struct_bases=[], name_mapping={'lower': 'lower', 'upper': 'upper', 'change': 'change'})
class CompleteScalingInterval():
    def __init__(self, *, lower: jsii.Number, upper: jsii.Number, change: typing.Optional[jsii.Number]=None) -> None:
        """
        :param lower: 
        :param upper: 
        :param change: 
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling_common.ScalingInterval", jsii_struct_bases=[], name_mapping={'change': 'change', 'lower': 'lower', 'upper': 'upper'})
