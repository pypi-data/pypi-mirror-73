...
class CfnDeliveryStream(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, delivery_stream_name: typing.Optional[str]=None, delivery_stream_type: typing.Optional[str]=None, elasticsearch_destination_configuration: typing.Optional[typing.Union["ElasticsearchDestinationConfigurationProperty", _IResolvable_9ceae33e]]=None, extended_s3_destination_configuration: typing.Optional[typing.Union["ExtendedS3DestinationConfigurationProperty", _IResolvable_9ceae33e]]=None, kinesis_stream_source_configuration: typing.Optional[typing.Union["KinesisStreamSourceConfigurationProperty", _IResolvable_9ceae33e]]=None, redshift_destination_configuration: typing.Optional[typing.Union["RedshiftDestinationConfigurationProperty", _IResolvable_9ceae33e]]=None, s3_destination_configuration: typing.Optional[typing.Union["S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]=None, splunk_destination_configuration: typing.Optional[typing.Union["SplunkDestinationConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDeliveryStream":
    ...
    def elasticsearch_destination_configuration(self) -> typing.Optional[typing.Union["ElasticsearchDestinationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def elasticsearch_destination_configuration(self, value: typing.Optional[typing.Union["ElasticsearchDestinationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "elasticsearchDestinationConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="extendedS3DestinationConfiguration")
    def extended_s3_destination_configuration(self) -> typing.Optional[typing.Union["ExtendedS3DestinationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def extended_s3_destination_configuration(self, value: typing.Optional[typing.Union["ExtendedS3DestinationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "extendedS3DestinationConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="kinesisStreamSourceConfiguration")
    def kinesis_stream_source_configuration(self) -> typing.Optional[typing.Union["KinesisStreamSourceConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def kinesis_stream_source_configuration(self, value: typing.Optional[typing.Union["KinesisStreamSourceConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "kinesisStreamSourceConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="redshiftDestinationConfiguration")
    def redshift_destination_configuration(self) -> typing.Optional[typing.Union["RedshiftDestinationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def redshift_destination_configuration(self, value: typing.Optional[typing.Union["RedshiftDestinationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "redshiftDestinationConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="s3DestinationConfiguration")
    def s3_destination_configuration(self) -> typing.Optional[typing.Union["S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def s3_destination_configuration(self, value: typing.Optional[typing.Union["S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "s3DestinationConfiguration", value)

    @builtins.property
    @jsii.member(jsii_name="splunkDestinationConfiguration")
    def splunk_destination_configuration(self) -> typing.Optional[typing.Union["SplunkDestinationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def splunk_destination_configuration(self, value: typing.Optional[typing.Union["SplunkDestinationConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "splunkDestinationConfiguration", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.BufferingHintsProperty", jsii_struct_bases=[], name_mapping={'interval_in_seconds': 'intervalInSeconds', 'size_in_m_bs': 'sizeInMBs'})
    class BufferingHintsProperty():
        def __init__(self, *, interval_in_seconds: typing.Optional[jsii.Number]=None, size_in_m_bs: typing.Optional[jsii.Number]=None) -> None:
            """
            ...
            if interval_in_seconds is not None: self._values["interval_in_seconds"] = interval_in_seconds
            if size_in_m_bs is not None: self._values["size_in_m_bs"] = size_in_m_bs
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.CloudWatchLoggingOptionsProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'log_group_name': 'logGroupName', 'log_stream_name': 'logStreamName'})
    class CloudWatchLoggingOptionsProperty():
        def __init__(self, *, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, log_group_name: typing.Optional[str]=None, log_stream_name: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.CopyCommandProperty", jsii_struct_bases=[], name_mapping={'data_table_name': 'dataTableName', 'copy_options': 'copyOptions', 'data_table_columns': 'dataTableColumns'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.DataFormatConversionConfigurationProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'input_format_configuration': 'inputFormatConfiguration', 'output_format_configuration': 'outputFormatConfiguration', 'schema_configuration': 'schemaConfiguration'})
    class DataFormatConversionConfigurationProperty():
        def __init__(self, *, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, input_format_configuration: typing.Optional[typing.Union["CfnDeliveryStream.InputFormatConfigurationProperty", _IResolvable_9ceae33e]]=None, output_format_configuration: typing.Optional[typing.Union["CfnDeliveryStream.OutputFormatConfigurationProperty", _IResolvable_9ceae33e]]=None, schema_configuration: typing.Optional[typing.Union["CfnDeliveryStream.SchemaConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if enabled is not None: self._values["enabled"] = enabled
            if input_format_configuration is not None: self._values["input_format_configuration"] = input_format_configuration
            if output_format_configuration is not None: self._values["output_format_configuration"] = output_format_configuration
            if schema_configuration is not None: self._values["schema_configuration"] = schema_configuration
        ...
        @builtins.property
        def input_format_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.InputFormatConfigurationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def output_format_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.OutputFormatConfigurationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def schema_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.SchemaConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.DeserializerProperty", jsii_struct_bases=[], name_mapping={'hive_json_ser_de': 'hiveJsonSerDe', 'open_x_json_ser_de': 'openXJsonSerDe'})
    class DeserializerProperty():
        def __init__(self, *, hive_json_ser_de: typing.Optional[typing.Union["CfnDeliveryStream.HiveJsonSerDeProperty", _IResolvable_9ceae33e]]=None, open_x_json_ser_de: typing.Optional[typing.Union["CfnDeliveryStream.OpenXJsonSerDeProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def hive_json_ser_de(self) -> typing.Optional[typing.Union["CfnDeliveryStream.HiveJsonSerDeProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def open_x_json_ser_de(self) -> typing.Optional[typing.Union["CfnDeliveryStream.OpenXJsonSerDeProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ElasticsearchBufferingHintsProperty", jsii_struct_bases=[], name_mapping={'interval_in_seconds': 'intervalInSeconds', 'size_in_m_bs': 'sizeInMBs'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ElasticsearchDestinationConfigurationProperty", jsii_struct_bases=[], name_mapping={'index_name': 'indexName', 'role_arn': 'roleArn', 's3_configuration': 's3Configuration', 'buffering_hints': 'bufferingHints', 'cloud_watch_logging_options': 'cloudWatchLoggingOptions', 'cluster_endpoint': 'clusterEndpoint', 'domain_arn': 'domainArn', 'index_rotation_period': 'indexRotationPeriod', 'processing_configuration': 'processingConfiguration', 'retry_options': 'retryOptions', 's3_backup_mode': 's3BackupMode', 'type_name': 'typeName', 'vpc_configuration': 'vpcConfiguration'})
    class ElasticsearchDestinationConfigurationProperty():
        def __init__(self, *, index_name: str, role_arn: str, s3_configuration: typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e], buffering_hints: typing.Optional[typing.Union["CfnDeliveryStream.ElasticsearchBufferingHintsProperty", _IResolvable_9ceae33e]]=None, cloud_watch_logging_options: typing.Optional[typing.Union["CfnDeliveryStream.CloudWatchLoggingOptionsProperty", _IResolvable_9ceae33e]]=None, cluster_endpoint: typing.Optional[str]=None, domain_arn: typing.Optional[str]=None, index_rotation_period: typing.Optional[str]=None, processing_configuration: typing.Optional[typing.Union["CfnDeliveryStream.ProcessingConfigurationProperty", _IResolvable_9ceae33e]]=None, retry_options: typing.Optional[typing.Union["CfnDeliveryStream.ElasticsearchRetryOptionsProperty", _IResolvable_9ceae33e]]=None, s3_backup_mode: typing.Optional[str]=None, type_name: typing.Optional[str]=None, vpc_configuration: typing.Optional[typing.Union["CfnDeliveryStream.VpcConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if buffering_hints is not None: self._values["buffering_hints"] = buffering_hints
            if cloud_watch_logging_options is not None: self._values["cloud_watch_logging_options"] = cloud_watch_logging_options
            if cluster_endpoint is not None: self._values["cluster_endpoint"] = cluster_endpoint
            if domain_arn is not None: self._values["domain_arn"] = domain_arn
            if index_rotation_period is not None: self._values["index_rotation_period"] = index_rotation_period
            ...
            if type_name is not None: self._values["type_name"] = type_name
        ...
        @builtins.property
        def s3_configuration(self) -> typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def buffering_hints(self) -> typing.Optional[typing.Union["CfnDeliveryStream.ElasticsearchBufferingHintsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def cloud_watch_logging_options(self) -> typing.Optional[typing.Union["CfnDeliveryStream.CloudWatchLoggingOptionsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def processing_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.ProcessingConfigurationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def retry_options(self) -> typing.Optional[typing.Union["CfnDeliveryStream.ElasticsearchRetryOptionsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def vpc_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.VpcConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ElasticsearchRetryOptionsProperty", jsii_struct_bases=[], name_mapping={'duration_in_seconds': 'durationInSeconds'})
    class ElasticsearchRetryOptionsProperty():
        def __init__(self, *, duration_in_seconds: typing.Optional[jsii.Number]=None) -> None:
            """
            ...
            if duration_in_seconds is not None: self._values["duration_in_seconds"] = duration_in_seconds
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.EncryptionConfigurationProperty", jsii_struct_bases=[], name_mapping={'kms_encryption_config': 'kmsEncryptionConfig', 'no_encryption_config': 'noEncryptionConfig'})
    class EncryptionConfigurationProperty():
        def __init__(self, *, kms_encryption_config: typing.Optional[typing.Union["CfnDeliveryStream.KMSEncryptionConfigProperty", _IResolvable_9ceae33e]]=None, no_encryption_config: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def kms_encryption_config(self) -> typing.Optional[typing.Union["CfnDeliveryStream.KMSEncryptionConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ExtendedS3DestinationConfigurationProperty", jsii_struct_bases=[], name_mapping={'bucket_arn': 'bucketArn', 'role_arn': 'roleArn', 'buffering_hints': 'bufferingHints', 'cloud_watch_logging_options': 'cloudWatchLoggingOptions', 'compression_format': 'compressionFormat', 'data_format_conversion_configuration': 'dataFormatConversionConfiguration', 'encryption_configuration': 'encryptionConfiguration', 'error_output_prefix': 'errorOutputPrefix', 'prefix': 'prefix', 'processing_configuration': 'processingConfiguration', 's3_backup_configuration': 's3BackupConfiguration', 's3_backup_mode': 's3BackupMode'})
    class ExtendedS3DestinationConfigurationProperty():
        def __init__(self, *, bucket_arn: str, role_arn: str, buffering_hints: typing.Optional[typing.Union["CfnDeliveryStream.BufferingHintsProperty", _IResolvable_9ceae33e]]=None, cloud_watch_logging_options: typing.Optional[typing.Union["CfnDeliveryStream.CloudWatchLoggingOptionsProperty", _IResolvable_9ceae33e]]=None, compression_format: typing.Optional[str]=None, data_format_conversion_configuration: typing.Optional[typing.Union["CfnDeliveryStream.DataFormatConversionConfigurationProperty", _IResolvable_9ceae33e]]=None, encryption_configuration: typing.Optional[typing.Union["CfnDeliveryStream.EncryptionConfigurationProperty", _IResolvable_9ceae33e]]=None, error_output_prefix: typing.Optional[str]=None, prefix: typing.Optional[str]=None, processing_configuration: typing.Optional[typing.Union["CfnDeliveryStream.ProcessingConfigurationProperty", _IResolvable_9ceae33e]]=None, s3_backup_configuration: typing.Optional[typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]=None, s3_backup_mode: typing.Optional[str]=None) -> None:
            """
            ...
            if buffering_hints is not None: self._values["buffering_hints"] = buffering_hints
            if cloud_watch_logging_options is not None: self._values["cloud_watch_logging_options"] = cloud_watch_logging_options
            if compression_format is not None: self._values["compression_format"] = compression_format
        ...
        @builtins.property
        def buffering_hints(self) -> typing.Optional[typing.Union["CfnDeliveryStream.BufferingHintsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def data_format_conversion_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.DataFormatConversionConfigurationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def encryption_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.EncryptionConfigurationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def s3_backup_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.HiveJsonSerDeProperty", jsii_struct_bases=[], name_mapping={'timestamp_formats': 'timestampFormats'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.InputFormatConfigurationProperty", jsii_struct_bases=[], name_mapping={'deserializer': 'deserializer'})
    class InputFormatConfigurationProperty():
        def __init__(self, *, deserializer: typing.Optional[typing.Union["CfnDeliveryStream.DeserializerProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if deserializer is not None: self._values["deserializer"] = deserializer

        @builtins.property
        def deserializer(self) -> typing.Optional[typing.Union["CfnDeliveryStream.DeserializerProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.KMSEncryptionConfigProperty", jsii_struct_bases=[], name_mapping={'awskms_key_arn': 'awskmsKeyArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.KinesisStreamSourceConfigurationProperty", jsii_struct_bases=[], name_mapping={'kinesis_stream_arn': 'kinesisStreamArn', 'role_arn': 'roleArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.OpenXJsonSerDeProperty", jsii_struct_bases=[], name_mapping={'case_insensitive': 'caseInsensitive', 'column_to_json_key_mappings': 'columnToJsonKeyMappings', 'convert_dots_in_json_keys_to_underscores': 'convertDotsInJsonKeysToUnderscores'})
    class OpenXJsonSerDeProperty():
        def __init__(self, *, case_insensitive: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, column_to_json_key_mappings: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, convert_dots_in_json_keys_to_underscores: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def case_insensitive(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def column_to_json_key_mappings(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]:
        ...
        @builtins.property
        def convert_dots_in_json_keys_to_underscores(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    class OrcSerDeProperty():
        ...
        @builtins.property
        def enable_padding(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.OutputFormatConfigurationProperty", jsii_struct_bases=[], name_mapping={'serializer': 'serializer'})
    class OutputFormatConfigurationProperty():
        def __init__(self, *, serializer: typing.Optional[typing.Union["CfnDeliveryStream.SerializerProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if serializer is not None: self._values["serializer"] = serializer

        @builtins.property
        def serializer(self) -> typing.Optional[typing.Union["CfnDeliveryStream.SerializerProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ParquetSerDeProperty", jsii_struct_bases=[], name_mapping={'block_size_bytes': 'blockSizeBytes', 'compression': 'compression', 'enable_dictionary_compression': 'enableDictionaryCompression', 'max_padding_bytes': 'maxPaddingBytes', 'page_size_bytes': 'pageSizeBytes', 'writer_version': 'writerVersion'})
    class ParquetSerDeProperty():
        def __init__(self, *, block_size_bytes: typing.Optional[jsii.Number]=None, compression: typing.Optional[str]=None, enable_dictionary_compression: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, max_padding_bytes: typing.Optional[jsii.Number]=None, page_size_bytes: typing.Optional[jsii.Number]=None, writer_version: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def enable_dictionary_compression(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ProcessingConfigurationProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'processors': 'processors'})
    class ProcessingConfigurationProperty():
        def __init__(self, *, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, processors: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDeliveryStream.ProcessorProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def processors(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDeliveryStream.ProcessorProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ProcessorParameterProperty", jsii_struct_bases=[], name_mapping={'parameter_name': 'parameterName', 'parameter_value': 'parameterValue'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.ProcessorProperty", jsii_struct_bases=[], name_mapping={'type': 'type', 'parameters': 'parameters'})
    class ProcessorProperty():
        def __init__(self, *, type: str, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDeliveryStream.ProcessorParameterProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def parameters(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDeliveryStream.ProcessorParameterProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.RedshiftDestinationConfigurationProperty", jsii_struct_bases=[], name_mapping={'cluster_jdbcurl': 'clusterJdbcurl', 'copy_command': 'copyCommand', 'password': 'password', 'role_arn': 'roleArn', 's3_configuration': 's3Configuration', 'username': 'username', 'cloud_watch_logging_options': 'cloudWatchLoggingOptions', 'processing_configuration': 'processingConfiguration', 'retry_options': 'retryOptions', 's3_backup_configuration': 's3BackupConfiguration', 's3_backup_mode': 's3BackupMode'})
    class RedshiftDestinationConfigurationProperty():
        def __init__(self, *, cluster_jdbcurl: str, copy_command: typing.Union["CfnDeliveryStream.CopyCommandProperty", _IResolvable_9ceae33e], password: str, role_arn: str, s3_configuration: typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e], username: str, cloud_watch_logging_options: typing.Optional[typing.Union["CfnDeliveryStream.CloudWatchLoggingOptionsProperty", _IResolvable_9ceae33e]]=None, processing_configuration: typing.Optional[typing.Union["CfnDeliveryStream.ProcessingConfigurationProperty", _IResolvable_9ceae33e]]=None, retry_options: typing.Optional[typing.Union["CfnDeliveryStream.RedshiftRetryOptionsProperty", _IResolvable_9ceae33e]]=None, s3_backup_configuration: typing.Optional[typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]=None, s3_backup_mode: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def copy_command(self) -> typing.Union["CfnDeliveryStream.CopyCommandProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def retry_options(self) -> typing.Optional[typing.Union["CfnDeliveryStream.RedshiftRetryOptionsProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.RedshiftRetryOptionsProperty", jsii_struct_bases=[], name_mapping={'duration_in_seconds': 'durationInSeconds'})
    class RedshiftRetryOptionsProperty():
        ...
        def __repr__(self) -> str:
            return 'RedshiftRetryOptionsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.S3DestinationConfigurationProperty", jsii_struct_bases=[], name_mapping={'bucket_arn': 'bucketArn', 'role_arn': 'roleArn', 'buffering_hints': 'bufferingHints', 'cloud_watch_logging_options': 'cloudWatchLoggingOptions', 'compression_format': 'compressionFormat', 'encryption_configuration': 'encryptionConfiguration', 'error_output_prefix': 'errorOutputPrefix', 'prefix': 'prefix'})
    class S3DestinationConfigurationProperty():
        def __init__(self, *, bucket_arn: str, role_arn: str, buffering_hints: typing.Optional[typing.Union["CfnDeliveryStream.BufferingHintsProperty", _IResolvable_9ceae33e]]=None, cloud_watch_logging_options: typing.Optional[typing.Union["CfnDeliveryStream.CloudWatchLoggingOptionsProperty", _IResolvable_9ceae33e]]=None, compression_format: typing.Optional[str]=None, encryption_configuration: typing.Optional[typing.Union["CfnDeliveryStream.EncryptionConfigurationProperty", _IResolvable_9ceae33e]]=None, error_output_prefix: typing.Optional[str]=None, prefix: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.SchemaConfigurationProperty", jsii_struct_bases=[], name_mapping={'catalog_id': 'catalogId', 'database_name': 'databaseName', 'region': 'region', 'role_arn': 'roleArn', 'table_name': 'tableName', 'version_id': 'versionId'})
    class SchemaConfigurationProperty():
        def __init__(self, *, catalog_id: typing.Optional[str]=None, database_name: typing.Optional[str]=None, region: typing.Optional[str]=None, role_arn: typing.Optional[str]=None, table_name: typing.Optional[str]=None, version_id: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.SerializerProperty", jsii_struct_bases=[], name_mapping={'orc_ser_de': 'orcSerDe', 'parquet_ser_de': 'parquetSerDe'})
    class SerializerProperty():
        def __init__(self, *, orc_ser_de: typing.Optional[typing.Union["CfnDeliveryStream.OrcSerDeProperty", _IResolvable_9ceae33e]]=None, parquet_ser_de: typing.Optional[typing.Union["CfnDeliveryStream.ParquetSerDeProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def orc_ser_de(self) -> typing.Optional[typing.Union["CfnDeliveryStream.OrcSerDeProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def parquet_ser_de(self) -> typing.Optional[typing.Union["CfnDeliveryStream.ParquetSerDeProperty", _IResolvable_9ceae33e]]:
    ...
    class SplunkDestinationConfigurationProperty():
        ...
        @builtins.property
        def retry_options(self) -> typing.Optional[typing.Union["CfnDeliveryStream.SplunkRetryOptionsProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.SplunkRetryOptionsProperty", jsii_struct_bases=[], name_mapping={'duration_in_seconds': 'durationInSeconds'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_kinesisfirehose.CfnDeliveryStream.VpcConfigurationProperty", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'security_group_ids': 'securityGroupIds', 'subnet_ids': 'subnetIds'})
    class VpcConfigurationProperty():
        def __init__(self, *, role_arn: str, security_group_ids: typing.List[str], subnet_ids: typing.List[str]) -> None:
            """
...
class CfnDeliveryStreamProps():
    ...
    @builtins.property
    def elasticsearch_destination_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.ElasticsearchDestinationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::KinesisFirehose::DeliveryStream.ElasticsearchDestinationConfiguration``.
    ...
    @builtins.property
    def extended_s3_destination_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.ExtendedS3DestinationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::KinesisFirehose::DeliveryStream.ExtendedS3DestinationConfiguration``.
    ...
    @builtins.property
    def kinesis_stream_source_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.KinesisStreamSourceConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::KinesisFirehose::DeliveryStream.KinesisStreamSourceConfiguration``.
    ...
    @builtins.property
    def redshift_destination_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.RedshiftDestinationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::KinesisFirehose::DeliveryStream.RedshiftDestinationConfiguration``.
    ...
    @builtins.property
    def s3_destination_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.S3DestinationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::KinesisFirehose::DeliveryStream.S3DestinationConfiguration``.
    ...
    @builtins.property
    def splunk_destination_configuration(self) -> typing.Optional[typing.Union["CfnDeliveryStream.SplunkDestinationConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::KinesisFirehose::DeliveryStream.SplunkDestinationConfiguration``.
