...
from ..aws_ec2 import (InstanceType as _InstanceType_85a97b30, Connections as _Connections_231f38b5, IConnectable as _IConnectable_a587039f, IVpc as _IVpc_3795853f, SubnetSelection as _SubnetSelection_36a13cd6, ISecurityGroup as _ISecurityGroup_d72ab8e8)
...
from ..aws_ecs import (ICluster as _ICluster_5cbcc408, TaskDefinition as _TaskDefinition_acfbb011, ContainerDefinition as _ContainerDefinition_1517aa7f, PlacementConstraint as _PlacementConstraint_dc6aebd4, PlacementStrategy as _PlacementStrategy_e3f6282b, FargatePlatformVersion as _FargatePlatformVersion_187ad0f4, ITaskDefinition as _ITaskDefinition_52b5da05)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.ContainerOverride", jsii_struct_bases=[], name_mapping={'container_definition': 'containerDefinition', 'command': 'command', 'cpu': 'cpu', 'environment': 'environment', 'memory_limit': 'memoryLimit', 'memory_reservation': 'memoryReservation'})
class ContainerOverride():
    def __init__(self, *, container_definition: _ContainerDefinition_1517aa7f, command: typing.Optional[typing.List[str]]=None, cpu: typing.Optional[jsii.Number]=None, environment: typing.Optional[typing.List["TaskEnvironmentVariable"]]=None, memory_limit: typing.Optional[jsii.Number]=None, memory_reservation: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsEc2LaunchTargetOptions", jsii_struct_bases=[], name_mapping={'placement_constraints': 'placementConstraints', 'placement_strategies': 'placementStrategies'})
class EcsEc2LaunchTargetOptions():
    def __init__(self, *, placement_constraints: typing.Optional[typing.List[_PlacementConstraint_dc6aebd4]]=None, placement_strategies: typing.Optional[typing.List[_PlacementStrategy_e3f6282b]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsFargateLaunchTargetOptions", jsii_struct_bases=[], name_mapping={'platform_version': 'platformVersion'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsLaunchTargetConfig", jsii_struct_bases=[], name_mapping={'parameters': 'parameters'})
...
class EcsRunTask(_TaskStateBase_bbd9d4f5, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsRunTask"):
    """Run a Task on ECS or Fargate.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cluster: _ICluster_5cbcc408, launch_target: "IEcsLaunchTarget", task_definition: _TaskDefinition_acfbb011, assign_public_ip: typing.Optional[bool]=None, container_overrides: typing.Optional[typing.List["ContainerOverride"]]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, subnets: typing.Optional[_SubnetSelection_36a13cd6]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[_Duration_5170c158]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[_IntegrationPattern_8cb2dd13]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsRunTaskProps", jsii_struct_bases=[_TaskStateBaseProps_b4aabf90], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster': 'cluster', 'launch_target': 'launchTarget', 'task_definition': 'taskDefinition', 'assign_public_ip': 'assignPublicIp', 'container_overrides': 'containerOverrides', 'security_groups': 'securityGroups', 'subnets': 'subnets'})
class EcsRunTaskProps(_TaskStateBaseProps_b4aabf90):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[_Duration_5170c158]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[_IntegrationPattern_8cb2dd13]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None, cluster: _ICluster_5cbcc408, launch_target: "IEcsLaunchTarget", task_definition: _TaskDefinition_acfbb011, assign_public_ip: typing.Optional[bool]=None, container_overrides: typing.Optional[typing.List["ContainerOverride"]]=None, security_groups: typing.Optional[typing.List[_ISecurityGroup_d72ab8e8]]=None, subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
...
class EvaluateExpression(_TaskStateBase_bbd9d4f5, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EvaluateExpression"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, expression: str, runtime: typing.Optional[_Runtime_8b970b80]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[_Duration_5170c158]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[_IntegrationPattern_8cb2dd13]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EvaluateExpressionProps", jsii_struct_bases=[_TaskStateBaseProps_b4aabf90], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'expression': 'expression', 'runtime': 'runtime'})
class EvaluateExpressionProps(_TaskStateBaseProps_b4aabf90):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[_Duration_5170c158]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[_IntegrationPattern_8cb2dd13]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None, expression: str, runtime: typing.Optional[_Runtime_8b970b80]=None) -> None:
...
class IEcsLaunchTarget(jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, task: "EcsRunTask", *, task_definition: _ITaskDefinition_52b5da05, cluster: typing.Optional[_ICluster_5cbcc408]=None) -> "EcsLaunchTargetConfig":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.LaunchTargetBindOptions", jsii_struct_bases=[], name_mapping={'task_definition': 'taskDefinition', 'cluster': 'cluster'})
class LaunchTargetBindOptions():
    def __init__(self, *, task_definition: _ITaskDefinition_52b5da05, cluster: typing.Optional[_ICluster_5cbcc408]=None) -> None:
...
class EcsEc2LaunchTarget(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsEc2LaunchTarget"):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, _task: "EcsRunTask", *, task_definition: _ITaskDefinition_52b5da05, cluster: typing.Optional[_ICluster_5cbcc408]=None) -> "EcsLaunchTargetConfig":
...
@jsii.implements(IEcsLaunchTarget)
class EcsFargateLaunchTarget(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EcsFargateLaunchTarget"):
