...
from .. import (Construct as _Construct_f50a3f53, IResolvable as _IResolvable_9ceae33e, CfnResource as _CfnResource_7760e8e4, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IInspectable as _IInspectable_051e6ed8, TagManager as _TagManager_2508893f, CfnTag as _CfnTag_b4661f1a)
from ..aws_cognito import (IUserPool as _IUserPool_e9547b0f)
from ..aws_dynamodb import (Table as _Table_208d82dc)
from ..aws_iam import (IPrincipal as _IPrincipal_97126874, IGrantable as _IGrantable_0fcfc53a, IRole as _IRole_e69bbae4)
from ..aws_lambda import (IFunction as _IFunction_1c1de0bc)


@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.ApiKeyConfig", jsii_struct_bases=[], name_mapping={'description': 'description', 'expires': 'expires', 'name': 'name'})
class ApiKeyConfig():
    def __init__(self, *, description: typing.Optional[str]=None, expires: typing.Optional[str]=None, name: typing.Optional[str]=None) -> None:
...
class Assign(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.Assign"):
...
class AttributeValues(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.AttributeValues"):
...
class AttributeValuesStep(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.AttributeValuesStep"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.AuthorizationConfig", jsii_struct_bases=[], name_mapping={'additional_authorization_modes': 'additionalAuthorizationModes', 'default_authorization': 'defaultAuthorization'})
class AuthorizationConfig():
    def __init__(self, *, additional_authorization_modes: typing.Optional[typing.List["AuthorizationMode"]]=None, default_authorization: typing.Optional["AuthorizationMode"]=None) -> None:
        ...
        :stability: experimental
        """
        if isinstance(default_authorization, dict): default_authorization = AuthorizationMode(**default_authorization)
        self._values = {
        }
    ...
    @builtins.property
    def additional_authorization_modes(self) -> typing.Optional[typing.List["AuthorizationMode"]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.AuthorizationMode", jsii_struct_bases=[], name_mapping={'authorization_type': 'authorizationType', 'api_key_config': 'apiKeyConfig', 'open_id_connect_config': 'openIdConnectConfig', 'user_pool_config': 'userPoolConfig'})
class AuthorizationMode():
    def __init__(self, *, authorization_type: "AuthorizationType", api_key_config: typing.Optional["ApiKeyConfig"]=None, open_id_connect_config: typing.Optional["OpenIdConnectConfig"]=None, user_pool_config: typing.Optional["UserPoolConfig"]=None) -> None:
        ...
        :stability: experimental
        """
        if isinstance(api_key_config, dict): api_key_config = ApiKeyConfig(**api_key_config)
        if isinstance(open_id_connect_config, dict): open_id_connect_config = OpenIdConnectConfig(**open_id_connect_config)
        if isinstance(user_pool_config, dict): user_pool_config = UserPoolConfig(**user_pool_config)
        self._values = {
            'authorization_type': authorization_type,
        }
        if api_key_config is not None: self._values["api_key_config"] = api_key_config
    ...
    def __repr__(self) -> str:
        return 'AuthorizationMode(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class BaseDataSource(_Construct_f50a3f53, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_appsync.BaseDataSource"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, props: "BackedDataSourceProps", *, type: str, dynamo_db_config: typing.Optional[typing.Union["CfnDataSource.DynamoDBConfigProperty", _IResolvable_9ceae33e]]=None, elasticsearch_config: typing.Optional[typing.Union["CfnDataSource.ElasticsearchConfigProperty", _IResolvable_9ceae33e]]=None, http_config: typing.Optional[typing.Union["CfnDataSource.HttpConfigProperty", _IResolvable_9ceae33e]]=None, lambda_config: typing.Optional[typing.Union["CfnDataSource.LambdaConfigProperty", _IResolvable_9ceae33e]]=None, relational_database_config: typing.Optional[typing.Union["CfnDataSource.RelationalDatabaseConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param props: -
    ...
    def create_resolver(self, *, field_name: str, type_name: str, pipeline_config: typing.Optional[typing.Union["CfnResolver.PipelineConfigProperty", _IResolvable_9ceae33e]]=None, request_mapping_template: typing.Optional["MappingTemplate"]=None, response_mapping_template: typing.Optional["MappingTemplate"]=None) -> "Resolver":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.BaseDataSourceProps", jsii_struct_bases=[], name_mapping={'api': 'api', 'name': 'name', 'description': 'description'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.BaseResolverProps", jsii_struct_bases=[], name_mapping={'field_name': 'fieldName', 'type_name': 'typeName', 'pipeline_config': 'pipelineConfig', 'request_mapping_template': 'requestMappingTemplate', 'response_mapping_template': 'responseMappingTemplate'})
class BaseResolverProps():
    def __init__(self, *, field_name: str, type_name: str, pipeline_config: typing.Optional[typing.Union["CfnResolver.PipelineConfigProperty", _IResolvable_9ceae33e]]=None, request_mapping_template: typing.Optional["MappingTemplate"]=None, response_mapping_template: typing.Optional["MappingTemplate"]=None) -> None:
    ...
    @builtins.property
    def pipeline_config(self) -> typing.Optional[typing.Union["CfnResolver.PipelineConfigProperty", _IResolvable_9ceae33e]]:
...
class CfnApiCache(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnApiCache"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_caching_behavior: str, api_id: str, ttl: jsii.Number, type: str, at_rest_encryption_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, transit_encryption_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnApiCache":
    ...
    def at_rest_encryption_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def at_rest_encryption_enabled(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "atRestEncryptionEnabled", value)

    @builtins.property
    @jsii.member(jsii_name="transitEncryptionEnabled")
    def transit_encryption_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def transit_encryption_enabled(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "transitEncryptionEnabled", value)


@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnApiCacheProps", jsii_struct_bases=[], name_mapping={'api_caching_behavior': 'apiCachingBehavior', 'api_id': 'apiId', 'ttl': 'ttl', 'type': 'type', 'at_rest_encryption_enabled': 'atRestEncryptionEnabled', 'transit_encryption_enabled': 'transitEncryptionEnabled'})
class CfnApiCacheProps():
    def __init__(self, *, api_caching_behavior: str, api_id: str, ttl: jsii.Number, type: str, at_rest_encryption_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, transit_encryption_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnApiKey(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnApiKey"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, description: typing.Optional[str]=None, expires: typing.Optional[jsii.Number]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnApiKey":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnApiKeyProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'description': 'description', 'expires': 'expires'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnDataSource(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnDataSource"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, name: str, type: str, description: typing.Optional[str]=None, dynamo_db_config: typing.Optional[typing.Union["DynamoDBConfigProperty", _IResolvable_9ceae33e]]=None, elasticsearch_config: typing.Optional[typing.Union["ElasticsearchConfigProperty", _IResolvable_9ceae33e]]=None, http_config: typing.Optional[typing.Union["HttpConfigProperty", _IResolvable_9ceae33e]]=None, lambda_config: typing.Optional[typing.Union["LambdaConfigProperty", _IResolvable_9ceae33e]]=None, relational_database_config: typing.Optional[typing.Union["RelationalDatabaseConfigProperty", _IResolvable_9ceae33e]]=None, service_role_arn: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDataSource":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def dynamo_db_config(self) -> typing.Optional[typing.Union["DynamoDBConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def dynamo_db_config(self, value: typing.Optional[typing.Union["DynamoDBConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "dynamoDbConfig", value)

    @builtins.property
    @jsii.member(jsii_name="elasticsearchConfig")
    def elasticsearch_config(self) -> typing.Optional[typing.Union["ElasticsearchConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def elasticsearch_config(self, value: typing.Optional[typing.Union["ElasticsearchConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "elasticsearchConfig", value)

    @builtins.property
    @jsii.member(jsii_name="httpConfig")
    def http_config(self) -> typing.Optional[typing.Union["HttpConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @http_config.setter
    def http_config(self, value: typing.Optional[typing.Union["HttpConfigProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def relational_database_config(self) -> typing.Optional[typing.Union["RelationalDatabaseConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def relational_database_config(self, value: typing.Optional[typing.Union["RelationalDatabaseConfigProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.AuthorizationConfigProperty", jsii_struct_bases=[], name_mapping={'authorization_type': 'authorizationType', 'aws_iam_config': 'awsIamConfig'})
    class AuthorizationConfigProperty():
        def __init__(self, *, authorization_type: str, aws_iam_config: typing.Optional[typing.Union["CfnDataSource.AwsIamConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def aws_iam_config(self) -> typing.Optional[typing.Union["CfnDataSource.AwsIamConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.AwsIamConfigProperty", jsii_struct_bases=[], name_mapping={'signing_region': 'signingRegion', 'signing_service_name': 'signingServiceName'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.DeltaSyncConfigProperty", jsii_struct_bases=[], name_mapping={'base_table_ttl': 'baseTableTtl', 'delta_sync_table_name': 'deltaSyncTableName', 'delta_sync_table_ttl': 'deltaSyncTableTtl'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.DynamoDBConfigProperty", jsii_struct_bases=[], name_mapping={'aws_region': 'awsRegion', 'table_name': 'tableName', 'delta_sync_config': 'deltaSyncConfig', 'use_caller_credentials': 'useCallerCredentials', 'versioned': 'versioned'})
    class DynamoDBConfigProperty():
        def __init__(self, *, aws_region: str, table_name: str, delta_sync_config: typing.Optional[typing.Union["CfnDataSource.DeltaSyncConfigProperty", _IResolvable_9ceae33e]]=None, use_caller_credentials: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, versioned: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def delta_sync_config(self) -> typing.Optional[typing.Union["CfnDataSource.DeltaSyncConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def use_caller_credentials(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def versioned(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.ElasticsearchConfigProperty", jsii_struct_bases=[], name_mapping={'aws_region': 'awsRegion', 'endpoint': 'endpoint'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.HttpConfigProperty", jsii_struct_bases=[], name_mapping={'endpoint': 'endpoint', 'authorization_config': 'authorizationConfig'})
    class HttpConfigProperty():
        def __init__(self, *, endpoint: str, authorization_config: typing.Optional[typing.Union["CfnDataSource.AuthorizationConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def authorization_config(self) -> typing.Optional[typing.Union["CfnDataSource.AuthorizationConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.LambdaConfigProperty", jsii_struct_bases=[], name_mapping={'lambda_function_arn': 'lambdaFunctionArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.RdsHttpEndpointConfigProperty", jsii_struct_bases=[], name_mapping={'aws_region': 'awsRegion', 'aws_secret_store_arn': 'awsSecretStoreArn', 'db_cluster_identifier': 'dbClusterIdentifier', 'database_name': 'databaseName', 'schema': 'schema'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSource.RelationalDatabaseConfigProperty", jsii_struct_bases=[], name_mapping={'relational_database_source_type': 'relationalDatabaseSourceType', 'rds_http_endpoint_config': 'rdsHttpEndpointConfig'})
    class RelationalDatabaseConfigProperty():
        def __init__(self, *, relational_database_source_type: str, rds_http_endpoint_config: typing.Optional[typing.Union["CfnDataSource.RdsHttpEndpointConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def rds_http_endpoint_config(self) -> typing.Optional[typing.Union["CfnDataSource.RdsHttpEndpointConfigProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnDataSourceProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'name': 'name', 'type': 'type', 'description': 'description', 'dynamo_db_config': 'dynamoDbConfig', 'elasticsearch_config': 'elasticsearchConfig', 'http_config': 'httpConfig', 'lambda_config': 'lambdaConfig', 'relational_database_config': 'relationalDatabaseConfig', 'service_role_arn': 'serviceRoleArn'})
class CfnDataSourceProps():
    def __init__(self, *, api_id: str, name: str, type: str, description: typing.Optional[str]=None, dynamo_db_config: typing.Optional[typing.Union["CfnDataSource.DynamoDBConfigProperty", _IResolvable_9ceae33e]]=None, elasticsearch_config: typing.Optional[typing.Union["CfnDataSource.ElasticsearchConfigProperty", _IResolvable_9ceae33e]]=None, http_config: typing.Optional[typing.Union["CfnDataSource.HttpConfigProperty", _IResolvable_9ceae33e]]=None, lambda_config: typing.Optional[typing.Union["CfnDataSource.LambdaConfigProperty", _IResolvable_9ceae33e]]=None, relational_database_config: typing.Optional[typing.Union["CfnDataSource.RelationalDatabaseConfigProperty", _IResolvable_9ceae33e]]=None, service_role_arn: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def dynamo_db_config(self) -> typing.Optional[typing.Union["CfnDataSource.DynamoDBConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::DataSource.DynamoDBConfig``.
    ...
    @builtins.property
    def elasticsearch_config(self) -> typing.Optional[typing.Union["CfnDataSource.ElasticsearchConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::DataSource.ElasticsearchConfig``.
    ...
    @builtins.property
    def http_config(self) -> typing.Optional[typing.Union["CfnDataSource.HttpConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::DataSource.HttpConfig``.
    ...
    @builtins.property
    def lambda_config(self) -> typing.Optional[typing.Union["CfnDataSource.LambdaConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::DataSource.LambdaConfig``.
    ...
    @builtins.property
    def relational_database_config(self) -> typing.Optional[typing.Union["CfnDataSource.RelationalDatabaseConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::DataSource.RelationalDatabaseConfig``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnFunctionConfiguration(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnFunctionConfiguration"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnFunctionConfiguration":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def response_mapping_template_s3_location(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "responseMappingTemplateS3Location", value)


@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnFunctionConfigurationProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'data_source_name': 'dataSourceName', 'function_version': 'functionVersion', 'name': 'name', 'description': 'description', 'request_mapping_template': 'requestMappingTemplate', 'request_mapping_template_s3_location': 'requestMappingTemplateS3Location', 'response_mapping_template': 'responseMappingTemplate', 'response_mapping_template_s3_location': 'responseMappingTemplateS3Location'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnGraphQLApi(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApi"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, authentication_type: str, name: str, additional_authentication_providers: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["AdditionalAuthenticationProviderProperty", _IResolvable_9ceae33e]]]]=None, log_config: typing.Optional[typing.Union["LogConfigProperty", _IResolvable_9ceae33e]]=None, open_id_connect_config: typing.Optional[typing.Union["OpenIDConnectConfigProperty", _IResolvable_9ceae33e]]=None, tags: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union[_IResolvable_9ceae33e, _CfnTag_b4661f1a]]]]=None, user_pool_config: typing.Optional[typing.Union["UserPoolConfigProperty", _IResolvable_9ceae33e]]=None, xray_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnGraphQLApi":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def additional_authentication_providers(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["AdditionalAuthenticationProviderProperty", _IResolvable_9ceae33e]]]]:
    ...
    def additional_authentication_providers(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["AdditionalAuthenticationProviderProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "additionalAuthenticationProviders", value)

    @builtins.property
    @jsii.member(jsii_name="logConfig")
    def log_config(self) -> typing.Optional[typing.Union["LogConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @log_config.setter
    def log_config(self, value: typing.Optional[typing.Union["LogConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "logConfig", value)

    @builtins.property
    @jsii.member(jsii_name="openIdConnectConfig")
    def open_id_connect_config(self) -> typing.Optional[typing.Union["OpenIDConnectConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def open_id_connect_config(self, value: typing.Optional[typing.Union["OpenIDConnectConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "openIdConnectConfig", value)

    @builtins.property
    @jsii.member(jsii_name="userPoolConfig")
    def user_pool_config(self) -> typing.Optional[typing.Union["UserPoolConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def user_pool_config(self, value: typing.Optional[typing.Union["UserPoolConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "userPoolConfig", value)

    @builtins.property
    @jsii.member(jsii_name="xrayEnabled")
    def xray_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @xray_enabled.setter
    def xray_enabled(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "xrayEnabled", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApi.AdditionalAuthenticationProviderProperty", jsii_struct_bases=[], name_mapping={'authentication_type': 'authenticationType', 'open_id_connect_config': 'openIdConnectConfig', 'user_pool_config': 'userPoolConfig'})
    class AdditionalAuthenticationProviderProperty():
        def __init__(self, *, authentication_type: str, open_id_connect_config: typing.Optional[typing.Union["CfnGraphQLApi.OpenIDConnectConfigProperty", _IResolvable_9ceae33e]]=None, user_pool_config: typing.Optional[typing.Union["CfnGraphQLApi.CognitoUserPoolConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def open_id_connect_config(self) -> typing.Optional[typing.Union["CfnGraphQLApi.OpenIDConnectConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def user_pool_config(self) -> typing.Optional[typing.Union["CfnGraphQLApi.CognitoUserPoolConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApi.CognitoUserPoolConfigProperty", jsii_struct_bases=[], name_mapping={'app_id_client_regex': 'appIdClientRegex', 'aws_region': 'awsRegion', 'user_pool_id': 'userPoolId'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApi.LogConfigProperty", jsii_struct_bases=[], name_mapping={'cloud_watch_logs_role_arn': 'cloudWatchLogsRoleArn', 'exclude_verbose_content': 'excludeVerboseContent', 'field_log_level': 'fieldLogLevel'})
    class LogConfigProperty():
        def __init__(self, *, cloud_watch_logs_role_arn: typing.Optional[str]=None, exclude_verbose_content: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, field_log_level: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def exclude_verbose_content(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApi.OpenIDConnectConfigProperty", jsii_struct_bases=[], name_mapping={'auth_ttl': 'authTtl', 'client_id': 'clientId', 'iat_ttl': 'iatTtl', 'issuer': 'issuer'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApi.UserPoolConfigProperty", jsii_struct_bases=[], name_mapping={'app_id_client_regex': 'appIdClientRegex', 'aws_region': 'awsRegion', 'default_action': 'defaultAction', 'user_pool_id': 'userPoolId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLApiProps", jsii_struct_bases=[], name_mapping={'authentication_type': 'authenticationType', 'name': 'name', 'additional_authentication_providers': 'additionalAuthenticationProviders', 'log_config': 'logConfig', 'open_id_connect_config': 'openIdConnectConfig', 'tags': 'tags', 'user_pool_config': 'userPoolConfig', 'xray_enabled': 'xrayEnabled'})
class CfnGraphQLApiProps():
    def __init__(self, *, authentication_type: str, name: str, additional_authentication_providers: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnGraphQLApi.AdditionalAuthenticationProviderProperty", _IResolvable_9ceae33e]]]]=None, log_config: typing.Optional[typing.Union["CfnGraphQLApi.LogConfigProperty", _IResolvable_9ceae33e]]=None, open_id_connect_config: typing.Optional[typing.Union["CfnGraphQLApi.OpenIDConnectConfigProperty", _IResolvable_9ceae33e]]=None, tags: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union[_IResolvable_9ceae33e, _CfnTag_b4661f1a]]]]=None, user_pool_config: typing.Optional[typing.Union["CfnGraphQLApi.UserPoolConfigProperty", _IResolvable_9ceae33e]]=None, xray_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def additional_authentication_providers(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnGraphQLApi.AdditionalAuthenticationProviderProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::AppSync::GraphQLApi.AdditionalAuthenticationProviders``.
    ...
    @builtins.property
    def log_config(self) -> typing.Optional[typing.Union["CfnGraphQLApi.LogConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::GraphQLApi.LogConfig``.
    ...
    @builtins.property
    def user_pool_config(self) -> typing.Optional[typing.Union["CfnGraphQLApi.UserPoolConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::GraphQLApi.UserPoolConfig``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnGraphQLSchema(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLSchema"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, definition: typing.Optional[str]=None, definition_s3_location: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnGraphQLSchema":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnGraphQLSchemaProps", jsii_struct_bases=[], name_mapping={'api_id': 'apiId', 'definition': 'definition', 'definition_s3_location': 'definitionS3Location'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnResolver(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.CfnResolver"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api_id: str, field_name: str, type_name: str, caching_config: typing.Optional[typing.Union["CachingConfigProperty", _IResolvable_9ceae33e]]=None, data_source_name: typing.Optional[str]=None, kind: typing.Optional[str]=None, pipeline_config: typing.Optional[typing.Union["PipelineConfigProperty", _IResolvable_9ceae33e]]=None, request_mapping_template: typing.Optional[str]=None, request_mapping_template_s3_location: typing.Optional[str]=None, response_mapping_template: typing.Optional[str]=None, response_mapping_template_s3_location: typing.Optional[str]=None, sync_config: typing.Optional[typing.Union["SyncConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnResolver":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def caching_config(self) -> typing.Optional[typing.Union["CachingConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def caching_config(self, value: typing.Optional[typing.Union["CachingConfigProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def pipeline_config(self) -> typing.Optional[typing.Union["PipelineConfigProperty", _IResolvable_9ceae33e]]:
    ...
    def pipeline_config(self, value: typing.Optional[typing.Union["PipelineConfigProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def sync_config(self) -> typing.Optional[typing.Union["SyncConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @sync_config.setter
    def sync_config(self, value: typing.Optional[typing.Union["SyncConfigProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "syncConfig", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnResolver.CachingConfigProperty", jsii_struct_bases=[], name_mapping={'caching_keys': 'cachingKeys', 'ttl': 'ttl'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnResolver.LambdaConflictHandlerConfigProperty", jsii_struct_bases=[], name_mapping={'lambda_conflict_handler_arn': 'lambdaConflictHandlerArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnResolver.PipelineConfigProperty", jsii_struct_bases=[], name_mapping={'functions': 'functions'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.CfnResolver.SyncConfigProperty", jsii_struct_bases=[], name_mapping={'conflict_detection': 'conflictDetection', 'conflict_handler': 'conflictHandler', 'lambda_conflict_handler_config': 'lambdaConflictHandlerConfig'})
    class SyncConfigProperty():
        def __init__(self, *, conflict_detection: str, conflict_handler: typing.Optional[str]=None, lambda_conflict_handler_config: typing.Optional[typing.Union["CfnResolver.LambdaConflictHandlerConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def lambda_conflict_handler_config(self) -> typing.Optional[typing.Union["CfnResolver.LambdaConflictHandlerConfigProperty", _IResolvable_9ceae33e]]:
...
class CfnResolverProps():
    ...
    @builtins.property
    def caching_config(self) -> typing.Optional[typing.Union["CfnResolver.CachingConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::Resolver.CachingConfig``.
    ...
    @builtins.property
    def sync_config(self) -> typing.Optional[typing.Union["CfnResolver.SyncConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::AppSync::Resolver.SyncConfig``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.ExtendedDataSourceProps", jsii_struct_bases=[], name_mapping={'type': 'type', 'dynamo_db_config': 'dynamoDbConfig', 'elasticsearch_config': 'elasticsearchConfig', 'http_config': 'httpConfig', 'lambda_config': 'lambdaConfig', 'relational_database_config': 'relationalDatabaseConfig'})
...
class GraphQLApi(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.GraphQLApi"):
    """An AppSync GraphQL API.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, authorization_config: typing.Optional["AuthorizationConfig"]=None, log_config: typing.Optional["LogConfig"]=None, schema_definition: typing.Optional[str]=None, schema_definition_file: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    def add_dynamo_db_data_source(self, name: str, description: str, table: _Table_208d82dc) -> "DynamoDbDataSource":
    ...
    def add_http_data_source(self, name: str, description: str, endpoint: str) -> "HttpDataSource":
    ...
    def add_lambda_data_source(self, name: str, description: str, lambda_function: _IFunction_1c1de0bc) -> "LambdaDataSource":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.GraphQLApiProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'authorization_config': 'authorizationConfig', 'log_config': 'logConfig', 'schema_definition': 'schemaDefinition', 'schema_definition_file': 'schemaDefinitionFile'})
...
class HttpDataSource(BaseDataSource, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.HttpDataSource"):
    """An AppSync datasource backed by a http endpoint.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, endpoint: str, api: "GraphQLApi", name: str, description: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param endpoint: The http endpoint.
        ...
        :stability: experimental
        """
        props = HttpDataSourceProps(endpoint=endpoint, api=api, name=name, description=description)

        jsii.create(HttpDataSource, self, [scope, id, props])


@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.HttpDataSourceProps", jsii_struct_bases=[BaseDataSourceProps], name_mapping={'api': 'api', 'name': 'name', 'description': 'description', 'endpoint': 'endpoint'})
class HttpDataSourceProps(BaseDataSourceProps):
    def __init__(self, *, api: "GraphQLApi", name: str, description: typing.Optional[str]=None, endpoint: str) -> None:
    ...
    def __repr__(self) -> str:
        return 'HttpDataSourceProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


class KeyCondition(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.KeyCondition"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.LogConfig", jsii_struct_bases=[], name_mapping={'exclude_verbose_content': 'excludeVerboseContent', 'field_log_level': 'fieldLogLevel'})
class LogConfig():
    def __init__(self, *, exclude_verbose_content: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, field_log_level: typing.Optional["FieldLogLevel"]=None) -> None:
...
class MappingTemplate(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_appsync.MappingTemplate"):
...
class NoneDataSource(BaseDataSource, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.NoneDataSource"):
    """An AppSync dummy datasource.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, api: "GraphQLApi", name: str, description: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param api: The API to attach this data source to.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.NoneDataSourceProps", jsii_struct_bases=[BaseDataSourceProps], name_mapping={'api': 'api', 'name': 'name', 'description': 'description'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.OpenIdConnectConfig", jsii_struct_bases=[], name_mapping={'oidc_provider': 'oidcProvider', 'client_id': 'clientId', 'token_expiry_from_auth': 'tokenExpiryFromAuth', 'token_expiry_from_issue': 'tokenExpiryFromIssue'})
class OpenIdConnectConfig():
    def __init__(self, *, oidc_provider: str, client_id: typing.Optional[str]=None, token_expiry_from_auth: typing.Optional[jsii.Number]=None, token_expiry_from_issue: typing.Optional[jsii.Number]=None) -> None:
        ...
        if client_id is not None: self._values["client_id"] = client_id
        if token_expiry_from_auth is not None: self._values["token_expiry_from_auth"] = token_expiry_from_auth
        if token_expiry_from_issue is not None: self._values["token_expiry_from_issue"] = token_expiry_from_issue
    ...
    def __repr__(self) -> str:
        return 'OpenIdConnectConfig(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


class PartitionKeyStep(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.PartitionKeyStep"):
...
class PrimaryKey(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.PrimaryKey"):
...
class SortKeyStep(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.SortKeyStep"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.UserPoolConfig", jsii_struct_bases=[], name_mapping={'user_pool': 'userPool', 'app_id_client_regex': 'appIdClientRegex', 'default_action': 'defaultAction'})
class UserPoolConfig():
    def __init__(self, *, user_pool: _IUserPool_e9547b0f, app_id_client_regex: typing.Optional[str]=None, default_action: typing.Optional["UserPoolDefaultAction"]=None) -> None:
...
class Values(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.Values"):
...
class BackedDataSource(BaseDataSource, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_appsync.BackedDataSource"):
    """Abstract AppSync datasource implementation.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.BackedDataSourceProps", jsii_struct_bases=[BaseDataSourceProps], name_mapping={'api': 'api', 'name': 'name', 'description': 'description', 'service_role': 'serviceRole'})
class BackedDataSourceProps(BaseDataSourceProps):
    def __init__(self, *, api: "GraphQLApi", name: str, description: typing.Optional[str]=None, service_role: typing.Optional[_IRole_e69bbae4]=None) -> None:
...
class DynamoDbDataSource(BackedDataSource, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.DynamoDbDataSource"):
    """An AppSync datasource backed by a DynamoDB table.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, table: _Table_208d82dc, read_only_access: typing.Optional[bool]=None, use_caller_credentials: typing.Optional[bool]=None, service_role: typing.Optional[_IRole_e69bbae4]=None, api: "GraphQLApi", name: str, description: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param table: The DynamoDB table backing this data source [disable-awslint:ref-via-interface].
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.DynamoDbDataSourceProps", jsii_struct_bases=[BackedDataSourceProps], name_mapping={'api': 'api', 'name': 'name', 'description': 'description', 'service_role': 'serviceRole', 'table': 'table', 'read_only_access': 'readOnlyAccess', 'use_caller_credentials': 'useCallerCredentials'})
class DynamoDbDataSourceProps(BackedDataSourceProps):
    def __init__(self, *, api: "GraphQLApi", name: str, description: typing.Optional[str]=None, service_role: typing.Optional[_IRole_e69bbae4]=None, table: _Table_208d82dc, read_only_access: typing.Optional[bool]=None, use_caller_credentials: typing.Optional[bool]=None) -> None:
    ...
    @builtins.property
    def table(self) -> _Table_208d82dc:
...
class LambdaDataSource(BackedDataSource, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.LambdaDataSource"):
    """An AppSync datasource backed by a Lambda function.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, lambda_function: _IFunction_1c1de0bc, service_role: typing.Optional[_IRole_e69bbae4]=None, api: "GraphQLApi", name: str, description: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param lambda_function: The Lambda function to call to interact with this data source.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.LambdaDataSourceProps", jsii_struct_bases=[BackedDataSourceProps], name_mapping={'api': 'api', 'name': 'name', 'description': 'description', 'service_role': 'serviceRole', 'lambda_function': 'lambdaFunction'})
class LambdaDataSourceProps(BackedDataSourceProps):
    def __init__(self, *, api: "GraphQLApi", name: str, description: typing.Optional[str]=None, service_role: typing.Optional[_IRole_e69bbae4]=None, lambda_function: _IFunction_1c1de0bc) -> None:
...
class PartitionKey(PrimaryKey, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.PartitionKey"):
