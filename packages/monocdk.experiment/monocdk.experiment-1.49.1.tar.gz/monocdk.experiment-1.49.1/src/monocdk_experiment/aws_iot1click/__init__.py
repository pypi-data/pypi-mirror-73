...
class CfnDevice(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot1click.CfnDevice"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, device_id: str, enabled: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot1click.CfnDeviceProps", jsii_struct_bases=[], name_mapping={'device_id': 'deviceId', 'enabled': 'enabled'})
class CfnDeviceProps():
    def __init__(self, *, device_id: str, enabled: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnPlacement(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot1click.CfnPlacement"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, project_name: str, associated_devices: typing.Any=None, attributes: typing.Any=None, placement_name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnPlacement":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot1click.CfnPlacementProps", jsii_struct_bases=[], name_mapping={'project_name': 'projectName', 'associated_devices': 'associatedDevices', 'attributes': 'attributes', 'placement_name': 'placementName'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnProject(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot1click.CfnProject"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, placement_template: typing.Union["PlacementTemplateProperty", _IResolvable_9ceae33e], description: typing.Optional[str]=None, project_name: typing.Optional[str]=None) -> None:
    ...
    def placement_template(self) -> typing.Union["PlacementTemplateProperty", _IResolvable_9ceae33e]:
    ...
    def placement_template(self, value: typing.Union["PlacementTemplateProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot1click.CfnProject.DeviceTemplateProperty", jsii_struct_bases=[], name_mapping={'callback_overrides': 'callbackOverrides', 'device_type': 'deviceType'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot1click.CfnProject.PlacementTemplateProperty", jsii_struct_bases=[], name_mapping={'default_attributes': 'defaultAttributes', 'device_templates': 'deviceTemplates'})
    class PlacementTemplateProperty():
        def __init__(self, *, default_attributes: typing.Any=None, device_templates: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, typing.Union["CfnProject.DeviceTemplateProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def device_templates(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, typing.Union["CfnProject.DeviceTemplateProperty", _IResolvable_9ceae33e]]]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot1click.CfnProjectProps", jsii_struct_bases=[], name_mapping={'placement_template': 'placementTemplate', 'description': 'description', 'project_name': 'projectName'})
class CfnProjectProps():
    def __init__(self, *, placement_template: typing.Union["CfnProject.PlacementTemplateProperty", _IResolvable_9ceae33e], description: typing.Optional[str]=None, project_name: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def placement_template(self) -> typing.Union["CfnProject.PlacementTemplateProperty", _IResolvable_9ceae33e]:
        """``AWS::IoT1Click::Project.PlacementTemplate``.
