...
class CfnCertificate(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnCertificate"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, certificate_signing_request: str, status: str) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnCertificate":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnCertificateProps", jsii_struct_bases=[], name_mapping={'certificate_signing_request': 'certificateSigningRequest', 'status': 'status'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnPolicy(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnPolicy"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, policy_document: typing.Any, policy_name: typing.Optional[str]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnPolicyPrincipalAttachment(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnPolicyPrincipalAttachment"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, policy_name: str, principal: str) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnPolicyPrincipalAttachment":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnPolicyPrincipalAttachmentProps", jsii_struct_bases=[], name_mapping={'policy_name': 'policyName', 'principal': 'principal'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnPolicyProps", jsii_struct_bases=[], name_mapping={'policy_document': 'policyDocument', 'policy_name': 'policyName'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnProvisioningTemplate(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplate"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, provisioning_role_arn: str, template_body: str, description: typing.Optional[str]=None, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, pre_provisioning_hook: typing.Optional[typing.Union["ProvisioningHookProperty", _IResolvable_9ceae33e]]=None, tags: typing.Optional[typing.List[typing.Any]]=None, template_name: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnProvisioningTemplateProps(provisioning_role_arn=provisioning_role_arn, template_body=template_body, description=description, enabled=enabled, pre_provisioning_hook=pre_provisioning_hook, tags=tags, template_name=template_name)

        jsii.create(CfnProvisioningTemplate, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnProvisioningTemplate":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def pre_provisioning_hook(self) -> typing.Optional[typing.Union["ProvisioningHookProperty", _IResolvable_9ceae33e]]:
    ...
    def pre_provisioning_hook(self, value: typing.Optional[typing.Union["ProvisioningHookProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplate.ProvisioningHookProperty", jsii_struct_bases=[], name_mapping={'payload_version': 'payloadVersion', 'target_arn': 'targetArn'})
    class ProvisioningHookProperty():
        def __init__(self, *, payload_version: typing.Optional[str]=None, target_arn: typing.Optional[str]=None) -> None:
            """
            ...
            if payload_version is not None: self._values["payload_version"] = payload_version
        ...
        def __repr__(self) -> str:
            return 'ProvisioningHookProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnProvisioningTemplateProps", jsii_struct_bases=[], name_mapping={'provisioning_role_arn': 'provisioningRoleArn', 'template_body': 'templateBody', 'description': 'description', 'enabled': 'enabled', 'pre_provisioning_hook': 'preProvisioningHook', 'tags': 'tags', 'template_name': 'templateName'})
class CfnProvisioningTemplateProps():
    def __init__(self, *, provisioning_role_arn: str, template_body: str, description: typing.Optional[str]=None, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, pre_provisioning_hook: typing.Optional[typing.Union["CfnProvisioningTemplate.ProvisioningHookProperty", _IResolvable_9ceae33e]]=None, tags: typing.Optional[typing.List[typing.Any]]=None, template_name: typing.Optional[str]=None) -> None:
        ...
        if pre_provisioning_hook is not None: self._values["pre_provisioning_hook"] = pre_provisioning_hook
    ...
    @builtins.property
    def pre_provisioning_hook(self) -> typing.Optional[typing.Union["CfnProvisioningTemplate.ProvisioningHookProperty", _IResolvable_9ceae33e]]:
        """``AWS::IoT::ProvisioningTemplate.PreProvisioningHook``.
    ...
    def __repr__(self) -> str:
        return 'CfnProvisioningTemplateProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(_IInspectable_051e6ed8)
class CfnThing(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnThing"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, attribute_payload: typing.Optional[typing.Union["AttributePayloadProperty", _IResolvable_9ceae33e]]=None, thing_name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnThing":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def attribute_payload(self) -> typing.Optional[typing.Union["AttributePayloadProperty", _IResolvable_9ceae33e]]:
    ...
    def attribute_payload(self, value: typing.Optional[typing.Union["AttributePayloadProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnThing.AttributePayloadProperty", jsii_struct_bases=[], name_mapping={'attributes': 'attributes'})
    class AttributePayloadProperty():
        def __init__(self, *, attributes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None) -> None:
            """
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnThingPrincipalAttachment(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnThingPrincipalAttachment"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, principal: str, thing_name: str) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnThingPrincipalAttachment":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnThingPrincipalAttachmentProps", jsii_struct_bases=[], name_mapping={'principal': 'principal', 'thing_name': 'thingName'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnThingProps", jsii_struct_bases=[], name_mapping={'attribute_payload': 'attributePayload', 'thing_name': 'thingName'})
class CfnThingProps():
    def __init__(self, *, attribute_payload: typing.Optional[typing.Union["CfnThing.AttributePayloadProperty", _IResolvable_9ceae33e]]=None, thing_name: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def attribute_payload(self) -> typing.Optional[typing.Union["CfnThing.AttributePayloadProperty", _IResolvable_9ceae33e]]:
        """``AWS::IoT::Thing.AttributePayload``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnTopicRule(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_iot.CfnTopicRule"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, topic_rule_payload: typing.Union["TopicRulePayloadProperty", _IResolvable_9ceae33e], rule_name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnTopicRule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def topic_rule_payload(self) -> typing.Union["TopicRulePayloadProperty", _IResolvable_9ceae33e]:
    ...
    def topic_rule_payload(self, value: typing.Union["TopicRulePayloadProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.ActionProperty", jsii_struct_bases=[], name_mapping={'cloudwatch_alarm': 'cloudwatchAlarm', 'cloudwatch_metric': 'cloudwatchMetric', 'dynamo_db': 'dynamoDb', 'dynamo_d_bv2': 'dynamoDBv2', 'elasticsearch': 'elasticsearch', 'firehose': 'firehose', 'http': 'http', 'iot_analytics': 'iotAnalytics', 'iot_events': 'iotEvents', 'iot_site_wise': 'iotSiteWise', 'kinesis': 'kinesis', 'lambda_': 'lambda', 'republish': 'republish', 's3': 's3', 'sns': 'sns', 'sqs': 'sqs', 'step_functions': 'stepFunctions'})
    class ActionProperty():
        def __init__(self, *, cloudwatch_alarm: typing.Optional[typing.Union["CfnTopicRule.CloudwatchAlarmActionProperty", _IResolvable_9ceae33e]]=None, cloudwatch_metric: typing.Optional[typing.Union["CfnTopicRule.CloudwatchMetricActionProperty", _IResolvable_9ceae33e]]=None, dynamo_db: typing.Optional[typing.Union["CfnTopicRule.DynamoDBActionProperty", _IResolvable_9ceae33e]]=None, dynamo_d_bv2: typing.Optional[typing.Union["CfnTopicRule.DynamoDBv2ActionProperty", _IResolvable_9ceae33e]]=None, elasticsearch: typing.Optional[typing.Union["CfnTopicRule.ElasticsearchActionProperty", _IResolvable_9ceae33e]]=None, firehose: typing.Optional[typing.Union["CfnTopicRule.FirehoseActionProperty", _IResolvable_9ceae33e]]=None, http: typing.Optional[typing.Union["CfnTopicRule.HttpActionProperty", _IResolvable_9ceae33e]]=None, iot_analytics: typing.Optional[typing.Union["CfnTopicRule.IotAnalyticsActionProperty", _IResolvable_9ceae33e]]=None, iot_events: typing.Optional[typing.Union["CfnTopicRule.IotEventsActionProperty", _IResolvable_9ceae33e]]=None, iot_site_wise: typing.Optional[typing.Union["CfnTopicRule.IotSiteWiseActionProperty", _IResolvable_9ceae33e]]=None, kinesis: typing.Optional[typing.Union["CfnTopicRule.KinesisActionProperty", _IResolvable_9ceae33e]]=None, lambda_: typing.Optional[typing.Union["CfnTopicRule.LambdaActionProperty", _IResolvable_9ceae33e]]=None, republish: typing.Optional[typing.Union["CfnTopicRule.RepublishActionProperty", _IResolvable_9ceae33e]]=None, s3: typing.Optional[typing.Union["CfnTopicRule.S3ActionProperty", _IResolvable_9ceae33e]]=None, sns: typing.Optional[typing.Union["CfnTopicRule.SnsActionProperty", _IResolvable_9ceae33e]]=None, sqs: typing.Optional[typing.Union["CfnTopicRule.SqsActionProperty", _IResolvable_9ceae33e]]=None, step_functions: typing.Optional[typing.Union["CfnTopicRule.StepFunctionsActionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def cloudwatch_alarm(self) -> typing.Optional[typing.Union["CfnTopicRule.CloudwatchAlarmActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def cloudwatch_metric(self) -> typing.Optional[typing.Union["CfnTopicRule.CloudwatchMetricActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def dynamo_db(self) -> typing.Optional[typing.Union["CfnTopicRule.DynamoDBActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def dynamo_d_bv2(self) -> typing.Optional[typing.Union["CfnTopicRule.DynamoDBv2ActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def elasticsearch(self) -> typing.Optional[typing.Union["CfnTopicRule.ElasticsearchActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def firehose(self) -> typing.Optional[typing.Union["CfnTopicRule.FirehoseActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def http(self) -> typing.Optional[typing.Union["CfnTopicRule.HttpActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def iot_analytics(self) -> typing.Optional[typing.Union["CfnTopicRule.IotAnalyticsActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def iot_events(self) -> typing.Optional[typing.Union["CfnTopicRule.IotEventsActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def iot_site_wise(self) -> typing.Optional[typing.Union["CfnTopicRule.IotSiteWiseActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def kinesis(self) -> typing.Optional[typing.Union["CfnTopicRule.KinesisActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def lambda_(self) -> typing.Optional[typing.Union["CfnTopicRule.LambdaActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def republish(self) -> typing.Optional[typing.Union["CfnTopicRule.RepublishActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def s3(self) -> typing.Optional[typing.Union["CfnTopicRule.S3ActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def sns(self) -> typing.Optional[typing.Union["CfnTopicRule.SnsActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def sqs(self) -> typing.Optional[typing.Union["CfnTopicRule.SqsActionProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def step_functions(self) -> typing.Optional[typing.Union["CfnTopicRule.StepFunctionsActionProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.AssetPropertyTimestampProperty", jsii_struct_bases=[], name_mapping={'time_in_seconds': 'timeInSeconds', 'offset_in_nanos': 'offsetInNanos'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.AssetPropertyValueProperty", jsii_struct_bases=[], name_mapping={'timestamp': 'timestamp', 'value': 'value', 'quality': 'quality'})
    class AssetPropertyValueProperty():
        def __init__(self, *, timestamp: typing.Union["CfnTopicRule.AssetPropertyTimestampProperty", _IResolvable_9ceae33e], value: typing.Union["CfnTopicRule.AssetPropertyVariantProperty", _IResolvable_9ceae33e], quality: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def timestamp(self) -> typing.Union["CfnTopicRule.AssetPropertyTimestampProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def value(self) -> typing.Union["CfnTopicRule.AssetPropertyVariantProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.AssetPropertyVariantProperty", jsii_struct_bases=[], name_mapping={'boolean_value': 'booleanValue', 'double_value': 'doubleValue', 'integer_value': 'integerValue', 'string_value': 'stringValue'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.CloudwatchAlarmActionProperty", jsii_struct_bases=[], name_mapping={'alarm_name': 'alarmName', 'role_arn': 'roleArn', 'state_reason': 'stateReason', 'state_value': 'stateValue'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.CloudwatchMetricActionProperty", jsii_struct_bases=[], name_mapping={'metric_name': 'metricName', 'metric_namespace': 'metricNamespace', 'metric_unit': 'metricUnit', 'metric_value': 'metricValue', 'role_arn': 'roleArn', 'metric_timestamp': 'metricTimestamp'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.DynamoDBActionProperty", jsii_struct_bases=[], name_mapping={'hash_key_field': 'hashKeyField', 'hash_key_value': 'hashKeyValue', 'role_arn': 'roleArn', 'table_name': 'tableName', 'hash_key_type': 'hashKeyType', 'payload_field': 'payloadField', 'range_key_field': 'rangeKeyField', 'range_key_type': 'rangeKeyType', 'range_key_value': 'rangeKeyValue'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.DynamoDBv2ActionProperty", jsii_struct_bases=[], name_mapping={'put_item': 'putItem', 'role_arn': 'roleArn'})
    class DynamoDBv2ActionProperty():
        def __init__(self, *, put_item: typing.Optional[typing.Union["CfnTopicRule.PutItemInputProperty", _IResolvable_9ceae33e]]=None, role_arn: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def put_item(self) -> typing.Optional[typing.Union["CfnTopicRule.PutItemInputProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.ElasticsearchActionProperty", jsii_struct_bases=[], name_mapping={'endpoint': 'endpoint', 'id': 'id', 'index': 'index', 'role_arn': 'roleArn', 'type': 'type'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.FirehoseActionProperty", jsii_struct_bases=[], name_mapping={'delivery_stream_name': 'deliveryStreamName', 'role_arn': 'roleArn', 'separator': 'separator'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.HttpActionHeaderProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.HttpActionProperty", jsii_struct_bases=[], name_mapping={'url': 'url', 'auth': 'auth', 'confirmation_url': 'confirmationUrl', 'headers': 'headers'})
    class HttpActionProperty():
        def __init__(self, *, url: str, auth: typing.Optional[typing.Union["CfnTopicRule.HttpAuthorizationProperty", _IResolvable_9ceae33e]]=None, confirmation_url: typing.Optional[str]=None, headers: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.HttpActionHeaderProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def auth(self) -> typing.Optional[typing.Union["CfnTopicRule.HttpAuthorizationProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def headers(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.HttpActionHeaderProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.HttpAuthorizationProperty", jsii_struct_bases=[], name_mapping={'sigv4': 'sigv4'})
    class HttpAuthorizationProperty():
        def __init__(self, *, sigv4: typing.Optional[typing.Union["CfnTopicRule.SigV4AuthorizationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def sigv4(self) -> typing.Optional[typing.Union["CfnTopicRule.SigV4AuthorizationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.IotAnalyticsActionProperty", jsii_struct_bases=[], name_mapping={'channel_name': 'channelName', 'role_arn': 'roleArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.IotEventsActionProperty", jsii_struct_bases=[], name_mapping={'input_name': 'inputName', 'role_arn': 'roleArn', 'message_id': 'messageId'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.IotSiteWiseActionProperty", jsii_struct_bases=[], name_mapping={'put_asset_property_value_entries': 'putAssetPropertyValueEntries', 'role_arn': 'roleArn'})
    class IotSiteWiseActionProperty():
        def __init__(self, *, put_asset_property_value_entries: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.PutAssetPropertyValueEntryProperty", _IResolvable_9ceae33e]]], role_arn: str) -> None:
            """
        ...
        @builtins.property
        def put_asset_property_value_entries(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.PutAssetPropertyValueEntryProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.KinesisActionProperty", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'stream_name': 'streamName', 'partition_key': 'partitionKey'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.LambdaActionProperty", jsii_struct_bases=[], name_mapping={'function_arn': 'functionArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.PutAssetPropertyValueEntryProperty", jsii_struct_bases=[], name_mapping={'property_values': 'propertyValues', 'asset_id': 'assetId', 'entry_id': 'entryId', 'property_alias': 'propertyAlias', 'property_id': 'propertyId'})
    class PutAssetPropertyValueEntryProperty():
        def __init__(self, *, property_values: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.AssetPropertyValueProperty", _IResolvable_9ceae33e]]], asset_id: typing.Optional[str]=None, entry_id: typing.Optional[str]=None, property_alias: typing.Optional[str]=None, property_id: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def property_values(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.AssetPropertyValueProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.PutItemInputProperty", jsii_struct_bases=[], name_mapping={'table_name': 'tableName'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.RepublishActionProperty", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'topic': 'topic', 'qos': 'qos'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.S3ActionProperty", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'key': 'key', 'role_arn': 'roleArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.SigV4AuthorizationProperty", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'service_name': 'serviceName', 'signing_region': 'signingRegion'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.SnsActionProperty", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'target_arn': 'targetArn', 'message_format': 'messageFormat'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.SqsActionProperty", jsii_struct_bases=[], name_mapping={'queue_url': 'queueUrl', 'role_arn': 'roleArn', 'use_base64': 'useBase64'})
    class SqsActionProperty():
        def __init__(self, *, queue_url: str, role_arn: str, use_base64: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def use_base64(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.StepFunctionsActionProperty", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'state_machine_name': 'stateMachineName', 'execution_name_prefix': 'executionNamePrefix'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRule.TopicRulePayloadProperty", jsii_struct_bases=[], name_mapping={'actions': 'actions', 'rule_disabled': 'ruleDisabled', 'sql': 'sql', 'aws_iot_sql_version': 'awsIotSqlVersion', 'description': 'description', 'error_action': 'errorAction'})
    class TopicRulePayloadProperty():
        def __init__(self, *, actions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.ActionProperty", _IResolvable_9ceae33e]]], rule_disabled: typing.Union[bool, _IResolvable_9ceae33e], sql: str, aws_iot_sql_version: typing.Optional[str]=None, description: typing.Optional[str]=None, error_action: typing.Optional[typing.Union["CfnTopicRule.ActionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def actions(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTopicRule.ActionProperty", _IResolvable_9ceae33e]]]:
        ...
        @builtins.property
        def error_action(self) -> typing.Optional[typing.Union["CfnTopicRule.ActionProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_iot.CfnTopicRuleProps", jsii_struct_bases=[], name_mapping={'topic_rule_payload': 'topicRulePayload', 'rule_name': 'ruleName'})
class CfnTopicRuleProps():
    def __init__(self, *, topic_rule_payload: typing.Union["CfnTopicRule.TopicRulePayloadProperty", _IResolvable_9ceae33e], rule_name: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def topic_rule_payload(self) -> typing.Union["CfnTopicRule.TopicRulePayloadProperty", _IResolvable_9ceae33e]:
        """``AWS::IoT::TopicRule.TopicRulePayload``.
