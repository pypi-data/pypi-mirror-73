...
from ..aws_iam import (AddToResourcePolicyResult as _AddToResourcePolicyResult_d2a345d1, PolicyStatement as _PolicyStatement_f75dc775, Grant as _Grant_96af6d2d, IGrantable as _IGrantable_0fcfc53a)


@jsii.implements(_IInspectable_051e6ed8)
class CfnRepository(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ecr.CfnRepository"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, lifecycle_policy: typing.Optional[typing.Union["LifecyclePolicyProperty", _IResolvable_9ceae33e]]=None, repository_name: typing.Optional[str]=None, repository_policy_text: typing.Any=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnRepository":
    ...
    def lifecycle_policy(self) -> typing.Optional[typing.Union["LifecyclePolicyProperty", _IResolvable_9ceae33e]]:
    ...
    def lifecycle_policy(self, value: typing.Optional[typing.Union["LifecyclePolicyProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.CfnRepository.LifecyclePolicyProperty", jsii_struct_bases=[], name_mapping={'lifecycle_policy_text': 'lifecyclePolicyText', 'registry_id': 'registryId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.CfnRepositoryProps", jsii_struct_bases=[], name_mapping={'lifecycle_policy': 'lifecyclePolicy', 'repository_name': 'repositoryName', 'repository_policy_text': 'repositoryPolicyText', 'tags': 'tags'})
class CfnRepositoryProps():
    def __init__(self, *, lifecycle_policy: typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", _IResolvable_9ceae33e]]=None, repository_name: typing.Optional[str]=None, repository_policy_text: typing.Any=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @builtins.property
    def lifecycle_policy(self) -> typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", _IResolvable_9ceae33e]]:
        """``AWS::ECR::Repository.LifecyclePolicy``.
...
class IRepository(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def on_cloud_trail_image_pushed(self, id: str, *, image_tag: typing.Optional[str]=None, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None) -> _Rule_c38e0b39:
    ...
    def on_image_scan_completed(self, id: str, *, image_tags: typing.Optional[typing.List[str]]=None, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None) -> _Rule_c38e0b39:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.LifecycleRule", jsii_struct_bases=[], name_mapping={'description': 'description', 'max_image_age': 'maxImageAge', 'max_image_count': 'maxImageCount', 'rule_priority': 'rulePriority', 'tag_prefix_list': 'tagPrefixList', 'tag_status': 'tagStatus'})
class LifecycleRule():
    def __init__(self, *, description: typing.Optional[str]=None, max_image_age: typing.Optional[_Duration_5170c158]=None, max_image_count: typing.Optional[jsii.Number]=None, rule_priority: typing.Optional[jsii.Number]=None, tag_prefix_list: typing.Optional[typing.List[str]]=None, tag_status: typing.Optional["TagStatus"]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.OnCloudTrailImagePushedOptions", jsii_struct_bases=[_OnEventOptions_926fbcf9], name_mapping={'description': 'description', 'event_pattern': 'eventPattern', 'rule_name': 'ruleName', 'target': 'target', 'image_tag': 'imageTag'})
class OnCloudTrailImagePushedOptions(_OnEventOptions_926fbcf9):
    def __init__(self, *, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None, image_tag: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.OnImageScanCompletedOptions", jsii_struct_bases=[_OnEventOptions_926fbcf9], name_mapping={'description': 'description', 'event_pattern': 'eventPattern', 'rule_name': 'ruleName', 'target': 'target', 'image_tags': 'imageTags'})
class OnImageScanCompletedOptions(_OnEventOptions_926fbcf9):
    def __init__(self, *, description: typing.Optional[str]=None, event_pattern: typing.Optional[_EventPattern_8aa7b781]=None, rule_name: typing.Optional[str]=None, target: typing.Optional[_IRuleTarget_41800a77]=None, image_tags: typing.Optional[typing.List[str]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.RepositoryAttributes", jsii_struct_bases=[], name_mapping={'repository_arn': 'repositoryArn', 'repository_name': 'repositoryName'})
...
class RepositoryBase(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_ecr.RepositoryBase"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecr.RepositoryProps", jsii_struct_bases=[], name_mapping={'image_scan_on_push': 'imageScanOnPush', 'lifecycle_registry_id': 'lifecycleRegistryId', 'lifecycle_rules': 'lifecycleRules', 'removal_policy': 'removalPolicy', 'repository_name': 'repositoryName'})
class RepositoryProps():
    def __init__(self, *, image_scan_on_push: typing.Optional[bool]=None, lifecycle_registry_id: typing.Optional[str]=None, lifecycle_rules: typing.Optional[typing.List["LifecycleRule"]]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, repository_name: typing.Optional[str]=None) -> None:
        """
...
class Repository(RepositoryBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ecr.Repository"):
    """Define an ECR repository.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, image_scan_on_push: typing.Optional[bool]=None, lifecycle_registry_id: typing.Optional[str]=None, lifecycle_rules: typing.Optional[typing.List["LifecycleRule"]]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, repository_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param image_scan_on_push: Enable the scan on push when creating the repository. Default: false
    ...
    @builtins.classmethod
    def arn_for_local_repository(cls, repository_name: str, scope: _IConstruct_db0cc7e3) -> str:
    ...
    @builtins.classmethod
    def from_repository_arn(cls, scope: _Construct_f50a3f53, id: str, repository_arn: str) -> "IRepository":
        """
        :param scope: -
        :param id: -
        :param repository_arn: -
    ...
    @builtins.classmethod
    def from_repository_attributes(cls, scope: _Construct_f50a3f53, id: str, *, repository_arn: str, repository_name: str) -> "IRepository":
        """Import a repository.
    ...
    @builtins.classmethod
    def from_repository_name(cls, scope: _Construct_f50a3f53, id: str, repository_name: str) -> "IRepository":
        """
        :param scope: -
        :param id: -
        :param repository_name: -
