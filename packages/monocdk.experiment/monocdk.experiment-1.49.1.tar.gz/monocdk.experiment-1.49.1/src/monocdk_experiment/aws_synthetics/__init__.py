...
class CfnCanary(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_synthetics.CfnCanary"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, artifact_s3_location: str, code: typing.Union["CodeProperty", _IResolvable_9ceae33e], execution_role_arn: str, name: str, run_config: typing.Union["RunConfigProperty", _IResolvable_9ceae33e], runtime_version: str, schedule: typing.Union["ScheduleProperty", _IResolvable_9ceae33e], start_canary_after_creation: typing.Union[bool, _IResolvable_9ceae33e], failure_retention_period: typing.Optional[jsii.Number]=None, success_retention_period: typing.Optional[jsii.Number]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, vpc_config: typing.Optional[typing.Union["VPCConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
        ...
        """
        props = CfnCanaryProps(artifact_s3_location=artifact_s3_location, code=code, execution_role_arn=execution_role_arn, name=name, run_config=run_config, runtime_version=runtime_version, schedule=schedule, start_canary_after_creation=start_canary_after_creation, failure_retention_period=failure_retention_period, success_retention_period=success_retention_period, tags=tags, vpc_config=vpc_config)

        jsii.create(CfnCanary, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnCanary":
    ...
    @run_config.setter
    def run_config(self, value: typing.Union["RunConfigProperty", _IResolvable_9ceae33e]) -> None:
    ...
    def start_canary_after_creation(self, value: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_synthetics.CfnCanary.CodeProperty", jsii_struct_bases=[], name_mapping={'handler': 'handler', 's3_bucket': 's3Bucket', 's3_key': 's3Key', 's3_object_version': 's3ObjectVersion', 'script': 'script'})
    class CodeProperty():
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_synthetics.CfnCanary.RunConfigProperty", jsii_struct_bases=[], name_mapping={'timeout_in_seconds': 'timeoutInSeconds'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_synthetics.CfnCanary.ScheduleProperty", jsii_struct_bases=[], name_mapping={'duration_in_seconds': 'durationInSeconds', 'expression': 'expression'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_synthetics.CfnCanary.VPCConfigProperty", jsii_struct_bases=[], name_mapping={'security_group_ids': 'securityGroupIds', 'subnet_ids': 'subnetIds', 'vpc_id': 'vpcId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_synthetics.CfnCanaryProps", jsii_struct_bases=[], name_mapping={'artifact_s3_location': 'artifactS3Location', 'code': 'code', 'execution_role_arn': 'executionRoleArn', 'name': 'name', 'run_config': 'runConfig', 'runtime_version': 'runtimeVersion', 'schedule': 'schedule', 'start_canary_after_creation': 'startCanaryAfterCreation', 'failure_retention_period': 'failureRetentionPeriod', 'success_retention_period': 'successRetentionPeriod', 'tags': 'tags', 'vpc_config': 'vpcConfig'})
class CfnCanaryProps():
    def __init__(self, *, artifact_s3_location: str, code: typing.Union["CfnCanary.CodeProperty", _IResolvable_9ceae33e], execution_role_arn: str, name: str, run_config: typing.Union["CfnCanary.RunConfigProperty", _IResolvable_9ceae33e], runtime_version: str, schedule: typing.Union["CfnCanary.ScheduleProperty", _IResolvable_9ceae33e], start_canary_after_creation: typing.Union[bool, _IResolvable_9ceae33e], failure_retention_period: typing.Optional[jsii.Number]=None, success_retention_period: typing.Optional[jsii.Number]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, vpc_config: typing.Optional[typing.Union["CfnCanary.VPCConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def run_config(self) -> typing.Union["CfnCanary.RunConfigProperty", _IResolvable_9ceae33e]:
        """``AWS::Synthetics::Canary.RunConfig``.
    ...
    @builtins.property
    def schedule(self) -> typing.Union["CfnCanary.ScheduleProperty", _IResolvable_9ceae33e]:
        """``AWS::Synthetics::Canary.Schedule``.
    ...
    @builtins.property
    def vpc_config(self) -> typing.Optional[typing.Union["CfnCanary.VPCConfigProperty", _IResolvable_9ceae33e]]:
        """``AWS::Synthetics::Canary.VPCConfig``.
