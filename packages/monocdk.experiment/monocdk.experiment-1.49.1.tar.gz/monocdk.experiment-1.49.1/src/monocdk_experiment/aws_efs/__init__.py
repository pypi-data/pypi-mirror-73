...
@jsii.data_type(jsii_type="monocdk-experiment.aws_efs.AccessPointOptions", jsii_struct_bases=[], name_mapping={'create_acl': 'createAcl', 'path': 'path', 'posix_user': 'posixUser'})
class AccessPointOptions():
    def __init__(self, *, create_acl: typing.Optional["Acl"]=None, path: typing.Optional[str]=None, posix_user: typing.Optional["PosixUser"]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'AccessPointOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_efs.AccessPointProps", jsii_struct_bases=[AccessPointOptions], name_mapping={'create_acl': 'createAcl', 'path': 'path', 'posix_user': 'posixUser', 'file_system': 'fileSystem'})
class AccessPointProps(AccessPointOptions):
    def __init__(self, *, create_acl: typing.Optional["Acl"]=None, path: typing.Optional[str]=None, posix_user: typing.Optional["PosixUser"]=None, file_system: "IFileSystem") -> None:
...
class FileSystem(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_efs.FileSystem"):
    ...
    def add_access_point(self, id: str, *, create_acl: typing.Optional["Acl"]=None, path: typing.Optional[str]=None, posix_user: typing.Optional["PosixUser"]=None) -> "AccessPoint":
        ...
        :stability: experimental
        """
        access_point_options = AccessPointOptions(create_acl=create_acl, path=path, posix_user=posix_user)
