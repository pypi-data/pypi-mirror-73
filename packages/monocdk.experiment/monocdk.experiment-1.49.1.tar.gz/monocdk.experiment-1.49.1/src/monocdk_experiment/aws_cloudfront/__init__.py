...
from ..aws_iam import (IGrantable as _IGrantable_0fcfc53a, IPrincipal as _IPrincipal_97126874)
from ..aws_lambda import (IVersion as _IVersion_1dc10564)
from ..aws_s3 import (IBucket as _IBucket_25bad983)


@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.AliasConfiguration", jsii_struct_bases=[], name_mapping={'acm_cert_ref': 'acmCertRef', 'names': 'names', 'security_policy': 'securityPolicy', 'ssl_method': 'sslMethod'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.Behavior", jsii_struct_bases=[], name_mapping={'allowed_methods': 'allowedMethods', 'cached_methods': 'cachedMethods', 'compress': 'compress', 'default_ttl': 'defaultTtl', 'forwarded_values': 'forwardedValues', 'is_default_behavior': 'isDefaultBehavior', 'lambda_function_associations': 'lambdaFunctionAssociations', 'max_ttl': 'maxTtl', 'min_ttl': 'minTtl', 'path_pattern': 'pathPattern', 'trusted_signers': 'trustedSigners'})
class Behavior():
    def __init__(self, *, allowed_methods: typing.Optional["CloudFrontAllowedMethods"]=None, cached_methods: typing.Optional["CloudFrontAllowedCachedMethods"]=None, compress: typing.Optional[bool]=None, default_ttl: typing.Optional[_Duration_5170c158]=None, forwarded_values: typing.Optional["CfnDistribution.ForwardedValuesProperty"]=None, is_default_behavior: typing.Optional[bool]=None, lambda_function_associations: typing.Optional[typing.List["LambdaFunctionAssociation"]]=None, max_ttl: typing.Optional[_Duration_5170c158]=None, min_ttl: typing.Optional[_Duration_5170c158]=None, path_pattern: typing.Optional[str]=None, trusted_signers: typing.Optional[typing.List[str]]=None) -> None:
...
class CfnCloudFrontOriginAccessIdentity(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.CfnCloudFrontOriginAccessIdentity"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cloud_front_origin_access_identity_config: typing.Union["CloudFrontOriginAccessIdentityConfigProperty", _IResolvable_9ceae33e]) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnCloudFrontOriginAccessIdentity":
    ...
    def cloud_front_origin_access_identity_config(self) -> typing.Union["CloudFrontOriginAccessIdentityConfigProperty", _IResolvable_9ceae33e]:
    ...
    def cloud_front_origin_access_identity_config(self, value: typing.Union["CloudFrontOriginAccessIdentityConfigProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "cloudFrontOriginAccessIdentityConfig", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnCloudFrontOriginAccessIdentity.CloudFrontOriginAccessIdentityConfigProperty", jsii_struct_bases=[], name_mapping={'comment': 'comment'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnCloudFrontOriginAccessIdentityProps", jsii_struct_bases=[], name_mapping={'cloud_front_origin_access_identity_config': 'cloudFrontOriginAccessIdentityConfig'})
class CfnCloudFrontOriginAccessIdentityProps():
    def __init__(self, *, cloud_front_origin_access_identity_config: typing.Union["CfnCloudFrontOriginAccessIdentity.CloudFrontOriginAccessIdentityConfigProperty", _IResolvable_9ceae33e]) -> None:
    ...
    @builtins.property
    def cloud_front_origin_access_identity_config(self) -> typing.Union["CfnCloudFrontOriginAccessIdentity.CloudFrontOriginAccessIdentityConfigProperty", _IResolvable_9ceae33e]:
        """``AWS::CloudFront::CloudFrontOriginAccessIdentity.CloudFrontOriginAccessIdentityConfig``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnDistribution(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, distribution_config: typing.Union["DistributionConfigProperty", _IResolvable_9ceae33e], tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDistribution":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def distribution_config(self) -> typing.Union["DistributionConfigProperty", _IResolvable_9ceae33e]:
    ...
    def distribution_config(self, value: typing.Union["DistributionConfigProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "distributionConfig", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.CacheBehaviorProperty", jsii_struct_bases=[], name_mapping={'forwarded_values': 'forwardedValues', 'path_pattern': 'pathPattern', 'target_origin_id': 'targetOriginId', 'viewer_protocol_policy': 'viewerProtocolPolicy', 'allowed_methods': 'allowedMethods', 'cached_methods': 'cachedMethods', 'compress': 'compress', 'default_ttl': 'defaultTtl', 'field_level_encryption_id': 'fieldLevelEncryptionId', 'lambda_function_associations': 'lambdaFunctionAssociations', 'max_ttl': 'maxTtl', 'min_ttl': 'minTtl', 'smooth_streaming': 'smoothStreaming', 'trusted_signers': 'trustedSigners'})
    class CacheBehaviorProperty():
        def __init__(self, *, forwarded_values: typing.Union["CfnDistribution.ForwardedValuesProperty", _IResolvable_9ceae33e], path_pattern: str, target_origin_id: str, viewer_protocol_policy: str, allowed_methods: typing.Optional[typing.List[str]]=None, cached_methods: typing.Optional[typing.List[str]]=None, compress: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, default_ttl: typing.Optional[jsii.Number]=None, field_level_encryption_id: typing.Optional[str]=None, lambda_function_associations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.LambdaFunctionAssociationProperty", _IResolvable_9ceae33e]]]]=None, max_ttl: typing.Optional[jsii.Number]=None, min_ttl: typing.Optional[jsii.Number]=None, smooth_streaming: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, trusted_signers: typing.Optional[typing.List[str]]=None) -> None:
            """
        ...
        @builtins.property
        def forwarded_values(self) -> typing.Union["CfnDistribution.ForwardedValuesProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def compress(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def lambda_function_associations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.LambdaFunctionAssociationProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def smooth_streaming(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.CookiesProperty", jsii_struct_bases=[], name_mapping={'forward': 'forward', 'whitelisted_names': 'whitelistedNames'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.CustomErrorResponseProperty", jsii_struct_bases=[], name_mapping={'error_code': 'errorCode', 'error_caching_min_ttl': 'errorCachingMinTtl', 'response_code': 'responseCode', 'response_page_path': 'responsePagePath'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.DistributionConfigProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'aliases': 'aliases', 'cache_behaviors': 'cacheBehaviors', 'comment': 'comment', 'custom_error_responses': 'customErrorResponses', 'default_cache_behavior': 'defaultCacheBehavior', 'default_root_object': 'defaultRootObject', 'http_version': 'httpVersion', 'ipv6_enabled': 'ipv6Enabled', 'logging': 'logging', 'origin_groups': 'originGroups', 'origins': 'origins', 'price_class': 'priceClass', 'restrictions': 'restrictions', 'viewer_certificate': 'viewerCertificate', 'web_acl_id': 'webAclId'})
    class DistributionConfigProperty():
        def __init__(self, *, enabled: typing.Union[bool, _IResolvable_9ceae33e], aliases: typing.Optional[typing.List[str]]=None, cache_behaviors: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.CacheBehaviorProperty", _IResolvable_9ceae33e]]]]=None, comment: typing.Optional[str]=None, custom_error_responses: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.CustomErrorResponseProperty", _IResolvable_9ceae33e]]]]=None, default_cache_behavior: typing.Optional[typing.Union["CfnDistribution.DefaultCacheBehaviorProperty", _IResolvable_9ceae33e]]=None, default_root_object: typing.Optional[str]=None, http_version: typing.Optional[str]=None, ipv6_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, logging: typing.Optional[typing.Union["CfnDistribution.LoggingProperty", _IResolvable_9ceae33e]]=None, origin_groups: typing.Optional[typing.Union["CfnDistribution.OriginGroupsProperty", _IResolvable_9ceae33e]]=None, origins: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginProperty", _IResolvable_9ceae33e]]]]=None, price_class: typing.Optional[str]=None, restrictions: typing.Optional[typing.Union["CfnDistribution.RestrictionsProperty", _IResolvable_9ceae33e]]=None, viewer_certificate: typing.Optional[typing.Union["CfnDistribution.ViewerCertificateProperty", _IResolvable_9ceae33e]]=None, web_acl_id: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def cache_behaviors(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.CacheBehaviorProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def custom_error_responses(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.CustomErrorResponseProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def default_cache_behavior(self) -> typing.Optional[typing.Union["CfnDistribution.DefaultCacheBehaviorProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def ipv6_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def logging(self) -> typing.Optional[typing.Union["CfnDistribution.LoggingProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def origin_groups(self) -> typing.Optional[typing.Union["CfnDistribution.OriginGroupsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def origins(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def restrictions(self) -> typing.Optional[typing.Union["CfnDistribution.RestrictionsProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def viewer_certificate(self) -> typing.Optional[typing.Union["CfnDistribution.ViewerCertificateProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.ForwardedValuesProperty", jsii_struct_bases=[], name_mapping={'query_string': 'queryString', 'cookies': 'cookies', 'headers': 'headers', 'query_string_cache_keys': 'queryStringCacheKeys'})
    class ForwardedValuesProperty():
        def __init__(self, *, query_string: typing.Union[bool, _IResolvable_9ceae33e], cookies: typing.Optional[typing.Union["CfnDistribution.CookiesProperty", _IResolvable_9ceae33e]]=None, headers: typing.Optional[typing.List[str]]=None, query_string_cache_keys: typing.Optional[typing.List[str]]=None) -> None:
            """
        ...
        @builtins.property
        def cookies(self) -> typing.Optional[typing.Union["CfnDistribution.CookiesProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.GeoRestrictionProperty", jsii_struct_bases=[], name_mapping={'restriction_type': 'restrictionType', 'locations': 'locations'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.LambdaFunctionAssociationProperty", jsii_struct_bases=[], name_mapping={'event_type': 'eventType', 'include_body': 'includeBody', 'lambda_function_arn': 'lambdaFunctionArn'})
    class LambdaFunctionAssociationProperty():
        def __init__(self, *, event_type: typing.Optional[str]=None, include_body: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, lambda_function_arn: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def include_body(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.LoggingProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'include_cookies': 'includeCookies', 'prefix': 'prefix'})
    class LoggingProperty():
        def __init__(self, *, bucket: str, include_cookies: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, prefix: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def include_cookies(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginCustomHeaderProperty", jsii_struct_bases=[], name_mapping={'header_name': 'headerName', 'header_value': 'headerValue'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginGroupFailoverCriteriaProperty", jsii_struct_bases=[], name_mapping={'status_codes': 'statusCodes'})
    class OriginGroupFailoverCriteriaProperty():
        def __init__(self, *, status_codes: typing.Union["CfnDistribution.StatusCodesProperty", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def status_codes(self) -> typing.Union["CfnDistribution.StatusCodesProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginGroupMemberProperty", jsii_struct_bases=[], name_mapping={'origin_id': 'originId'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginGroupMembersProperty", jsii_struct_bases=[], name_mapping={'items': 'items', 'quantity': 'quantity'})
    class OriginGroupMembersProperty():
        def __init__(self, *, items: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginGroupMemberProperty", _IResolvable_9ceae33e]]], quantity: jsii.Number) -> None:
            """
        ...
        @builtins.property
        def items(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginGroupMemberProperty", _IResolvable_9ceae33e]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginGroupProperty", jsii_struct_bases=[], name_mapping={'failover_criteria': 'failoverCriteria', 'id': 'id', 'members': 'members'})
    class OriginGroupProperty():
        def __init__(self, *, failover_criteria: typing.Union["CfnDistribution.OriginGroupFailoverCriteriaProperty", _IResolvable_9ceae33e], id: str, members: typing.Union["CfnDistribution.OriginGroupMembersProperty", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def failover_criteria(self) -> typing.Union["CfnDistribution.OriginGroupFailoverCriteriaProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def members(self) -> typing.Union["CfnDistribution.OriginGroupMembersProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginGroupsProperty", jsii_struct_bases=[], name_mapping={'quantity': 'quantity', 'items': 'items'})
    class OriginGroupsProperty():
        def __init__(self, *, quantity: jsii.Number, items: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginGroupProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def items(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginGroupProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginProperty", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'id': 'id', 'connection_attempts': 'connectionAttempts', 'connection_timeout': 'connectionTimeout', 'custom_origin_config': 'customOriginConfig', 'origin_custom_headers': 'originCustomHeaders', 'origin_path': 'originPath', 's3_origin_config': 's3OriginConfig'})
    class OriginProperty():
        def __init__(self, *, domain_name: str, id: str, connection_attempts: typing.Optional[jsii.Number]=None, connection_timeout: typing.Optional[jsii.Number]=None, custom_origin_config: typing.Optional[typing.Union["CfnDistribution.CustomOriginConfigProperty", _IResolvable_9ceae33e]]=None, origin_custom_headers: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginCustomHeaderProperty", _IResolvable_9ceae33e]]]]=None, origin_path: typing.Optional[str]=None, s3_origin_config: typing.Optional[typing.Union["CfnDistribution.S3OriginConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
            ...
            if connection_attempts is not None: self._values["connection_attempts"] = connection_attempts
            if connection_timeout is not None: self._values["connection_timeout"] = connection_timeout
        ...
        @builtins.property
        def custom_origin_config(self) -> typing.Optional[typing.Union["CfnDistribution.CustomOriginConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def origin_custom_headers(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnDistribution.OriginCustomHeaderProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def s3_origin_config(self) -> typing.Optional[typing.Union["CfnDistribution.S3OriginConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.RestrictionsProperty", jsii_struct_bases=[], name_mapping={'geo_restriction': 'geoRestriction'})
    class RestrictionsProperty():
        def __init__(self, *, geo_restriction: typing.Union["CfnDistribution.GeoRestrictionProperty", _IResolvable_9ceae33e]) -> None:
            """
        ...
        @builtins.property
        def geo_restriction(self) -> typing.Union["CfnDistribution.GeoRestrictionProperty", _IResolvable_9ceae33e]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.S3OriginConfigProperty", jsii_struct_bases=[], name_mapping={'origin_access_identity': 'originAccessIdentity'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.StatusCodesProperty", jsii_struct_bases=[], name_mapping={'items': 'items', 'quantity': 'quantity'})
    class StatusCodesProperty():
        def __init__(self, *, items: typing.Union[_IResolvable_9ceae33e, typing.List[jsii.Number]], quantity: jsii.Number) -> None:
            """
        ...
        @builtins.property
        def items(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[jsii.Number]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.ViewerCertificateProperty", jsii_struct_bases=[], name_mapping={'acm_certificate_arn': 'acmCertificateArn', 'cloud_front_default_certificate': 'cloudFrontDefaultCertificate', 'iam_certificate_id': 'iamCertificateId', 'minimum_protocol_version': 'minimumProtocolVersion', 'ssl_support_method': 'sslSupportMethod'})
    class ViewerCertificateProperty():
        def __init__(self, *, acm_certificate_arn: typing.Optional[str]=None, cloud_front_default_certificate: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, iam_certificate_id: typing.Optional[str]=None, minimum_protocol_version: typing.Optional[str]=None, ssl_support_method: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def cloud_front_default_certificate(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistributionProps", jsii_struct_bases=[], name_mapping={'distribution_config': 'distributionConfig', 'tags': 'tags'})
class CfnDistributionProps():
    def __init__(self, *, distribution_config: typing.Union["CfnDistribution.DistributionConfigProperty", _IResolvable_9ceae33e], tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @builtins.property
    def distribution_config(self) -> typing.Union["CfnDistribution.DistributionConfigProperty", _IResolvable_9ceae33e]:
        """``AWS::CloudFront::Distribution.DistributionConfig``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnStreamingDistribution(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.CfnStreamingDistribution"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, streaming_distribution_config: typing.Union["StreamingDistributionConfigProperty", _IResolvable_9ceae33e], tags: typing.List[_CfnTag_b4661f1a]) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnStreamingDistribution":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def streaming_distribution_config(self) -> typing.Union["StreamingDistributionConfigProperty", _IResolvable_9ceae33e]:
    ...
    def streaming_distribution_config(self, value: typing.Union["StreamingDistributionConfigProperty", _IResolvable_9ceae33e]) -> None:
        jsii.set(self, "streamingDistributionConfig", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnStreamingDistribution.LoggingProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'enabled': 'enabled', 'prefix': 'prefix'})
    class LoggingProperty():
        def __init__(self, *, bucket: str, enabled: typing.Union[bool, _IResolvable_9ceae33e], prefix: str) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnStreamingDistribution.S3OriginProperty", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'origin_access_identity': 'originAccessIdentity'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnStreamingDistribution.StreamingDistributionConfigProperty", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'enabled': 'enabled', 's3_origin': 's3Origin', 'trusted_signers': 'trustedSigners', 'aliases': 'aliases', 'logging': 'logging', 'price_class': 'priceClass'})
    class StreamingDistributionConfigProperty():
        def __init__(self, *, comment: str, enabled: typing.Union[bool, _IResolvable_9ceae33e], s3_origin: typing.Union["CfnStreamingDistribution.S3OriginProperty", _IResolvable_9ceae33e], trusted_signers: typing.Union["CfnStreamingDistribution.TrustedSignersProperty", _IResolvable_9ceae33e], aliases: typing.Optional[typing.List[str]]=None, logging: typing.Optional[typing.Union["CfnStreamingDistribution.LoggingProperty", _IResolvable_9ceae33e]]=None, price_class: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def s3_origin(self) -> typing.Union["CfnStreamingDistribution.S3OriginProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def trusted_signers(self) -> typing.Union["CfnStreamingDistribution.TrustedSignersProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def logging(self) -> typing.Optional[typing.Union["CfnStreamingDistribution.LoggingProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnStreamingDistribution.TrustedSignersProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'aws_account_numbers': 'awsAccountNumbers'})
    class TrustedSignersProperty():
        def __init__(self, *, enabled: typing.Union[bool, _IResolvable_9ceae33e], aws_account_numbers: typing.Optional[typing.List[str]]=None) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnStreamingDistributionProps", jsii_struct_bases=[], name_mapping={'streaming_distribution_config': 'streamingDistributionConfig', 'tags': 'tags'})
class CfnStreamingDistributionProps():
    def __init__(self, *, streaming_distribution_config: typing.Union["CfnStreamingDistribution.StreamingDistributionConfigProperty", _IResolvable_9ceae33e], tags: typing.List[_CfnTag_b4661f1a]) -> None:
    ...
    @builtins.property
    def streaming_distribution_config(self) -> typing.Union["CfnStreamingDistribution.StreamingDistributionConfigProperty", _IResolvable_9ceae33e]:
        """``AWS::CloudFront::StreamingDistribution.StreamingDistributionConfig``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CloudFrontWebDistributionProps", jsii_struct_bases=[], name_mapping={'origin_configs': 'originConfigs', 'alias_configuration': 'aliasConfiguration', 'comment': 'comment', 'default_root_object': 'defaultRootObject', 'enable_ip_v6': 'enableIpV6', 'error_configurations': 'errorConfigurations', 'geo_restriction': 'geoRestriction', 'http_version': 'httpVersion', 'logging_config': 'loggingConfig', 'price_class': 'priceClass', 'viewer_certificate': 'viewerCertificate', 'viewer_protocol_policy': 'viewerProtocolPolicy', 'web_acl_id': 'webACLId'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CustomOriginConfig", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'allowed_origin_ssl_versions': 'allowedOriginSSLVersions', 'http_port': 'httpPort', 'https_port': 'httpsPort', 'origin_keepalive_timeout': 'originKeepaliveTimeout', 'origin_protocol_policy': 'originProtocolPolicy', 'origin_read_timeout': 'originReadTimeout'})
class CustomOriginConfig():
    def __init__(self, *, domain_name: str, allowed_origin_ssl_versions: typing.Optional[typing.List["OriginSslPolicy"]]=None, http_port: typing.Optional[jsii.Number]=None, https_port: typing.Optional[jsii.Number]=None, origin_keepalive_timeout: typing.Optional[_Duration_5170c158]=None, origin_protocol_policy: typing.Optional["OriginProtocolPolicy"]=None, origin_read_timeout: typing.Optional[_Duration_5170c158]=None) -> None:
...
class GeoRestriction(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.GeoRestriction"):
    """Controls the countries in which your content is distributed.
...
class IOriginAccessIdentity(_IResource_72f7ee7e, _IGrantable_0fcfc53a, jsii.compat.Protocol):
...
class _IOriginAccessIdentityProxy(jsii.proxy_for(_IResource_72f7ee7e), jsii.proxy_for(_IGrantable_0fcfc53a)):
    """Interface for CloudFront OriginAccessIdentity.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.LambdaFunctionAssociation", jsii_struct_bases=[], name_mapping={'event_type': 'eventType', 'lambda_function': 'lambdaFunction'})
class LambdaFunctionAssociation():
    def __init__(self, *, event_type: "LambdaEdgeEventType", lambda_function: _IVersion_1dc10564) -> None:
        """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.LoggingConfiguration", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'include_cookies': 'includeCookies', 'prefix': 'prefix'})
class LoggingConfiguration():
    def __init__(self, *, bucket: typing.Optional[_IBucket_25bad983]=None, include_cookies: typing.Optional[bool]=None, prefix: typing.Optional[str]=None) -> None:
...
class OriginAccessIdentity(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.OriginAccessIdentity"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_origin_access_identity_name(cls, scope: _Construct_f50a3f53, id: str, origin_access_identity_name: str) -> "IOriginAccessIdentity":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.OriginAccessIdentityProps", jsii_struct_bases=[], name_mapping={'comment': 'comment'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.S3OriginConfig", jsii_struct_bases=[], name_mapping={'s3_bucket_source': 's3BucketSource', 'origin_access_identity': 'originAccessIdentity'})
class S3OriginConfig():
    def __init__(self, *, s3_bucket_source: _IBucket_25bad983, origin_access_identity: typing.Optional["IOriginAccessIdentity"]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.SourceConfiguration", jsii_struct_bases=[], name_mapping={'behaviors': 'behaviors', 'custom_origin_source': 'customOriginSource', 'origin_headers': 'originHeaders', 'origin_path': 'originPath', 's3_origin_source': 's3OriginSource'})
...
class ViewerCertificate(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.ViewerCertificate"):
    ...
    @builtins.classmethod
    def from_acm_certificate(cls, certificate: _ICertificate_8f3d4c96, *, aliases: typing.Optional[typing.List[str]]=None, security_policy: typing.Optional["SecurityPolicyProtocol"]=None, ssl_method: typing.Optional["SSLMethod"]=None) -> "ViewerCertificate":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.ViewerCertificateOptions", jsii_struct_bases=[], name_mapping={'aliases': 'aliases', 'security_policy': 'securityPolicy', 'ssl_method': 'sslMethod'})
...
class CloudFrontWebDistribution(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.CloudFrontWebDistribution"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, origin_configs: typing.List["SourceConfiguration"], alias_configuration: typing.Optional["AliasConfiguration"]=None, comment: typing.Optional[str]=None, default_root_object: typing.Optional[str]=None, enable_ip_v6: typing.Optional[bool]=None, error_configurations: typing.Optional[typing.List["CfnDistribution.CustomErrorResponseProperty"]]=None, geo_restriction: typing.Optional["GeoRestriction"]=None, http_version: typing.Optional["HttpVersion"]=None, logging_config: typing.Optional["LoggingConfiguration"]=None, price_class: typing.Optional["PriceClass"]=None, viewer_certificate: typing.Optional["ViewerCertificate"]=None, viewer_protocol_policy: typing.Optional["ViewerProtocolPolicy"]=None, web_acl_id: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param origin_configs: The origin configurations for this distribution. Behaviors are a part of the origin.
