...
class HelmChart(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_eks.HelmChart"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cluster: "Cluster", chart: str, create_namespace: typing.Optional[bool]=None, namespace: typing.Optional[str]=None, release: typing.Optional[str]=None, repository: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None, values: typing.Optional[typing.Mapping[str, typing.Any]]=None, version: typing.Optional[str]=None, wait: typing.Optional[bool]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cluster: The EKS cluster to apply this configuration to. [disable-awslint:ref-via-interface]
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_eks.HelmChartOptions", jsii_struct_bases=[], name_mapping={'chart': 'chart', 'create_namespace': 'createNamespace', 'namespace': 'namespace', 'release': 'release', 'repository': 'repository', 'timeout': 'timeout', 'values': 'values', 'version': 'version', 'wait': 'wait'})
class HelmChartOptions():
    def __init__(self, *, chart: str, create_namespace: typing.Optional[bool]=None, namespace: typing.Optional[str]=None, release: typing.Optional[str]=None, repository: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None, values: typing.Optional[typing.Mapping[str, typing.Any]]=None, version: typing.Optional[str]=None, wait: typing.Optional[bool]=None) -> None:
        """Helm Chart options.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_eks.HelmChartProps", jsii_struct_bases=[HelmChartOptions], name_mapping={'chart': 'chart', 'create_namespace': 'createNamespace', 'namespace': 'namespace', 'release': 'release', 'repository': 'repository', 'timeout': 'timeout', 'values': 'values', 'version': 'version', 'wait': 'wait', 'cluster': 'cluster'})
...
class Cluster(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_eks.Cluster"):
    ...
    def add_chart(self, id: str, *, chart: str, create_namespace: typing.Optional[bool]=None, namespace: typing.Optional[str]=None, release: typing.Optional[str]=None, repository: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None, values: typing.Optional[typing.Mapping[str, typing.Any]]=None, version: typing.Optional[str]=None, wait: typing.Optional[bool]=None) -> "HelmChart":
