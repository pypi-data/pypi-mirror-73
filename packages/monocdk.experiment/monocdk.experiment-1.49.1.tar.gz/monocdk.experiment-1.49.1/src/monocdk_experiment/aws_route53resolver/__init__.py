...
class CfnResolverEndpoint(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverEndpoint"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, direction: str, ip_addresses: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["IpAddressRequestProperty", _IResolvable_9ceae33e]]], security_group_ids: typing.List[str], name: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnResolverEndpoint":
    ...
    def ip_addresses(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["IpAddressRequestProperty", _IResolvable_9ceae33e]]]:
    ...
    @ip_addresses.setter
    def ip_addresses(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["IpAddressRequestProperty", _IResolvable_9ceae33e]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverEndpoint.IpAddressRequestProperty", jsii_struct_bases=[], name_mapping={'subnet_id': 'subnetId', 'ip': 'ip'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverEndpointProps", jsii_struct_bases=[], name_mapping={'direction': 'direction', 'ip_addresses': 'ipAddresses', 'security_group_ids': 'securityGroupIds', 'name': 'name', 'tags': 'tags'})
class CfnResolverEndpointProps():
    def __init__(self, *, direction: str, ip_addresses: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnResolverEndpoint.IpAddressRequestProperty", _IResolvable_9ceae33e]]], security_group_ids: typing.List[str], name: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @builtins.property
    def ip_addresses(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnResolverEndpoint.IpAddressRequestProperty", _IResolvable_9ceae33e]]]:
        """``AWS::Route53Resolver::ResolverEndpoint.IpAddresses``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnResolverRule(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRule"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, domain_name: str, rule_type: str, name: typing.Optional[str]=None, resolver_endpoint_id: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, target_ips: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetAddressProperty", _IResolvable_9ceae33e]]]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnResolverRule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def target_ips(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetAddressProperty", _IResolvable_9ceae33e]]]]:
    ...
    @target_ips.setter
    def target_ips(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetAddressProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "targetIps", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRule.TargetAddressProperty", jsii_struct_bases=[], name_mapping={'ip': 'ip', 'port': 'port'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnResolverRuleAssociation(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRuleAssociation"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, resolver_rule_id: str, vpc_id: str, name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnResolverRuleAssociation":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRuleAssociationProps", jsii_struct_bases=[], name_mapping={'resolver_rule_id': 'resolverRuleId', 'vpc_id': 'vpcId', 'name': 'name'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_route53resolver.CfnResolverRuleProps", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'rule_type': 'ruleType', 'name': 'name', 'resolver_endpoint_id': 'resolverEndpointId', 'tags': 'tags', 'target_ips': 'targetIps'})
class CfnResolverRuleProps():
    def __init__(self, *, domain_name: str, rule_type: str, name: typing.Optional[str]=None, resolver_endpoint_id: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, target_ips: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnResolverRule.TargetAddressProperty", _IResolvable_9ceae33e]]]]=None) -> None:
    ...
    @builtins.property
    def target_ips(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnResolverRule.TargetAddressProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::Route53Resolver::ResolverRule.TargetIps``.
