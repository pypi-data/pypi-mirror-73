...
# api.transmit.upload_json_content(task_id=24118143, content=json_content, file_name="task.json")
...
#
# print("======= 停止任务 =============")
# stop_task = api.task.stop_task(task_param_list=[23750805])
# print(stop_task)

# print("======= 开始任务 =============")
# start_task = api.task.start_task(task_param_list=[23750805])
# print(start_task)

# print("======= 放弃任务 =============")
# abort_task = api.task.abort_task(task_param_list=[23750805])
# print(abort_task)

# print("======= 删除任务 =============")
# delete_task = api.task.delete_task(task_param_list=[23750805])
# print(delete_task)

# print("======= 获取任务渲染帧详情 =============")
# task_frame = api.query.task_frames(task_id=23750805, page_num=1, page_size=1)
# print(task_frame)
...
# print("======= 删除自定义标签 =============")
# delete_label_name = api.tag.delete_label(del_name="test_tag5")
...
# print("======= 删除用户渲染环境配置 =============")
# delete_user_env = api.env.delete_render_env(edit_name="testRenderEnv3")
# print(delete_user_env)

# print("======= 设置默认渲染环境配置 =============")
# set_default_user_env = api.env.set_default_render_env(edit_name="testRenderEnv6")
# print(set_default_user_env)

# print("======= 获取用户渲染环境配置 =============")
# user_render_config = api.env.get_render_env(name='maya')
...
# print("======= 加载缩略图 =============")
# frame_thumbnall = api.query.get_frame_thumbnall(frame_id=448872939)
...
# print("======= 全速渲染 =============")
# full_speed_render = api.task.full_speed(task_id_list=[23750805])
