...
class CfnApiProps():
    def __init__(self, *, stage_name: str, access_log_setting: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnApi.AccessLogSettingProperty"]]=None, auth: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnApi.AuthProperty"]]=None, binary_media_types: typing.Optional[typing.List[str]]=None, cache_cluster_enabled: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, cache_cluster_size: typing.Optional[str]=None, cors: typing.Optional[typing.Union[str, aws_cdk.core.IResolvable, "CfnApi.CorsConfigurationProperty"]]=None, definition_body: typing.Any=None, definition_uri: typing.Optional[typing.Union[str, aws_cdk.core.IResolvable, "CfnApi.S3LocationProperty"]]=None, endpoint_configuration: typing.Optional[str]=None, method_settings: typing.Optional[typing.Union[typing.List[typing.Any], aws_cdk.core.IResolvable]]=None, name: typing.Optional[str]=None, open_api_version: typing.Optional[str]=None, tracing_enabled: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, variables: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, str]]]=None) -> None:
        ...
        if open_api_version is not None: self._values["open_api_version"] = open_api_version
...
class CfnFunction(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sam.CfnFunction"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-sam.CfnFunction.EventBridgeRuleEventProperty", jsii_struct_bases=[], name_mapping={'pattern': 'pattern', 'event_bus_name': 'eventBusName', 'input': 'input', 'input_path': 'inputPath'})
    class EventBridgeRuleEventProperty():
        def __init__(self, *, pattern: typing.Any, event_bus_name: typing.Optional[str]=None, input: typing.Optional[str]=None, input_path: typing.Optional[str]=None) -> None:
            """
        ...
        def __repr__(self) -> str:
            return 'EventBridgeRuleEventProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
