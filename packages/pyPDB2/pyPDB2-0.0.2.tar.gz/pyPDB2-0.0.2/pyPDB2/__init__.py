...
class errorBox:
    ...
    def draw(self):
        ...
        while loop == True:
            ...
            pygame.draw.rect(self.disp, red, (okBut))

            eText = font1.render('Error', True, (white))
            self.disp.blit(eText, (70, 10))

            okText = font1.render('Ok', True, (black))
            self.disp.blit(okText, (85, 60))
    

            if mouseClicked and okBut.collidepoint(mX, mY):
                loop = False
                pygame.quit()
