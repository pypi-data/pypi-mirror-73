...
from fuglu.shared import ScannerPlugin, AppenderPlugin, SuspectFilter, DUNNO, FileList
    ...
    def examine(self, suspect):
        ...
        if fuhash.digest is not None:
            ...
            try:
                ...
                self.logger.error('%s failed to connect to redis server: %s' % (suspect.id, str(e)))
                return DUNNO
