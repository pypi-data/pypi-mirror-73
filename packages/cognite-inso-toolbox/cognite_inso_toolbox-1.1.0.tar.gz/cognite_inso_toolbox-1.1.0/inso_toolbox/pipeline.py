...
class Pipeline(object):
    ...
    Example:
        ...
        Interpolating (where data is a pd.DataFrame with columns id1 and id2):
    ...
    def add_sequential(
        ...
        """
        Adds the specified functions in a list to perform sequentially on the columns.
        Args:
            columns (str or List[str]): column names to apply the functions on.
            functions (Callable or List[Callable]): functions to apply on the specified columns.
                Function output will overwrite the specified columns.
            output_names (Union[str, List[str]]): names of output columns if output should not be inplace.
        Returns:
            None
        """
        # Clean input data
