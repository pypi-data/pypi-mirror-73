...
Python DynamoDB Lock could always use more documentation, whether as part of the
official Python DynamoDB Lock docs, in docstrings, or even on the web in blog posts,
articles, and such.
