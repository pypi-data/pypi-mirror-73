...
__jsii_assembly__ = jsii.JSIIAssembly.load("@matthewbonig/sqs-redrive", "1.51.1", __name__, "sqs-redrive@1.51.1.jsii.tgz")


class SqsRedrive(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@matthewbonig/sqs-redrive.SqsRedrive"):
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, dead_letter_queue: aws_cdk.aws_sqs.IQueue, main_queue: aws_cdk.aws_sqs.IQueue, lambda_props: typing.Optional[aws_cdk.aws_lambda_nodejs.NodejsFunctionProps]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :param lambda_props: -
        """
        props = SqsRedriveProps(dead_letter_queue=dead_letter_queue, main_queue=main_queue, lambda_props=lambda_props)

        jsii.create(SqsRedrive, self, [scope, id, props])


@jsii.data_type(jsii_type="@matthewbonig/sqs-redrive.SqsRedriveProps", jsii_struct_bases=[], name_mapping={'dead_letter_queue': 'deadLetterQueue', 'main_queue': 'mainQueue', 'lambda_props': 'lambdaProps'})
class SqsRedriveProps():
    def __init__(self, *, dead_letter_queue: aws_cdk.aws_sqs.IQueue, main_queue: aws_cdk.aws_sqs.IQueue, lambda_props: typing.Optional[aws_cdk.aws_lambda_nodejs.NodejsFunctionProps]=None):
        """
        :param dead_letter_queue: -
        :param main_queue: -
        :param lambda_props: -
        """
        if isinstance(lambda_props, dict): lambda_props = aws_cdk.aws_lambda_nodejs.NodejsFunctionProps(**lambda_props)
        self._values = {
            'dead_letter_queue': dead_letter_queue,
            'main_queue': main_queue,
        }
        if lambda_props is not None: self._values["lambda_props"] = lambda_props
    ...
    @builtins.property
    def lambda_props(self) -> typing.Optional[aws_cdk.aws_lambda_nodejs.NodejsFunctionProps]:
    ...
    def __repr__(self) -> str:
        return 'SqsRedriveProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


__all__ = ["SqsRedrive", "SqsRedriveProps", "__jsii_assembly__"]
