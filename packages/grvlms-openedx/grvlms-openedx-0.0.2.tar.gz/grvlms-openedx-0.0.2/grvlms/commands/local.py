...
@click.pass_context
def local(context):
    context.obj = LocalContext(context.obj.root, context.obj.user, context.obj.remote_config)
...
See the official certbot documentation for your platform: https://certbot.eff.org/""".format(
    ...
    utils.docker_run(
        "--volume",
        "{}:/etc/letsencrypt/".format(grvlms_env.data_path(context.root, "letsencrypt")),
        "-p",
        "80:80",
        "--entrypoint=sh",
