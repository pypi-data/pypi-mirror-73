...
class ExperienceBase(object):
    ...
    """
    def __init__(self, python_executable=executable, script_name=None, save_filename="latest.pkl", job_filename='latest.job', output_dir='output', job_name='latest'):
        """
    ...
    def _generate_jobfile(self):
        ...
        for exclusive_namespace, sub_dict in self._sub_exclusive_namespace_dict.items():
            ...
            for item in experience_parameter_product:
                ...
                item_copy[exclusive_namespace] = namespace_product
