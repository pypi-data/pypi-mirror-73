...
class CfnWorkspace(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-workspaces.CfnWorkspace"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, bundle_id: str, directory_id: str, user_name: str, root_volume_encryption_enabled: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, user_volume_encryption_enabled: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, volume_encryption_key: typing.Optional[str]=None, workspace_properties: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "WorkspacePropertiesProperty"]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnWorkspace":
    ...
    def root_volume_encryption_enabled(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    def root_volume_encryption_enabled(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
        jsii.set(self, "rootVolumeEncryptionEnabled", value)

    @builtins.property
    @jsii.member(jsii_name="userVolumeEncryptionEnabled")
    def user_volume_encryption_enabled(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    def user_volume_encryption_enabled(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
    ...
    def workspace_properties(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "WorkspacePropertiesProperty"]]:
    ...
    def workspace_properties(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "WorkspacePropertiesProperty"]]) -> None:
...
class CfnWorkspaceProps():
    ...
    @builtins.property
    def workspace_properties(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnWorkspace.WorkspacePropertiesProperty"]]:
        """``AWS::WorkSpaces::Workspace.WorkspaceProperties``.
