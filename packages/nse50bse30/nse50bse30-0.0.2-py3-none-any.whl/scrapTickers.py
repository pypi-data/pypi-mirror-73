...
def getNSE50():
    ...
    n50data = requests.get("https://www1.nseindia.com/live_market/dynaContent/live_watch/stock_watch/niftyStockWatch.json", headers=n50_headers);
...
def getBSE30():
    ...
    bse30data = requests.get("https://api.bseindia.com/BseIndiaAPI/api/GetMktData/w?ordcol=TT&strType=index&strfilter=S%26P+BSE+SENSEX", headers=bse30_headers)
