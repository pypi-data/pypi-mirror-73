...
class BaseModel(object):
    ...
    def __build_necessary__(self, generated_shape: List[tuple]) -> bool:
        ...
        if self.keras_model is not None:
            input_shape = self.keras_model.get_input_shape_at(0)[1:]
    ...
    def __build_model__(self,
        ...
        with strategy.scope():
            ...
            self.output_names = [l.name for l in self.keras_model._output_layers]
        return
