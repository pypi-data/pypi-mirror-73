...
class ClusterApi(object):
    ...
    def delete_result_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `id` when calling `delete_result`, length must be less than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) < 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `delete_result`, length must be greater than or equal to `36`")  # noqa: E501
        collection_formats = {}
    ...
    def get_result_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) > 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `get_result`, length must be less than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) < 36):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `get_result`, length must be greater than or equal to `36`")  # noqa: E501
        collection_formats = {}
