...
class TestD64_fsck(unittest.TestCase):
    ...
    def test_file_unclosed(self):
        ...
        try:
            image.open('rb')
            self.assertTrue(image.path('SMALL10').entry.closed)
        finally:
            image.close()
    ...
    def test_file_loop_1st(self):
        ...
        try:
            image.open('rb')
            self.assertNotEqual(image.path('LARGE4').entry.first_block, image.path('LARGE5').entry.first_block)
        finally:
            image.close()
    ...
    def test_file_bad_link(self):
        ...
        try:
            image.open('rb')
            self.assertEqual(image.path('LARGE10').size_blocks, 2)
        finally:
            image.close()
    ...
    def test_file_xlink(self):
        ...
        try:
            ...
            self.assertEqual(image.path('LARGE10').size_blocks, 4)
        finally:
            image.close()
    ...
    def test_ss_bad_index(self):
        ...
        try:
            image.open('rb')
            side_sector = SideSector(image, *image.path('DATABASE').entry.side_sector_ts)
