...
class DB:
    ...
    def __init__(self, db_path=None):
        self.db_path = db_path or guess_database_path()
        ...
        self.collection_names = self.query_df(collection_names_query).T.values.tolist()[0]
    ...
    def draw_creator_graph(self, collection: str) -> plt.Figure:
        ...
        :rtype: plt.Figure
        """
        g = self.build_creator_graph(collection)
        ...
        nx.draw_networkx(g, pos=layout, with_labels=True, node_color=colors,
                         node_size=sizes_normed, alpha=0.9, font_size=6)
        return fig
