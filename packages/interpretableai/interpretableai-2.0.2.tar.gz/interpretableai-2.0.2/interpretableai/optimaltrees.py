from .iai import _IAI, _iai_version_less_than
...
class OptimalTreeSurvivalLearner(OptimalTreeLearner, SurvivalTreeLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalTreeSurvivalLearner <https://docs.interpretable.ai/v1.2.0/OptimalTrees/reference/#IAI.OptimalTreeSurvivalLearner>`

    Examples
    --------
    >>> OptimalTreeSurvivalLearner(**kwargs)
