...
class NorgateDataIndexConstituent(Filter):
    ...
    def _compute(self, arrays, dates, assets, mask):
        logger.info('Populating ' + self.__class__.__name__ + ' pipeline populating with ' + self._indexname + ' on ' + str(assets.size) + ' securities from ' + str(dates[0].strftime('%Y-%m-%d')) + ' to ' + str(dates[-1].strftime('%Y-%m-%d')) + '....' )
