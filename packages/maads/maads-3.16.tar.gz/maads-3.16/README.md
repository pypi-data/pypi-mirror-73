...
- Automatically optimize the optimal algorithms by MINIMIZING or MAXIMIZING them to find optimal values of the independent variables
...
**19. maads.optimize(MAADSTOKEN,maads_rest_url,algo1,ismin=1,objeq='1,1,1',a1cons=1,forceupdate=0,algo2='',algo3='',a2cons='1',a3cons='1',iters=100,step=3,perc='min_0_max_0')**

// optimize (maadstoken,algo1,ismin=1,objeq='1,1,1',a1cons='1',forceupdate=0,algo2='',algo3='',a2cons='1',a3cons='1',iters=100,step=3,perc='min_0_max_0'):
...
- objeq is when you have a multi-objective optimal algorithms you want to maximize or minimize.  For example, if you want to minimize TWO optimal algorithms and you want an objective function= algo1 + algo1, then objeq=1,1.  If objective function=-algo1 - algo2 then objeq=-1,-1.  If objective function=-algo1 + algo2 + algo3 then objeq=-1,1,1, etc.  etc.  
...
*step* : int, optional, default=3, can be 1,2,3
