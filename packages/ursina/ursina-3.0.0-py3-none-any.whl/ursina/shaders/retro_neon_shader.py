...
void main() {
    ...
    color.r = mix(bottom_color.r, top_color.r, normal_y);
    // vec4 color = bottom_color;
...
if __name__ == '__main__':
    ...
    for e in (a, b):
        ...
        e.set_shader_input('top_color',  (255, 0, 0, 255))
        e.set_shader_input('bottom_color', color.red)
