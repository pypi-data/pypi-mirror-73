...
def get_config(file_path=None):
    ...
    if main_config:
        config = {
            ...
            "marathon_site_test": os.environ.get(
                "marathon_site_test", main_config.get("marathon", "site_test")
            ),
        ...
        config = {
            ...
            "marathon_site_test": os.environ.get("marathon_site_test"),
...
def deploy_jobs(
    ...
    removed_fields = remove_fields(filtered_jobs, ("version", "versionInfo", "fetch"))
    all_ok = deploy_apps(test, marathon_site, user, password, removed_fields)
    return all_ok
