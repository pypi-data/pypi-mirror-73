...
start = time.time()
for i in range(repeats):
    real_data_vector = al.util.inversion.data_vector_via_transformed_mapping_matrix_from(
...
start = time.time()
for i in range(repeats):
    imag_data_vector = al.util.inversion.data_vector_via_transformed_mapping_matrix_from(
...
start = time.time()
for i in range(repeats):
    real_curvature_matrix = al.util.inversion.curvature_matrix_via_transformed_mapping_matrix_from(
        transformed_mapping_matrix=transformed_mapping_matrices[0],
...
start = time.time()
for i in range(repeats):
    imag_curvature_matrix = al.util.inversion.curvature_matrix_via_transformed_mapping_matrix_from(
        transformed_mapping_matrix=transformed_mapping_matrices[1],
...
start = time.time()
for i in range(repeats):
    real_mapped_visibilities = al.util.inversion.mapped_reconstructed_data_from(
...
start = time.time()
for i in range(repeats):
    imag_mapped_visibilities = al.util.inversion.mapped_reconstructed_data_from(
