...
void init_replayer(pybind11::module& m) {
  ...
  pybind11::module m_sub = m.def_submodule("replayer");
  pybind11::class_<Order>(m_sub, "Order")
      .def(pybind11::init<>())
  ...
  pybind11::class_<UnitCommand>(m_sub, "UnitCommand")
      .def(pybind11::init<>())
  ...
  pybind11::class_<Unit> unit(m_sub, "Unit");
...
#undef DO_FLAG
  ...
  pybind11::class_<Resources>(m_sub, "Resources")
      .def(pybind11::init<>())
  ...
  pybind11::class_<Replayer>(m_sub, "Replayer")
      .def(pybind11::init<>())
