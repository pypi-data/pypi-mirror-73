    ...
    def __main_parsing(self):
        ...
        while not Q.is_empty():
            ...
            while not S.is_empty():
                ...
                leftThreshold = ( listin[temp1]['xmin'] + ((1/7) * listin[temp1]['w']) ) if label != 10 else listin[temp1]['xmin']
                rightThreshold = ( listin[temp1]['xmax'] - ((1/7) * listin[temp1]['w']) ) if label != 10 else listin[temp1]['xmax']
