...
class Hyperlinks(Collection):
    ...
    def get_hyperlink(self, i_object=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-11 12:40:47.360445))
    ...
    def item(self, i_index=None):
        ...
        :return: Hyperlink
        """
        return Hyperlink(self.hyperlinks.Item(i_index.com_object))
    ...
    def remove(self, i_index=None):
        ...
        :return: None
        """
        return self.hyperlinks.Remove(i_index.com_object)
        ...
        # # vba_code = """
        # # Public Function remove(hyperlinks)
        # #     Dim iIndex (2)
        # #     hyperlinks.Remove iIndex
        # #     remove = iIndex
        # # End Function
        # # """
