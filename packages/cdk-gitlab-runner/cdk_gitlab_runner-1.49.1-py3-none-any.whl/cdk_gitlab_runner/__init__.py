...
class GitlabContainerRunner(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk-gitlab-runner.GitlabContainerRunner"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, gitlabtoken: str, ec2iamrole: typing.Optional[aws_cdk.aws_iam.IRole]=None, ec2type: typing.Optional[str]=None, selfvpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None, tag1: typing.Optional[str]=None, tag2: typing.Optional[str]=None, tag3: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param gitlabtoken: 
...
class GitlabContainerRunnerProps():
    def __init__(self, *, gitlabtoken: str, ec2iamrole: typing.Optional[aws_cdk.aws_iam.IRole]=None, ec2type: typing.Optional[str]=None, selfvpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None, tag1: typing.Optional[str]=None, tag2: typing.Optional[str]=None, tag3: typing.Optional[str]=None) -> None:
        """
        :param gitlabtoken: 
        :param ec2iamrole: 
        :param ec2type: 
