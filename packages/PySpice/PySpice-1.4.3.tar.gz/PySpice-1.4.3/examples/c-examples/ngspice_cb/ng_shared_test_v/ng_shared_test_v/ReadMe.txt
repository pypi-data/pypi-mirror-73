========================================================================
    KONSOLENANWENDUNG: ng_shared_test_v-Projektübersicht
========================================================================

Diese ng_shared_test_v-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die ng_shared_test_v-Anwendung besteht.


ng_shared_test_v.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen ng_shared_test_v.pch sowie eine vorkompilierte 
