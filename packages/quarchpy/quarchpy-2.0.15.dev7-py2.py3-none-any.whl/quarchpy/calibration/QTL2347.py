...
class QTL2347 (PowerModule):
    ...
    class QTL2347_3V3_AUX_LeakageCalibration (QTL2347Calibration):
        ...
        def init(self):
            ...
            # Ask user to setup 3.3V Aux Leakage
            showDialog(title="Setup 3.3V Leakage Calibration",message="\aPlease connect the load to the 3.3v Aux channel and disconnect host power")
