...
class CfnCustomDataIdentifier(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-macie.CfnCustomDataIdentifier"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, name: str, regex: str, description: typing.Optional[str]=None, ignore_words: typing.Optional[typing.List[str]]=None, keywords: typing.Optional[typing.List[str]]=None, maximum_match_distance: typing.Optional[jsii.Number]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnCustomDataIdentifier":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-macie.CfnCustomDataIdentifierProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'regex': 'regex', 'description': 'description', 'ignore_words': 'ignoreWords', 'keywords': 'keywords', 'maximum_match_distance': 'maximumMatchDistance'})
...
@jsii.implements(aws_cdk.core.IInspectable)
class CfnFindingsFilter(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-macie.CfnFindingsFilter"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, finding_criteria: typing.Union["FindingCriteriaProperty", aws_cdk.core.IResolvable], name: str, action: typing.Optional[str]=None, description: typing.Optional[str]=None, position: typing.Optional[jsii.Number]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnFindingsFilter":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def finding_criteria(self) -> typing.Union["FindingCriteriaProperty", aws_cdk.core.IResolvable]:
    ...
    def finding_criteria(self, value: typing.Union["FindingCriteriaProperty", aws_cdk.core.IResolvable]) -> None:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-macie.CfnFindingsFilter.CriterionProperty", jsii_struct_bases=[], name_mapping={})
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-macie.CfnFindingsFilter.FindingCriteriaProperty", jsii_struct_bases=[], name_mapping={'criterion': 'criterion'})
    class FindingCriteriaProperty():
        def __init__(self, *, criterion: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnFindingsFilter.CriterionProperty"]]=None) -> None:
            """
        ...
        @builtins.property
        def criterion(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnFindingsFilter.CriterionProperty"]]:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-macie.CfnFindingsFilterProps", jsii_struct_bases=[], name_mapping={'finding_criteria': 'findingCriteria', 'name': 'name', 'action': 'action', 'description': 'description', 'position': 'position'})
class CfnFindingsFilterProps():
    def __init__(self, *, finding_criteria: typing.Union["CfnFindingsFilter.FindingCriteriaProperty", aws_cdk.core.IResolvable], name: str, action: typing.Optional[str]=None, description: typing.Optional[str]=None, position: typing.Optional[jsii.Number]=None) -> None:
    ...
    @builtins.property
    def finding_criteria(self) -> typing.Union["CfnFindingsFilter.FindingCriteriaProperty", aws_cdk.core.IResolvable]:
        """``AWS::Macie::FindingsFilter.FindingCriteria``.
...
@jsii.implements(aws_cdk.core.IInspectable)
class CfnSession(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-macie.CfnSession"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, finding_publishing_frequency: typing.Optional[str]=None, status: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnSession":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-macie.CfnSessionProps", jsii_struct_bases=[], name_mapping={'finding_publishing_frequency': 'findingPublishingFrequency', 'status': 'status'})
