...
class CfnMicrosoftAD(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-directoryservice.CfnMicrosoftAD"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnMicrosoftAD":
    ...
    @vpc_settings.setter
    def vpc_settings(self, value: typing.Union["VpcSettingsProperty", aws_cdk.core.IResolvable]) -> None:
        jsii.set(self, "vpcSettings", value)

    @builtins.property
    @jsii.member(jsii_name="createAlias")
    def create_alias(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    @create_alias.setter
    def create_alias(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
    ...
    def enable_sso(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    @enable_sso.setter
    def enable_sso(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
...
class CfnSimpleAD(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-directoryservice.CfnSimpleAD"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnSimpleAD":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @vpc_settings.setter
    def vpc_settings(self, value: typing.Union[aws_cdk.core.IResolvable, "VpcSettingsProperty"]) -> None:
        jsii.set(self, "vpcSettings", value)
