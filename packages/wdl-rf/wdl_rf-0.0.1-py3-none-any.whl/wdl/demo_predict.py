...
from wdl.run_utils import addwrite_csv2
...
if __name__ == "__main__":
    input_file = 'E:\\keti_data\\A5.csv'
    temp = input_file.split('\\')[-1].split('.')[0]
    trained_weights_file = 'model\\'+temp+'_trained_weights.pkl'
    model_file = 'model\\'+temp+'_RF.pkl'
    fp, pvalue = predict_fp_and_pvalue(input_file, trained_weights_file, model_file)
    save_result_file = 'result\\'+temp+'_result.csv'
    addwrite_csv2(input_file, save_result_file, pvalue, fp)
