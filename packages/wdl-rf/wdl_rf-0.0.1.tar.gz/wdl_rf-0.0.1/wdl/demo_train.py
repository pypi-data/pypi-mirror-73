...
def run_experiment(param):
    ...
    if(param.save_params['flag']):
        ...
        """记录训练过程中调参的结果"""
        save_experiment('result\\experiment_record.csv', param.file_params['input_file'],
                        param.train_params["num_iters"], param.train_params["batch_size"], RMSE, r2)


if __name__ == '__main__':
    param = InitParam("E:\keti_data\A2.csv", 320, 20)
    param.save_model('model\\A2_trained_weights.pkl','model\\A2_RF.pkl')
