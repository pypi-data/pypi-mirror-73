...
class CfnSkill(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/alexa-ask.CfnSkill"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnSkill":
    ...
    def authentication_configuration(self, value: typing.Union["AuthenticationConfigurationProperty", aws_cdk.core.IResolvable]) -> None:
    ...
    def skill_package(self, value: typing.Union[aws_cdk.core.IResolvable, "SkillPackageProperty"]) -> None:
    ...
    class SkillPackageProperty():
        def __init__(self, *, s3_bucket: str, s3_key: str, overrides: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnSkill.OverridesProperty"]]=None, s3_bucket_role: typing.Optional[str]=None, s3_object_version: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def overrides(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnSkill.OverridesProperty"]]:
