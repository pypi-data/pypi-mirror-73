...
class CfdiParser(object):
    ...
    def load_xml(self, xml_file: str):
        with open(xml_file, "rb") as f:
            ...
            conceptos_lines = conceptos.pop("cfdi:Concepto", [])
            if isinstance(conceptos_lines, dict):
                conceptos_lines = [conceptos_lines]

            for c in conceptos_lines:
                line = CfdiLine()
                ...
                line.Descuento = c.pop("Descuento", 0)
