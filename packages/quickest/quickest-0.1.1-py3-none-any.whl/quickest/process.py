...
class Process(DynamicsFactory, GaussianSensorMixin, CostFactory):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            pre_change_states (list, optional): The 0-indexed states that occur before the quickest. Defaults to [0].
            post_change_states (list, optional): The 0-indexed states that occur after the quickest. Defaults to [1].
