...
interface IPlaywrightService_IGetSelectContent extends grpc.MethodDefinition<playwright_pb.Request.selector, playwright_pb.Response.Select> {
...
interface IPlaywrightService_ISelectOption extends grpc.MethodDefinition<playwright_pb.Request.selectOption, playwright_pb.Response.Empty> {
    path: string; // "/.Playwright/SelectOption"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<playwright_pb.Request.selectOption>;
    requestDeserialize: grpc.deserialize<playwright_pb.Request.selectOption>;
    responseSerialize: grpc.serialize<playwright_pb.Response.Empty>;
    responseDeserialize: grpc.deserialize<playwright_pb.Response.Empty>;
}
interface IPlaywrightService_IDeselectOption extends grpc.MethodDefinition<playwright_pb.Request.selector, playwright_pb.Response.Empty> {
...
interface IPlaywrightService_IWaitForElementsState extends grpc.MethodDefinition<playwright_pb.Request.selectorOptions, playwright_pb.Response.Empty> {
...
interface IPlaywrightService_IExecuteJavascriptOnPage extends grpc.MethodDefinition<playwright_pb.Request.jsExecution, playwright_pb.Response.jsResult> {
    path: string; // "/.Playwright/ExecuteJavascriptOnPage"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<playwright_pb.Request.jsExecution>;
    requestDeserialize: grpc.deserialize<playwright_pb.Request.jsExecution>;
    responseSerialize: grpc.serialize<playwright_pb.Response.jsResult>;
    responseDeserialize: grpc.deserialize<playwright_pb.Response.jsResult>;
}
interface IPlaywrightService_IGetPageState extends grpc.MethodDefinition<playwright_pb.Request.Empty, playwright_pb.Response.jsResult> {
...
export interface IPlaywrightServer {
    ...
    getSelectContent: grpc.handleUnaryCall<playwright_pb.Request.selector, playwright_pb.Response.Select>;
    selectOption: grpc.handleUnaryCall<playwright_pb.Request.selectOption, playwright_pb.Response.Empty>;
    deselectOption: grpc.handleUnaryCall<playwright_pb.Request.selector, playwright_pb.Response.Empty>;
    ...
    waitForElementsState: grpc.handleUnaryCall<playwright_pb.Request.selectorOptions, playwright_pb.Response.Empty>;
    executeJavascriptOnPage: grpc.handleUnaryCall<playwright_pb.Request.jsExecution, playwright_pb.Response.jsResult>;
    getPageState: grpc.handleUnaryCall<playwright_pb.Request.Empty, playwright_pb.Response.jsResult>;
}
...
export interface IPlaywrightClient {
    ...
    getSelectContent(request: playwright_pb.Request.selector, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Select) => void): grpc.ClientUnaryCall;
    getSelectContent(request: playwright_pb.Request.selector, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Select) => void): grpc.ClientUnaryCall;
    getSelectContent(request: playwright_pb.Request.selector, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Select) => void): grpc.ClientUnaryCall;
    selectOption(request: playwright_pb.Request.selectOption, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    selectOption(request: playwright_pb.Request.selectOption, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    selectOption(request: playwright_pb.Request.selectOption, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    deselectOption(request: playwright_pb.Request.selector, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    deselectOption(request: playwright_pb.Request.selector, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    deselectOption(request: playwright_pb.Request.selector, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    ...
    waitForElementsState(request: playwright_pb.Request.selectorOptions, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    waitForElementsState(request: playwright_pb.Request.selectorOptions, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    waitForElementsState(request: playwright_pb.Request.selectorOptions, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    executeJavascriptOnPage(request: playwright_pb.Request.jsExecution, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    executeJavascriptOnPage(request: playwright_pb.Request.jsExecution, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    executeJavascriptOnPage(request: playwright_pb.Request.jsExecution, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    getPageState(request: playwright_pb.Request.Empty, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    getPageState(request: playwright_pb.Request.Empty, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    getPageState(request: playwright_pb.Request.Empty, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
}
...
export class PlaywrightClient extends grpc.Client implements IPlaywrightClient {
    ...
    public getSelectContent(request: playwright_pb.Request.selector, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Select) => void): grpc.ClientUnaryCall;
    public getSelectContent(request: playwright_pb.Request.selector, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Select) => void): grpc.ClientUnaryCall;
    public getSelectContent(request: playwright_pb.Request.selector, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Select) => void): grpc.ClientUnaryCall;
    public selectOption(request: playwright_pb.Request.selectOption, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public selectOption(request: playwright_pb.Request.selectOption, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public selectOption(request: playwright_pb.Request.selectOption, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public deselectOption(request: playwright_pb.Request.selector, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public deselectOption(request: playwright_pb.Request.selector, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public deselectOption(request: playwright_pb.Request.selector, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    ...
    public waitForElementsState(request: playwright_pb.Request.selectorOptions, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public waitForElementsState(request: playwright_pb.Request.selectorOptions, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public waitForElementsState(request: playwright_pb.Request.selectorOptions, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.Empty) => void): grpc.ClientUnaryCall;
    public executeJavascriptOnPage(request: playwright_pb.Request.jsExecution, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    public executeJavascriptOnPage(request: playwright_pb.Request.jsExecution, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    public executeJavascriptOnPage(request: playwright_pb.Request.jsExecution, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    public getPageState(request: playwright_pb.Request.Empty, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    public getPageState(request: playwright_pb.Request.Empty, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
    public getPageState(request: playwright_pb.Request.Empty, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: playwright_pb.Response.jsResult) => void): grpc.ClientUnaryCall;
}
