...
class PlaywrightStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SelectOption = channel.unary_unary(
                ...
                request_serializer=playwright__pb2.Request.selectOption.SerializeToString,
                response_deserializer=playwright__pb2.Response.Empty.FromString,
                )
        ...
        self.ExecuteJavascriptOnPage = channel.unary_unary(
                ...
                request_serializer=playwright__pb2.Request.jsExecution.SerializeToString,
                response_deserializer=playwright__pb2.Response.jsResult.FromString,
                )
...
def add_PlaywrightServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SelectOption': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=playwright__pb2.Request.selectOption.FromString,
                    response_serializer=playwright__pb2.Response.Empty.SerializeToString,
            ),
            ...
            'ExecuteJavascriptOnPage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=playwright__pb2.Request.jsExecution.FromString,
                    response_serializer=playwright__pb2.Response.jsResult.SerializeToString,
            ),
...
class Playwright(object):
    ...
    def SelectOption(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Playwright/SelectOption',
            playwright__pb2.Request.selectOption.SerializeToString,
            playwright__pb2.Response.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ExecuteJavascriptOnPage(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Playwright/ExecuteJavascriptOnPage',
            playwright__pb2.Request.jsExecution.SerializeToString,
            playwright__pb2.Response.jsResult.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
