...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="http://localhost:9090/api",
            ...
            'api_key':
                {
                    ...
                    'in': 'header',
                    'key': 'X-Auth',
                    'value': self.get_api_key_with_prefix('X-Auth')
                },
            'basic':
                {
                    'type': 'basic',
                    'in': 'header',
                    'key': 'Authorization',
                    'value': self.get_basic_auth_token() if self.username and self.password else None
                },
            'jwt':
                {
                    'type': 'bearer',
                    ...
                    'format': 'JWT',
                    'key': 'Authorization',
                    'value': 'Bearer ' + self.access_token if self.access_token else None
                },
        }
