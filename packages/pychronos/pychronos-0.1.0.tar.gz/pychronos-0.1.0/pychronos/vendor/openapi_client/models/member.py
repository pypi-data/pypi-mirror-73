...
class Member(object):
    ...
    def __init__(self, type=None, id=None, name=None, email=None, role=None):  # noqa: E501
    ...
    def role(self, role):
        ...
        :type: str
        """
        allowed_values = ["manager", "member", "owner", "annotator", "uploader", "analyst", "maintainer", "owner"]  # noqa: E501
