...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.3.0-alpha.1593770087+f5ea490c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.3.0-alpha.1593770087+f5ea490c`
                """)
            else:
                raise
