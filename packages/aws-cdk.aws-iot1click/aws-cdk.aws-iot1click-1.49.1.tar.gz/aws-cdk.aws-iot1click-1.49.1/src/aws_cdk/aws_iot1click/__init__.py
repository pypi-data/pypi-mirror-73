...
class CfnPlacement(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iot1click.CfnPlacement"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnPlacement":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnProject(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iot1click.CfnProject"):
    ...
    def placement_template(self, value: typing.Union["PlacementTemplateProperty", aws_cdk.core.IResolvable]) -> None:
    ...
    class PlacementTemplateProperty():
        def __init__(self, *, default_attributes: typing.Any=None, device_templates: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, typing.Union[aws_cdk.core.IResolvable, "CfnProject.DeviceTemplateProperty"]]]]=None) -> None:
            """
        ...
        @builtins.property
        def device_templates(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, typing.Union[aws_cdk.core.IResolvable, "CfnProject.DeviceTemplateProperty"]]]]:
