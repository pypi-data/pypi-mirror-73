...
setup(
    ...
    packages=find_packages(include=["dataflow.cli*", "dataflow.cloud*", "dataflow.collections*", "dataflow.creds*", "dataflow.dataset_generators*"], exclude=["dataflow.dataset_generators.intelinair*"]),
    py_modules=[
        "dataflow.config",
        "dataflow.hub_api",
        "dataflow.logger",
    ...
    entry_points={
        "console_scripts": [
            "hub-login = dataflow.cli.auth:login",
        ],
    },
)
