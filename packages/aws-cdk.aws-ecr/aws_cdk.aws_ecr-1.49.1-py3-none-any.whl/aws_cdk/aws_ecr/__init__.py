...
class CfnRepository(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecr.CfnRepository"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, lifecycle_policy: typing.Optional[typing.Union["LifecyclePolicyProperty", aws_cdk.core.IResolvable]]=None, repository_name: typing.Optional[str]=None, repository_policy_text: typing.Any=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    def lifecycle_policy(self) -> typing.Optional[typing.Union["LifecyclePolicyProperty", aws_cdk.core.IResolvable]]:
    ...
    def lifecycle_policy(self, value: typing.Optional[typing.Union["LifecyclePolicyProperty", aws_cdk.core.IResolvable]]) -> None:
...
class CfnRepositoryProps():
    def __init__(self, *, lifecycle_policy: typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", aws_cdk.core.IResolvable]]=None, repository_name: typing.Optional[str]=None, repository_policy_text: typing.Any=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    @builtins.property
    def lifecycle_policy(self) -> typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", aws_cdk.core.IResolvable]]:
        """``AWS::ECR::Repository.LifecyclePolicy``.
