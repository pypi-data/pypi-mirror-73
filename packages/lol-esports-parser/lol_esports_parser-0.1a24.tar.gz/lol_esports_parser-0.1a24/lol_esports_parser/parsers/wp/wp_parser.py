        ...
        for idx, key_player_tuple in enumerate(players_list.items()):
            ...
            if player_dict.get("stats"):
                ...
                end_of_game_stats = LolGamePlayerEndOfGameStats(
                    ...
                    cs=(player_dict["stats"].get("minionsKilled") or player_dict["stats"].get("totalMinionsKilled"))
        ...
        for event in frame["events"]:
            ...
            # Item buying, selling, and undoing
                ...
                try:
                    ...
                    # This happens very rarely for items getting destroyed (eye of the Herald time out?)
                    logging.debug(f"Item destroyed with participantId=0.")
                    continue
