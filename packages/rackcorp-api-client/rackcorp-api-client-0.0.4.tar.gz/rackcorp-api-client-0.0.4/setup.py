...
.. moduleauthor:: dboekelman <dboekelman@rackcorp.com>
"""
...
setup(
    name='rackcorp-api-client',
    description="Command-line application access to RackCorp's API",
    ...
    license='GPLv3',  # noqa
    author='dboekelman',
    author_email='dboekelman@rackcorp.com',
    # Use the URL to the github repo.
    url= 'https://github.com/lord.nk@gmail.com/rackcorp-api-client',
    download_url=(
        f'https://github.com/lord.nk@gmail.com/'
        f'rcapi/archive/{version}.tar.gz'
    ),
    keywords=[
