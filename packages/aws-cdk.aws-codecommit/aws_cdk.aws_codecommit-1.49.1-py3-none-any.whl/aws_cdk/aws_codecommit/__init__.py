...
class CfnRepository(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codecommit.CfnRepository"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnRepository":
    ...
    def triggers(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "RepositoryTriggerProperty"]]]]:
    ...
    @triggers.setter
    def triggers(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "RepositoryTriggerProperty"]]]]) -> None:
...
class CfnRepositoryProps():
    ...
    @builtins.property
    def code(self) -> typing.Optional[typing.Union["CfnRepository.CodeProperty", aws_cdk.core.IResolvable]]:
        """``AWS::CodeCommit::Repository.Code``.
    ...
    @builtins.property
    def triggers(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnRepository.RepositoryTriggerProperty"]]]]:
        """``AWS::CodeCommit::Repository.Triggers``.
