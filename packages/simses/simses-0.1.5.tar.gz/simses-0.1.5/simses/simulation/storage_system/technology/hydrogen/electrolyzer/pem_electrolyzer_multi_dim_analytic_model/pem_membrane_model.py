...
class PemMembraneModel:
    ...
    def get_h2_permeation_for_cell(self, hydrogen_state: HydrogenState, current_cell: float) -> float:
        """
        ...
        part_pressure_h2: float = self.__pressure_model.get_partial_pressure_h2(hydrogen_state, current_dens_cell)
        sat_pressure_h2o: float = self.__pressure_model.get_sat_pressure_h2o(hydrogen_state.temperature_el)
        part_pressure_o2: float = self.__pressure_model.get_partial_pressure_o2(hydrogen_state, current_dens_cell)
    ...
    def get_o2_permeation_for_cell(self, hydrogen_state: HydrogenState, current_cell: float) -> float:
        """
    ...
    def get_h2o_permeation_for_cell(self, current_cell: float) -> float:
        return self.WATER_DRAG_COEFF * current_cell / ConstantsHydrogen.FARADAY_CONST
