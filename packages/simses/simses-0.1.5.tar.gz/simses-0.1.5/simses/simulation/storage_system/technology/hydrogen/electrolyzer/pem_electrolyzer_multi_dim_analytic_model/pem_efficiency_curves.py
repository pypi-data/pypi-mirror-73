...
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.pem_electrolyzer_multi_dim_analytic_model.pem_electrical_model import \
    PemElectricalModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.pem_electrolyzer_multi_dim_analytic_model.pem_fluid_model import \
    PemFluidModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.pem_electrolyzer_multi_dim_analytic_model.pem_membrane_model import \
    PemMembraneModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.pem_electrolyzer_multi_dim_analytic_model.pem_pressure_model import \
    PemPressureModel
...
class PemElectrolyzerEfficiencyCurves:
    ...
    def calculate_efficiency_curves(self, hydrogen_state: HydrogenState, start=0.01, stop=3.01, step=0.01):
        ...
        rev_voltage = self.__electrical_model.get_rev_voltage(hydrogen_state.temperature_el)

        # calculation of partial pressures of hydrogen and oxygen and saturation pressure of water
        h2o_sat_pressure = self.__pressure_model.get_sat_pressure_h2o(hydrogen_state.temperature_el)
