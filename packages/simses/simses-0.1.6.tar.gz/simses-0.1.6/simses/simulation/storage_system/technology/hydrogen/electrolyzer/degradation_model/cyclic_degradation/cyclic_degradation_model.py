...
class CyclicDegradationModel(ABC):
    ...
    def calculate_degradation(self, time: float, hydrogen_state: HydrogenState):
        self.calculate_resistance_increase(time, hydrogen_state)
        self.calculate_exchange_current_dens_decrerase(hydrogen_state)
