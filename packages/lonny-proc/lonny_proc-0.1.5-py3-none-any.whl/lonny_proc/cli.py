...
def _build_targets(args):
    ...
    for target in args.targets:
        ...
        # don't preload the app! Wrap the code in a lambda so the import
        # is loaded by each child separately,
        fn = lambda: import_module(split[0]).__getattribute__(split[1])()
