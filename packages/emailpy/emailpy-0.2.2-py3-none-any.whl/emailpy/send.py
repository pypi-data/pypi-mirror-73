...
def genzoominvite(meetingurl, meetingid = None, meetingpwd = None):
    if meetingid == None:
        meetingid = 'Host has not provided a meeting ID. '
    if meetingpwd == None:
        meetingpwd = 'Host has not provided a meeting Password. '
...
def sendzoominvite(email, pwd, invitees, meetingurl,
                   meetingid = None, meetingpwd = None):
