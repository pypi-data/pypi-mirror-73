...
class ModelInterface(ABC):
    ...
    def get_inputs(self):
        """
        This function will be used to build the Tensorflow inputs. For that we need
        the image_resizer configurations and data augmentation options

        Return:
            inputs: A list of deepomatic.oef.protos.models.image.preprocessing_pb2.Input.
        """
...
class TensorflowModelInterface(ModelInterface):
    ...
    @abstractmethod
    def get_min_number_of_proposals(self):
        """
