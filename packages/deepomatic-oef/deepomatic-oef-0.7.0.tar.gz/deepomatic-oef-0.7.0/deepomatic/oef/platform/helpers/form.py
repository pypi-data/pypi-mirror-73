...
class Form(SectionGroup):
    ...
    def json(self, get_backend_fn):
        ...
        for view_type in self._enabled_models:
            ...
            for model_key in self._enabled_models[view_type]:
                ...
                model_select_tags[model_key] = Tags([get_backend_fn(model_key)])
            ...
            json_payload['view_types'][view_type.value] = {
                ...
                'default_values': {
                    model_key: self._model_json_(model_key, get_backend_fn) for model_key in self._enabled_models[view_type]
                }
            }
    ...
    def _model_json_(self, model_key, get_backend_fn):
        """
        ...
        default_values = {}
        for control in self.controls:
            backend = get_backend_fn(model_key)
