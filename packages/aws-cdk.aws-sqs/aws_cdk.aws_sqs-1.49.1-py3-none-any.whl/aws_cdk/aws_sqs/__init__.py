...
class CfnQueue(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sqs.CfnQueue"):
    ...
    def fifo_queue(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    @fifo_queue.setter
    def fifo_queue(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
...
class CfnQueuePolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sqs.CfnQueuePolicy"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnQueuePolicy":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
