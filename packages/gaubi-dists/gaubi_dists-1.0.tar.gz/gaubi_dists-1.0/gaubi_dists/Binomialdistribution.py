...
class Binomial(Distribution):
    ...
    #           the probability (p) of getting a positive outcome (also known as success)
    ...
    def __init__(self, prob=.5, size=20):
        ...
        # Inilitialize Distribution class first
    ...
    def calculate_mean(self):
        ...
        self.mean = self.n * self.p  # Store mean via self var
    ...
    def calculate_stdev(self):
        ...
        self.stdev = math.sqrt(self.n * self.p * (1 - self.p))  # Store stdev via self var
    ...
    def replace_stats_with_data(self):
        ...
        # Updates size
        self.n = len(self.data)  # Note this self.data comes from Distribution class

        # Calculate and update prob
        count = 0
        for i in self.data:
            if i == 1:
                count += 1

        self.p = 1.0 * count / self.n
    ...
    def plot_bar_pdf(self):
        ...
        # List with x values (or k values for pdf())
        x = [i for i in list(range(0, self.n + 1, 1))]

        # List with y values (or pdf values)
