...
(Rg) and solvent accessible surface area (SASA) estimation. We call these estimations because
they are calculated on short simulations used during optimization (time depends on parameters
used for optimization), therefore you should always run a long simulation at the end of the
optimizaton process, from which you can calculate the real Rg and SASA values for your model.
