...
def prepare_data(root, full_length=False, accelerometer=True, gyroscope=True, orientation=False, stroke=False, merge_clap_null=True, verbose=1):
    csv_list = []
    segment_data_list = []
...
def get_full_length_label_data(root, accelerometer=True, gyroscope=True, orientation=False, stroke=False, merge_clap_null=True, verbose=1):
    ...
    csv_list, segment_data_list, segment_timestamp_list, labels_list, subjects_list, label_info, unique_subjects = prepare_data(
        ...
        merge_clap_null=merge_clap_null, verbose=verbose)
...
def make_training_data(data_root, save_root=None, window_size=300, stride=1, chunk_size=50,
    ...
    if window_size < 1:
        ...
        data, label, subjects, label_info, unique_subjects = prepare_data(data_root, merge_clap_null=merge_clap_null)
