...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.12.0-alpha.1594406446+b847f7ab'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.12.0-alpha.1594406446+b847f7ab`
                """)
            else:
                raise
