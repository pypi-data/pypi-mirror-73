...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.11.0-alpha.1594041189+9bb2068a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.11.0-alpha.1594041189+9bb2068a`
                """)
            else:
                raise
