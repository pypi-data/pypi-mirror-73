...
class TimeSeriesTransaction(ABC, Generic[TSStoreT, TimeSeriesT, TSColumnT]):
    ...
    class CoverageOperation(_Operation):
        ...
        member: Optional[str]
        coverage: Optional[Dict[str, datetime]]
    ...
    class EnsembleOperation(_Operation):
        ...
        time_series: TimeSeriesT
        t0_start: Optional[datetime]
        t0_end: Optional[datetime]
        ensemble_members: Optional[List[EnsembleMemberInfo]]
    ...
    def get_coverage(
        ...
        **kwargs: Mapping,
        ...
        coverage = self.CoverageOperation(
            time_series=ts, t0=t0, dispatch_info=dispatch_info, member=member, coverage=None, kwargs=kwargs
        )
        self._coverage_ops.append(coverage)
        return coverage

    def get_ensemble_members(
        self, ts: TimeSeriesT, t0_start: Optional[datetime], t0_end: Optional[datetime], **kwargs: Mapping
        ...
        """
        ensemble = self.EnsembleOperation(
            time_series=ts, t0_start=t0_start, t0_end=t0_end, ensemble_members=None, kwargs=kwargs
        )
