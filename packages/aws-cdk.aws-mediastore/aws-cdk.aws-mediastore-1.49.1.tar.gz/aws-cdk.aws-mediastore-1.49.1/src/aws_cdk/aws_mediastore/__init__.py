...
class CfnContainer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediastore.CfnContainer"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnContainer":
    ...
    def access_logging_enabled(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    def access_logging_enabled(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
        jsii.set(self, "accessLoggingEnabled", value)

    @builtins.property
    @jsii.member(jsii_name="corsPolicy")
    def cors_policy(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]]]]:
    ...
    @cors_policy.setter
    def cors_policy(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]]]]) -> None:
    ...
    def metric_policy(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "MetricPolicyProperty"]]:
    ...
    def metric_policy(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "MetricPolicyProperty"]]) -> None:
    ...
    class MetricPolicyProperty():
        def __init__(self, *, container_level_metrics: str, metric_policy_rules: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.MetricPolicyRuleProperty"]]]]=None) -> None:
            """
        ...
        @builtins.property
        def metric_policy_rules(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.MetricPolicyRuleProperty"]]]]:
...
class CfnContainerProps():
    ...
    @builtins.property
    def cors_policy(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.CorsRuleProperty"]]]]:
        """``AWS::MediaStore::Container.CorsPolicy``.
    ...
    @builtins.property
    def metric_policy(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnContainer.MetricPolicyProperty"]]:
        """``AWS::MediaStore::Container.MetricPolicy``.
