...
class SIOCore(StreamAppCore):
    def __init__(self, stream, *args, **kwargs):
        super(SIOCore, self).__init__(*args, **kwargs)
        self.__stream = stream
...
class SIOAppManagerCore(SIOCore):
    def __init__(self, stream, *args, **kwargs):
        super(SIOAppManagerCore, self).__init__(stream, *args, **kwargs)
        self._siomap = {}
...
class SIOAppCore(SIOCore):
    def __init__(self, stream, event, *args, **kwargs):
        super(SIOAppCore, self).__init__(stream, *args, **kwargs)
        self._event = event


class SIOAppManager(SIOAppManagerCore):
    def __init__(self, stream, *args, **kwargs):
        super(SIOAppManager, self).__init__(stream, *args, **kwargs)
        self._siomap = {}
