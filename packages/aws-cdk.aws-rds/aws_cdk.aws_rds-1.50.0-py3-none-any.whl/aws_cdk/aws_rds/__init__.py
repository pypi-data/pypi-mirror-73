...
class DatabaseClusterEngine(
    ...
    def __init__(
        self,
        name: str,
        single_user_rotation_application: aws_cdk.aws_secretsmanager.SecretRotationApplication,
        multi_user_rotation_application: aws_cdk.aws_secretsmanager.SecretRotationApplication,
        parameter_group_families: typing.Optional[
            typing.List["ParameterGroupFamily"]
        ] = None,
    ) -> None:
        """
        :param name: -
    ...
    def parameter_group_family(
        self, engine_version: typing.Optional[str] = None
    ) -> typing.Optional[str]:
...
class DatabaseInstanceEngine(
    ...
    def ORACLE_SE1(cls) -> "DatabaseInstanceEngine":
        """
        stability
        :stability: experimental
        """
    ...
    def ORACLE_SE2(cls) -> "DatabaseInstanceEngine":
        """
        stability
        :stability: experimental
        """
    ...
    def __init__(
        ...
        *,
        ...
        props = ParameterGroupProps(
            family=family, description=description, parameters=parameters
        )
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-rds.ParameterGroupFamily",
    jsii_struct_bases=[],
    name_mapping={
...
class ParameterGroupFamily:
    def __init__(
        self, *, engine_major_version: str, parameter_group_family: str
    ) -> None:
    ...
    def __repr__(self) -> str:
        return "ParameterGroupFamily(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class ClusterParameterGroup(
    aws_cdk.core.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-rds.ClusterParameterGroup",
):
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-rds.ClusterParameterGroupProps",
    jsii_struct_bases=[ParameterGroupProps],
    name_mapping={
        "family": "family",
        "description": "description",
        "parameters": "parameters",
