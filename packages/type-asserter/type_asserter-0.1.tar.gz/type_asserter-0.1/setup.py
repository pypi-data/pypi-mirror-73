...
setup(
    ...
    description='This package provide a decorator to check at runtime the functions type hints, raising an TypeError (by default) or a Warning based on a parameter.',  # Give a short description about your library
