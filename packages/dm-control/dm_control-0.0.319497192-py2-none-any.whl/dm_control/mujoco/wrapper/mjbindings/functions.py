...
mjDISABLESTRING = (ctypes.c_char_p * 12).in_dll(mjlib, u'mjDISABLESTRING')
mjENABLESTRING = (ctypes.c_char_p * 4).in_dll(mjlib, u'mjENABLESTRING')
mjTIMERSTRING = (ctypes.c_char_p * 13).in_dll(mjlib, u'mjTIMERSTRING')
mjLABELSTRING = (ctypes.c_char_p * 14).in_dll(mjlib, u'mjLABELSTRING')
mjFRAMESTRING = (ctypes.c_char_p * 7).in_dll(mjlib, u'mjFRAMESTRING')
mjVISSTRING = ((ctypes.c_char_p * 3) * 22).in_dll(mjlib, u'mjVISSTRING')
mjRNDSTRING = ((ctypes.c_char_p * 3) * 9).in_dll(mjlib, u'mjRNDSTRING')
...
class _Callbacks(object):
  ...
  def __init__(self):
    self._mjcb_passive = ctypes.c_void_p.in_dll(mjlib, u'mjcb_passive')
    self._mjcb_control = ctypes.c_void_p.in_dll(mjlib, u'mjcb_control')
    self._mjcb_contactfilter = ctypes.c_void_p.in_dll(mjlib, u'mjcb_contactfilter')
    self._mjcb_sensor = ctypes.c_void_p.in_dll(mjlib, u'mjcb_sensor')
    self._mjcb_time = ctypes.c_void_p.in_dll(mjlib, u'mjcb_time')
    self._mjcb_act_dyn = ctypes.c_void_p.in_dll(mjlib, u'mjcb_act_dyn')
    self._mjcb_act_gain = ctypes.c_void_p.in_dll(mjlib, u'mjcb_act_gain')
    self._mjcb_act_bias = ctypes.c_void_p.in_dll(mjlib, u'mjcb_act_bias')
