...
setup(
    ...
    url='https://github.com/mileo/erpbrail.edoc.gen',
    ...
    project_urls={
        'Documentation': 'https://erpbrailedocgen.readthedocs.io/',
        'Changelog': 'https://erpbrailedocgen.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/mileo/erpbrail.edoc.gen/issues',
    },
    keywords=[
