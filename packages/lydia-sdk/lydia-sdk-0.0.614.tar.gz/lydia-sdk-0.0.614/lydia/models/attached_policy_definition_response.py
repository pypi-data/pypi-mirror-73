...
class AttachedPolicyDefinitionResponse(object):
    ...
    def __init__(self, source_role=None, role_hierarchy_index=None, description=None, applications=None, policy_type=None, id=None, grant=None, selectors=None, _for=None, _if=None, when=None, how=None):  # noqa: E501
        ...
        :param policy_type: 
        :type policy_type: lydia.PolicyType
        :param id: 
        :type id: lydia.PolicyId
        :param grant: 
        :type grant: lydia.Grant
        :param selectors: 
        :type selectors: list[lydia.SelectorDefinition]
        :param _for: 
        :type _for: list[lydia.ForSpec]
        :param _if: 
        :type _if: list[lydia.IfExpression]
        :param when: 
        :type when: lydia.WhenSpec
        :param how: 
        :type how: lydia.HowSpec
