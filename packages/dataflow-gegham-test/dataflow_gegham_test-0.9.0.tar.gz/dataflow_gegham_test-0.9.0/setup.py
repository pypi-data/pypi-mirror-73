...
setup(
    ...
    packages=find_packages(include=["dataflow.cloud*", "dataflow.collections*", "dataflow.creds*"], exclude=["dataflow.dataset_generators.intelinair*", "dataflow.dataset_generators.tests*"]),
    py_modules=[
        "dataflow.config",
        "dataflow.hub_api",
        "dataflow.logger",
