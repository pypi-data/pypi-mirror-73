...
class CfnScalingPlan(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-autoscalingplans.CfnScalingPlan"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnScalingPlan":
    ...
    def application_source(self, value: typing.Union["ApplicationSourceProperty", aws_cdk.core.IResolvable]) -> None:
    ...
    def scaling_instructions(self, value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ScalingInstructionProperty"]]]) -> None:
    ...
    class ApplicationSourceProperty():
        def __init__(self, *, cloud_formation_stack_arn: typing.Optional[str]=None, tag_filters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.TagFilterProperty"]]]]=None) -> None:
            """
        ...
        @builtins.property
        def tag_filters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.TagFilterProperty"]]]]:
    ...
    class CustomizedLoadMetricSpecificationProperty():
        def __init__(self, *, metric_name: str, namespace: str, statistic: str, dimensions: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.MetricDimensionProperty"]]]]=None, unit: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def dimensions(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.MetricDimensionProperty"]]]]:
    ...
    class ScalingInstructionProperty():
        def __init__(self, *, max_capacity: jsii.Number, min_capacity: jsii.Number, resource_id: str, scalable_dimension: str, service_namespace: str, target_tracking_configurations: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.TargetTrackingConfigurationProperty"]]], customized_load_metric_specification: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.CustomizedLoadMetricSpecificationProperty"]]=None, disable_dynamic_scaling: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, predefined_load_metric_specification: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.PredefinedLoadMetricSpecificationProperty"]]=None, predictive_scaling_max_capacity_behavior: typing.Optional[str]=None, predictive_scaling_max_capacity_buffer: typing.Optional[jsii.Number]=None, predictive_scaling_mode: typing.Optional[str]=None, scaling_policy_update_behavior: typing.Optional[str]=None, scheduled_action_buffer_time: typing.Optional[jsii.Number]=None) -> None:
            """
        ...
        @builtins.property
        def customized_load_metric_specification(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.CustomizedLoadMetricSpecificationProperty"]]:
        ...
        @builtins.property
        def disable_dynamic_scaling(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
        ...
        @builtins.property
        def predefined_load_metric_specification(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.PredefinedLoadMetricSpecificationProperty"]]:
    ...
    class TargetTrackingConfigurationProperty():
        def __init__(self, *, target_value: jsii.Number, customized_scaling_metric_specification: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.CustomizedScalingMetricSpecificationProperty"]]=None, disable_scale_in: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, estimated_instance_warmup: typing.Optional[jsii.Number]=None, predefined_scaling_metric_specification: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.PredefinedScalingMetricSpecificationProperty"]]=None, scale_in_cooldown: typing.Optional[jsii.Number]=None, scale_out_cooldown: typing.Optional[jsii.Number]=None) -> None:
            """
        ...
        @builtins.property
        def customized_scaling_metric_specification(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.CustomizedScalingMetricSpecificationProperty"]]:
        ...
        @builtins.property
        def predefined_scaling_metric_specification(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnScalingPlan.PredefinedScalingMetricSpecificationProperty"]]:
