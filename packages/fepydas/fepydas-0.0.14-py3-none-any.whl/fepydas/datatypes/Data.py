...
class VacuumCorrection(Transformation):
  """
  This class generates a Transformation object which performs the vacuum correction with the given parameters. 
  The default parameters correspond to dry air at standard pressure.
  
  Parameters
  ----------
  temperature : float, optional
    Temperature at time of measurement in °C
