...
# dashboard {{{1
class GenericDashboardView(TemplateView):
    models = []
    template_name = 'genviews/dashboard.html'
    template_list_name = 'genviews/dashboard_list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        for m in self.models:
            ...
            model_dict['html'] = m.get_view_data('dashboard', 'html') or self.template_list_name
...
class GenericDetailView(PermissionRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['obj_html'] = self.model.get_view_data('detail', 'detail_html')
