...
class CfnStream(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-kinesis.CfnStream"):
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnStream":
    ...
    def stream_encryption(self) -> typing.Optional[typing.Union["StreamEncryptionProperty", aws_cdk.core.IResolvable]]:
    ...
    def stream_encryption(self, value: typing.Optional[typing.Union["StreamEncryptionProperty", aws_cdk.core.IResolvable]]) -> None:
...
class CfnStreamConsumer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-kinesis.CfnStreamConsumer"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnStreamConsumer":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnStreamProps():
    ...
    @builtins.property
    def stream_encryption(self) -> typing.Optional[typing.Union["CfnStream.StreamEncryptionProperty", aws_cdk.core.IResolvable]]:
        """``AWS::Kinesis::Stream.StreamEncryption``.
