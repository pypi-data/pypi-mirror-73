...
class CfnSubscription(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.CfnSubscription"):
    ...
    def raw_message_delivery(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    def raw_message_delivery(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
...
class CfnSubscriptionProps():
    def __init__(self, *, protocol: str, topic_arn: str, delivery_policy: typing.Any=None, endpoint: typing.Optional[str]=None, filter_policy: typing.Any=None, raw_message_delivery: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, redrive_policy: typing.Any=None, region: typing.Optional[str]=None) -> None:
...
class CfnTopic(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.CfnTopic"):
    ...
    def content_based_deduplication(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    def content_based_deduplication(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
    ...
    def fifo_topic(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    @fifo_topic.setter
    def fifo_topic(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
    ...
    def subscription(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "SubscriptionProperty"]]]]:
    ...
    @subscription.setter
    def subscription(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "SubscriptionProperty"]]]]) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns.CfnTopicProps", jsii_struct_bases=[], name_mapping={'content_based_deduplication': 'contentBasedDeduplication', 'display_name': 'displayName', 'fifo_topic': 'fifoTopic', 'kms_master_key_id': 'kmsMasterKeyId', 'subscription': 'subscription', 'tags': 'tags', 'topic_name': 'topicName'})
class CfnTopicProps():
    ...
    @builtins.property
    def subscription(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnTopic.SubscriptionProperty"]]]]:
        """``AWS::SNS::Topic.Subscription``.
...
class Subscription(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.Subscription"):
    ...
    this class.
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, topic: "ITopic", endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns.SubscriptionOptions", jsii_struct_bases=[], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol', 'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'region': 'region'})
class SubscriptionOptions():
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns.SubscriptionProps", jsii_struct_bases=[SubscriptionOptions], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol', 'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'region': 'region', 'topic': 'topic'})
class SubscriptionProps(SubscriptionOptions):
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None, topic: "ITopic") -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns.TopicSubscriptionConfig", jsii_struct_bases=[SubscriptionOptions], name_mapping={'endpoint': 'endpoint', 'protocol': 'protocol', 'dead_letter_queue': 'deadLetterQueue', 'filter_policy': 'filterPolicy', 'raw_message_delivery': 'rawMessageDelivery', 'region': 'region', 'subscriber_id': 'subscriberId', 'subscriber_scope': 'subscriberScope'})
class TopicSubscriptionConfig(SubscriptionOptions):
    def __init__(self, *, endpoint: str, protocol: "SubscriptionProtocol", dead_letter_queue: typing.Optional[aws_cdk.aws_sqs.IQueue]=None, filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]=None, raw_message_delivery: typing.Optional[bool]=None, region: typing.Optional[str]=None, subscriber_id: str, subscriber_scope: typing.Optional[aws_cdk.core.Construct]=None) -> None:
