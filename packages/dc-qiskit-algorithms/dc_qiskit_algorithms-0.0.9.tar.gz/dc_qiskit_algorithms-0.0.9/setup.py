...
with open("requirements.txt") as f:
    requirements_pip = f.readlines()

with open("requirements_conda.txt") as f:
    requirements_conda = f.readlines()

requirements = requirements_pip + requirements_conda

info = {
    'name': 'dc_qiskit_algorithms',
    'version': version,
