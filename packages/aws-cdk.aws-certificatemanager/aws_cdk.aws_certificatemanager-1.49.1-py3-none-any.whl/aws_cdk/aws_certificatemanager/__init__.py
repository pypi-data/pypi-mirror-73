...
class CfnCertificate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-certificatemanager.CfnCertificate"):
    ...
    def domain_validation_options(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["DomainValidationOptionProperty", aws_cdk.core.IResolvable]]]]:
    ...
    def domain_validation_options(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["DomainValidationOptionProperty", aws_cdk.core.IResolvable]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-certificatemanager.CfnCertificate.DomainValidationOptionProperty", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'hosted_zone_id': 'hostedZoneId', 'validation_domain': 'validationDomain'})
...
class CfnCertificateProps():
    ...
    @builtins.property
    def domain_validation_options(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnCertificate.DomainValidationOptionProperty", aws_cdk.core.IResolvable]]]]:
        """``AWS::CertificateManager::Certificate.DomainValidationOptions``.
