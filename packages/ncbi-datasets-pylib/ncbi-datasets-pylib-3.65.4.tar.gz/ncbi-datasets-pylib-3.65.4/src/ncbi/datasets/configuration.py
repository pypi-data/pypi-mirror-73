...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ncbi.datasets.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = ncbi.datasets.Configuration(
    ...
    Note you can use the constants defined in the ncbi.datasets.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ncbi.datasets.Configuration(
        signing_info = ncbi.datasets.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
