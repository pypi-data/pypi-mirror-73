...
def getUpdates(
    *,
    ...
    return "GET", "getUpdates", None, params or None, None
...
def sendMessage(
    ...
    *,
    ...
    if reply_markup is not None:
        params["reply_markup"] = json_dumps(
            reply_markup.serialized, check_circular=False
        )
...
def stopMessageLiveLocation(
    *,
    ...
    return "GET", "stopMessageLiveLocation", None, params or None, None
...
def sendPoll(
    ...
    *,
    ...
    params: dict = {"chat_id": chat_id, "question": question, "options": options}
...
def sendChatAction(chat_id: Union[int, str], action: str) -> EndpointCall:
...
def getUserProfilePhotos(
    user_id: int, *, offset: Optional[int] = None, limit: Optional[int] = None
) -> EndpointCall:
...
def getFile(file_id: str) -> EndpointCall:
...
def kickChatMember(
    chat_id: Union[int, str], user_id: int, *, until_date: Optional[int] = None
) -> EndpointCall:
...
def unbanChatMember(chat_id: Union[int, str], user_id: int) -> EndpointCall:
    params: dict = {"chat_id": chat_id, "user_id": user_id}
...
def setChatPermissions(
    chat_id: Union[int, str], permissions: ChatPermissions
) -> EndpointCall:
    params: dict = {
        "chat_id": chat_id,
        "permissions": json_dumps(permissions, check_circular=False),
...
def exportChatInviteLink(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "exportChatInviteLink", None, params, None


def setChatPhoto(chat_id: Union[int, str], photo: InputFile) -> EndpointCall:
    files: List[Tuple[bytes, bytes, bytes, bytes]] = []
...
def deleteChatPhoto(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "deleteChatPhoto", None, params, None


def setChatTitle(chat_id: Union[int, str], title: str) -> EndpointCall:
...
def setChatDescription(
    chat_id: Union[int, str], *, description: Optional[str] = None
) -> EndpointCall:
    params: dict = {"chat_id": chat_id}
...
def unpinChatMessage(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "unpinChatMessage", None, params, None


def leaveChat(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "leaveChat", None, params, None


def getChat(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "getChat", None, params, None


def getChatAdministrators(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "getChatAdministrators", None, params, None


def getChatMembersCount(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}

    return "GET", "getChatMembersCount", None, params, None


def getChatMember(chat_id: Union[int, str], user_id: int) -> EndpointCall:
    params: dict = {"chat_id": chat_id, "user_id": user_id}

    return "GET", "getChatMember", None, params, None


def setChatStickerSet(chat_id: Union[int, str], sticker_set_name: str) -> EndpointCall:
    params: dict = {"chat_id": chat_id, "sticker_set_name": sticker_set_name}

    return "GET", "setChatStickerSet", None, params, None


def deleteChatStickerSet(chat_id: Union[int, str]) -> EndpointCall:
    params: dict = {"chat_id": chat_id}
...
def setMyCommands(commands: List[BotCommand]) -> EndpointCall:
    params: dict = {"commands": json_dumps(commands, check_circular=False)}
...
def editMessageCaption(
    *,
    ...
    return "GET", "editMessageCaption", None, params or None, None
...
def editMessageReplyMarkup(
    *,
    ...
    return "GET", "editMessageReplyMarkup", None, params or None, None
...
def deleteMessage(chat_id: Union[int, str], message_id: int) -> EndpointCall:
    params: dict = {"chat_id": chat_id, "message_id": message_id}
...
def getStickerSet(name: str) -> EndpointCall:
    params: dict = {"name": name}

    return "GET", "getStickerSet", None, params, None


def uploadStickerFile(user_id: int, png_sticker: InputFile) -> EndpointCall:
    files: List[Tuple[bytes, bytes, bytes, bytes]] = []
...
def createNewStickerSet(
    ...
    *,
    ...
    params: dict = {"user_id": user_id, "name": name, "title": title, "emojis": emojis}
...
def addStickerToSet(
    ...
    *,
    ...
    params: dict = {"user_id": user_id, "name": name, "emojis": emojis}
...
def setStickerPositionInSet(sticker: InputFile, position: int) -> EndpointCall:
    files: List[Tuple[bytes, bytes, bytes, bytes]] = []
...
def deleteStickerFromSet(sticker: InputFile) -> EndpointCall:
    files: List[Tuple[bytes, bytes, bytes, bytes]] = []
...
def setStickerSetThumb(
    name: str, user_id: int, *, thumb: Optional[InputFile] = None
) -> EndpointCall:
    files: List[Tuple[bytes, bytes, bytes, bytes]] = []

    params: dict = {"name": name, "user_id": user_id}
...
def answerShippingQuery(
    ...
    *,
    ...
    params: dict = {"shipping_query_id": shipping_query_id, "ok": ok}
...
def answerPreCheckoutQuery(
    pre_checkout_query_id: str, ok: bool, *, error_message: Optional[str] = None
) -> EndpointCall:
    params: dict = {"pre_checkout_query_id": pre_checkout_query_id, "ok": ok}
...
def setPassportDataErrors(
    user_id: int, errors: List[PassportElementError]
) -> EndpointCall:
    params: dict = {
        "user_id": user_id,
...
def setGameScore(
    ...
    *,
    ...
    params: dict = {"user_id": user_id, "score": score}
