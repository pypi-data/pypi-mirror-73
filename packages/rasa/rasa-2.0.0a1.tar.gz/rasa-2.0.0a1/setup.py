...
extras_require = \
{'convert': ['tensorflow-text>=2.2,<2.3'],
 'full': ['spacy>=2.1,<2.3',
          'tensorflow-text>=2.2,<2.3',
          'transformers>=2.4,<2.12',
          'jieba>=0.39,<0.43'],
 'gh-release-notes': ['pypandoc>=1.4,<1.6', 'github3.py>=1.3.0,<1.4.0'],
 'spacy': ['spacy>=2.1,<2.3'],
