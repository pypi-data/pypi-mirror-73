...
from mastapy.math_utility.optimisation import _1111, _1110
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self) -> '_1111.TargetingPropertyTo':
        ...
        return constructor.new(_1111.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1111.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1110.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1110.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1110.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
