...
from mastapy.bearings.bearing_results.rolling import _1669, _1641
...
class LoadedToroidalRollerBearingRow(_1641.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1669.LoadedToroidalRollerBearingResults':
