...
class TiltingPadThrustBearing(_1788.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1534.TiltingPadTypes':
        ...
        return constructor.new(_1534.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1534.TiltingPadTypes'):
