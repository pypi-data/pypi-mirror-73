...
class LoadedBolt(_0.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1034.AxialLoadType':
        ...
        return constructor.new(_1034.AxialLoadType)(value) if value else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1034.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1050.JointTypes':
        '''JointTypes: 'JointType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.JointType)
        return constructor.new(_1050.JointTypes)(value) if value else None

    @joint_type.setter
    def joint_type(self, value: '_1050.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tightening_technique(self) -> '_1056.TighteningTechniques':
        ...
        return constructor.new(_1056.TighteningTechniques)(value) if value else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1056.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TighteningTechnique = value

    @property
    def bolt(self) -> '_1046.DetailedBoltDesign':
        ...
        return constructor.new(_1046.DetailedBoltDesign)(self.wrapped.Bolt) if self.wrapped.Bolt else None
