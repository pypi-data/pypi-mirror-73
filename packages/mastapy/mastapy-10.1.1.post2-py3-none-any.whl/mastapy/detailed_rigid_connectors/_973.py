...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def twod_spline_drawing(self) -> '_6517.SMTBitmap':
        ...
        return constructor.new(_6517.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
