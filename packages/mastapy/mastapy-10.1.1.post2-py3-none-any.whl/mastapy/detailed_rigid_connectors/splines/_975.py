...
from mastapy.detailed_rigid_connectors.splines import _985, _994, _1002
...
class DIN5480SplineHalfDesign(_1002.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_985.ManufacturingTypes':
        ...
        return constructor.new(_985.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_985.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_994.FinishingMethods':
        ...
        return constructor.new(_994.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_994.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
