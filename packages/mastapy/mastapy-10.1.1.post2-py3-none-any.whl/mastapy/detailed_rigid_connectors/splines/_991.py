...
from mastapy.detailed_rigid_connectors.splines import _978, _1003
...
class SAESplineJointDesign(_1003.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_978.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_978.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_978.FitTypes'):
