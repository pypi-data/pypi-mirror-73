...
from mastapy.detailed_rigid_connectors.splines import _981
...
class SplineMaterial(_76.Material):
    ...
    @property
    def heat_treatment_type(self) -> '_981.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_981.HeatTreatmentTypes'):
