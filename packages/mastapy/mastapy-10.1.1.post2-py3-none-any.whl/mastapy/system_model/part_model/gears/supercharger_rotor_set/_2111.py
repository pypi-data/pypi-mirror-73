...
class SuperchargerRotorSet(_1346.NamedDatabaseItem):
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2113.YVariableForImportedData':
        ...
        return constructor.new(_2113.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2113.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2106.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2106.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2108.RotorSpeedInputOptions':
        ...
        return constructor.new(_2108.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2103.BoostPressureInputOptions':
        ...
        return constructor.new(_2103.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2105.PressureRatioInputOptions':
        ...
        return constructor.new(_2105.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2104.InputPowerInputOptions':
        ...
        return constructor.new(_2104.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2107.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2107.RotorSetMeasuredPoint))
        return value
