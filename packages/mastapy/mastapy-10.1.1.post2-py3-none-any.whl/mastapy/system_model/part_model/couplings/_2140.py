...
from mastapy.system_model.part_model.couplings import _2141, _2143, _2118
...
class TorqueConverter(_2118.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2141.TorqueConverterPump':
        ...
        return constructor.new(_2141.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2143.TorqueConverterTurbine':
        ...
        return constructor.new(_2143.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
