...
from mastapy.system_model.part_model.couplings import _2145, _2147
...
class SynchroniserHalf(_2147.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2145.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2145.SynchroniserCone))
        return value
