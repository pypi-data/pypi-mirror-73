...
from mastapy.system_model.part_model.projections import _2034
from mastapy.system_model.part_model.part_groups import _2039
...
class RootAssembly(_1989.Assembly):
    '''RootAssembly
    ...
    def model(self) -> '_1801.Design':
        ...
        return constructor.new(_1801.Design)(self.wrapped.Model) if self.wrapped.Model else None
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2034.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2034.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2039.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2039.ParallelPartGroup))
        return value
