...
from mastapy.system_model.analyses_and_results.system_deflections import _2337, _2339
...
class PowerLoadSystemDeflection(_2339.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3300.PowerLoadPowerFlow':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2337.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2337.TransmissionErrorResult))
        return value
