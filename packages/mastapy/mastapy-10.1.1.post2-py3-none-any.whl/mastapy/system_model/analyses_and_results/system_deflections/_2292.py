...
class PartSystemDeflection(_6493.PartFEAnalysis):
    '''PartSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces(self) -> '_6504.SMTBitmap':
        ...
        return constructor.new(_6504.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForces) if self.wrapped.TwoDDrawingShowingAxialForces else None
