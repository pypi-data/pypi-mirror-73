...
class SpringDamperConnectionSystemDeflection(_2244.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3313.SpringDamperConnectionPowerFlow':
