...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2443, _2356
...
class ShaftCompoundSystemDeflection(_2356.AbstractShaftOrHousingCompoundSystemDeflection):
    '''ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2443.ShaftDutyCycleSystemDeflection':
        ...
        return constructor.new(_2443.ShaftDutyCycleSystemDeflection)(self.wrapped.ShaftDutyCycleDamageResults) if self.wrapped.ShaftDutyCycleDamageResults else None
