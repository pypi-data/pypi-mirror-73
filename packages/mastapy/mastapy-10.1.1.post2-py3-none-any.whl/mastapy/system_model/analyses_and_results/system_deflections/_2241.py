...
class ConicalGearSystemDeflection(_2269.GearSystemDeflection):
    ...
    @property
    def conical_gear_ltca_results(self) -> '_640.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_640.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
