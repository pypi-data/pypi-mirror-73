...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4096
...
class RootAssemblyCompoundModalAnalysesAtSpeeds(_4096.AssemblyCompoundModalAnalysesAtSpeeds):
    '''RootAssemblyCompoundModalAnalysesAtSpeeds
