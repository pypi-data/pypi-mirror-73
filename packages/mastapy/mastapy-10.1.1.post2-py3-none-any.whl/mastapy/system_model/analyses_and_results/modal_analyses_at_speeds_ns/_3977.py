...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _3976, _3975, _3982
...
class BevelDifferentialGearSetModalAnalysesAtSpeeds(_3982.BevelGearSetModalAnalysesAtSpeeds):
    '''BevelDifferentialGearSetModalAnalysesAtSpeeds
    ...
    @property
    def bevel_differential_gears_modal_analyses_at_speeds(self) -> 'List[_3976.BevelDifferentialGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysesAtSpeeds, constructor.new(_3976.BevelDifferentialGearModalAnalysesAtSpeeds))
        return value

    @property
    def bevel_differential_meshes_modal_analyses_at_speeds(self) -> 'List[_3975.BevelDifferentialGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysesAtSpeeds, constructor.new(_3975.BevelDifferentialGearMeshModalAnalysesAtSpeeds))
        return value
