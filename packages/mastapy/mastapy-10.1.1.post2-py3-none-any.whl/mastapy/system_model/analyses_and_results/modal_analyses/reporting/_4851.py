...
from mastapy.utility.modal_analysis import _1318
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2191.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1318.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1318.DesignEntityExcitationDescription))
        return value
