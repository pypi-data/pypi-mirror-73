...
from mastapy.system_model.analyses_and_results.modal_analyses import _4831, _4830, _4715
...
class ZerolBevelGearSetModalAnalysis(_4715.BevelGearSetModalAnalysis):
    '''ZerolBevelGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2344.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4831.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysis, constructor.new(_4831.ZerolBevelGearModalAnalysis))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4830.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysis, constructor.new(_4830.ZerolBevelGearMeshModalAnalysis))
        return value
