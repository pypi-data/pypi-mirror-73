...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4868
...
class ExternalCADModelCompoundModalAnalysis(_4868.ComponentCompoundModalAnalysis):
    '''ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4746.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4746.ExternalCADModelModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4746.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4746.ExternalCADModelModalAnalysis))
        return value
