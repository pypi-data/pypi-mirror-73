...
from mastapy.system_model.analyses_and_results.modal_analyses import _4748, _4747, _4754
...
class FaceGearSetModalAnalysis(_4754.GearSetModalAnalysis):
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4748.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4748.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4747.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4747.FaceGearMeshModalAnalysis))
        return value
