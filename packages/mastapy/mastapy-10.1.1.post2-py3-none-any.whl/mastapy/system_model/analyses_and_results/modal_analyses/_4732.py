...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4843
...
class ConnectionModalAnalysis(_6487.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_4772.ModalAnalysis':
        ...
        return constructor.new(_4772.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None

    @property
    def excited_modes_summary(self) -> 'List[_4843.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4843.SingleExcitationResultsModalAnalysis))
        return value
