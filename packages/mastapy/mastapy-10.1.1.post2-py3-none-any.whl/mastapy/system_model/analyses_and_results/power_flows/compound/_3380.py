...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3348
...
class CVTBeltConnectionCompoundPowerFlow(_3348.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
