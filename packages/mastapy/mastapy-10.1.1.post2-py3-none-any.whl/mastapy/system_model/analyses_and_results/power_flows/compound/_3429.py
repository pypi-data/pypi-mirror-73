...
class ShaftCompoundPowerFlow(_3342.AbstractShaftOrHousingCompoundPowerFlow):
    '''ShaftCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3307.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3307.ShaftPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3307.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3307.ShaftPowerFlow))
        return value
