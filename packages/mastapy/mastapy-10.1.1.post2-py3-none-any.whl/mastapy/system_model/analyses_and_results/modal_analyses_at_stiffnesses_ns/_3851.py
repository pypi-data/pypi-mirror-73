...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3850, _3849, _3785
...
class WormGearSetModalAnalysesAtStiffnesses(_3785.GearSetModalAnalysesAtStiffnesses):
    '''WormGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def worm_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3850.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtStiffnesses, constructor.new(_3850.WormGearModalAnalysesAtStiffnesses))
        return value

    @property
    def worm_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3849.WormGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtStiffnesses, constructor.new(_3849.WormGearMeshModalAnalysesAtStiffnesses))
        return value
