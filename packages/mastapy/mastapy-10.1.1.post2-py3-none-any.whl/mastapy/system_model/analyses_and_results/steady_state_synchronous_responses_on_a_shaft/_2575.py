...
class SteadyStateSynchronousResponseOnAShaft(_6496.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3064.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3064.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
