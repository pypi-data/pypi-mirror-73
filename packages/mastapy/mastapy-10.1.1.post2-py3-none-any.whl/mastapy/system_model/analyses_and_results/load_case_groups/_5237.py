...
from mastapy.system_model.analyses_and_results.load_case_groups import _5235, _5236, _5232
...
class DesignState(_5232.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5235.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5235.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5236.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5236.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1894.ClutchConnection') -> '_5235.ClutchEngagementStatus':
        ...
        return constructor.new(_5235.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2064.CylindricalGear') -> '_5236.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5236.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6184.StaticLoadCase':
        ...
        return constructor.new(_6184.StaticLoadCase)(method_result) if method_result else None
