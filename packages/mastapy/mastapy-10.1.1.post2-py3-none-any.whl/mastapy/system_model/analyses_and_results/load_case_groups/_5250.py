...
from mastapy.system_model.analyses_and_results.load_case_groups import _5243
...
class GroupOfTimeSeriesLoadCases(_5243.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_6210.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6210.TimeSeriesLoadCase))
        return value
