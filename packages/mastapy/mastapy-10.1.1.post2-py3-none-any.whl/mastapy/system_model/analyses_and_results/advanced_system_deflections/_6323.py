...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6234, _6240
...
class RootAssemblyAdvancedSystemDeflection(_6240.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6234.AdvancedSystemDeflection':
        ...
        return constructor.new(_6234.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
