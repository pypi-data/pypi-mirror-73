...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3543, _3540
...
class ParametricStudyVariable(_2178.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3543.ParametricStudyDimension':
        ...
        return constructor.new(_3543.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3543.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3540.MonteCarloDistribution':
        ...
        return constructor.new(_3540.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3540.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
