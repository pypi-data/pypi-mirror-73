...
class ParametricStudyDOEResultVariable(_1106.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1108.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1108.PropertyTargetForDominantCandidateSearch'):
