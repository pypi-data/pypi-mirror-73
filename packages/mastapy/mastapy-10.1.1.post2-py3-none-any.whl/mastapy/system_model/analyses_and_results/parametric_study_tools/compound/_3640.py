...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3682
...
class CVTPulleyCompoundParametricStudyTool(_3682.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
