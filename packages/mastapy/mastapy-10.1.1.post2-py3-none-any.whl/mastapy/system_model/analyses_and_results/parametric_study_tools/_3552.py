...
from mastapy.system_model.analyses_and_results.analysis_cases import _6491
...
class PartParametricStudyTool(_6491.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3548.ParametricStudyTool':
        ...
        return constructor.new(_3548.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
