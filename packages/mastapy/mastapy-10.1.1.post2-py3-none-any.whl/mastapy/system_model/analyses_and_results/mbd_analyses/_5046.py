...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5032, _5070, _5065
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.analyses_and_results.analysis_cases import _6482
...
class MBDRunUpAnalysisOptions(_6482.AbstractAnalysisOptions['_6198.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5032.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5032.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5032.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5070.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5070.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5070.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5065.RunUpDrivingMode':
        ...
        return constructor.new(_5065.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5065.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
