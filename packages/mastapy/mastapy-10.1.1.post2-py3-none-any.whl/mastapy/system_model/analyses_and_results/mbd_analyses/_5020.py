...
class GearMeshMultiBodyDynamicsAnalysis(_5033.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''GearMeshMultiBodyDynamicsAnalysis
    ...
    @property
    def contact_status(self) -> '_1375.GearMeshContactStatus':
