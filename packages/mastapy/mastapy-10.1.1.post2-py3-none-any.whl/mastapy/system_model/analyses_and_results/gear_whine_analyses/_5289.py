...
class CouplingConnectionGearWhineAnalysis(_5332.InterMountableComponentConnectionGearWhineAnalysis):
    '''CouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2244.CouplingConnectionSystemDeflection':
