...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.reportable_property_results import _5664, _5660
...
class GearWhineAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_5664.SingleWhineAnalysisResultsPropertyAccessor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_5664.SingleWhineAnalysisResultsPropertyAccessor))
        return value

    @property
    def orders_for_combined_excitations(self) -> 'List[_5660.ResultsForOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OrdersForCombinedExcitations, constructor.new(_5660.ResultsForOrder))
        return value
