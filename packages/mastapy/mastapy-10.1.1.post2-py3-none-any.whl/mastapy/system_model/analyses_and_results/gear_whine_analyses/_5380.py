...
class StraightBevelSunGearGearWhineAnalysis(_5373.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2324.StraightBevelSunGearSystemDeflection':
