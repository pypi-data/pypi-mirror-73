...
class RollingRingAssemblyGearWhineAnalysis(_5365.SpecialisedAssemblyGearWhineAnalysis):
    '''RollingRingAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2301.RollingRingAssemblySystemDeflection':
