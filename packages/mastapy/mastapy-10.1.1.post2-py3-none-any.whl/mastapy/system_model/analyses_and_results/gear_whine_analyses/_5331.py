...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5323, _5254
...
class ImportedFEComponentGearWhineAnalysis(_5254.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4759.ImportedFEComponentModalAnalysis':
    ...
    @property
    def export(self) -> '_5323.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5323.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
