...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5499, _5413
...
class RootAssemblySingleMeshWhineAnalysis(_5413.AssemblySingleMeshWhineAnalysis):
    '''RootAssemblySingleMeshWhineAnalysis
    ...
    @property
    def single_mesh_whine_analysis_inputs(self) -> '_5499.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_5499.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysisInputs) if self.wrapped.SingleMeshWhineAnalysisInputs else None
