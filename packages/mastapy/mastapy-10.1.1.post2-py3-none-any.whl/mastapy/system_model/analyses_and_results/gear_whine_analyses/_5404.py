...
class WormGearGearWhineAnalysis(_5328.GearGearWhineAnalysis):
    '''WormGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2352.WormGearSystemDeflection':
        ...
        return constructor.new(_2352.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
