...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5407
...
class ResultLocationSelectionGroup(_0.APIBase):
    ...
    @property
    def response_locations(self) -> 'List[_5407.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResponseLocations, constructor.new(_5407.ResultNodeSelection))
        return value
