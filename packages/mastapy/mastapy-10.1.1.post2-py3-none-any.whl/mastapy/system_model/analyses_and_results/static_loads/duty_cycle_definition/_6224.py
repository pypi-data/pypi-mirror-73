...
class PointLoadInputOptions(_1498.ColumnInputOptions):
    ...
    @property
    def conversion_to_load_case(self) -> '_6215.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6215.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6215.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
