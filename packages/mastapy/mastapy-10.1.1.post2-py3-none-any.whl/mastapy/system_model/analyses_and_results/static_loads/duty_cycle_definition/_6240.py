...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6230, _6241, _6232, _6229,
    _6233, _6235, _6242, _6239,
    _6231, _6234, _6228
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6149.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6149.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6149.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6241.TimeStepInputOptions':
        ...
        return constructor.new(_6241.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6232.GearRatioInputOptions':
        ...
        return constructor.new(_6232.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6229.DesignStateOptions':
        ...
        return constructor.new(_6229.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6233.LoadCaseNameOptions':
        ...
        return constructor.new(_6233.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6235.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6235.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6242.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6242.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6239.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6239.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6231.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6231.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6234.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6234.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6228.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6228.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1337.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1337.ColumnTitle))
        return value
