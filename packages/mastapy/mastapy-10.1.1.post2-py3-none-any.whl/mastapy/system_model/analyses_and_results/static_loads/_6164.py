...
class PointLoadHarmonicLoadData(_6177.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1068.DegreesOfFreedom':
        ...
        return constructor.new(_1068.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1068.DegreesOfFreedom'):
