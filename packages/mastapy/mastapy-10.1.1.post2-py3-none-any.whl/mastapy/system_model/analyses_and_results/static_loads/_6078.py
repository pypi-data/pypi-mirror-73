...
from mastapy.system_model.analyses_and_results.static_loads import _6079, _6118
...
class ConicalGearLoadCase(_6118.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6079.ConicalGearManufactureError':
