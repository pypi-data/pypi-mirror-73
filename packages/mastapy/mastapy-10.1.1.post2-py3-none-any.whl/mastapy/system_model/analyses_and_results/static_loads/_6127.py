...
from mastapy.system_model.analyses_and_results.static_loads import _6152, _6128, _6108
...
class HarmonicLoadDataExcelImport(_6128.HarmonicLoadDataImportBase['_6108.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6152.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6152.NamedSpeed))
        return value
