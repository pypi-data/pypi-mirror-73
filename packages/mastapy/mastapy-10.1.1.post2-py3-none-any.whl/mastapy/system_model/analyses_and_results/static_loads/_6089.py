...
from mastapy.system_model.analyses_and_results.static_loads import _6090, _6056
...
class CVTLoadCase(_6056.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6090.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6090.CVTPulleyLoadCase))
        return value
