...
from mastapy.system_model.analyses_and_results.static_loads import _6113, _6114, _6123
...
class FaceGearSetLoadCase(_6123.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6113.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6113.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6114.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6114.FaceGearMeshLoadCase))
        return value
