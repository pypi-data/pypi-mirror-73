...
class TimeSeriesLoadCase(_6045.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5045.MBDAnalysisOptions':
        ...
        return constructor.new(_5045.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
