...
from mastapy.system_model.analyses_and_results.static_loads import _6188, _6189, _6064
...
class StraightBevelGearSetLoadCase(_6064.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6188.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6188.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6189.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6189.StraightBevelGearMeshLoadCase))
        return value
