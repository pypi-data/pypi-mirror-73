...
from mastapy.system_model.analyses_and_results.static_loads import _6081, _6123
...
class ConicalGearSetLoadCase(_6123.GearSetLoadCase):
    '''ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6081.ConicalGearSetHarmonicLoadData':
        ...
        return constructor.new(_6081.ConicalGearSetHarmonicLoadData)(method_result) if method_result else None
