...
from mastapy.system_model.analyses_and_results.static_loads import _6121, _6126
...
class GearSetHarmonicLoadData(_6126.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6121.GearMeshTEOrderType':
        ...
        return constructor.new(_6121.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6121.GearMeshTEOrderType'):
