...
from mastapy.system_model.analyses_and_results.static_loads import _6161, _6151
...
class PlanetCarrierLoadCase(_6151.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6161.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6161.PlanetarySocketManufactureError))
        return value
