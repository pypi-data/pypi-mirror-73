...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3058, _3056, _2979
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2979.BevelGearSetSteadyStateSynchronousResponse):
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3058.SpiralBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSteadyStateSynchronousResponse, constructor.new(_3058.SpiralBevelGearSteadyStateSynchronousResponse))
        return value

    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3056.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3056.SpiralBevelGearMeshSteadyStateSynchronousResponse))
        return value
