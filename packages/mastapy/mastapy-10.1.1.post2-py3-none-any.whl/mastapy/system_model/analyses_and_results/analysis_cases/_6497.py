...
class TimeSeriesLoadAnalysisCase(_6481.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6198.TimeSeriesLoadCase':
        ...
        return constructor.new(_6198.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
