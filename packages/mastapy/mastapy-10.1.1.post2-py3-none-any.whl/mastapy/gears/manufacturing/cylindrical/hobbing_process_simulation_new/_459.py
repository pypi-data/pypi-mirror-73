...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _450
...
class HobbingProcessTotalModificationCalculation(_450.HobbingProcessCalculation):
    '''HobbingProcessTotalModificationCalculation
