...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _469, _456, _483
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_469.ProcessSimulationInput':
        ...
        return constructor.new(_469.ProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_456.HobbingProcessSimulationInput':
        ...
        if _456.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_456.HobbingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_483.WormGrindingProcessSimulationInput':
        ...
        if _483.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new(_483.WormGrindingProcessSimulationInput)(self.wrapped.Inputs) if self.wrapped.Inputs else None
