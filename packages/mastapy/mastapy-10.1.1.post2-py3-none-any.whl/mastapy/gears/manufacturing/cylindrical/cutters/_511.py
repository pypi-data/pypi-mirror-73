...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _527, _532, _530
...
class CylindricalGearHobDesign(_514.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_415.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_415.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_415.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_527.CylindricalGearHobShape':
        ...
        return constructor.new(_527.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None
    ...
    @property
    def maximum_hob_material_shape(self) -> '_527.CylindricalGearHobShape':
        ...
        return constructor.new(_527.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_527.CylindricalGearHobShape':
        ...
        return constructor.new(_527.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
