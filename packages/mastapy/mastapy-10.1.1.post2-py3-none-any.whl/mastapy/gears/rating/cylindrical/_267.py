...
from mastapy.gears.gear_designs.cylindrical import _821, _820
...
class CylindricalMeshSingleFlankRating(_168.MeshSingleFlankRating):
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_821.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_821.ScuffingCoefficientOfFrictionMethods)(value) if value else None
