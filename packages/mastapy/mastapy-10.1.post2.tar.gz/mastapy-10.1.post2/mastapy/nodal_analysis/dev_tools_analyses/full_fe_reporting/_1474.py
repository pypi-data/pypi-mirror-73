...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _965, _966
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def master_type(self) -> '_965.ContactPairMasterType':
        ...
        return constructor.new(_965.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_966.ContactPairSlaveType':
        ...
        return constructor.new(_966.ContactPairSlaveType)(value) if value else None
