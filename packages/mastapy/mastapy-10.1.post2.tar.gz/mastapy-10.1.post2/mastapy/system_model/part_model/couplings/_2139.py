...
from mastapy.system_model.part_model.couplings import _2140, _2142, _2117
...
class TorqueConverter(_2117.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2140.TorqueConverterPump':
        ...
        return constructor.new(_2140.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2142.TorqueConverterTurbine':
        ...
        return constructor.new(_2142.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
