...
class ShaftHubConnection(_1991.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2125.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2125.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2125.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2126.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2126.RigidConnectorToothLocation))
        return value
