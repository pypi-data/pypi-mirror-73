...
from mastapy.system_model.part_model.couplings import _2135, _2137
...
class SynchroniserHalf(_2137.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2135.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2135.SynchroniserCone))
        return value
