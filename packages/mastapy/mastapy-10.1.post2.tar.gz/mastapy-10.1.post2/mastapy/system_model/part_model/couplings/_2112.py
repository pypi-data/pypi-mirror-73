...
from mastapy.system_model.part_model.couplings import _2114, _2117
...
class Clutch(_2117.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2114.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2114.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2114.ClutchType'):
    ...
    @property
    def clutch_connection(self) -> '_1893.ClutchConnection':
        ...
        return constructor.new(_1893.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
