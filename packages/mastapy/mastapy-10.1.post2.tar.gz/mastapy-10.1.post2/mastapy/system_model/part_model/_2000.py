...
class ImportedFEComponent(_1981.AbstractShaftOrHousing):
    '''ImportedFEComponent
    ...
    @property
    def default_active_imported_fe(self) -> '_1934.ImportedFE':
        ...
        return constructor.new(_1934.ImportedFE)(self.wrapped.DefaultActiveImportedFE) if self.wrapped.DefaultActiveImportedFE else None
    ...
    def add_imported_fe(self) -> '_1934.ImportedFE':
        ...
        return constructor.new(_1934.ImportedFE)(method_result) if method_result else None

    def add_imported_fe_with_name(self, name: 'str') -> '_1934.ImportedFE':
        ''' 'AddImportedFE' is the original name of this method.
    ...
    def select_imported_fe(self, imported_fe: '_1934.ImportedFE'):
    ...
    def remove_imported_fe(self, imported_fe: '_1934.ImportedFE') -> 'bool':
