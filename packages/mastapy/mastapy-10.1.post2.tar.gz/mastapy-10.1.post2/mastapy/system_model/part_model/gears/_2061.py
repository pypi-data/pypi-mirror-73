...
from mastapy.system_model.part_model.gears import _2069, _2068
...
class ConicalGear(_2068.Gear):
    ...
    @property
    def orientation(self) -> '_2069.GearOrientations':
        ...
        return constructor.new(_2069.GearOrientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_2069.GearOrientations'):
