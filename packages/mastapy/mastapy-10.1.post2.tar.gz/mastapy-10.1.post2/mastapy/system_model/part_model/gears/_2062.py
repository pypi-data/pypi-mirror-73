...
from mastapy.system_model.part_model.gears import _2061, _2070
...
class ConicalGearSet(_2070.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2061.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2061.ConicalGear))
        return value
