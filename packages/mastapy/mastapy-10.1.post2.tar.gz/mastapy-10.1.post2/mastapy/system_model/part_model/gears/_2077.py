...
from mastapy.system_model.part_model.gears import _2076, _2075
...
class KlingelnbergCycloPalloidHypoidGearSet(_2075.KlingelnbergCycloPalloidConicalGearSet):
    '''KlingelnbergCycloPalloidHypoidGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2076.KlingelnbergCycloPalloidHypoidGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGears, constructor.new(_2076.KlingelnbergCycloPalloidHypoidGear))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_1879.KlingelnbergCycloPalloidHypoidGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshes, constructor.new(_1879.KlingelnbergCycloPalloidHypoidGearMesh))
        return value
