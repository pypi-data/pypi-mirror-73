...
from mastapy.system_model.part_model.gears import _2066, _2070
...
class FaceGearSet(_2070.GearSet):
    '''FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2066.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2066.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1871.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1871.FaceGearMesh))
        return value
