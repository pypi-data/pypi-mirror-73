...
class SuperchargerRotorSet(_1342.NamedDatabaseItem):
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2103.YVariableForImportedData':
        ...
        return constructor.new(_2103.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2103.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2096.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2096.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2098.RotorSpeedInputOptions':
        ...
        return constructor.new(_2098.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2093.BoostPressureInputOptions':
        ...
        return constructor.new(_2093.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2095.PressureRatioInputOptions':
        ...
        return constructor.new(_2095.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2094.InputPowerInputOptions':
        ...
        return constructor.new(_2094.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2097.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2097.RotorSetMeasuredPoint))
        return value
