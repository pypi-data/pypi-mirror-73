...
from mastapy.system_model.part_model.gears import _2059, _2070
...
class ConceptGearSet(_2070.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2059.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2059.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1865.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1865.ConceptGearMesh))
        return value
