...
class ImportedFEWithSelection(_1912.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1934.ImportedFE':
        ...
        return constructor.new(_1934.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1925.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1925.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1959.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1959.NodeGroupWithSelection))
        return value
