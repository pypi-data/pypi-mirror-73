...
from mastapy.system_model.imported_fes import _1916
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_1916.BearingRacePosition':
        ...
        return constructor.new(_1916.BearingRacePosition)(value) if value else None
