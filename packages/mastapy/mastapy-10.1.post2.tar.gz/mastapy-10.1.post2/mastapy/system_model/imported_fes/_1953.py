...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def imported_fe_node(self) -> '_1946.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1946.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
