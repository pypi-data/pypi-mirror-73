...
from mastapy.system_model.imported_fes import (
    _1914, _1947, _1971, _1908,
    _1910, _1972, _1967, _1946,
    _1906, _1930, _1933, _1953,
    _1952, _1949, _1950, _1951
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1992, _1988, _2000
...
class ImportedFE(_1372.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_1914.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1914.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1914.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1908.AlignmentMethod':
        ...
        return constructor.new(_1908.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1908.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_to_component(self) -> '_1807.RelativeComponentAlignment[_1988.Component]':
        ...
        return constructor.new(_1807.RelativeComponentAlignment)[_1988.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1910.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1910.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_1972.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1972.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1967.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1967.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2021.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2021.Shaft))
        return value

    @property
    def links(self) -> 'List[_1906.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1906.ImportedFELink))
        return value
    ...
    @property
    def geometries(self) -> 'List[_1930.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1930.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1933.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1933.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1953.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1953.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2000.ImportedFEComponent':
        ...
        return constructor.new(_2000.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6500.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1952.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1952.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1949.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1949.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1950.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1950.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1951.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1951.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None
    ...
    def links_for(self, node: '_1946.ImportedFEStiffnessNode') -> 'List[_1906.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1906.ImportedFELink))
