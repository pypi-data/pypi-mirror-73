...
from mastapy.system_model.analyses_and_results.static_loads import _6151, _6127, _6107
...
class HarmonicLoadDataExcelImport(_6127.HarmonicLoadDataImportBase['_6107.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6151.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6151.NamedSpeed))
        return value
