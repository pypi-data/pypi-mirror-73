...
from mastapy.system_model.analyses_and_results.static_loads import _6102, _6108
...
T = TypeVar('T', bound='_6108.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6102.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
