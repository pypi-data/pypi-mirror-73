...
from mastapy.system_model.analyses_and_results import _2183
...
class PartLoadCase(_2183.PartAnalysis):
    '''PartLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6125.HarmonicLoadDataBase':
        ...
        return constructor.new(_6125.HarmonicLoadDataBase)(method_result) if method_result else None
