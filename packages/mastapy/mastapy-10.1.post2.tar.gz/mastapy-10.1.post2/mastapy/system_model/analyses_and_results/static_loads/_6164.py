...
from mastapy.system_model.analyses_and_results.static_loads import _6163, _6207
...
class PointLoadLoadCase(_6207.VirtualComponentLoadCase):
    '''PointLoadLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6163.PointLoadHarmonicLoadData':
        ...
        return constructor.new(_6163.PointLoadHarmonicLoadData)(method_result) if method_result else None
