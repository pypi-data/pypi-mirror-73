...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3210
...
class ShaftModalComplexShape(_3210.ShaftComplexShape['_1219.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
