...
from mastapy.system_model.analyses_and_results.analysis_cases import _6485
...
class ConnectionDynamicAnalysis(_6485.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5840.DynamicAnalysis':
        ...
        return constructor.new(_5840.DynamicAnalysis)(self.wrapped.DynamicAnalysis) if self.wrapped.DynamicAnalysis else None
