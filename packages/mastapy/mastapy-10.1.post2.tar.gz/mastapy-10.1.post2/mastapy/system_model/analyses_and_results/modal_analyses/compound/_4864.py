...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4880
...
class ClutchConnectionCompoundModalAnalysis(_4880.CouplingConnectionCompoundModalAnalysis):
    '''ClutchConnectionCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4717.ClutchConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4717.ClutchConnectionModalAnalysis))
        return value

    @property
    def connection_modal_analysis_load_cases(self) -> 'List[_4717.ClutchConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisLoadCases, constructor.new(_4717.ClutchConnectionModalAnalysis))
        return value
