...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4844
...
class SpecialisedAssemblyCompoundModalAnalysis(_4844.AbstractAssemblyCompoundModalAnalysis):
    '''SpecialisedAssemblyCompoundModalAnalysis
