...
class GearMultiBodyDynamicsAnalysis(_5047.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5107.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5107.DynamicTorqueResultAtTime))
        return value
