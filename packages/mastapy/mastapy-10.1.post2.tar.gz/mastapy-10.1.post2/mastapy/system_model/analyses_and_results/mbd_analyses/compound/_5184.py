...
class PartToPartShearCouplingCompoundMultiBodyDynamicsAnalysis(_5145.CouplingCompoundMultiBodyDynamicsAnalysis):
    '''PartToPartShearCouplingCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5053.PartToPartShearCouplingMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5053.PartToPartShearCouplingMultiBodyDynamicsAnalysis))
        return value

    @property
    def assembly_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5053.PartToPartShearCouplingMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5053.PartToPartShearCouplingMultiBodyDynamicsAnalysis))
        return value
