...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5093, _5003
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5003.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5093.TorqueConverterStatus':
        ...
        return constructor.new(_5093.TorqueConverterStatus)(value) if value else None
