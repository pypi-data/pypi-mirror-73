...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_6271.CouplingHalfAdvancedSystemDeflection):
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2293.PartToPartShearCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2293.PartToPartShearCouplingHalfSystemDeflection))
        return value
