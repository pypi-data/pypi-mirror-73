...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6233, _6239
...
class RootAssemblyAdvancedSystemDeflection(_6239.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6233.AdvancedSystemDeflection':
        ...
        return constructor.new(_6233.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
