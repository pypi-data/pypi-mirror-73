...
class ConceptCouplingAdvancedSystemDeflection(_6269.CouplingAdvancedSystemDeflection):
    '''ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6073.ConceptCouplingLoadCase':
        ...
        return constructor.new(_6073.ConceptCouplingLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2233.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2233.ConceptCouplingSystemDeflection))
        return value
