...
class TorqueConverterConnectionAdvancedSystemDeflection(_6270.CouplingConnectionAdvancedSystemDeflection):
    '''TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6198.TorqueConverterConnectionLoadCase':
        ...
        return constructor.new(_6198.TorqueConverterConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2331.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2331.TorqueConverterConnectionSystemDeflection))
        return value
