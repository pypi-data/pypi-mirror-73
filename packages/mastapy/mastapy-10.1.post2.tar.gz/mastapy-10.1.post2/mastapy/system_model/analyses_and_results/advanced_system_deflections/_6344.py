...
class SynchroniserSleeveAdvancedSystemDeflection(_6343.SynchroniserPartAdvancedSystemDeflection):
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2326.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2326.SynchroniserSleeveSystemDeflection))
        return value
