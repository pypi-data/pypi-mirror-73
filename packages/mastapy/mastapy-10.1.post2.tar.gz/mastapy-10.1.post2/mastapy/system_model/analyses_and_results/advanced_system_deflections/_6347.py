...
class TorqueConverterPumpAdvancedSystemDeflection(_6271.CouplingHalfAdvancedSystemDeflection):
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2332.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2332.TorqueConverterPumpSystemDeflection))
        return value
