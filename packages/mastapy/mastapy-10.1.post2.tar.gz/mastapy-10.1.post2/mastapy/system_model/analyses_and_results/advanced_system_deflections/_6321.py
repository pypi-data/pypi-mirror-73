...
class RollingRingConnectionAdvancedSystemDeflection(_6294.InterMountableComponentConnectionAdvancedSystemDeflection):
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2301.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2301.RollingRingConnectionSystemDeflection))
        return value
