...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3547, _3467
...
class RootAssemblyParametricStudyTool(_3467.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_3547.ParametricStudyTool':
        ...
        return constructor.new(_3547.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
