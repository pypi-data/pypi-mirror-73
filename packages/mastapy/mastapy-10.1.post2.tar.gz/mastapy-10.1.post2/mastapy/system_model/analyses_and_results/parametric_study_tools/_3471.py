...
class BevelDifferentialGearMeshParametricStudyTool(_3476.BevelGearMeshParametricStudyTool):
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2215.BevelDifferentialGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2215.BevelDifferentialGearMeshSystemDeflection))
        return value
