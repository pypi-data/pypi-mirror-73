...
class FlexiblePinAnalysisStopStartAnalysis(_5786.FlexiblePinAnalysis):
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2307.ShaftSystemDeflection':
        ...
        return constructor.new(_2307.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase else None

    @property
    def shaft_extreme_load_case(self) -> '_2307.ShaftSystemDeflection':
        ...
        return constructor.new(_2307.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase else None
