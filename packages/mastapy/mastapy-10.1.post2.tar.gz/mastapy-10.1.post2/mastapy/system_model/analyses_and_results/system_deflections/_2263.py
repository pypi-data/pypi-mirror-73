...
from mastapy.system_model.analyses_and_results.system_deflections import _2264, _2262, _2267
...
class FaceGearSetSystemDeflection(_2267.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3265.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3265.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2264.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2264.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2262.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2262.FaceGearMeshSystemDeflection))
        return value
