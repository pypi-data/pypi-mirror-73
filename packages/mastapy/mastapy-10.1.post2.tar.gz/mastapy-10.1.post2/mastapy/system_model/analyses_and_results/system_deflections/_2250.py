...
class CylindricalGearMeshSystemDeflectionTimestep(_2249.CylindricalGearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflectionTimestep
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_631.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_631.CylindricalGearMeshLoadedContactLine))
        return value
