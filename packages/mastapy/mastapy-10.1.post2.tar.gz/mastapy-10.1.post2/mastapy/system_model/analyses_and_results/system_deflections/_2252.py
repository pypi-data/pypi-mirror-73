...
from mastapy.system_model.analyses_and_results.system_deflections import _2255, _2249, _2267
...
class CylindricalGearSetSystemDeflection(_2267.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3259.CylindricalGearSetPowerFlow':
        ...
        return constructor.new(_3259.CylindricalGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2255.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2255.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2249.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2249.CylindricalGearMeshSystemDeflection))
        return value
