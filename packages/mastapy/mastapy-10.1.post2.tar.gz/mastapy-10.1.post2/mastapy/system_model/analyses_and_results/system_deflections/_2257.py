...
class CylindricalGearSystemDeflectionWithLTCAResults(_2255.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_629.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_629.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
