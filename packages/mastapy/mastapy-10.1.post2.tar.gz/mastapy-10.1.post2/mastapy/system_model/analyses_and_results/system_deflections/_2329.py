...
from mastapy.system_model.drawing import _1827, _1825
...
class SystemDeflectionDrawStyle(_1825.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1827.ScalingDrawStyle':
        ...
        return constructor.new(_1827.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
