...
from mastapy.system_model.analyses_and_results.power_flows import _3324, _3323, _3326
...
class SynchroniserPartSystemDeflection(_2244.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3324.SynchroniserPartPowerFlow':
