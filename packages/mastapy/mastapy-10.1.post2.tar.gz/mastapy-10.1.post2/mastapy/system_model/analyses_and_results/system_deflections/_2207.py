...
from mastapy.system_model.analyses_and_results.power_flows import _3216, _3274, _3306
...
class AbstractShaftOrHousingSystemDeflection(_2229.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3216.AbstractShaftOrHousingPowerFlow':
        ...
        return constructor.new(_3216.AbstractShaftOrHousingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def power_flow_results_of_type_imported_fe_component_power_flow(self) -> '_3274.ImportedFEComponentPowerFlow':
        ...
        if _3274.ImportedFEComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_power_flow(self) -> '_3306.ShaftPowerFlow':
        ...
        if _3306.ShaftPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
