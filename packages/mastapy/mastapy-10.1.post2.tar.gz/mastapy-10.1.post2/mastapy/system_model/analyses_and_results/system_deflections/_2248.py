...
class CVTSystemDeflection(_2214.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3254.CVTPowerFlow':
        ...
        return constructor.new(_3254.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
