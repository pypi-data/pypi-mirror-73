...
class SpringDamperSystemDeflection(_2245.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3314.SpringDamperPowerFlow':
        ...
        return constructor.new(_3314.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
