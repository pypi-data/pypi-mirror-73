...
class StraightBevelDiffGearMeshSystemDeflection(_2220.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3315.StraightBevelDiffGearMeshPowerFlow':
