...
class FaceGearMeshSystemDeflection(_2266.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3263.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3263.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
