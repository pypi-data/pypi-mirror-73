...
class TorqueConverterConnectionSystemDeflection(_2243.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3328.TorqueConverterConnectionPowerFlow':
        ...
        return constructor.new(_3328.TorqueConverterConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
