...
class ConceptGearMeshSystemDeflection(_2266.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3242.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3242.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
