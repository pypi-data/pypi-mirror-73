...
class SteadyStateSynchronousResponseOnAShaft(_6495.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3063.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3063.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
