...
from mastapy.system_model.analyses_and_results import _2182, _2180
...
class DesignEntityCompoundAnalysis(_2180.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2182.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2182.DesignEntitySingleContextAnalysis))
        return value
