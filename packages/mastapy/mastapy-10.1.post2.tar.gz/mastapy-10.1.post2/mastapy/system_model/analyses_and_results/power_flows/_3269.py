...
from mastapy.system_model.analyses_and_results.power_flows import _3267, _3268, _3308
...
class GearSetPowerFlow(_3308.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3267.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3267.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3268.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3268.GearPowerFlow))
        return value
