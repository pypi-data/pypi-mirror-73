...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3347
...
class CVTBeltConnectionCompoundPowerFlow(_3347.BeltConnectionCompoundPowerFlow):
    '''CVTBeltConnectionCompoundPowerFlow
