...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3376
...
class PartToPartShearCouplingCompoundPowerFlow(_3376.CouplingCompoundPowerFlow):
    '''PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3292.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3292.PartToPartShearCouplingPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3292.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3292.PartToPartShearCouplingPowerFlow))
        return value
