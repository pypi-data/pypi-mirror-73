...
class BeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_2901.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1831.BeltConnection':
    ...
    @property
    def connection_design(self) -> '_1831.BeltConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2727.BeltConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2727.BeltConnectionSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2727.BeltConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2727.BeltConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
