...
class BevelGearSetSteadyStateSynchronousResponseAtASpeed(_2723.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    '''BevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_design(self) -> '_2058.BevelGearSet':
