...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4014, _4013, _4019
...
class FaceGearSetModalAnalysesAtSpeeds(_4019.GearSetModalAnalysesAtSpeeds):
    '''FaceGearSetModalAnalysesAtSpeeds
    ...
    @property
    def face_gears_modal_analyses_at_speeds(self) -> 'List[_4014.FaceGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtSpeeds, constructor.new(_4014.FaceGearModalAnalysesAtSpeeds))
        return value

    @property
    def face_meshes_modal_analyses_at_speeds(self) -> 'List[_4013.FaceGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtSpeeds, constructor.new(_4013.FaceGearMeshModalAnalysesAtSpeeds))
        return value
