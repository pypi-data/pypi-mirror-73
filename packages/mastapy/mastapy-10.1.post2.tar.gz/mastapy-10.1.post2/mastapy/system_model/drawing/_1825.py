...
from mastapy.system_model.drawing import _1827, _1826
...
class ContourDrawStyle(_113.DrawStyleBase):
    ...
    @property
    def deflection_scaling(self) -> '_1827.ScalingDrawStyle':
        ...
        return constructor.new(_1827.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1826.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1826.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
