...
from mastapy.system_model.connections_and_sockets.gears import _1873
...
class CylindricalGearMesh(_1873.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2064.CylindricalGearSet':
        ...
        return constructor.new(_2064.CylindricalGearSet)(self.wrapped.CylindricalGearSet) if self.wrapped.CylindricalGearSet else None
