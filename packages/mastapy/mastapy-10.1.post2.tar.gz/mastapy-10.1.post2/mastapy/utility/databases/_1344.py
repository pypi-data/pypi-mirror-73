...
from mastapy.utility.databases import _1342, _1339, _1338
...
class SQLDatabase(_1338.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1342.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1339.DatabaseKey'):
