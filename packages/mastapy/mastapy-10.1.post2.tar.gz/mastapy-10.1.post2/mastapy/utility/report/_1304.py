...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4833, _4837
...
class DynamicCustomReportItem(_1293.CustomReportNameableItem):
    ...
    @property
    def inner_item_of_type_shaft_system_deflection_sections_report(self) -> '_2352.ShaftSystemDeflectionSectionsReport':
        ...
        if _2352.ShaftSystemDeflectionSectionsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_2352.ShaftSystemDeflectionSectionsReport)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_parametric_study_histogram(self) -> '_3545.ParametricStudyHistogram':
        ...
        if _3545.ParametricStudyHistogram.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_3545.ParametricStudyHistogram)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_campbell_diagram_report(self) -> '_4833.CampbellDiagramReport':
        ...
        if _4833.CampbellDiagramReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_4833.CampbellDiagramReport)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None

    @property
    def inner_item_of_type_per_mode_results_report(self) -> '_4837.PerModeResultsReport':
        ...
        if _4837.PerModeResultsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
        ...
        return constructor.new(_4837.PerModeResultsReport)(self.wrapped.InnerItem) if self.wrapped.InnerItem else None
