...
from mastapy.system_model.part_model import (
    _2012, _1992, _1988, _1981,
    _1984, _1986, _1991, _1995,
    _1997, _2000, _2003, _2004,
    _2005, _2007, _2009, _2011,
    _2017, _2018
)
from mastapy.system_model.imported_fes import (
    _1906, _1935, _1936, _1937,
    _1939, _1940, _1941, _1942,
    _1943, _1944, _1945, _1957,
    _1968, _1969, _1946, _1934,
    _1923
)
...
from mastapy.system_model.part_model.gears import (
    ...
    _2089, _2091, _2064, _2070,
    _2052, _2054, _2058, _2060,
    _2062, _2067, _2073, _2075,
    _2077, _2079, _2080, _2082,
    _2084, _2086, _2090, _2092
)
...
class ListWithSelectedItem_PowerLoad(_2012.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2012.PowerLoad.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2012.PowerLoad.TYPE

    @property
    def selected_value(self) -> '_2012.PowerLoad':
        ...
        return constructor.new(_2012.PowerLoad)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_2012.PowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2012.PowerLoad))
        return value


class ListWithSelectedItem_ImportedFELink(_1906.ImportedFELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1906.ImportedFELink.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1906.ImportedFELink.TYPE

    @property
    def selected_value(self) -> '_1906.ImportedFELink':
        ...
        return constructor.new(_1906.ImportedFELink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_electric_machine_stator_link(self) -> '_1935.ImportedFEElectricMachineStatorLink':
        ...
        if _1935.ImportedFEElectricMachineStatorLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1935.ImportedFEElectricMachineStatorLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_gear_mesh_link(self) -> '_1936.ImportedFEGearMeshLink':
        ...
        if _1936.ImportedFEGearMeshLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1936.ImportedFEGearMeshLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_gear_with_duplicated_meshes_link(self) -> '_1937.ImportedFEGearWithDuplicatedMeshesLink':
        ...
        if _1937.ImportedFEGearWithDuplicatedMeshesLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1937.ImportedFEGearWithDuplicatedMeshesLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_multi_node_connector_link(self) -> '_1939.ImportedFEMultiNodeConnectorLink':
        ...
        if _1939.ImportedFEMultiNodeConnectorLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1939.ImportedFEMultiNodeConnectorLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_multi_node_link(self) -> '_1940.ImportedFEMultiNodeLink':
        ...
        if _1940.ImportedFEMultiNodeLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1940.ImportedFEMultiNodeLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_node_link(self) -> '_1941.ImportedFENodeLink':
        ...
        if _1941.ImportedFENodeLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1941.ImportedFENodeLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_planetary_connector_multi_node_link(self) -> '_1942.ImportedFEPlanetaryConnectorMultiNodeLink':
        ...
        if _1942.ImportedFEPlanetaryConnectorMultiNodeLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1942.ImportedFEPlanetaryConnectorMultiNodeLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_planet_based_link(self) -> '_1943.ImportedFEPlanetBasedLink':
        ...
        if _1943.ImportedFEPlanetBasedLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1943.ImportedFEPlanetBasedLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_planet_carrier_link(self) -> '_1944.ImportedFEPlanetCarrierLink':
        ...
        if _1944.ImportedFEPlanetCarrierLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1944.ImportedFEPlanetCarrierLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_point_load_link(self) -> '_1945.ImportedFEPointLoadLink':
        ...
        if _1945.ImportedFEPointLoadLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1945.ImportedFEPointLoadLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_multi_angle_connection_link(self) -> '_1957.MultiAngleConnectionLink':
        ...
        if _1957.MultiAngleConnectionLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1957.MultiAngleConnectionLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_rolling_ring_connection_link(self) -> '_1968.RollingRingConnectionLink':
        ...
        if _1968.RollingRingConnectionLink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1968.RollingRingConnectionLink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_shaft_hub_connection_fe_link(self) -> '_1969.ShaftHubConnectionFELink':
        ...
        if _1969.ShaftHubConnectionFELink.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1969.ShaftHubConnectionFELink)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_1906.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1906.ImportedFELink))
        return value


class ListWithSelectedItem_ImportedFEStiffnessNode(_1946.ImportedFEStiffnessNode, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1946.ImportedFEStiffnessNode.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1946.ImportedFEStiffnessNode.TYPE

    @property
    def selected_value(self) -> '_1946.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1946.ImportedFEStiffnessNode)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_1946.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1946.ImportedFEStiffnessNode))
        return value


class ListWithSelectedItem_Datum(_1992.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1992.Datum.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1992.Datum.TYPE

    @property
    def selected_value(self) -> '_1992.Datum':
        ...
        return constructor.new(_1992.Datum)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_1992.Datum]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1992.Datum))
        return value


class ListWithSelectedItem_Component(_1988.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1988.Component.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1988.Component.TYPE

    @property
    def selected_value(self) -> '_1988.Component':
        ...
        return constructor.new(_1988.Component)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_abstract_shaft_or_housing(self) -> '_1981.AbstractShaftOrHousing':
        ...
        if _1981.AbstractShaftOrHousing.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1981.AbstractShaftOrHousing)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bearing(self) -> '_1984.Bearing':
        ...
        if _1984.Bearing.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1984.Bearing)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bolt(self) -> '_1986.Bolt':
        ...
        if _1986.Bolt.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1986.Bolt)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_connector(self) -> '_1991.Connector':
        ...
        if _1991.Connector.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1991.Connector)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_datum(self) -> '_1992.Datum':
        '''Datum: 'SelectedValue' is the original name of this property.
        ...
        if _1992.Datum.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
    ...
    @property
    def selected_value_of_type_external_cad_model(self) -> '_1995.ExternalCADModel':
        ...
        if _1995.ExternalCADModel.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1995.ExternalCADModel)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_guide_dxf_model(self) -> '_1997.GuideDxfModel':
        ...
        if _1997.GuideDxfModel.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_1997.GuideDxfModel)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_imported_fe_component(self) -> '_2000.ImportedFEComponent':
        ...
        if _2000.ImportedFEComponent.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2000.ImportedFEComponent)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_mass_disc(self) -> '_2003.MassDisc':
        ...
        if _2003.MassDisc.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2003.MassDisc)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_measurement_component(self) -> '_2004.MeasurementComponent':
        ...
        if _2004.MeasurementComponent.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2004.MeasurementComponent)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_mountable_component(self) -> '_2005.MountableComponent':
        ...
        if _2005.MountableComponent.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2005.MountableComponent)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_oil_seal(self) -> '_2007.OilSeal':
        ...
        if _2007.OilSeal.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2007.OilSeal)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_planet_carrier(self) -> '_2009.PlanetCarrier':
        ...
        if _2009.PlanetCarrier.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2009.PlanetCarrier)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_point_load(self) -> '_2011.PointLoad':
        ...
        if _2011.PointLoad.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2011.PointLoad)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_power_load(self) -> '_2012.PowerLoad':
        '''PowerLoad: 'SelectedValue' is the original name of this property.
        ...
        if _2012.PowerLoad.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
    ...
    @property
    def selected_value_of_type_unbalanced_mass(self) -> '_2017.UnbalancedMass':
        ...
        if _2017.UnbalancedMass.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2017.UnbalancedMass)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_virtual_component(self) -> '_2018.VirtualComponent':
        ...
        if _2018.VirtualComponent.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2018.VirtualComponent)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_shaft(self) -> '_2021.Shaft':
        ...
        if _2021.Shaft.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2021.Shaft)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_agma_gleason_conical_gear(self) -> '_2051.AGMAGleasonConicalGear':
        ...
        if _2051.AGMAGleasonConicalGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2051.AGMAGleasonConicalGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bevel_differential_gear(self) -> '_2053.BevelDifferentialGear':
        ...
        if _2053.BevelDifferentialGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2053.BevelDifferentialGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bevel_differential_planet_gear(self) -> '_2055.BevelDifferentialPlanetGear':
        ...
        if _2055.BevelDifferentialPlanetGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2055.BevelDifferentialPlanetGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bevel_differential_sun_gear(self) -> '_2056.BevelDifferentialSunGear':
        ...
        if _2056.BevelDifferentialSunGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2056.BevelDifferentialSunGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bevel_gear(self) -> '_2057.BevelGear':
        ...
        if _2057.BevelGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2057.BevelGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_concept_gear(self) -> '_2059.ConceptGear':
        ...
        if _2059.ConceptGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2059.ConceptGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_conical_gear(self) -> '_2061.ConicalGear':
        ...
        if _2061.ConicalGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2061.ConicalGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cylindrical_gear(self) -> '_2063.CylindricalGear':
        ...
        if _2063.CylindricalGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2063.CylindricalGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cylindrical_planet_gear(self) -> '_2065.CylindricalPlanetGear':
        ...
        if _2065.CylindricalPlanetGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2065.CylindricalPlanetGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_face_gear(self) -> '_2066.FaceGear':
        ...
        if _2066.FaceGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2066.FaceGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_gear(self) -> '_2068.Gear':
        ...
        if _2068.Gear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2068.Gear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_hypoid_gear(self) -> '_2072.HypoidGear':
        ...
        if _2072.HypoidGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2072.HypoidGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> '_2074.KlingelnbergCycloPalloidConicalGear':
        ...
        if _2074.KlingelnbergCycloPalloidConicalGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2074.KlingelnbergCycloPalloidConicalGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_2076.KlingelnbergCycloPalloidHypoidGear':
        ...
        if _2076.KlingelnbergCycloPalloidHypoidGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2076.KlingelnbergCycloPalloidHypoidGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_2078.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        if _2078.KlingelnbergCycloPalloidSpiralBevelGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2078.KlingelnbergCycloPalloidSpiralBevelGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_spiral_bevel_gear(self) -> '_2081.SpiralBevelGear':
        ...
        if _2081.SpiralBevelGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2081.SpiralBevelGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_straight_bevel_diff_gear(self) -> '_2083.StraightBevelDiffGear':
        ...
        if _2083.StraightBevelDiffGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2083.StraightBevelDiffGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_straight_bevel_gear(self) -> '_2085.StraightBevelGear':
        ...
        if _2085.StraightBevelGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2085.StraightBevelGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_straight_bevel_planet_gear(self) -> '_2087.StraightBevelPlanetGear':
        ...
        if _2087.StraightBevelPlanetGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2087.StraightBevelPlanetGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_straight_bevel_sun_gear(self) -> '_2088.StraightBevelSunGear':
        ...
        if _2088.StraightBevelSunGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2088.StraightBevelSunGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_worm_gear(self) -> '_2089.WormGear':
        ...
        if _2089.WormGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2089.WormGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_zerol_bevel_gear(self) -> '_2091.ZerolBevelGear':
        ...
        if _2091.ZerolBevelGear.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2091.ZerolBevelGear)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_clutch_half(self) -> '_2113.ClutchHalf':
        ...
        if _2113.ClutchHalf.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2113.ClutchHalf)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_concept_coupling_half(self) -> '_2116.ConceptCouplingHalf':
        ...
        if _2116.ConceptCouplingHalf.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2116.ConceptCouplingHalf)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_coupling_half(self) -> '_2118.CouplingHalf':
        ...
        if _2118.CouplingHalf.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2118.CouplingHalf)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cvt_pulley(self) -> '_2120.CVTPulley':
        ...
        if _2120.CVTPulley.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2120.CVTPulley)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_part_to_part_shear_coupling_half(self) -> '_2122.PartToPartShearCouplingHalf':
        ...
        if _2122.PartToPartShearCouplingHalf.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2122.PartToPartShearCouplingHalf)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_pulley(self) -> '_2123.Pulley':
        ...
        if _2123.Pulley.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2123.Pulley)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_rolling_ring(self) -> '_2129.RollingRing':
        ...
        if _2129.RollingRing.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2129.RollingRing)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_shaft_hub_connection(self) -> '_2131.ShaftHubConnection':
        ...
        if _2131.ShaftHubConnection.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2131.ShaftHubConnection)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_spring_damper_half(self) -> '_2133.SpringDamperHalf':
        ...
        if _2133.SpringDamperHalf.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2133.SpringDamperHalf)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_synchroniser_half(self) -> '_2136.SynchroniserHalf':
        ...
        if _2136.SynchroniserHalf.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2136.SynchroniserHalf)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_synchroniser_part(self) -> '_2137.SynchroniserPart':
        ...
        if _2137.SynchroniserPart.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2137.SynchroniserPart)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_synchroniser_sleeve(self) -> '_2138.SynchroniserSleeve':
        ...
        if _2138.SynchroniserSleeve.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2138.SynchroniserSleeve)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_torque_converter_pump(self) -> '_2140.TorqueConverterPump':
        ...
        if _2140.TorqueConverterPump.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2140.TorqueConverterPump)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_torque_converter_turbine(self) -> '_2142.TorqueConverterTurbine':
        ...
        if _2142.TorqueConverterTurbine.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2142.TorqueConverterTurbine)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_1988.Component]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1988.Component))
        return value


class ListWithSelectedItem_ImportedFE(_1934.ImportedFE, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1934.ImportedFE.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1934.ImportedFE.TYPE

    @property
    def selected_value(self) -> '_1934.ImportedFE':
        ...
        return constructor.new(_1934.ImportedFE)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_1934.ImportedFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1934.ImportedFE))
        return value


class ListWithSelectedItem_GuideDxfModel(_1997.GuideDxfModel, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1997.GuideDxfModel.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1997.GuideDxfModel.TYPE

    @property
    def selected_value(self) -> '_1997.GuideDxfModel':
        '''GuideDxfModel: 'SelectedValue' is the original name of this property.
    ...
    @property
    def available_values(self) -> 'List[_1997.GuideDxfModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1997.GuideDxfModel))
        return value


class ListWithSelectedItem_ConcentricPartGroup(_2026.ConcentricPartGroup, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2026.ConcentricPartGroup.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2026.ConcentricPartGroup.TYPE

    @property
    def selected_value(self) -> '_2026.ConcentricPartGroup':
        ...
        return constructor.new(_2026.ConcentricPartGroup)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_2026.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2026.ConcentricPartGroup))
        return value
...
class ListWithSelectedItem_ShaftHubConnection(_2131.ShaftHubConnection, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2131.ShaftHubConnection.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2131.ShaftHubConnection.TYPE

    @property
    def selected_value(self) -> '_2131.ShaftHubConnection':
        '''ShaftHubConnection: 'SelectedValue' is the original name of this property.
    ...
    @property
    def available_values(self) -> 'List[_2131.ShaftHubConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2131.ShaftHubConnection))
        return value
...
class ListWithSelectedItem_CylindricalGearSystemDeflection(_2255.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2255.CylindricalGearSystemDeflection.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2255.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self) -> '_2255.CylindricalGearSystemDeflection':
        ...
        return constructor.new(_2255.CylindricalGearSystemDeflection)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2256.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2256.CylindricalGearSystemDeflectionTimestep.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2256.CylindricalGearSystemDeflectionTimestep)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2257.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2257.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2257.CylindricalGearSystemDeflectionWithLTCAResults)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2258.CylindricalPlanetGearSystemDeflection':
        ...
        if _2258.CylindricalPlanetGearSystemDeflection.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2258.CylindricalPlanetGearSystemDeflection)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_2255.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2255.CylindricalGearSystemDeflection))
        return value


class ListWithSelectedItem_DesignState(_5236.DesignState, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_5236.DesignState.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _5236.DesignState.TYPE

    @property
    def selected_value(self) -> '_5236.DesignState':
        ...
        return constructor.new(_5236.DesignState)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_5236.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_5236.DesignState))
        return value


class ListWithSelectedItem_ImportedFEComponent(_2000.ImportedFEComponent, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2000.ImportedFEComponent.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2000.ImportedFEComponent.TYPE

    @property
    def selected_value(self) -> '_2000.ImportedFEComponent':
        '''ImportedFEComponent: 'SelectedValue' is the original name of this property.
    ...
    @property
    def available_values(self) -> 'List[_2000.ImportedFEComponent]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2000.ImportedFEComponent))
        return value


class ListWithSelectedItem_ImportedFEComponentGearWhineAnalysis(_5330.ImportedFEComponentGearWhineAnalysis, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_5330.ImportedFEComponentGearWhineAnalysis.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _5330.ImportedFEComponentGearWhineAnalysis.TYPE

    @property
    def selected_value(self) -> '_5330.ImportedFEComponentGearWhineAnalysis':
        ...
        return constructor.new(_5330.ImportedFEComponentGearWhineAnalysis)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_5330.ImportedFEComponentGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_5330.ImportedFEComponentGearWhineAnalysis))
        return value


class ListWithSelectedItem_ResultLocationSelectionGroup(_5404.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_5404.ResultLocationSelectionGroup.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _5404.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self) -> '_5404.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5404.ResultLocationSelectionGroup)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_5404.ResultLocationSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_5404.ResultLocationSelectionGroup))
        return value


class ListWithSelectedItem_StaticLoadCase(_6183.StaticLoadCase, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_6183.StaticLoadCase.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _6183.StaticLoadCase.TYPE

    @property
    def selected_value(self) -> '_6183.StaticLoadCase':
        ...
        return constructor.new(_6183.StaticLoadCase)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_6183.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_6183.StaticLoadCase))
        return value


class ListWithSelectedItem_DutyCycle(_5237.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_5237.DutyCycle.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _5237.DutyCycle.TYPE

    @property
    def selected_value(self) -> '_5237.DutyCycle':
        ...
        return constructor.new(_5237.DutyCycle)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_5237.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_5237.DutyCycle))
        return value
...
class ListWithSelectedItem_ElectricMachineDataSet(_1923.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_1923.ElectricMachineDataSet.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _1923.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self) -> '_1923.ElectricMachineDataSet':
        ...
        return constructor.new(_1923.ElectricMachineDataSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_1923.ElectricMachineDataSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_1923.ElectricMachineDataSet))
        return value


class ListWithSelectedItem_CylindricalGearSet(_2064.CylindricalGearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2064.CylindricalGearSet.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2064.CylindricalGearSet.TYPE

    @property
    def selected_value(self) -> '_2064.CylindricalGearSet':
        ...
        return constructor.new(_2064.CylindricalGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_2064.CylindricalGearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2064.CylindricalGearSet))
        return value


class ListWithSelectedItem_PointLoad(_2011.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2011.PointLoad.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2011.PointLoad.TYPE

    @property
    def selected_value(self) -> '_2011.PointLoad':
        '''PointLoad: 'SelectedValue' is the original name of this property.
    ...
    @property
    def available_values(self) -> 'List[_2011.PointLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2011.PointLoad))
        return value


class ListWithSelectedItem_GearSet(_2070.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> '_2070.GearSet.TYPE':
        '''Implicit Pythonnet type of this class.
        ...
        return _2070.GearSet.TYPE

    @property
    def selected_value(self) -> '_2070.GearSet':
        ...
        return constructor.new(_2070.GearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_agma_gleason_conical_gear_set(self) -> '_2052.AGMAGleasonConicalGearSet':
        ...
        if _2052.AGMAGleasonConicalGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2052.AGMAGleasonConicalGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bevel_differential_gear_set(self) -> '_2054.BevelDifferentialGearSet':
        ...
        if _2054.BevelDifferentialGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2054.BevelDifferentialGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_bevel_gear_set(self) -> '_2058.BevelGearSet':
        ...
        if _2058.BevelGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2058.BevelGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_concept_gear_set(self) -> '_2060.ConceptGearSet':
        ...
        if _2060.ConceptGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2060.ConceptGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_conical_gear_set(self) -> '_2062.ConicalGearSet':
        ...
        if _2062.ConicalGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2062.ConicalGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_cylindrical_gear_set(self) -> '_2064.CylindricalGearSet':
        '''CylindricalGearSet: 'SelectedValue' is the original name of this property.
        ...
        if _2064.CylindricalGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
    ...
    @property
    def selected_value_of_type_face_gear_set(self) -> '_2067.FaceGearSet':
        ...
        if _2067.FaceGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2067.FaceGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_hypoid_gear_set(self) -> '_2073.HypoidGearSet':
        ...
        if _2073.HypoidGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2073.HypoidGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> '_2075.KlingelnbergCycloPalloidConicalGearSet':
        ...
        if _2075.KlingelnbergCycloPalloidConicalGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2075.KlingelnbergCycloPalloidConicalGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> '_2077.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        if _2077.KlingelnbergCycloPalloidHypoidGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2077.KlingelnbergCycloPalloidHypoidGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_2079.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        if _2079.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2079.KlingelnbergCycloPalloidSpiralBevelGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_planetary_gear_set(self) -> '_2080.PlanetaryGearSet':
        ...
        if _2080.PlanetaryGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2080.PlanetaryGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_spiral_bevel_gear_set(self) -> '_2082.SpiralBevelGearSet':
        ...
        if _2082.SpiralBevelGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2082.SpiralBevelGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_straight_bevel_diff_gear_set(self) -> '_2084.StraightBevelDiffGearSet':
        ...
        if _2084.StraightBevelDiffGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2084.StraightBevelDiffGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_straight_bevel_gear_set(self) -> '_2086.StraightBevelGearSet':
        ...
        if _2086.StraightBevelGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2086.StraightBevelGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_worm_gear_set(self) -> '_2090.WormGearSet':
        ...
        if _2090.WormGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2090.WormGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def selected_value_of_type_zerol_bevel_gear_set(self) -> '_2092.ZerolBevelGearSet':
        ...
        if _2092.ZerolBevelGearSet.TYPE not in self.enclosing.SelectedValue.__class__.__mro__:
        ...
        return constructor.new(_2092.ZerolBevelGearSet)(self.enclosing.SelectedValue) if self.enclosing.SelectedValue else None

    @property
    def available_values(self) -> 'List[_2070.GearSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.enclosing.AvailableValues, constructor.new(_2070.GearSet))
        return value
