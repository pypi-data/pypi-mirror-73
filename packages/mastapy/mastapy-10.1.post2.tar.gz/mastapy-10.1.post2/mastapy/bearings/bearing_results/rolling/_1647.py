...
from mastapy.bearings.bearing_results.rolling import _1646, _1616
...
class LoadedSelfAligningBallBearingRow(_1616.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1646.LoadedSelfAligningBallBearingResults':
