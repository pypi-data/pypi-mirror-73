...
from mastapy.bearings.bearing_results.rolling import _1602, _1640
...
class LoadedAsymmetricSphericalRollerBearingRow(_1640.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1602.LoadedAsymmetricSphericalRollerBearingResults':
