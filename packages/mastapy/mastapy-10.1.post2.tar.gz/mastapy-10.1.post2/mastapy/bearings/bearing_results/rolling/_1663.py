...
from mastapy.bearings.bearing_results.rolling import _1662, _1616
...
class LoadedThreePointContactBallBearingRow(_1616.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1662.LoadedThreePointContactBallBearingResults':
