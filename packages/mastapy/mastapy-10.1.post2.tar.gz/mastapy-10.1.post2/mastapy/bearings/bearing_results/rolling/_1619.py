...
from mastapy.bearings.bearing_results.rolling import _1683, _1634
...
class LoadedCylindricalRollerBearingResults(_1634.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1683.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1683.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
