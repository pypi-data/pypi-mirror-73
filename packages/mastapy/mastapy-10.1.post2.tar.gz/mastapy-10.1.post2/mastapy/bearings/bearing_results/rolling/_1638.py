...
from mastapy.bearings.bearing_results.rolling import _1679, _1624
...
class LoadedRollerBearingElement(_1624.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1679.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1679.ResultsAtRollerOffset))
        return value
