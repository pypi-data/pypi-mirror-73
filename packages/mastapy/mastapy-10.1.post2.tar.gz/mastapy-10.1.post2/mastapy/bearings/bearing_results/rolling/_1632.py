...
from mastapy.bearings.bearing_results.rolling import _1631, _1620
...
class LoadedNeedleRollerBearingRow(_1620.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1631.LoadedNeedleRollerBearingResults':
