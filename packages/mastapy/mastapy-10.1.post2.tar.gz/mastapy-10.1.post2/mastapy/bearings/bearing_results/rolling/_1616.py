...
from mastapy.bearings.bearing_results.rolling import (
    _1615, _1596, _1599, _1622,
    _1627, _1646, _1662, _1665,
    _1614, _1644
)
...
class LoadedBallBearingRow(_1644.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1615.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1614.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1614.LoadedBallBearingRaceResults))
        return value
