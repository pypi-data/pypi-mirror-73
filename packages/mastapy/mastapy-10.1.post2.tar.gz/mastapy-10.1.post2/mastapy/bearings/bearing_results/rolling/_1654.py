...
from mastapy.bearings.bearing_results.rolling import _1653, _1640
...
class LoadedSphericalRollerThrustBearingRow(_1640.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1653.LoadedSphericalRollerThrustBearingResults':
