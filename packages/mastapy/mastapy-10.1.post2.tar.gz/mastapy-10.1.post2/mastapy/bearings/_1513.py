...
class BearingSettings(_1139.PerMachineSettings):
    ...
    @property
    def skf_credentials(self) -> '_1705.SKFCredentials':
        ...
        return constructor.new(_1705.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
