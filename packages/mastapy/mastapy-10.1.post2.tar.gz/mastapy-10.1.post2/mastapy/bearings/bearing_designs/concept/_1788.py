...
from mastapy.bearings.bearing_designs.concept import _1787, _1789
...
class ConceptAxialClearanceBearing(_1789.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1787.BearingNodePosition':
        ...
        return constructor.new(_1787.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1787.BearingNodePosition'):
