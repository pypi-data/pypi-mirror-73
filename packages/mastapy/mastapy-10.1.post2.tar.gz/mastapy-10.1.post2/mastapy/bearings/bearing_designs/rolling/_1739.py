...
from mastapy.bearings.bearing_designs.rolling import _1740, _1757
...
class BallBearing(_1757.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1740.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1740.BallBearingShoulderDefinition))
        return value
