...
from mastapy.bearings.bearing_designs.rolling import _1755, _1756, _1754
...
class NonBarrelRollerBearing(_1754.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1755.RollerEndShape':
        ...
        return constructor.new(_1755.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1755.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1756.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1756.RollerRibDetail))
        return value
