...
class RollingBearingDatabase(_1344.SQLDatabase['_1526.RollingBearingKey', '_1757.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1757.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1757.RollingBearing'):
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1503.BearingCatalog', type_: '_1528.RollingBearingType') -> 'List[_1757.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(designation if designation else None, catalog, type_), constructor.new(_1757.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1503.BearingCatalog') -> '_1757.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        return constructor.new(_1757.RollingBearing)(method_result) if method_result else None

    def search_for_rolling_bearing_with_catalog(self, catalog: '_1503.BearingCatalog') -> 'List[_1757.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing(catalog), constructor.new(_1757.RollingBearing))

    def create_bearing(self, type_: '_1528.RollingBearingType', designation: Optional['str'] = 'None') -> '_1757.RollingBearing':
