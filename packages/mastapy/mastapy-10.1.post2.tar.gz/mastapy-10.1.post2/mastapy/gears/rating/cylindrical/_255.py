...
from mastapy.gears.rating.cylindrical import _264, _260, _274
...
class CylindricalGearDutyCycleRating(_161.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_264.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_264.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_264.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_274.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_274.MeshRatingForReports))
        return value
