...
class KlingelnbergConicalMeshSingleFlankRating(_169.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_190.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_190.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
