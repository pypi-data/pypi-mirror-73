...
from mastapy.gears.rating import _159, _157
...
class GearRating(_157.AbstractGearRating):
    '''GearRating
    ...
    @property
    def static_safety_factor(self) -> '_159.BendingAndContactReportingObject':
        ...
        return constructor.new(_159.BendingAndContactReportingObject)(self.wrapped.StaticSafetyFactor) if self.wrapped.StaticSafetyFactor else None
