...
class CylindricalGearRealCutterDesign(_508.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
