...
class TiffAnalysisSettings(_1134.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    ...
    @property
    def case_hardening_properties_for_fe_analysis(self) -> '_767.CaseHardeningPropertiesForFEAnalysis':
        ...
        return constructor.new(_767.CaseHardeningPropertiesForFEAnalysis)(self.wrapped.CaseHardeningPropertiesForFEAnalysis) if self.wrapped.CaseHardeningPropertiesForFEAnalysis else None
