...
from mastapy.math_utility.optimisation import _1108, _1106
...
class ParetoOptimistaionVariable(_1106.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1108.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1108.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1108.PropertyTargetForDominantCandidateSearch'):
