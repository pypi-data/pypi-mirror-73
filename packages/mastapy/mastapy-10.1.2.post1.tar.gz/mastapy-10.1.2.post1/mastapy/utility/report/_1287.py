...
from mastapy.utility.report import _1288, _1289
...
T = TypeVar('T', bound='_1289.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1288.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
