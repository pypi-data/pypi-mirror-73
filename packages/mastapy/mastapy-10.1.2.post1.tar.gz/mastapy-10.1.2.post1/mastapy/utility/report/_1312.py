...
from mastapy.utility.report import _1311, _1304
...
class UserTextRow(_1304.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1311.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1311.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1311.HeadingSize'):
