...
class WormGearSystemDeflection(_2279.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3346.WormGearPowerFlow':
        ...
        return constructor.new(_3346.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
