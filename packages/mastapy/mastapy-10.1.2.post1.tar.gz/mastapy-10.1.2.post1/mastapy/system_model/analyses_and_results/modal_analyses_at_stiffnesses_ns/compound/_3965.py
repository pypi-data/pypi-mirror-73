...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns.compound import _3891
...
class TorqueConverterConnectionCompoundModalAnalysesAtStiffnesses(_3891.CouplingConnectionCompoundModalAnalysesAtStiffnesses):
    '''TorqueConverterConnectionCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_1913.TorqueConverterConnection':
        ...
        return constructor.new(_1913.TorqueConverterConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3843.TorqueConverterConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3843.TorqueConverterConnectionModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3843.TorqueConverterConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3843.TorqueConverterConnectionModalAnalysesAtStiffnesses))
        return value
