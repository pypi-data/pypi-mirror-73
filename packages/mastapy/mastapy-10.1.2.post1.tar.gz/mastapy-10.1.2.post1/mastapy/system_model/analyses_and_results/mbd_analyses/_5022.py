...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5021, _5019, _5070
...
class GearSetMultiBodyDynamicsAnalysis(_5070.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5021.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5021.GearMultiBodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5019.GearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5019.GearMeshMultiBodyDynamicsAnalysis))
        return value
