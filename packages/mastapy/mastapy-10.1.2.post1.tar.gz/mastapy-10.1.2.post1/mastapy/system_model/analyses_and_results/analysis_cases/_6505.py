...
class PartCompoundAnalysis(_6502.DesignEntityCompoundAnalysis):
    '''PartCompoundAnalysis
    ...
    @property
    def twod_drawing(self) -> '_6517.SMTBitmap':
        ...
        return constructor.new(_6517.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None
