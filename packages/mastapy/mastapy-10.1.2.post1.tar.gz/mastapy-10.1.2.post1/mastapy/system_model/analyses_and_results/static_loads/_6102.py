...
from mastapy.system_model.analyses_and_results.static_loads import _6202, _6131, _6176
...
class ElectricMachineHarmonicLoadData(_6176.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
