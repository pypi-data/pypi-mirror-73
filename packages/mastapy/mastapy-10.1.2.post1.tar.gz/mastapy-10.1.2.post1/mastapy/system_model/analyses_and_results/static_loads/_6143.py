...
from mastapy.system_model.analyses_and_results.static_loads import _6141, _6142, _6140
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6140.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    '''KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6141.KlingelnbergCycloPalloidHypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsLoadCase, constructor.new(_6141.KlingelnbergCycloPalloidHypoidGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6142.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesLoadCase, constructor.new(_6142.KlingelnbergCycloPalloidHypoidGearMeshLoadCase))
        return value
