...
class WormGearMeshGearWhineAnalysis(_5330.GearMeshGearWhineAnalysis):
    '''WormGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2350.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2350.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
