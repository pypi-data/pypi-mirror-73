...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4733, _4822, _4821, _4777,
    _4823
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5400, _5405, _5406
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5316, _5365
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_4733.CoordinateSystemForWhine':
        ...
        return constructor.new(_4733.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4733.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def magnitude_method_for_complex_vectors(self) -> '_1079.ComplexMagnitudeMethod':
    ...
    def magnitude_method_for_complex_vectors(self, value: '_1079.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def whine_waterfall_export_option(self) -> '_4822.WhineWaterfallExportOption':
        ...
        return constructor.new(_4822.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4822.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5400.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5400.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4821.WaterfallChartSettings':
        ...
        return constructor.new(_4821.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4777.OrderCutsChartSettings':
        ...
        return constructor.new(_4777.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_5316.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5316.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5365.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5365.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1206.LengthVeryShort]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1206.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1160.AngleSmall]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1160.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1258.VelocitySmall]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1258.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1166.AngularVelocity]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1166.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1157.Acceleration]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1157.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1162.AngularAcceleration]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1162.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1180.Force]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1180.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1253.Torque]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1253.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1174.Energy]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1174.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1224.PowerSmall]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1224.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1225.PowerSmallPerArea]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1225.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4823.WhineWaterfallReferenceValues[_1228.Pressure]':
        ...
        return constructor.new(_4823.WhineWaterfallReferenceValues)[_1228.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5405.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5405.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5406.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5406.ResultNodeSelection))
        return value
