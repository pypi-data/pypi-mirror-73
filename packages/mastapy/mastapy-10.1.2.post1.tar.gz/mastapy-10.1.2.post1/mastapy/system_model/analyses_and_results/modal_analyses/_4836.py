...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4744, _4833, _4832, _4788,
    _4834
)
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5413, _5418, _5419
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5327, _5378
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_4744.CoordinateSystemForWhine':
        ...
        return constructor.new(_4744.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4744.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def whine_waterfall_export_option(self) -> '_4833.WhineWaterfallExportOption':
        ...
        return constructor.new(_4833.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4833.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5413.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5413.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4832.WaterfallChartSettings':
        ...
        return constructor.new(_4832.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4788.OrderCutsChartSettings':
        ...
        return constructor.new(_4788.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def frequency_options(self) -> '_5327.FrequencyOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5327.FrequencyOptionsForGearWhineAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5378.SpeedOptionsForGearWhineAnalysisResults':
        ...
        return constructor.new(_5378.SpeedOptionsForGearWhineAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1210.LengthVeryShort]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1210.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1164.AngleSmall]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1164.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1262.VelocitySmall]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1262.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1170.AngularVelocity]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1170.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1161.Acceleration]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1161.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1166.AngularAcceleration]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1166.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1184.Force]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1184.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1257.Torque]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1257.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1178.Energy]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1178.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1228.PowerSmall]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1228.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1229.PowerSmallPerArea]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1229.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4834.WhineWaterfallReferenceValues[_1232.Pressure]':
        ...
        return constructor.new(_4834.WhineWaterfallReferenceValues)[_1232.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5418.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5418.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5419.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5419.ResultNodeSelection))
        return value
