...
class FlexiblePinAssembly(_2017.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2064.CylindricalGear':
        ...
        return constructor.new(_2064.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
