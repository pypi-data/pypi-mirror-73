...
from mastapy.gears.gear_designs.cylindrical import _817, _816, _775
...
class CylindricalPlanetGearDesign(_775.CylindricalGearDesign):
    ...
    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_817.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_817.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_816.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_816.NamedPlanetAssemblyIndex))
        return value
