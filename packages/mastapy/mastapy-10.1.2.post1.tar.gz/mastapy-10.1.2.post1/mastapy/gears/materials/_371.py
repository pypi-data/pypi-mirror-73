...
from mastapy.gears.materials import _392, _378
...
class BevelGearMaterial(_378.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_392.SNCurveDefinition':
        ...
        return constructor.new(_392.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_392.SNCurveDefinition'):
