...
from mastapy.gears.gear_designs.cylindrical import _785, _822
...
class AGMA2101MeshSingleFlankRating(_267.CylindricalMeshSingleFlankRating):
    ...
    @property
    def scuffing_temperature_method(self) -> '_822.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_822.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_320.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_320.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_320.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_320.AGMA2101GearSingleFlankRating))
        return value
