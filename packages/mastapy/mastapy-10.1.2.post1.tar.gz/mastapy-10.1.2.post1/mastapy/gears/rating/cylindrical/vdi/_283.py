...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_318.DIN3990GearSingleFlankRating':
        ...
        if _318.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_318.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
