...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def result_chart_scatter(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.ResultChartScatter) if self.wrapped.ResultChartScatter else None

    @property
    def result_chart_bar_and_line(self) -> '_6503.SMTBitmap':
        ...
        return constructor.new(_6503.SMTBitmap)(self.wrapped.ResultChartBarAndLine) if self.wrapped.ResultChartBarAndLine else None
    ...
    def optimiser(self) -> '_674.DesignSpaceSearchBase[TAnalysis, TCandidate]':
        ...
        return constructor.new(_674.DesignSpaceSearchBase)[TAnalysis, TCandidate](self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_cylindrical_gear_set_pareto_optimiser(self) -> '_673.CylindricalGearSetParetoOptimiser':
        ...
        return constructor.new(_673.CylindricalGearSetParetoOptimiser)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_face_gear_set_pareto_optimiser(self) -> '_676.FaceGearSetParetoOptimiser':
        ...
        return constructor.new(_676.FaceGearSetParetoOptimiser)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_gear_set_pareto_optimiser(self) -> '_680.GearSetParetoOptimiser':
        ...
        return constructor.new(_680.GearSetParetoOptimiser)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_hypoid_gear_set_pareto_optimiser(self) -> '_681.HypoidGearSetParetoOptimiser':
        ...
        return constructor.new(_681.HypoidGearSetParetoOptimiser)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_micro_geometry_design_space_search(self) -> '_684.MicroGeometryDesignSpaceSearch':
        ...
        return constructor.new(_684.MicroGeometryDesignSpaceSearch)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_687.MicroGeometryGearSetDesignSpaceSearch':
        ...
        return constructor.new(_687.MicroGeometryGearSetDesignSpaceSearch)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_spiral_bevel_gear_set_pareto_optimiser(self) -> '_706.SpiralBevelGearSetParetoOptimiser':
        ...
        return constructor.new(_706.SpiralBevelGearSetParetoOptimiser)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
    ...
    def optimiser_of_type_straight_bevel_gear_set_pareto_optimiser(self) -> '_707.StraightBevelGearSetParetoOptimiser':
        ...
        return constructor.new(_707.StraightBevelGearSetParetoOptimiser)(self.wrapped.Optimiser) if self.wrapped.Optimiser else None
