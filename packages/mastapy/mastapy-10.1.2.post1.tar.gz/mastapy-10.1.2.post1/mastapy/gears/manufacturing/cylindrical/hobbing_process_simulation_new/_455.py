...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _446, _450
...
class HobbingProcessProfileCalculation(_450.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
