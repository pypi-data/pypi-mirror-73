...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _445, _450
...
class HobbingProcessPitchCalculation(_450.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
