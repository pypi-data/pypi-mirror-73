...
class VirtualPlungeShaverOutputs(_436.PlungeShaverOutputs):
    ...
    @property
    def lead_modification_on_conjugate_shaver_chart_left_flank(self) -> '_6517.SMTBitmap':
        ...
        return constructor.new(_6517.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank) if self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank else None

    @property
    def lead_modification_on_conjugate_shaver_chart_right_flank(self) -> '_6517.SMTBitmap':
        ...
        return constructor.new(_6517.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartRightFlank) if self.wrapped.LeadModificationOnConjugateShaverChartRightFlank else None
