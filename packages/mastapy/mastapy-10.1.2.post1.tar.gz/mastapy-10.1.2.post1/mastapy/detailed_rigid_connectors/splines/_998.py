...
class SplineJointDesign(_970.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_988.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_988.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_988.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_992.SAETorqueCycles':
        ...
        return constructor.new(_992.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_992.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_989.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_989.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_989.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_996.SplineFixtureTypes':
        ...
        return constructor.new(_996.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_996.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_997.SplineHalfDesign':
        ...
        return constructor.new(_997.SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_972.CustomSplineHalfDesign':
        ...
        if _972.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_972.CustomSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_975.DIN5480SplineHalfDesign':
        ...
        if _975.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_975.DIN5480SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_979.GBT3478SplineHalfDesign':
        ...
        if _979.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_979.GBT3478SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_982.ISO4156SplineHalfDesign':
        ...
        if _982.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_982.ISO4156SplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_990.SAESplineHalfDesign':
        ...
        if _990.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_990.SAESplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1002.StandardSplineHalfDesign':
        ...
        if _1002.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1002.StandardSplineHalfDesign)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf else None

    @property
    def internal_half(self) -> '_997.SplineHalfDesign':
        ...
        return constructor.new(_997.SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_972.CustomSplineHalfDesign':
        ...
        if _972.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_972.CustomSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_975.DIN5480SplineHalfDesign':
        ...
        if _975.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_975.DIN5480SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_979.GBT3478SplineHalfDesign':
        ...
        if _979.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_979.GBT3478SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_982.ISO4156SplineHalfDesign':
        ...
        if _982.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_982.ISO4156SplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_990.SAESplineHalfDesign':
        ...
        if _990.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_990.SAESplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None

    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1002.StandardSplineHalfDesign':
        ...
        if _1002.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new(_1002.StandardSplineHalfDesign)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf else None
