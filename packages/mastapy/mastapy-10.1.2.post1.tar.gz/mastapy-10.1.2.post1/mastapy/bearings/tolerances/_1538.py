...
from mastapy.bearings.tolerances import _1534, _1531
...
class InterferenceTolerance(_1531.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1534.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1534.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1520.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1520.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1520.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
