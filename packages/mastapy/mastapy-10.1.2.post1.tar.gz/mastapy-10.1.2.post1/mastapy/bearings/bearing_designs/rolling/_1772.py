...
from mastapy.bearings.bearing_designs.rolling import _1766, _1763
...
class TaperRollerBearing(_1763.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1514.BearingMeasurementType':
        ...
        return constructor.new(_1514.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1514.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1766.RollerRibDetail':
        ...
        return constructor.new(_1766.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
