...
from mastapy.bearings.bearing_results.rolling import _1597, _1617
...
class LoadedAngularContactBallBearingRow(_1617.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1597.LoadedAngularContactBallBearingResults':
