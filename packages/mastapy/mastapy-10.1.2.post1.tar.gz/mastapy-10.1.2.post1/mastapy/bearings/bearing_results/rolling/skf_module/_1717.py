...
from mastapy.bearings.bearing_results.rolling.skf_module import _1711, _1713
...
class Viscosities(_1713.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1711.OperatingViscosity':
        ...
        return constructor.new(_1711.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
