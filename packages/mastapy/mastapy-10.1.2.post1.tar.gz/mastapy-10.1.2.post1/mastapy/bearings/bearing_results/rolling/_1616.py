...
from mastapy.bearings.bearing_results.rolling import _1687, _1644
...
class LoadedBallBearingResults(_1644.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1687.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1687.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
