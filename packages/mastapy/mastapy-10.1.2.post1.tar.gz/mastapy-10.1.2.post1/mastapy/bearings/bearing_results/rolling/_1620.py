...
from mastapy.bearings.bearing_results.rolling import _1684, _1635
...
class LoadedCylindricalRollerBearingResults(_1635.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1684.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1684.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
