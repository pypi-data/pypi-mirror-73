...
from mastapy.bearings.bearing_results.rolling.skf_module import _1703, _1705
...
class Viscosities(_1705.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1703.OperatingViscosity':
        ...
        return constructor.new(_1703.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
