...
from mastapy.bearings.bearing_results.rolling import _1666, _1617
...
class LoadedThrustBallBearingRow(_1617.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1666.LoadedThrustBallBearingResults':
