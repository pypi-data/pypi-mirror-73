...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1486, _1476
...
class ElementPropertiesRigid(_1476.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1486.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1486.RigidElementNodeDegreesOfFreedom))
        return value
