...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1475
...
class RigidElementNodeDegreesOfFreedom(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1475.DegreeOfFreedomType':
        ...
        return constructor.new(_1475.DegreeOfFreedomType)(value) if value else None
