...
from mastapy.bearings.bearing_results.rolling import _1603, _1641
...
class LoadedAsymmetricSphericalRollerBearingRow(_1641.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1603.LoadedAsymmetricSphericalRollerBearingResults':
