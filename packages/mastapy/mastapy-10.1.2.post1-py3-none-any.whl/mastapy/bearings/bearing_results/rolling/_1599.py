...
from mastapy.bearings.bearing_results.rolling import _1596
...
class LoadedAngularContactThrustBallBearingElement(_1596.LoadedAngularContactBallBearingElement):
    '''LoadedAngularContactThrustBallBearingElement
