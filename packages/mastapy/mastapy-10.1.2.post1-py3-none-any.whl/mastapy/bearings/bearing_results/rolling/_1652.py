...
from mastapy.bearings.bearing_results.rolling import _1651, _1641
...
class LoadedSphericalRollerRadialBearingRow(_1641.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1651.LoadedSphericalRollerRadialBearingResults':
