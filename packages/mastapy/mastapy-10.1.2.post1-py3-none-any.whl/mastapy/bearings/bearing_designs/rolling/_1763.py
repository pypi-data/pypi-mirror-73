...
from mastapy.bearings.bearing_designs.rolling import _1757, _1754
...
class TaperRollerBearing(_1754.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1510.BearingMeasurementType':
        ...
        return constructor.new(_1510.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1510.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1757.RollerRibDetail':
        ...
        return constructor.new(_1757.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
