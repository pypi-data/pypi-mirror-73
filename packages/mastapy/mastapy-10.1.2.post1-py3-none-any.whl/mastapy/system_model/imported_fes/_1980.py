...
from mastapy.system_model.imported_fes import _1973, _1972
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1973.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1973.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1972.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1972.PerLinkExportOptions))
        return value
