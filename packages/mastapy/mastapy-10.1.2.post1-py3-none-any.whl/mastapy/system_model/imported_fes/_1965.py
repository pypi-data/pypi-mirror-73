...
from mastapy.system_model.imported_fes import _1910, _1916
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1910.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1910.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1910.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1916.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1916.BearingRaceNodeLink))
        return value
