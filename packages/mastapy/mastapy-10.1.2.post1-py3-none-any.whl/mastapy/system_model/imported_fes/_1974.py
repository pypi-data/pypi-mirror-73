...
from mastapy.system_model.imported_fes import _1919, _1925
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1919.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1919.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1919.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1925.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1925.BearingRaceNodeLink))
        return value
