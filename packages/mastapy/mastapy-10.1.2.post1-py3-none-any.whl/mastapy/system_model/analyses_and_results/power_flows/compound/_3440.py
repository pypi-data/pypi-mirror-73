...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3438, _3439, _3357
...
class StraightBevelDiffGearSetCompoundPowerFlow(_3357.BevelGearSetCompoundPowerFlow):
    ...
    @property
    def straight_bevel_diff_gears_compound_power_flow(self) -> 'List[_3438.StraightBevelDiffGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundPowerFlow, constructor.new(_3438.StraightBevelDiffGearCompoundPowerFlow))
        return value

    @property
    def straight_bevel_diff_meshes_compound_power_flow(self) -> 'List[_3439.StraightBevelDiffGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundPowerFlow, constructor.new(_3439.StraightBevelDiffGearMeshCompoundPowerFlow))
        return value
