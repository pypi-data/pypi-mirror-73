...
from mastapy.system_model.analyses_and_results.static_loads import _6183, _6094, _6052
...
class RootAssemblyLoadCase(_6052.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6094.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6094.CylindricalGearSetLoadCase))
        return value
