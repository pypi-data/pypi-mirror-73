...
from mastapy.system_model.analyses_and_results.static_loads import _6160, _6150
...
class PlanetCarrierLoadCase(_6150.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6160.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6160.PlanetarySocketManufactureError))
        return value
