...
from mastapy.system_model.drawing import _1828, _1826
...
class SystemDeflectionDrawStyle(_1826.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1828.ScalingDrawStyle':
        ...
        return constructor.new(_1828.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
