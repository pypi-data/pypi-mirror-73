...
class ComponentSystemDeflection(_2292.PartSystemDeflection):
    ...
    @property
    def mass_properties_in_local_coordinate_system_from_node_model(self) -> '_1077.MassProperties':
        ...
        return constructor.new(_1077.MassProperties)(self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel) if self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel else None
