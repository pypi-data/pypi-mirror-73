...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4843, _4840, _4842
...
class PartModalAnalysis(_6493.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_4771.ModalAnalysis':
        ...
        return constructor.new(_4771.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis else None

    @property
    def results_for_modes(self) -> 'List[_4843.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4843.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4840.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4840.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4840.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4840.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4842.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4842.SingleExcitationResultsModalAnalysis))
        return value
