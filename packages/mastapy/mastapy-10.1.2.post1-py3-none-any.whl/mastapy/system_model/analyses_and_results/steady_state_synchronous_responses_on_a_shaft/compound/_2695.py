...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_2636.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    '''SpringDamperConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1902.SpringDamperConnection':
    ...
    @property
    def connection_design(self) -> '_1902.SpringDamperConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2572.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2572.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2572.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2572.SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
