...
from mastapy.system_model.analyses_and_results import _2192, _2190
...
class DesignEntityCompoundAnalysis(_2190.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2192.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2192.DesignEntitySingleContextAnalysis))
        return value
