...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5375, _5376, _5268
...
class StraightBevelGearSetGearWhineAnalysis(_5268.BevelGearSetGearWhineAnalysis):
    '''StraightBevelGearSetGearWhineAnalysis
    ...
    @property
    def gears_gear_whine_analysis(self) -> 'List[_5375.StraightBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsGearWhineAnalysis, constructor.new(_5375.StraightBevelGearGearWhineAnalysis))
        return value

    @property
    def straight_bevel_gears_gear_whine_analysis(self) -> 'List[_5375.StraightBevelGearGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsGearWhineAnalysis, constructor.new(_5375.StraightBevelGearGearWhineAnalysis))
        return value

    @property
    def meshes_gear_whine_analysis(self) -> 'List[_5376.StraightBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesGearWhineAnalysis, constructor.new(_5376.StraightBevelGearMeshGearWhineAnalysis))
        return value

    @property
    def straight_bevel_meshes_gear_whine_analysis(self) -> 'List[_5376.StraightBevelGearMeshGearWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesGearWhineAnalysis, constructor.new(_5376.StraightBevelGearMeshGearWhineAnalysis))
        return value
