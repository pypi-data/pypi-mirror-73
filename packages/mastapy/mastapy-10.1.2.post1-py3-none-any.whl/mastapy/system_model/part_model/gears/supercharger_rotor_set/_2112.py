...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2111
...
class SuperchargerRotorSetDatabase(_1345.NamedDatabase['_2111.SuperchargerRotorSet']):
    '''SuperchargerRotorSetDatabase
