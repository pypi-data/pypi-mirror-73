...
from mastapy.system_model.part_model.couplings import _2150, _2152, _2127
...
class TorqueConverter(_2127.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2150.TorqueConverterPump':
        ...
        return constructor.new(_2150.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2152.TorqueConverterTurbine':
        ...
        return constructor.new(_2152.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
