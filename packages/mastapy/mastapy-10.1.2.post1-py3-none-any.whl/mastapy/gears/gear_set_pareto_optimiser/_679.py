...
class GearSetOptimiserCandidate(_675.DesignSpaceSearchCandidateBase['_157.AbstractGearSetRating', 'GearSetOptimiserCandidate']):
    '''GearSetOptimiserCandidate
    ...
    @property
    def candidate_of_type_conical_gear_set_duty_cycle_rating(self) -> '_326.ConicalGearSetDutyCycleRating':
        ...
        if _326.ConicalGearSetDutyCycleRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
        ...
        return constructor.new(_326.ConicalGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_conical_gear_set_rating(self) -> '_327.ConicalGearSetRating':
        ...
        if _327.ConicalGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
        ...
        return constructor.new(_327.ConicalGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_concept_gear_set_duty_cycle_rating(self) -> '_337.ConceptGearSetDutyCycleRating':
        ...
        if _337.ConceptGearSetDutyCycleRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
        ...
        return constructor.new(_337.ConceptGearSetDutyCycleRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_concept_gear_set_rating(self) -> '_338.ConceptGearSetRating':
        ...
        if _338.ConceptGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
        ...
        return constructor.new(_338.ConceptGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_bevel_gear_set_rating(self) -> '_341.BevelGearSetRating':
        ...
        if _341.BevelGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
        ...
        return constructor.new(_341.BevelGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None

    @property
    def candidate_of_type_agma_gleason_conical_gear_set_rating(self) -> '_352.AGMAGleasonConicalGearSetRating':
        ...
        if _352.AGMAGleasonConicalGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
        ...
        return constructor.new(_352.AGMAGleasonConicalGearSetRating)(self.wrapped.Candidate) if self.wrapped.Candidate else None
