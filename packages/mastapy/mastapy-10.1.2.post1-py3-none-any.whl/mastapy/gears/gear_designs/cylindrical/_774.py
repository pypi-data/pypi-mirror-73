...
from mastapy.gears.manufacturing.cylindrical.cutters import _524
...
class CylindricalGearDefaults(_1139.PerMachineSettings):
    ...
    @property
    def rough_cutter_creation_settings(self) -> '_524.RoughCutterCreationSettings':
        ...
        return constructor.new(_524.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
