...
class LtcaSettings(_1134.IndependentReportablePropertiesBase['LtcaSettings']):
    '''LtcaSettings
    ...
    @property
    def load_case_modifiable_settings(self) -> '_811.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_811.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
