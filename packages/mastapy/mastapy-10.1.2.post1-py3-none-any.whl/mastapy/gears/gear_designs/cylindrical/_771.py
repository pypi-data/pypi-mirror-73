...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    def gear(self) -> '_775.CylindricalGearDesign':
        ...
        return constructor.new(_775.CylindricalGearDesign)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def shaper_for_agma_rating(self) -> '_516.CylindricalGearShaper':
        ...
        return constructor.new(_516.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None
