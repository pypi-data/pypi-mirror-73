...
from mastapy.gears.manufacturing.bevel import _578, _571
...
class ConicalMeshManufacturingConfig(_571.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_578.ConicalWheelManufacturingConfig':
