...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _446, _478
...
class WormGrindingProcessProfileCalculation(_478.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_446.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_446.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_446.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_446.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
