...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_447.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_447.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_447.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_443.AnalysisMethod':
        ...
        return constructor.new(_443.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_443.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_474.RackMountingError':
        ...
        return constructor.new(_474.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_449.GearMountingError':
        ...
        return constructor.new(_449.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_448.CutterHeadSlideError':
        ...
        return constructor.new(_448.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
