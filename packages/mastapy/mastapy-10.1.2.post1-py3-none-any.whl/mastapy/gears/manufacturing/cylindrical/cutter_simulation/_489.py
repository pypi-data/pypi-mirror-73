...
from mastapy.gears.gear_designs.cylindrical import _834, _800, _833
...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_834.ToothThicknessSpecificationBase':
        ...
        return constructor.new(_834.ToothThicknessSpecificationBase)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
    ...
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_800.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_800.FinishToothThicknessDesignSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None

    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_833.ToothThicknessSpecification':
        ...
        if _833.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new(_833.ToothThicknessSpecification)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification else None
