...
class FormWheelGrindingSimulationCalculator(_487.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_526.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_526.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
