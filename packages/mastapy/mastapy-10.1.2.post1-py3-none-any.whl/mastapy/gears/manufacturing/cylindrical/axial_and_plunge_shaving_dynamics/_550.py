...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _546, _545, _549
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_546.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_546.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_546.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_546.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_488.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_488.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_517.CylindricalGearShaver':
        ...
        return constructor.new(_517.CylindricalGearShaver)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver else None
