...
from mastapy.gears.gear_designs.cylindrical import _831, _779
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_831.TolerancedMetalMeasurements':
    ...
    def default_rough_toleranced_metal_measurement(self, value: '_831.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
