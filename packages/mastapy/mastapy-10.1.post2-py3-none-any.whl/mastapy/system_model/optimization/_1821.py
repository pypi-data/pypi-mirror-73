...
from mastapy.system_model.optimization import _1822, _1820
...
TStep = TypeVar('TStep', bound='_1820.OptimizationStep')


class OptimizationStrategy(_1822.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
