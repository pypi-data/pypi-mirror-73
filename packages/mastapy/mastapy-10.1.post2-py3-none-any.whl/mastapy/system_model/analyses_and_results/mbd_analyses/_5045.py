...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5031, _5069, _5064
...
class MBDRunUpAnalysisOptions(_6481.AbstractAnalysisOptions['_6197.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5031.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5031.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5031.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5069.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5069.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5069.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5064.RunUpDrivingMode':
        ...
        return constructor.new(_5064.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5064.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
