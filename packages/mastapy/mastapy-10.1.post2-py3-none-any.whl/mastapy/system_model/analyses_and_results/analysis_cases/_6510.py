...
class TimeSeriesLoadAnalysisCase(_6494.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6210.TimeSeriesLoadCase':
        ...
        return constructor.new(_6210.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
