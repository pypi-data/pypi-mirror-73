...
class FaceGearCompoundPowerFlow(_3392.GearCompoundPowerFlow):
    '''FaceGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3264.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3264.FaceGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3264.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3264.FaceGearPowerFlow))
        return value
