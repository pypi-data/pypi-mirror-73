...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3438, _3439, _3356
...
class StraightBevelDiffGearSetCompoundPowerFlow(_3356.BevelGearSetCompoundPowerFlow):
    '''StraightBevelDiffGearSetCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3317.StraightBevelDiffGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3317.StraightBevelDiffGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3317.StraightBevelDiffGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3317.StraightBevelDiffGearSetPowerFlow))
        return value
