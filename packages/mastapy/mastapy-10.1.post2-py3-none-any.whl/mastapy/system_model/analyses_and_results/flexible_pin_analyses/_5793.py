...
class WindTurbineCertificationReport(_5785.CombinationAnalysis):
    ...
    @property
    def design(self) -> '_2014.RootAssembly':
        ...
        return constructor.new(_2014.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2440.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2440.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2303.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2303.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2303.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2303.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
