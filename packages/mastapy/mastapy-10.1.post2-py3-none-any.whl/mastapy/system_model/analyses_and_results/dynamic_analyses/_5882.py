...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5840, _5799
...
class RootAssemblyDynamicAnalysis(_5799.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_5840.DynamicAnalysis':
        ...
        return constructor.new(_5840.DynamicAnalysis)(self.wrapped.DynamicAnalysisInputs) if self.wrapped.DynamicAnalysisInputs else None
