...
class SteadyStateSynchronousResponse(_6482.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3063.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3063.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
