...
class ConnectionParametricStudyTool(_6483.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_3547.ParametricStudyTool':
        ...
        return constructor.new(_3547.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
