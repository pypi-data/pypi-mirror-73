...
from mastapy.system_model.analyses_and_results.static_loads import _6051, _6153
from mastapy.system_model import _1798
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3549, _3550
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6153.ParametricStudyType':
        ...
        return constructor.new(_6153.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6153.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1798.ExternalFullFELoader':
        ...
        return constructor.new(_1798.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3549.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3549.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3550.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3550.ParametricStudyVariable))
        return value
