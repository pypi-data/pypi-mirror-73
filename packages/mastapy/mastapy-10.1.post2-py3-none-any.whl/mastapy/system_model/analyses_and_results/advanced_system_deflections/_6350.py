...
class UnbalancedMassAdvancedSystemDeflection(_6352.VirtualComponentAdvancedSystemDeflection):
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2337.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2337.UnbalancedMassSystemDeflection))
        return value
