...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6356, _6357, _6250
...
class ZerolBevelGearSetAdvancedSystemDeflection(_6250.BevelGearSetAdvancedSystemDeflection):
    '''ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_6356.ZerolBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsAdvancedSystemDeflection, constructor.new(_6356.ZerolBevelGearAdvancedSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_6357.ZerolBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesAdvancedSystemDeflection, constructor.new(_6357.ZerolBevelGearMeshAdvancedSystemDeflection))
        return value
