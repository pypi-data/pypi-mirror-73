...
class MeasurementComponentAdvancedSystemDeflection(_6352.VirtualComponentAdvancedSystemDeflection):
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2286.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2286.MeasurementComponentSystemDeflection))
        return value
