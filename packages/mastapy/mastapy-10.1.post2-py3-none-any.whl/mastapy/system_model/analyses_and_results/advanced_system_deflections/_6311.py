...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_6270.CouplingConnectionAdvancedSystemDeflection):
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2292.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2292.PartToPartShearCouplingConnectionSystemDeflection))
        return value
