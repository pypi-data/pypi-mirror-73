...
from mastapy.system_model.analyses_and_results.system_deflections import _2304, _2284, _2265
...
class FlexiblePinAssemblyAdvancedSystemDeflection(_6326.SpecialisedAssemblyAdvancedSystemDeflection):
    ...
    @property
    def pin_spindle_fit_advanced_analyses(self) -> 'List[_2304.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinSpindleFitAdvancedAnalyses, constructor.new(_2304.ShaftHubConnectionSystemDeflection))
        return value
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2265.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2265.FlexiblePinAssemblySystemDeflection))
        return value
