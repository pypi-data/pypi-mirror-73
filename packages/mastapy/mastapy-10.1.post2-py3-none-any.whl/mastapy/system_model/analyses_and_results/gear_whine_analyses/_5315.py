...
class FlexiblePinAssemblyGearWhineAnalysis(_5364.SpecialisedAssemblyGearWhineAnalysis):
    '''FlexiblePinAssemblyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2265.FlexiblePinAssemblySystemDeflection':
