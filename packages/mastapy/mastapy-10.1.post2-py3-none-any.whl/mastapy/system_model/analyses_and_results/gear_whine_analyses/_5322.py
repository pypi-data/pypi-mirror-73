...
class GearWhineAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def excitation_options(self) -> '_5400.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5400.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationOptions) if self.wrapped.ExcitationOptions else None

    @property
    def analysis_options(self) -> '_5323.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5323.GearWhineAnalysisOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
