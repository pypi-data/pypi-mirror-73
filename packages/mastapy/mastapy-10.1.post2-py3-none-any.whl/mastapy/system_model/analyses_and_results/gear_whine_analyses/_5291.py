...
class CVTBeltConnectionGearWhineAnalysis(_5259.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1836.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2246.CVTBeltConnectionSystemDeflection':
