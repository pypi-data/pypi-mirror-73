...
class TorqueConverterTurbineGearWhineAnalysis(_5290.CouplingHalfGearWhineAnalysis):
    '''TorqueConverterTurbineGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2334.TorqueConverterTurbineSystemDeflection':
