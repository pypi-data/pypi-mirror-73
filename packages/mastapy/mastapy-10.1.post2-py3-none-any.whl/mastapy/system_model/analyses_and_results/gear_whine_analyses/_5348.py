...
class PartToPartShearCouplingHalfGearWhineAnalysis(_5290.CouplingHalfGearWhineAnalysis):
    '''PartToPartShearCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2293.PartToPartShearCouplingHalfSystemDeflection':
