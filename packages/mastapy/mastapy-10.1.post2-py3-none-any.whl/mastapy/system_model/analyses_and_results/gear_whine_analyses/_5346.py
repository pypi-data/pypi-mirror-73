...
class PartToPartShearCouplingConnectionGearWhineAnalysis(_5288.CouplingConnectionGearWhineAnalysis):
    '''PartToPartShearCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2292.PartToPartShearCouplingConnectionSystemDeflection':
