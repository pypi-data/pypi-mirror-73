...
class StraightBevelSunGearGearWhineAnalysis(_5372.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2088.StraightBevelSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2323.StraightBevelSunGearSystemDeflection':
