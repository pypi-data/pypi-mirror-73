...
class CylindricalPlanetGearGearWhineAnalysis(_5294.CylindricalGearGearWhineAnalysis):
    '''CylindricalPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2065.CylindricalPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2258.CylindricalPlanetGearSystemDeflection':
