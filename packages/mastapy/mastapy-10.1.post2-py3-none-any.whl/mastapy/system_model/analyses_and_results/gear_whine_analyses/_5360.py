...
class ShaftGearWhineAnalysis(_5253.AbstractShaftOrHousingGearWhineAnalysis):
    '''ShaftGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4793.ShaftModalAnalysis':
    ...
    @property
    def system_deflection_results(self) -> '_2307.ShaftSystemDeflection':
