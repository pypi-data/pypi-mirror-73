...
class BevelDifferentialPlanetGearSystemDeflection(_2217.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3227.BevelDifferentialPlanetGearPowerFlow':
