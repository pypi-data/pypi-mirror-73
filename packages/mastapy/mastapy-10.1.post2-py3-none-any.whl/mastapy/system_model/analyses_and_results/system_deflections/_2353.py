...
class ZerolBevelGearMeshSystemDeflection(_2231.BevelGearMeshSystemDeflection):
    '''ZerolBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3348.ZerolBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3348.ZerolBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
