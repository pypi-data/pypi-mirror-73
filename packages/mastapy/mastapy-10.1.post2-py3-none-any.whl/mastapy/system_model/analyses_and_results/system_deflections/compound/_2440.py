...
from mastapy.system_model.imported_fes import _1965
...
class RootAssemblyCompoundSystemDeflection(_2359.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_3427.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3427.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None

    @property
    def bearing_race_fes(self) -> 'List[_1965.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1965.RaceBearingFESystemDeflection))
        return value
