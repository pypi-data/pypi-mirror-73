...
class CoaxialConnectionSystemDeflection(_2308.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3237.CoaxialConnectionPowerFlow':
