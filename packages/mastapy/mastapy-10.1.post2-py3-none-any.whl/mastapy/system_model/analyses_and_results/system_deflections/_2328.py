...
class SystemDeflection(_6489.FEAnalysis):
    ...
    @property
    def analysis_options(self) -> '_2330.SystemDeflectionOptions':
        ...
        return constructor.new(_2330.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
