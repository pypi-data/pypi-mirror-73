...
class BevelGearSetSystemDeflection(_2209.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3231.BevelGearSetPowerFlow':
