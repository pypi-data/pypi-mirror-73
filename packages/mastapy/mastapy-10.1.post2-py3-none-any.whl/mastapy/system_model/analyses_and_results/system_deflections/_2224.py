...
class BoltSystemDeflection(_2229.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3233.BoltPowerFlow':
        ...
        return constructor.new(_3233.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
