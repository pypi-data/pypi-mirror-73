...
from mastapy.system_model.part_model.gears import _2070, _2068
...
TGearSet = TypeVar('TGearSet', bound='_2070.GearSet')
TGear = TypeVar('TGear', bound='_2068.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6117.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1873.GearMesh')
