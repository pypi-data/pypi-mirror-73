...
from mastapy.system_model.analyses_and_results import _2180
...
class SingleAnalysis:
    ...
    def results_for(self, design_entity: '_1794.DesignEntity') -> '_2180.DesignEntityAnalysis':
        ...
        return constructor.new(_2180.DesignEntityAnalysis)(method_result) if method_result else None

    def results_for_design_entity_analysis(self, design_entity_analysis: '_2180.DesignEntityAnalysis') -> '_2180.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
