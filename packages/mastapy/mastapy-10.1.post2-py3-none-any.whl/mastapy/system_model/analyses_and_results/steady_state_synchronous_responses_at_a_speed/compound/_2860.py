...
class BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(_2932.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_1987.BoltedJoint':
    ...
    @property
    def assembly_design(self) -> '_1987.BoltedJoint':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2737.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2737.BoltedJointSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_steady_state_synchronous_response_at_a_speed_load_cases(self) -> 'List[_2737.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySteadyStateSynchronousResponseAtASpeedLoadCases, constructor.new(_2737.BoltedJointSteadyStateSynchronousResponseAtASpeed))
        return value
