...
from mastapy.system_model.analyses_and_results.static_loads import _6208, _6209, _6122
...
class WormGearSetLoadCase(_6122.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6208.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6208.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6209.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6209.WormGearMeshLoadCase))
        return value
