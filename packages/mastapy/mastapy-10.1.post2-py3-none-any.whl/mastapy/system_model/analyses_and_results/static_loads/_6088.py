...
from mastapy.system_model.analyses_and_results.static_loads import _6089, _6055
...
class CVTLoadCase(_6055.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6089.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6089.CVTPulleyLoadCase))
        return value
