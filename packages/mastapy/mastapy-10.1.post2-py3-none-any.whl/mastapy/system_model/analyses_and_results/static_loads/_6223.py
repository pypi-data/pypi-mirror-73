...
from mastapy.system_model.analyses_and_results.static_loads import _6221, _6222, _6135
...
class WormGearSetLoadCase(_6135.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6221.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6221.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6222.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6222.WormGearMeshLoadCase))
        return value
