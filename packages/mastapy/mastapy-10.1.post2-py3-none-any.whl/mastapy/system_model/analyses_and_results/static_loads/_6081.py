...
from mastapy.system_model.analyses_and_results.static_loads import _6080, _6122
...
class ConicalGearSetLoadCase(_6122.GearSetLoadCase):
    '''ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6080.ConicalGearSetHarmonicLoadData':
        ...
        return constructor.new(_6080.ConicalGearSetHarmonicLoadData)(method_result) if method_result else None
