...
from mastapy.system_model import _1803, _1804, _1805
from mastapy.system_model.analyses_and_results.mbd_analyses import _5097
from mastapy.system_model.analyses_and_results.static_loads import _6203, _6102, _6207
from mastapy.system_model.imported_fes import _1923
...
class PowerLoadLoadCase(_6207.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1803.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1803.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1803.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5097.WheelSlipType':
        ...
        return constructor.new(_5097.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5097.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1805.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1805.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1805.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def get_harmonic_load_data_for_import(self) -> '_6102.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6102.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
