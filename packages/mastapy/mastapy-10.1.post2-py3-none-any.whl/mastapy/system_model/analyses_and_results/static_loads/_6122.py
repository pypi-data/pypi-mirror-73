...
class GearSetLoadCase(_6175.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5020.GearMeshStiffnessModel':
        ...
        return constructor.new(_5020.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5020.GearMeshStiffnessModel'):
