...
from mastapy.system_model.imported_fes import _1911, _1934
...
class ImportedFEComponentLoadCase(_6046.AbstractShaftOrHousingLoadCase):
    ...
    @property
    def angle_source(self) -> '_1911.AngleSource':
        ...
        return constructor.new(_1911.AngleSource)(value) if value else None
