...
from mastapy.system_model.analyses_and_results.static_loads import _6183, _6197
...
class ConnectionLoadCase(_2178.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6183.StaticLoadCase':
        ...
        return constructor.new(_6183.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None
