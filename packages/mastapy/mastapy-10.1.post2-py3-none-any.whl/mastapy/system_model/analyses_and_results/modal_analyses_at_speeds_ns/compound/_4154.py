...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysesAtSpeeds(_4151.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysesAtSpeeds):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4029.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4029.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_4029.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_4029.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysesAtSpeeds))
        return value
