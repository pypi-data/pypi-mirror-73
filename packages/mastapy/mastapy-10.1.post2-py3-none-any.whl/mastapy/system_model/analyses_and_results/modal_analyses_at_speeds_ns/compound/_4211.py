...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4137
...
class TorqueConverterConnectionCompoundModalAnalysesAtSpeeds(_4137.CouplingConnectionCompoundModalAnalysesAtSpeeds):
    '''TorqueConverterConnectionCompoundModalAnalysesAtSpeeds
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4089.TorqueConverterConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4089.TorqueConverterConnectionModalAnalysesAtSpeeds))
        return value

    @property
    def connection_modal_analyses_at_speeds_load_cases(self) -> 'List[_4089.TorqueConverterConnectionModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtSpeedsLoadCases, constructor.new(_4089.TorqueConverterConnectionModalAnalysesAtSpeeds))
        return value
