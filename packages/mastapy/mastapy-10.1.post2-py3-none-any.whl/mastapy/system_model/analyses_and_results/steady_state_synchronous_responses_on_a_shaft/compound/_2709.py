...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_2635.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_1903.TorqueConverterConnection':
    ...
    @property
    def connection_design(self) -> '_1903.TorqueConverterConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2587.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2587.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2587.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2587.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
