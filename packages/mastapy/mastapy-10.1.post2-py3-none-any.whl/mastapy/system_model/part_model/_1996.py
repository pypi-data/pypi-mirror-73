...
class FlexiblePinAssembly(_2016.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2063.CylindricalGear':
        ...
        return constructor.new(_2063.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
