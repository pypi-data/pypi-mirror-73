...
from mastapy.system_model.part_model import _2030, _2028
...
class PowerLoad(_2028.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2030.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2030.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6113.ElectricMachineDetail':
        ...
        return constructor.new(_6113.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
