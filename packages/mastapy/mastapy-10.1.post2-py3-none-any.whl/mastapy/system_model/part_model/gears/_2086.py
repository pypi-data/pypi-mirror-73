...
from mastapy.system_model.part_model.gears import _2085, _2058
...
class StraightBevelGearSet(_2058.BevelGearSet):
    '''StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2085.StraightBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGears, constructor.new(_2085.StraightBevelGear))
        return value

    @property
    def straight_bevel_meshes(self) -> 'List[_1887.StraightBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_1887.StraightBevelGearMesh))
        return value
