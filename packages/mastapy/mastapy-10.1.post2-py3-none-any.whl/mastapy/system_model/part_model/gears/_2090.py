...
from mastapy.system_model.part_model.gears import _2089, _2070
...
class WormGearSet(_2070.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2089.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2089.WormGear))
        return value

    @property
    def worm_meshes(self) -> 'List[_1889.WormGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_1889.WormGearMesh))
        return value
