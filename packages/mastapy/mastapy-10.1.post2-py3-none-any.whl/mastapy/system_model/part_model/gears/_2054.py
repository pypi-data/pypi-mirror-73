...
from mastapy.system_model.part_model.gears import _2057, _2058
...
class BevelDifferentialGearSet(_2058.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2057.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2057.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1863.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1863.BevelGearMesh))
        return value
