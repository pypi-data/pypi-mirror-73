...
from mastapy.system_model.part_model.gears import _2078, _2075
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2075.KlingelnbergCycloPalloidConicalGearSet):
    '''KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2078.KlingelnbergCycloPalloidSpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGears, constructor.new(_2078.KlingelnbergCycloPalloidSpiralBevelGear))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_1880.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_1880.KlingelnbergCycloPalloidSpiralBevelGearMesh))
        return value
