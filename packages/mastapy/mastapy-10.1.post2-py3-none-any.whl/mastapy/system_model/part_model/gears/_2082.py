...
from mastapy.system_model.part_model.gears import _2081, _2058
...
class SpiralBevelGearSet(_2058.BevelGearSet):
    '''SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2081.SpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_2081.SpiralBevelGear))
        return value

    @property
    def spiral_bevel_meshes(self) -> 'List[_1883.SpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_1883.SpiralBevelGearMesh))
        return value
