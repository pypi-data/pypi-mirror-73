...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2101
from mastapy.system_model.part_model.gears import _2063, _2070
...
class CylindricalGearSet(_2070.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2101.SuperchargerRotorSet':
        ...
        return constructor.new(_2101.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2063.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2063.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1869.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1869.CylindricalGearMesh))
        return value
