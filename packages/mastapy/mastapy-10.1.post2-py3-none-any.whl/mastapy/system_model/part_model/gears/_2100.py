...
from mastapy.system_model.part_model.gears import _2099, _2080
...
class WormGearSet(_2080.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2099.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2099.WormGear))
        return value

    @property
    def worm_meshes(self) -> 'List[_1899.WormGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_1899.WormGearMesh))
        return value
