...
from mastapy.system_model.connections_and_sockets import _1833, _1850
...
class Component(_2008.Part):
    ...
    @property
    def component_connections(self) -> 'List[_1833.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1833.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1063.CoordinateSystem3D') -> '_1850.RealignmentResult':
        ...
        return constructor.new(_1850.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1850.RealignmentResult':
