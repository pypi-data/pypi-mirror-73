...
class MountableComponent(_1988.Component):
    '''MountableComponent
    ...
    def mount_on(self, shaft: '_2021.Shaft', offset: Optional['float'] = float('nan')) -> '_1832.CoaxialConnection':
        ...
        return constructor.new(_1832.CoaxialConnection)(method_result) if method_result else None
