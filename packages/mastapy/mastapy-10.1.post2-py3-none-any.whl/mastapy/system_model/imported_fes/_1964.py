...
from mastapy.system_model.imported_fes import _1909, _1915
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1909.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1909.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1909.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1915.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1915.BearingRaceNodeLink))
        return value
