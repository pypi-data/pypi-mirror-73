...
class ElectricMachineDataSet(_0.APIBase):
    ...
    def multiple_fourier_series_interpolator_for_with_stiffness_node(self, harmonic_load_data_type: '_6131.HarmonicLoadDataType', node: '_1946.ImportedFEStiffnessNode') -> '_1080.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_stiffness_node(self, harmonic_load_data_type: '_6131.HarmonicLoadDataType', node: '_1946.ImportedFEStiffnessNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6501.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
