...
from mastapy.system_model.imported_fes import _1964, _1912
...
class RaceBearingFEWithSelection(_1912.BaseFEWithSelection):
    '''RaceBearingFEWithSelection
    ...
    @property
    def race_bearing(self) -> '_1964.RaceBearingFE':
        ...
        return constructor.new(_1964.RaceBearingFE)(self.wrapped.RaceBearing) if self.wrapped.RaceBearing else None
