...
from mastapy.system_model.imported_fes import _1924, _1940
...
class ImportedFEElectricMachineStatorLink(_1940.ImportedFEMultiNodeLink):
    '''ImportedFEElectricMachineStatorLink
    ...
    @property
    def electric_machine_dynamic_load_data(self) -> '_1924.ElectricMachineDynamicLoadData':
        ...
        return constructor.new(_1924.ElectricMachineDynamicLoadData)(self.wrapped.ElectricMachineDynamicLoadData) if self.wrapped.ElectricMachineDynamicLoadData else None
