...
from mastapy.system_model.imported_fes import _1963, _1962
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1963.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1963.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1962.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1962.PerLinkExportOptions))
        return value
