...
class ImportedFEWithSelectionComponents(_1948.ImportedFEWithSelection):
    '''ImportedFEWithSelectionComponents
    ...
    @property
    def component_links(self) -> 'List[_1938.ImportedFeLinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentLinks, constructor.new(_1938.ImportedFeLinkWithSelection))
        return value

    @property
    def links_for_selected_component(self) -> 'List[_1938.ImportedFeLinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForSelectedComponent, constructor.new(_1938.ImportedFeLinkWithSelection))
        return value

    @property
    def links_for_electric_machine(self) -> 'List[_1938.ImportedFeLinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForElectricMachine, constructor.new(_1938.ImportedFeLinkWithSelection))
        return value

    @property
    def rigid_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1480.ElementPropertiesRigid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1480.ElementPropertiesRigid])
        return value

    @property
    def solid_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1482.ElementPropertiesSolid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1482.ElementPropertiesSolid])
        return value

    @property
    def shell_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1481.ElementPropertiesShell]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1481.ElementPropertiesShell])
        return value

    @property
    def beam_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1477.ElementPropertiesBeam]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1477.ElementPropertiesBeam])
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1483.ElementPropertiesSpringDashpot]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1483.ElementPropertiesSpringDashpot])
        return value

    @property
    def mass_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1479.ElementPropertiesMass]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1479.ElementPropertiesMass])
        return value

    @property
    def interface_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1478.ElementPropertiesInterface]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1478.ElementPropertiesInterface])
        return value

    @property
    def other_element_properties(self) -> 'List[_1926.ElementPropertiesWithSelection[_1476.ElementPropertiesBase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_1926.ElementPropertiesWithSelection)[_1476.ElementPropertiesBase])
        return value

    @property
    def materials(self) -> 'List[_1956.MaterialPropertiesWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_1956.MaterialPropertiesWithSelection))
        return value

    @property
    def contact_pairs(self) -> 'List[_1918.ContactPairWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_1918.ContactPairWithSelection))
        return value
