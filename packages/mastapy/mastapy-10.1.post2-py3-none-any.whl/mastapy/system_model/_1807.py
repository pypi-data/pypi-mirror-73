...
T = TypeVar('T', bound='_1988.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self) -> '_1808.RelativeOffsetOption':
        ...
        return constructor.new(_1808.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1808.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
