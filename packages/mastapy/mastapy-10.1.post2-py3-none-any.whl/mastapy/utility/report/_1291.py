...
from mastapy.utility.report import _1292, _1295
...
TItem = TypeVar('TItem', bound='_1295.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1292.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
