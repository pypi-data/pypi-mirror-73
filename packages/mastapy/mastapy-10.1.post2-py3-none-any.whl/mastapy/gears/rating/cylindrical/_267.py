...
class CylindricalMeshDutyCycleRating(_168.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_258.CylindricalGearMeshRating':
        ...
        return constructor.new(_258.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
