...
from mastapy.gears.ltca.cylindrical import _630, _629, _633
...
class MicroGeometryDesignSpaceSearch(_674.DesignSpaceSearchBase['_633.CylindricalGearSetLoadDistributionAnalysis', '_685.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_633.CylindricalGearSetLoadDistributionAnalysis':
        ...
        return constructor.new(_633.CylindricalGearSetLoadDistributionAnalysis)(self.wrapped.LoadCaseDutyCycle) if self.wrapped.LoadCaseDutyCycle else None
