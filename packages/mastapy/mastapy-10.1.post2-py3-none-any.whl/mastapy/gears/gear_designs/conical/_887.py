...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_896.CutterGaugeLengths':
        ...
        return constructor.new(_896.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_896.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_895.CutterBladeType':
        ...
        return constructor.new(_895.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_895.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_904.TopremEntryType':
        ...
        return constructor.new(_904.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_904.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_905.TopremLetter':
    ...
    def outer_toprem_letter_concave(self, value: '_905.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_905.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_905.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
