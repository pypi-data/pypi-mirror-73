...
from mastapy.math_utility.optimisation import _1100, _1101, _1104
...
class ParetoOptimisationStrategy(_1342.NamedDatabaseItem):
    '''ParetoOptimisationStrategy
    ...
    @property
    def inputs(self) -> 'List[_1100.ParetoOptimisationInput]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Inputs, constructor.new(_1100.ParetoOptimisationInput))
        return value

    @property
    def outputs(self) -> 'List[_1101.ParetoOptimisationOutput]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Outputs, constructor.new(_1101.ParetoOptimisationOutput))
        return value

    @property
    def charts(self) -> 'List[_1104.ParetoOptimisationStrategyChartInformation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Charts, constructor.new(_1104.ParetoOptimisationStrategyChartInformation))
        return value
