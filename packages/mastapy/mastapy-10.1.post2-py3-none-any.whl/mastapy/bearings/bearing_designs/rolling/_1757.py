...
class RollingBearing(_1730.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def type_information(self) -> '_1745.BearingTypeExtraInformation':
        ...
        return constructor.new(_1745.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def sleeve_type(self) -> '_1759.SleeveType':
        ...
        return constructor.new(_1759.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1742.BearingProtection':
        ...
        return constructor.new(_1742.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
