...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1768, _1767
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1768.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1768.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1767.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1767.AbstractXmlVariableAssignment))
        return value
