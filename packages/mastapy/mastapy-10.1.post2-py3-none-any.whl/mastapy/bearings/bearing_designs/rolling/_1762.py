...
from mastapy.bearings.bearing_designs.rolling import _1756, _1753
...
class TaperRollerBearing(_1753.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def major_rib_detail(self) -> '_1756.RollerRibDetail':
        ...
        return constructor.new(_1756.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
