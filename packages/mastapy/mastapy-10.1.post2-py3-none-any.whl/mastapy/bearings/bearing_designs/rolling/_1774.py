...
from mastapy.bearings.bearing_designs.rolling import _1748
...
class ThrustBallBearing(_1748.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1525.OuterRingMounting':
        ...
        return constructor.new(_1525.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1525.OuterRingMounting'):
