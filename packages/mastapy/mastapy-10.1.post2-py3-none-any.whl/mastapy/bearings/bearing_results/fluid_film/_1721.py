...
class LoadedPlainJournalBearingResults(_1575.LoadedDetailedBearingResults):
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1722.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1722.LoadedPlainJournalBearingRow))
        return value
