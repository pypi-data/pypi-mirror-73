...
from mastapy.bearings.bearing_results.rolling import _1668, _1640
...
class LoadedToroidalRollerBearingRow(_1640.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1668.LoadedToroidalRollerBearingResults':
