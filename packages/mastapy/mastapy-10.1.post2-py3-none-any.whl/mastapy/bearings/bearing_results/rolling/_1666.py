...
from mastapy.bearings.bearing_results.rolling import _1665, _1616
...
class LoadedThrustBallBearingRow(_1616.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1665.LoadedThrustBallBearingResults':
