...
from mastapy.bearings.bearing_results.rolling.skf_module import _1700, _1704
...
class BearingRatingLife(_1704.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1700.LifeModel':
        ...
        return constructor.new(_1700.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
