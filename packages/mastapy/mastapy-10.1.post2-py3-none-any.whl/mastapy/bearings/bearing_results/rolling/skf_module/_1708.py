...
from mastapy.bearings.bearing_results.rolling.skf_module import _1702, _1704
...
class Viscosities(_1704.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1702.OperatingViscosity':
        ...
        return constructor.new(_1702.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
