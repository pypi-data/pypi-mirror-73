...
from mastapy.bearings.bearing_results.rolling import _1641
...
class LoadedAbstractSphericalRollerBearingStripLoadResults(_1641.LoadedRollerStripLoadResults):
    '''LoadedAbstractSphericalRollerBearingStripLoadResults
