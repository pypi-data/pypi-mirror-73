...
from mastapy.bearings.bearing_results.rolling import _1622, _1616
...
class LoadedDeepGrooveBallBearingRow(_1616.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1622.LoadedDeepGrooveBallBearingResults':
