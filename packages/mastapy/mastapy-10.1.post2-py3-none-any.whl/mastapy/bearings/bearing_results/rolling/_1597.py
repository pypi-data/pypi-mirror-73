...
from mastapy.bearings.bearing_results.rolling import _1596, _1616
...
class LoadedAngularContactBallBearingRow(_1616.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1596.LoadedAngularContactBallBearingResults':
