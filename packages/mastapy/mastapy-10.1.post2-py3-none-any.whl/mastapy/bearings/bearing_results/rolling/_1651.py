...
from mastapy.bearings.bearing_results.rolling import _1650, _1640
...
class LoadedSphericalRollerRadialBearingRow(_1640.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1650.LoadedSphericalRollerRadialBearingResults':
