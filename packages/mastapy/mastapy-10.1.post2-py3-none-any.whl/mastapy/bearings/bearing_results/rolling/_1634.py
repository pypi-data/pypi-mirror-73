...
from mastapy.bearings.bearing_results.rolling import _1684, _1639
...
class LoadedNonBarrelRollerBearingResults(_1639.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1684.SMTRibStressResults':
        ...
        return constructor.new(_1684.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
