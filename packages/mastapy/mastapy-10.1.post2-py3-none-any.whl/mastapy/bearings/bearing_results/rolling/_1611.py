...
from mastapy.bearings.bearing_results.rolling import _1610, _1608
...
class LoadedAxialThrustNeedleRollerBearingRow(_1608.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1610.LoadedAxialThrustNeedleRollerBearingResults':
