...
from mastapy.bearings.bearing_results.rolling import _1599, _1597
...
class LoadedAngularContactThrustBallBearingRow(_1597.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1599.LoadedAngularContactThrustBallBearingResults':
