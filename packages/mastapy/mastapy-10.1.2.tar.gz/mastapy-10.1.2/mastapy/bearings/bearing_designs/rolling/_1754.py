...
from mastapy.bearings.bearing_designs.rolling import _1756, _1757, _1755
...
class NonBarrelRollerBearing(_1755.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1756.RollerEndShape':
        ...
        return constructor.new(_1756.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1756.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1757.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1757.RollerRibDetail))
        return value
