...
from mastapy.bearings.bearing_results.rolling import _1654, _1641
...
class LoadedSphericalRollerThrustBearingRow(_1641.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1654.LoadedSphericalRollerThrustBearingResults':
