...
from mastapy.bearings.bearing_results.rolling import _1680, _1625
...
class LoadedRollerBearingElement(_1625.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1680.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1680.ResultsAtRollerOffset))
        return value
