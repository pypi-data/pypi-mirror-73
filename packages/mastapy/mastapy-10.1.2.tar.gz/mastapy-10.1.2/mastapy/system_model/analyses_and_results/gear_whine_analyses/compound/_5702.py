...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5671
...
class CVTBeltConnectionCompoundGearWhineAnalysis(_5671.BeltConnectionCompoundGearWhineAnalysis):
    '''CVTBeltConnectionCompoundGearWhineAnalysis
