...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5400
from mastapy.system_model.analyses_and_results.modal_analyses import _4774
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5365, _5316
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5400.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5400.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4774.ModalAnalysisOptions':
        ...
        return constructor.new(_4774.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
