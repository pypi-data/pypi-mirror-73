...
class PartToPartShearCouplingCompoundPowerFlow(_3376.CouplingCompoundPowerFlow):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3293.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3293.PartToPartShearCouplingPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3293.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3293.PartToPartShearCouplingPowerFlow))
        return value
