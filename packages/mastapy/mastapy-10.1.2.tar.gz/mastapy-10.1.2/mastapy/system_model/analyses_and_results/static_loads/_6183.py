...
from mastapy.system_model.analyses_and_results.load_case_groups import _5234, _5235, _5236
...
class StaticLoadCase(_6044.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5323.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5323.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5234.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5234.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5235.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5235.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5236.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
