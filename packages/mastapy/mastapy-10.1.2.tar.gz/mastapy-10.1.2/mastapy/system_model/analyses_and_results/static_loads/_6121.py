...
class GearSetHarmonicLoadData(_6125.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6120.GearMeshTEOrderType':
        ...
        return constructor.new(_6120.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6120.GearMeshTEOrderType'):
