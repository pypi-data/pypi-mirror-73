...
class TimeSeriesLoadCase(_6044.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5044.MBDAnalysisOptions':
        ...
        return constructor.new(_5044.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
