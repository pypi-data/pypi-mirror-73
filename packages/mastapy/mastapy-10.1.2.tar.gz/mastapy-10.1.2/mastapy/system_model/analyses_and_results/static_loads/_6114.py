...
from mastapy.system_model.analyses_and_results.static_loads import _6112, _6113, _6122
...
class FaceGearSetLoadCase(_6122.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6112.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6112.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6113.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6113.FaceGearMeshLoadCase))
        return value
