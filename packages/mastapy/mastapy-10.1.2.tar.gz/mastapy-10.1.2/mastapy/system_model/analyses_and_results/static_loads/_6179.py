...
from mastapy.system_model.analyses_and_results.static_loads import _6177, _6178, _6063
...
class SpiralBevelGearSetLoadCase(_6063.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6177.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_6177.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6178.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_6178.SpiralBevelGearMeshLoadCase))
        return value
