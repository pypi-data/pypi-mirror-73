...
from mastapy.system_model.analyses_and_results.static_loads import _6131, _6127, _6108
...
class HarmonicLoadDataImportFromMotorPackages(_6127.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
