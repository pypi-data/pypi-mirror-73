...
class ConceptGearMeshRating(_162.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_911.ConceptGearMeshDesign':
        ...
        return constructor.new(_911.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
