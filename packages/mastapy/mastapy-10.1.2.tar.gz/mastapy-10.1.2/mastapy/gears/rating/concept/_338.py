...
class ConceptGearSetRating(_165.GearSetRating):
    ...
    @property
    def concept_mesh_ratings(self) -> 'List[_335.ConceptGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshRatings, constructor.new(_335.ConceptGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_336.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_336.ConceptGearRating))
        return value

    @property
    def concept_gear_ratings(self) -> 'List[_336.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearRatings, constructor.new(_336.ConceptGearRating))
        return value
