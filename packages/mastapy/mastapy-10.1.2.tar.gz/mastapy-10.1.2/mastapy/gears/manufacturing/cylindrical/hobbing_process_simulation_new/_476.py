...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _437
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _478
...
class WormGrindingCutterCalculation(_478.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_437.PointOfInterest':
        ...
        return constructor.new(_437.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
