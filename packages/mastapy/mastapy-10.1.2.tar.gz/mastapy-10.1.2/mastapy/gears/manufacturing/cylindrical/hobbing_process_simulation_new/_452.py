...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _444, _450
...
class HobbingProcessLeadCalculation(_450.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
