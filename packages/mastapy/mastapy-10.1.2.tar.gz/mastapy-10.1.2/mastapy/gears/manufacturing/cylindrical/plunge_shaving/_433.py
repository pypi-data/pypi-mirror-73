...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _440, _426
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_440.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_440.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_426.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_426.CalculationError))
        return value
