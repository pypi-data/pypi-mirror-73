...
from mastapy.gears.manufacturing.bevel.control_parameters import _601
...
class ConicalManufacturingSGTControlParameters(_601.ConicalGearManufacturingControlParameters):
    '''ConicalManufacturingSGTControlParameters
