...
from mastapy.gears.manufacturing.bevel import _560, _569, _577
...
class ConicalSetManufacturingConfig(_577.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_560.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_560.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_569.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_569.ConicalMeshManufacturingConfig))
        return value
