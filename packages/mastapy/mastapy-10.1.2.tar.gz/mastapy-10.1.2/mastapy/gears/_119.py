...
class BevelHypoidGearRatingSettings(_1139.PerMachineSettings):
    '''BevelHypoidGearRatingSettings
    ...
    @property
    def bevel_gear_rating_method(self) -> '_389.RatingMethods':
        ...
        return constructor.new(_389.RatingMethods)(value) if value else None

    @bevel_gear_rating_method.setter
    def bevel_gear_rating_method(self, value: '_389.RatingMethods'):
