...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def contact_patch_detailed(self, result_type: '_609.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1074.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_609.ContactResultType', include_tip_contact: 'bool') -> '_1074.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_609.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
