...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_618.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_618.GearMeshLoadedContactLine))
        return value
