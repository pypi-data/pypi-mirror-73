...
from mastapy.nodal_analysis.system_solvers import _1406
...
class TransientSolver(_1406.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1392.TransientSolverStatus':
        ...
        return constructor.new(_1392.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1392.TransientSolverStatus'):
