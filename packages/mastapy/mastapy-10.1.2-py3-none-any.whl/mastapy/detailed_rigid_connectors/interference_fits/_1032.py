...
from mastapy.bearings.tolerances import _1552, _1540, _1545
...
class InterferenceFitHalfDesign(_974.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1552.SupportTolerance':
        ...
        return constructor.new(_1552.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1540.InnerSupportTolerance':
        ...
        if _1540.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1540.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1545.OuterSupportTolerance':
        ...
        if _1545.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1545.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
