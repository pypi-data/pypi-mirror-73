...
from mastapy.gears.ltca import _617, _615
...
class GearMeshLoadDistributionAnalysis(_954.GearMeshImplementationAnalysis):
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_617.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_617.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_615.GearLoadDistributionAnalysis', flank: '_128.GearFlanks', stress_type: '_1390.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_615.GearLoadDistributionAnalysis', stress_type: '_1390.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
