...
class CylindricalGearSetDesign(_715.GearSetDesign):
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_302.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_302.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_302.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ltca_settings(self) -> '_812.LtcaSettings':
        ...
        return constructor.new(_812.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_409.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_409.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None
    ...
    def create_optimiser(self, duty_cycle: '_263.CylindricalGearSetDutyCycleRating') -> '_787.CylindricalGearSetMacroGeometryOptimiser':
        ...
        return constructor.new(_787.CylindricalGearSetMacroGeometryOptimiser)(method_result) if method_result else None
