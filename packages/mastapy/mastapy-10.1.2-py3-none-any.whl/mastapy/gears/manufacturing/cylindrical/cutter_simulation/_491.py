...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _503
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_503.VirtualSimulationCalculator':
        ...
        return constructor.new(_503.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
