...
class WormGrinderSimulationCalculator(_499.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_530.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_530.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
