...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _549
...
class RedressingSettings(_0.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_517.CylindricalGearShaver':
        ...
        return constructor.new(_517.CylindricalGearShaver)(self.wrapped.RedressedShaver) if self.wrapped.RedressedShaver else None
