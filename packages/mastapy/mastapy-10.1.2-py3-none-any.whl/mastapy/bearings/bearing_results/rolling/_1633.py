...
from mastapy.bearings.bearing_results.rolling import _1632, _1621
...
class LoadedNeedleRollerBearingRow(_1621.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1632.LoadedNeedleRollerBearingResults':
