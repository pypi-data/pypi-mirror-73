...
from mastapy.bearings.bearing_results.rolling import _1647, _1617
...
class LoadedSelfAligningBallBearingRow(_1617.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1647.LoadedSelfAligningBallBearingResults':
