...
from mastapy.bearings.bearing_results.rolling import _1611, _1609
...
class LoadedAxialThrustNeedleRollerBearingRow(_1609.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1611.LoadedAxialThrustNeedleRollerBearingResults':
