...
class ThrustBallBearing(_1740.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1521.OuterRingMounting':
        ...
        return constructor.new(_1521.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1521.OuterRingMounting'):
