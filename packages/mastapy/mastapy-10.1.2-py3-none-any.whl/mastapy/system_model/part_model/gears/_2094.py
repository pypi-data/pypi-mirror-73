...
from mastapy.system_model.part_model.gears import _2093, _2068
...
class StraightBevelDiffGearSet(_2068.BevelGearSet):
    '''StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2093.StraightBevelDiffGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_2093.StraightBevelDiffGear))
        return value

    @property
    def straight_bevel_diff_meshes(self) -> 'List[_1895.StraightBevelDiffGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_1895.StraightBevelDiffGearMesh))
        return value
