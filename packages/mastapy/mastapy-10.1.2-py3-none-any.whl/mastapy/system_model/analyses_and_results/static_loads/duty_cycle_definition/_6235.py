...
class MultiTimeSeriesDataInputFileOptions(_1503.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1338.TextFileDelimiterOptions':
        ...
        return constructor.new(_1338.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
