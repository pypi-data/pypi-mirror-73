...
class SteadyStateSynchronousResponse(_6482.CompoundAnalysisCase):
    ...
    @property
    def steady_state_analysis_options(self) -> '_3064.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3064.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
