...
class SpringDamperHalfCompoundModalAnalysis(_4881.CouplingHalfCompoundModalAnalysis):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4801.SpringDamperHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4801.SpringDamperHalfModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4801.SpringDamperHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4801.SpringDamperHalfModalAnalysis))
        return value
