...
class WormGearAdvancedSystemDeflection(_6300.GearAdvancedSystemDeflection):
    '''WormGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6221.WormGearLoadCase':
        ...
        return constructor.new(_6221.WormGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2352.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2352.WormGearSystemDeflection))
        return value
