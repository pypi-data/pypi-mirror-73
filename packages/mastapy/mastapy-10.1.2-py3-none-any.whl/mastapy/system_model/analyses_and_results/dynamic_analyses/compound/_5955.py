...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5924
...
class CVTBeltConnectionCompoundDynamicAnalysis(_5924.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
