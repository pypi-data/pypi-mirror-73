...
class TorqueConverterPumpGearWhineAnalysis(_5301.CouplingHalfGearWhineAnalysis):
    '''TorqueConverterPumpGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2343.TorqueConverterPumpSystemDeflection':
        ...
        return constructor.new(_2343.TorqueConverterPumpSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
