...
from mastapy.system_model.analyses_and_results.power_flows import _3324, _3309
...
class SynchroniserPowerFlow(_3309.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3324.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3324.SynchroniserHalfPowerFlow))
        return value
