...
class StaticLoadAnalysisCase(_6494.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6196.StaticLoadCase':
        ...
        return constructor.new(_6196.StaticLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
