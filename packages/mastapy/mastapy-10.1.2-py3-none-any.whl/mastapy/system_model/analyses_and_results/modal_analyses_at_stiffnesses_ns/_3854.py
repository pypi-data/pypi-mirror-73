...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3853, _3852, _3747
...
class ZerolBevelGearSetModalAnalysesAtStiffnesses(_3747.BevelGearSetModalAnalysesAtStiffnesses):
    '''ZerolBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3853.ZerolBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3853.ZerolBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3852.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3852.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value
