...
from mastapy.gears.rating.cylindrical.iso6336 import _306, _311, _310
...
class ISO6336AbstractMetalMeshSingleFlankRating(_310.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_306.ISO63362006MeshSingleFlankRating':
        ...
        return constructor.new(_306.ISO63362006MeshSingleFlankRating)(self.wrapped.SingleFlankRatingOfTestGearsForMicropitting) if self.wrapped.SingleFlankRatingOfTestGearsForMicropitting else None

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_311.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_311.ISO6336AbstractMetalGearSingleFlankRating))
        return value
