...
from mastapy.gears.manufacturing.bevel import _582, _596
...
class ManufacturingMachine(_1342.NamedDatabaseItem):
    ...
    @property
    def machine_type(self) -> '_582.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_582.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_582.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_596.WheelFormatMachineTypes':
        ...
        return constructor.new(_596.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_596.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
