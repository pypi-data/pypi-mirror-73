...
from mastapy.gears.gear_designs.cylindrical import _832, _764
...
class CylindricalMeshLinearBacklashSpecification(_832.TolerancedValueSpecification['_764.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
