...
class MeshAlignment(_0.APIBase):
    ...
    @property
    def gear_a_alignment(self) -> '_854.GearAlignment':
        ...
        return constructor.new(_854.GearAlignment)(self.wrapped.GearAAlignment) if self.wrapped.GearAAlignment else None

    @property
    def gear_b_alignment(self) -> '_854.GearAlignment':
        ...
        return constructor.new(_854.GearAlignment)(self.wrapped.GearBAlignment) if self.wrapped.GearBAlignment else None
