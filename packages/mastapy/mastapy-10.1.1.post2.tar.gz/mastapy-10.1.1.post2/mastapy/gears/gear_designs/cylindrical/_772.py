...
class CylindricalGearBasicRack(_771.CylindricalGearAbstractRack):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_830.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_830.TipAlterationCoefficientMethod)(value) if value else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_830.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
