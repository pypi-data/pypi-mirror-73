...
class ElementPropertiesShell(_1484.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_967.ElementPropertiesShellWallType':
        ...
        return constructor.new(_967.ElementPropertiesShellWallType)(value) if value else None
