...
from mastapy.math_utility.stiffness_calculators import _1090
...
class SurfaceToSurfaceContactStiffnessEntity(_1423.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1090.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1090.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
