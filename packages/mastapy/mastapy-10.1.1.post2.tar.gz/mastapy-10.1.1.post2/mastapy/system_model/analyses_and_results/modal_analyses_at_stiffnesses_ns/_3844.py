...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3843, _3842, _3737
...
class ZerolBevelGearSetModalAnalysesAtStiffnesses(_3737.BevelGearSetModalAnalysesAtStiffnesses):
    '''ZerolBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3843.ZerolBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3843.ZerolBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3842.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3842.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value
