...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5247, _5248, _5249
from mastapy.system_model.part_model.gears import _2071, _2069
from mastapy.system_model.analyses_and_results.static_loads import _6118, _6120, _6123
...
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6118.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1874.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6120.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6123.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5249.DesignEntityStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5247.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5247.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5248.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5248.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
