...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3022, _3020, _2967
...
class HypoidGearSetSteadyStateSynchronousResponse(_2967.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse):
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response(self) -> 'List[_3022.HypoidGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSteadyStateSynchronousResponse, constructor.new(_3022.HypoidGearSteadyStateSynchronousResponse))
        return value

    @property
    def hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_3020.HypoidGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSteadyStateSynchronousResponse, constructor.new(_3020.HypoidGearMeshSteadyStateSynchronousResponse))
        return value
