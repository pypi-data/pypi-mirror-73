...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3548, _3468
...
class RootAssemblyParametricStudyTool(_3468.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_3548.ParametricStudyTool':
        ...
        return constructor.new(_3548.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
