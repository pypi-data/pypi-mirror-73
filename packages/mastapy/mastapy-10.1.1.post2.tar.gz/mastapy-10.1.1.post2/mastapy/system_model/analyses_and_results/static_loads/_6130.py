...
from mastapy.system_model.analyses_and_results.static_loads import _6098, _6129, _6110
...
class HarmonicLoadDataJMAGImport(_6129.HarmonicLoadDataImportFromMotorPackages['_6110.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6098.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6098.DataFromJMAGPerSpeed))
        return value
