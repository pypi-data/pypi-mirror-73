...
from mastapy.system_model.imported_fes import _1912, _1935
...
class ImportedFEComponentLoadCase(_6047.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1912.AngleSource':
        ...
        return constructor.new(_1912.AngleSource)(value) if value else None
