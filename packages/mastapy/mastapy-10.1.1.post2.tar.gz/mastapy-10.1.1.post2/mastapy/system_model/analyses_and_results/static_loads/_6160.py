...
class PlanetaryGearSetLoadCase(_6095.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1137.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1137.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2081.PlanetaryGearSet':
