...
class DesignStateOptions(_1498.ColumnInputOptions):
    ...
    @property
    def design_state_destinations(self) -> 'List[_1798.DutyCycleImporterDesignEntityMatch[_5237.DesignState]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStateDestinations, constructor.new(_1798.DutyCycleImporterDesignEntityMatch)[_5237.DesignState])
        return value
