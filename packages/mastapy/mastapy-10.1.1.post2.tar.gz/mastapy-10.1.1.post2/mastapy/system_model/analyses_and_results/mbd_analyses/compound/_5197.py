...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5116
...
class RootAssemblyCompoundMultiBodyDynamicsAnalysis(_5116.AssemblyCompoundMultiBodyDynamicsAnalysis):
    '''RootAssemblyCompoundMultiBodyDynamicsAnalysis
