...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5107, _5109
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5003.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5107.DynamicForceVector3DResult':
        ...
        return constructor.new(_5107.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_5109.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5109.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
