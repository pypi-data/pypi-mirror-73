...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5060, _5071
...
class BeltDriveMultiBodyDynamicsAnalysis(_5071.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''BeltDriveMultiBodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5060.PulleyMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5060.PulleyMultiBodyDynamicsAnalysis))
        return value
