...
class KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis(_5286.ConicalGearSetGearWhineAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2277.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
