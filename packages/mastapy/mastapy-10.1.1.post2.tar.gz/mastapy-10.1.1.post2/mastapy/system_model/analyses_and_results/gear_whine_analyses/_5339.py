...
class KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis(_5333.KlingelnbergCycloPalloidConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2284.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
