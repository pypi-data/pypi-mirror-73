...
class SpringDamperConnectionGearWhineAnalysis(_5289.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2314.SpringDamperConnectionSystemDeflection':
