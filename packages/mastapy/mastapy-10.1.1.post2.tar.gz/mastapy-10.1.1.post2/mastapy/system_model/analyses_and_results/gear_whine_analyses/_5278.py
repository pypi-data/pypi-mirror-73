...
class ConceptCouplingConnectionGearWhineAnalysis(_5289.CouplingConnectionGearWhineAnalysis):
    '''ConceptCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2232.ConceptCouplingConnectionSystemDeflection':
