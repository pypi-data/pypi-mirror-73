...
class PlanetaryConnectionGearWhineAnalysis(_5363.ShaftToMountableComponentConnectionGearWhineAnalysis):
    '''PlanetaryConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2296.PlanetaryConnectionSystemDeflection':
