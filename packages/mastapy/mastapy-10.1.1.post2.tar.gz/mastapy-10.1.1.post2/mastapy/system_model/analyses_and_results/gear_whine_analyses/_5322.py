...
class GearWhineAnalysis(_6483.CompoundAnalysisCase):
    '''GearWhineAnalysis
    ...
    @property
    def single_mesh_whine_analyses(self) -> 'List[_5499.SingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleMeshWhineAnalyses, constructor.new(_5499.SingleMeshWhineAnalysis))
        return value
