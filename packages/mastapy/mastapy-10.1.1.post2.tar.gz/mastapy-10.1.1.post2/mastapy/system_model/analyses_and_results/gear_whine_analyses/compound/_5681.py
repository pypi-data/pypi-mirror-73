...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5669
...
class BevelGearSetCompoundGearWhineAnalysis(_5669.AGMAGleasonConicalGearSetCompoundGearWhineAnalysis):
    '''BevelGearSetCompoundGearWhineAnalysis
