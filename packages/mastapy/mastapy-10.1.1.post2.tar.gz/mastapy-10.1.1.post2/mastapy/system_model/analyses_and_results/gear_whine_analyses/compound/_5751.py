...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5670
...
class RootAssemblyCompoundGearWhineAnalysis(_5670.AssemblyCompoundGearWhineAnalysis):
    '''RootAssemblyCompoundGearWhineAnalysis
