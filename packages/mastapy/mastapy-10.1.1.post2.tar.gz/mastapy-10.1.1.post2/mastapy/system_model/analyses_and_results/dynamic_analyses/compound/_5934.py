...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5922
...
class BevelGearSetCompoundDynamicAnalysis(_5922.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    '''BevelGearSetCompoundDynamicAnalysis
