...
class CouplingConnectionSystemDeflection(_2275.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3251.CouplingConnectionPowerFlow':
