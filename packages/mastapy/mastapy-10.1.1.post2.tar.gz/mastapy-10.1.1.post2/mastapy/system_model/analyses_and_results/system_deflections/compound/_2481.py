...
from mastapy.system_model.analyses_and_results.power_flows.compound import _2839
...
class RootAssemblyCompoundSystemDeflection(_2402.AssemblyCompoundSystemDeflection):
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_2839.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_2839.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None
