...
class ConicalGearCompoundSystemDeflection(_2406.GearCompoundSystemDeflection):
    ...
    @property
    def duty_cycle_rating(self) -> '_323.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_323.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_323.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
