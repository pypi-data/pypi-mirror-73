...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3383
...
class CylindricalPlanetGearCompoundPowerFlow(_3383.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
