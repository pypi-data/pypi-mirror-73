...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(_4387.GearMeshCompoundModalAnalysisAtAStiffness):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4239.ConceptGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4239.ConceptGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_modal_analysis_at_a_stiffness_load_cases(self) -> 'List[_4239.ConceptGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisAtAStiffnessLoadCases, constructor.new(_4239.ConceptGearMeshModalAnalysisAtAStiffness))
        return value
