...
class MeasurementComponentCompoundModalAnalysis(_4959.VirtualComponentCompoundModalAnalysis):
    '''MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4771.MeasurementComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4771.MeasurementComponentModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4771.MeasurementComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4771.MeasurementComponentModalAnalysis))
        return value
