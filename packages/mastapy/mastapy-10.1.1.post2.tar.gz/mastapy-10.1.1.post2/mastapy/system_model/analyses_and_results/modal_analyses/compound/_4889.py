...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4886
...
class CylindricalPlanetGearCompoundModalAnalysis(_4886.CylindricalGearCompoundModalAnalysis):
    '''CylindricalPlanetGearCompoundModalAnalysis
