...
class Clutch(_2118.Coupling):
    ...
    @property
    def spring_type(self) -> '_4990.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_4990.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_4990.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
