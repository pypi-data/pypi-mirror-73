...
from mastapy.bolts import _1054, _1035
...
class BoltMaterial(_1035.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1054.StrengthGrades':
        ...
        return constructor.new(_1054.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1054.StrengthGrades'):
