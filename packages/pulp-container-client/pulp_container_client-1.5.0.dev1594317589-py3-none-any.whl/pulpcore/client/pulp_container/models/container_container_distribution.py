...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, repository_version=None, pulp_created=None, content_guard=None, repository=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
