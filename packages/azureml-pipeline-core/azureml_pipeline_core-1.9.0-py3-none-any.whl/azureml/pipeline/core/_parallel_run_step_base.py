...
DATAPREP_FUSE_PANDAS_PACKAGES = ["azureml-dataprep[fuse,pandas]", "azureml-dataprep[pandas,fuse]", "azureml-automl",
                                 "azureml-train", "azureml-datadrift",
                                 "azureml-contrib-dataset"]
# current packages which also install azureml-dataprep[fuse]
DATAPREP_FUSE_ONLY_PACKAGES = ["azureml-defaults", "azureml-sdk", "azureml-dataprep[fuse]"]
...
Please add azureml-core package in CondaDependencies.""", UserWarning)
        ...
        if not next(findings_dataprep, False):
            ...
            warnings.warn(
                """
ParallelRunStep requires azureml-dataprep[{}] for {} dataset.
