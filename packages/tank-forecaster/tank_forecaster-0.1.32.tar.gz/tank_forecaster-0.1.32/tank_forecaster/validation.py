...
def validate_tank(tank_data, sales_data):
    ...
    val_df.loc[mask_nan, 'output'] = val_df.loc[mask_nan, 'estimated']
    val_df.loc[mask_not_nan, 'output'] = val_df.loc[mask_not_nan, 'actual']

    # for testing purposes, uncomment this
    return val_df

    # for use in forecasting, uncomment this
    # val_df.rename(columns={'ds_x': 'ds', 'output':'y'}, inplace=True)
    # return val_df[['ds', 'y']]
