...
class Layers:
    ...
    def output (self, n_input, n_output, name, activation = None, kreg = None):
    ...
    def _rnn_impl  (self, cell, n_input, units, activation = 'tanh', return_sequences = True, return_state = True, time_major = False, dropout = 0.0, kreg = None, stateful = False):
