...
def add_initial_category_prices_to_shipments(
    ...
    initial_prices = (
        ...
        .dropna(subset=["price_in_eur", "margin_price_in_eur", "proposition_id"], how="all")
        .rename(
            columns={
    ...
    shipments_with_prices = pd.merge(
        ...
        initial_prices[["initial_proposition_id", "category", "initial_margin_price_in_eur", "initial_price_in_eur"]],
