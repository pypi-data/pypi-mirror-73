...
from ovretl.prices_utils.features_functions.calculate_category_prices import (
    pivot_category_prices,
    pivot_category_purchase_prices,
)
...
def add_prices_to_shipments(
    ...
    category_purchase_prices_df = pivot_category_purchase_prices(shipments_with_category_prices_df)
    ...
    shipments_df = merge_all_features(
        ...
        category_purchase_prices_df=category_purchase_prices_df,
    )
