...
class CampaignStateManager:
   ...
   # pylint: disable=invalid-name
    def sagemaker_create_model(self, training_job_name: str) -> str:
        """
    ...
    def sagemaker_update_campaign(self, endpoint_name: str, training_job_name: str):
        """
        ...
        model_name = self.sagemaker_create_model(training_job_name=training_job_name)
    ...
    def update_state(self, campaign: dict, solution: dict):
        ...
        response = self.sagemaker_update_campaign(
            endpoint_name=vendor_campaign.get('EndpointName'),
            training_job_name=vendor_solution.get('TrainingJobName')
        )
