...
from netbox_client.models.writable_inventory_item import WritableInventoryItem  # noqa: E501
...
class TestWritableInventoryItem(unittest.TestCase):
    ...
    def testWritableInventoryItem(self):
        ...
        # model = netbox_client.models.writable_inventory_item.WritableInventoryItem()  # noqa: E501
        pass
