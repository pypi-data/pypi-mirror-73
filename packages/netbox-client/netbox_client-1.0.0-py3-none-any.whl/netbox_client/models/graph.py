...
class Graph(object):
    ...
    def __init__(self, id=None, type=None, weight=None, name=None, template_language=None, source=None, link=None):  # noqa: E501
    ...
    def template_language(self):
        """Gets the template_language of this Graph.  # noqa: E501


        :return: The template_language of this Graph.  # noqa: E501
        :rtype: str
        """
    ...
    def template_language(self, template_language):
        ...
        :param template_language: The template_language of this Graph.  # noqa: E501
        :type: str
        """
        allowed_values = ["django", "jinja2"]  # noqa: E501
        if template_language not in allowed_values:
            raise ValueError(
                "Invalid value for `template_language` ({0}), must be one of {1}"  # noqa: E501
