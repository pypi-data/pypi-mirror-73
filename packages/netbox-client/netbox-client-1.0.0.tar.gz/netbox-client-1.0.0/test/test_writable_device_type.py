...
from netbox_client.models.writable_device_type import WritableDeviceType  # noqa: E501
...
class TestWritableDeviceType(unittest.TestCase):
    ...
    def testWritableDeviceType(self):
        ...
        # model = netbox_client.models.writable_device_type.WritableDeviceType()  # noqa: E501
        pass
