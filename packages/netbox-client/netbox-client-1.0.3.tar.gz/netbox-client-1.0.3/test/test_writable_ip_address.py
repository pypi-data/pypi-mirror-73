...
from netbox_client.models.writable_ip_address import WritableIPAddress  # noqa: E501
...
class TestWritableIPAddress(unittest.TestCase):
    ...
    def testWritableIPAddress(self):
        ...
        # model = netbox_client.models.writable_ip_address.WritableIPAddress()  # noqa: E501
        pass
