...
class SpatialSearchRequestDTO(object):
    ...
    def __init__(self, limit=10, name=None, metadata=None, asset_ids=None, source=None, created_time=None, last_updated_time=None, external_id_prefix=None, spatial_filter=None, crs=None, local_vars_configuration=None):  # noqa: E501
