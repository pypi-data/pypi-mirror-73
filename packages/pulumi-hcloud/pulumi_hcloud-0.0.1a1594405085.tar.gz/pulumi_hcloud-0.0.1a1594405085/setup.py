...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.0.1-alpha.1594405085+8a6835c3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.0.1-alpha.1594405085+8a6835c3`
                """)
            else:
                raise
