...
function GetOciCommandsToLongParams_oce() {
    $ociCommandsToLongParams = @{
        ...
        'oce oce-instance create' = 'admin-email compartment-id defined-tags description freeform-tags from-json help idcs-access-token identity-stripe instance-access-type instance-usage-type max-wait-seconds name object-storage-namespace tenancy-id tenancy-name upgrade-schedule waf-primary-domain wait-for-state wait-interval-seconds'
        ...
        'oce oce-instance update' = 'defined-tags description force freeform-tags from-json help if-match max-wait-seconds oce-instance-id waf-primary-domain wait-for-state wait-interval-seconds'
