...
class Cliente(core.models.Log, core.models.PessoaLog):
    ...
    origem = CompositeForeignKey(core.models.Tipo, on_delete=models.DO_NOTHING, null=True, related_name='cliente_cliente_origem', to_fields={
...
class Endereco(core.models.Log, core.models.EnderecoComplementoLog):
    ...
    origem_codigo = models.CharField(null=True, max_length=200)
    origem_tipo = models.CharField(null=True, max_length=200, default='CLIENTE.ORIGEM')
    origem = CompositeForeignKey(core.models.Tipo, on_delete=models.DO_NOTHING, null=True, related_name='cliente_endereco_origem', to_fields={
        "codigo": "origem_codigo",
        "tipo": "origem_tipo"
    })
...
class Termo(core.models.Log):
    ...
    cliente = models.ManyToManyField('Cliente', through='ClienteTermo', through_fields=('termo', 'cliente'))
...
class ClienteTermo(core.models.Log):
    termo = models.ForeignKey('Termo', on_delete=models.DO_NOTHING, null=True)
