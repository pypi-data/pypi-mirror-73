"""
@file
@brief Copy of `singlehtml.py <https://github.com/sphinx-doc/sphinx/blob/3.x/sphinx/builders/singlehtml.py>`_
...
class CustomSingleFileHTMLBuilder(StandaloneHTMLBuilder):
    """
    ...
    def get_doc_context(self, docname: str, body: str, metatags: str) -> Dict:
        # no relation links...
        toctree = TocTree(self.env).get_toctree_for(
            self.config.master_doc, self, False)
