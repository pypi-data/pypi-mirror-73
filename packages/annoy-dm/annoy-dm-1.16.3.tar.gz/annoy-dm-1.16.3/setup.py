...
cputune = ['-march=ivybridge',]
if platform.machine() == 'ppc64le':
    extra_compile_args += ['-march=ivybridge',]
...
setup(name='annoy-dm',
      version='1.16.3',
      description='Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk. dm-compatible',
      packages=['annoy'],
      ext_modules=[
          Extension(
