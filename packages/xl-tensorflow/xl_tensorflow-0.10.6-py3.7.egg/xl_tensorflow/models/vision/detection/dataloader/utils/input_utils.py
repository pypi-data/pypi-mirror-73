...
def pad_groundtruths_to_fixed_size(gt, n):
    ...
    gt['boxes'] = pad_to_fixed_size(gt['boxes'], n, -1)
    gt['is_crowds'] = pad_to_fixed_size(gt['is_crowds'], n, 0)
    gt['areas'] = pad_to_fixed_size(gt['areas'], n, -1)
    gt['classes'] = pad_to_fixed_size(gt['classes'], n, -1)
    return gt