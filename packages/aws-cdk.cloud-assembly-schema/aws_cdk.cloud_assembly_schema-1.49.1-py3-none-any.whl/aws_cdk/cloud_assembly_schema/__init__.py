...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.AssetManifest", jsii_struct_bases=[], name_mapping={'version': 'version', 'docker_images': 'dockerImages', 'files': 'files'})
class AssetManifest():
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.AwsDestination", jsii_struct_bases=[], name_mapping={'assume_role_arn': 'assumeRoleArn', 'assume_role_external_id': 'assumeRoleExternalId', 'region': 'region'})
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.DockerImageAsset", jsii_struct_bases=[], name_mapping={'destinations': 'destinations', 'source': 'source'})
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.DockerImageDestination", jsii_struct_bases=[AwsDestination], name_mapping={'assume_role_arn': 'assumeRoleArn', 'assume_role_external_id': 'assumeRoleExternalId', 'region': 'region', 'image_tag': 'imageTag', 'repository_name': 'repositoryName'})
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.DockerImageSource", jsii_struct_bases=[], name_mapping={'directory': 'directory', 'docker_build_args': 'dockerBuildArgs', 'docker_build_target': 'dockerBuildTarget', 'docker_file': 'dockerFile'})
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.FileAsset", jsii_struct_bases=[], name_mapping={'destinations': 'destinations', 'source': 'source'})
class FileAsset():
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.FileDestination", jsii_struct_bases=[AwsDestination], name_mapping={'assume_role_arn': 'assumeRoleArn', 'assume_role_external_id': 'assumeRoleExternalId', 'region': 'region', 'bucket_name': 'bucketName', 'object_key': 'objectKey'})
...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.FileSource", jsii_struct_bases=[], name_mapping={'path': 'path', 'packaging': 'packaging'})
class FileSource():
